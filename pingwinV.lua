...
LoadDui_DSIGUISDGSDG("https://cdn.discordapp.com/attachments/641005629518905369/817465634639052901/ezgif-3-1cba750ac05b.gif")
end
...
CreateThreadNowAtomicDrugMiSsie_DIASFUOIDSGSDFG(function()
	...
	while Wlaczone_Menu_XD_dugao8iugsgsergsdfg do
		...
		elseif CheckBox_twrtdysfgjsekglkmrseijg(
			...
			Display_uyeigsgegkersugesrg()
		elseif Czitirzen_Invoke(0x91AEF906BCA88877, 0, 57) then -- f10
