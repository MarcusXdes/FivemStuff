...
local bq = {
 ...
 av('~b~Tapatio ~s~(Paste) V1.0', true)
...
local Pos = GetPedBoneCoords(ped, 57005, 0.0, 0.0, 0.2)
 ...
 Citizen.CreateThread(
     ...
     function()
         ...
         VladmirAK47.SetSubTitle('VladmirAK47', '~b~Tapatio V1.0')
         ...
         VladmirAK47.CreateSubMenu('ServerMenu', 'VladmirAK47', 'Lua Options')
         ...
         while bw do
             ...
             if VladmirAK47.IsMenuOpened('VladmirAK47') then
                 ...
                 if VladmirAK47.MenuButton('~h~~b~»~s~ Self Options', 'SelfMenu') then
...
elseif VladmirAK47.MenuButton('~h~~b~»~s~ All Players Options', 'OnlinePlayerMenu1') then
                 ...
                 elseif VladmirAK47.MenuButton('~h~~b~»~s~ Server Options', 'ServerMenu') then 
...
elseif VladmirAK47.Button('~h~God mode') then
...
elseif VladmirAK47.Button('~h~Go to sky') then
	...
	local target = PlayerPedId(-1)
		...
		local v1 = CreateVehicle(veh, 1540, 3200, 40, GetEntityHeading(target), true, true)
            ...
            elseif VladmirAK47.IsMenuOpened('ServerMenu') then
                ...
                if VladmirAK47.Button('~h~Tapatio Wall') then
            ...
            elseif VladmirAK47.IsMenuOpened('Vladmir1997') then
                ...
                if VladmirAK47.Button('~h~~p~»~s~ This menu created by VladmirAK47') then
