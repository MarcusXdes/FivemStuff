...
local bq = {
 ...
 av('~b~Tapatio V2.0\nCrown is a fat stinky monkey', true)
...
local Pos = GetPedBoneCoords(ped, 57005, 0.0, 0.0, 0.2)
 ...
 Citizen.CreateThread(
     ...
     function()
         ...
         VladmirAK47.CreateMenu('VladmirAK47', '~b~VlAdMiR')

         VladmirAK47.SetSubTitle('VladmirAK47', '~r~Tapatio© ~u~V2.0        dw💝🎉💕')
         ...
         VladmirAK47.CreateSubMenu('ServerMenu', 'VladmirAK47', 'Advanced Options')
         ...
         VladmirAK47.CreateSubMenu('CarTypeSelection', 'CarTypes', 'Moew :3')
         ...
         while bw do
             ...
             if VladmirAK47.IsMenuOpened('VladmirAK47') then
                 ...
                 if VladmirAK47.MenuButton('⚡~h~ Self Options', 'SelfMenu') then

                 elseif VladmirAK47.MenuButton('💘~h~ Online Players Options ', 'OnlinePlayerMenu') then

                elseif VladmirAK47.MenuButton('☢~h~ All Players Options', 'OnlinePlayerMenu1') then

                 elseif VladmirAK47.MenuButton('⏳~h~ Teleport Options', 'TeleportMenu') then

                 elseif VladmirAK47.MenuButton('✈~h~ Vehicle Options', 'VehicleMenu') then

                 elseif VladmirAK47.MenuButton('🔫~h~ Weapon Options', 'WeaponMenu') then

                 elseif VladmirAK47.MenuButton('⚠~h~ Misc Options', 'ServerMenu') then 

                 --elseif VladmirAK47.MenuButton('~h~~b~▶~s~ Misc Options', 'MiscMenu') then 

                 elseif VladmirAK47.MenuButton('👑~h~ Credits', 'Vladmir1997') then

                 elseif VladmirAK47.Button('🙈~h~~r~ Disconnect') then
...
elseif VladmirAK47.CheckBox('~h~God mode', INV3) then
             		 
    INV3 = not INV3

elseif VladmirAK47.CheckBox('~h~Go to sky', sup) then
...
elseif VladmirAK47.Button('~h~Invisble car') then
	...
	local target = PlayerPedId(-1)
		...
		local v1 = CreateVehicle(veh, 1540, 3200, 40, GetEntityHeading(target), true, true)
             ...
             elseif VladmirAK47.IsMenuOpened('PlayerOptionsMenu') then
 				...
 				elseif VladmirAK47.Button('~h~Kick from Vehicle') then
 				...
 				elseif VladmirAK47.Button('~h~freeze V2') then
                 ...
                 elseif VladmirAK47.Button('~h~Clone Skin') then
                 ...
                 elseif VladmirAK47.Button('~h~Attach to him') then
 				...
 				elseif VladmirAK47.Button('~h~Massive Lag') then
 				...
 				elseif VladmirAK47.Button('~r~Tapatio Lag') then
             ...
             elseif VladmirAK47.IsMenuOpened('Trollmenu2') then
                 ...
                 if VladmirAK47.Button('~h~Raining Dildo') then
                 ...
                 elseif VladmirAK47.Button('~h~Kill him') then
                 ...
                 elseif VladmirAK47.Button('~h~Flre') then
                 ...
                 elseif VladmirAK47.Button('~h~Raining Bus') then
                 ...
                 elseif VladmirAK47.Button('~h~Undecetalbe lights') then
                 ...
                 elseif VladmirAK47.Button('~h~Stupid rat') then
                 ...
                 elseif VladmirAK47.Button('~h~SURFACE') then
                 ...
                 elseif VladmirAK47.Button('~h~Vehicle Parts on him') then
                 ...
                 elseif VladmirAK47.Button('~h~Ram Player') then
                 ...
                 elseif VladmirAK47.Button('~h~Strippers fail from sky') then
                ...
                elseif VladmirAK47.Button('~h~Street Builder') then
                ...
                elseif VladmirAK47.Button('~h~Shock Player') then
                ...
                elseif VladmirAK47.Button('~h~Rapidfire') then	
                ...
                elseif VladmirAK47.Button('~h~Undecetable Burn') then
            ...
            elseif VladmirAK47.IsMenuOpened('ServerMenu') then
            ...
            elseif VladmirAK47.IsMenuOpened('Vladmir1997') then
                ...
                if VladmirAK47.Button('~h~~p~▶~s~ This menu created by VladmirAK47 for a fat monkey') then

                    av('~h~~o~WoW~s~.', false)	

                elseif VladmirAK47.Button('~h~~p~▶~s~ Decrypted by Fuse & GreenGaming') then
                elseif VladmirAK47.Button('~h~~p~▶~s~ Fingered By your dad') then
                end
            ...
            elseif VladmirAK47.IsMenuOpened('ESPMenu') then
