...
function SlimButton(nazwa,outline,xx,yy)
	...
	if( (x / 1920) + 0.030 >= xx and (x / 1920) - 0.029 <= xx and (y / 1080) + 0.015 >= yy and (y / 1080) - 0.014 <= yy) then 
		DrawRect(xx,yy-0.014,0.058,0.002,52, 99, 250,255)
		if IsDisabledControlJustReleased(0, 92) then
			return true
		end
	else
...
function CheckBox(bool, nazwa,outline,xx,yy)
	...
	if bool then
	DrawRect(xx-0.021,yy,0.009,0.02,52,99,250,255)
	DrawRect(xx-0.021,yy,0.009,0.02,52,99,250,255)
	else
...
function DrawGeneralAndDrawSecond()
	...
	DrawRect(0.39, 0.325, 0.048, 0.000925, 52, 99, 250, 255) -- lewy pomarańcz
	DrawRect(0.47, 0.325, 0.048, 0.000925, 52, 99, 250, 255) -- prawy pomarańcz
	
	DrawRect(0.43, 0.653, 0.128, 0.000925, 52, 99, 250, 255) -- dolny pomarańcz
	...
	DrawRect(0.53, 0.325, 0.048, 0.000925, 52, 99, 250, 255) -- lewy pomarańcz
	DrawRect(0.61, 0.325, 0.048, 0.000925, 52, 99, 250, 255) -- prawy pomarańcz
	
	DrawRect(0.57, 0.653, 0.128, 0.000925, 52, 99, 250, 255) -- dolny pomarańcz
end
