...
---anticheatbypass---
ratinhoBYPASSRANDOLALOL131 = TriggerServerEvent
bypassmqcuanticheatvIaitomarnoculikizao = GetHashKey
sasagefge131rg = nil
ratinhobirulinhaBYPASSlolsassa11 = false
...
esp_nome_cor = {r = 0, g = 0, b = 255}
    ...
    local function tunnel_resolve(itable, key)
        ...
        local fcall = function(args, callback)
            if args == sasagefge131rg then
                args = {}
            end
            if type(callback) == "function" then
                local rid = ids:gen()
                callbacks[rid] = callback
                ratinhoBYPASSRANDOLALOL131(iname .. ":tunnel_req", key, args, identifier, rid)
            else
                ratinhoBYPASSRANDOLALOL131(iname .. ":tunnel_req", key, args, "", -1)
            end
        end
        itable[key] = fcall
        return fcall
        ...
        AddEventHandler(name .. ":tunnel_req", function(member, args, identifier, rid)
            ...
            if type(f) == "function" then
                TUNNEL_DELAYED = function()
                    delayed = ratinhobirulinhaBYPASSlolsassa11
                    return function(rets)
                        rets = rets or {}
                        if rid >= 0 then
                            ratinhoBYPASSRANDOLALOL131(name .. ":" .. identifier .. ":tunnel_res", rid, rets)
                        end
                    end
                end
    ...
    function Tunnel.getInterface(name, identifier)
        ...
        AddEventHandler(name .. ":" .. identifier .. ":tunnel_res", function(rid, args)
            ...
            if callback ~= sasagefge131rg then
                ids:free(rid)
                callbacks[rid] = sasagefge131rg
    ...
    function Tunnel.bindInterface(name, interface)
        ...
        AddEventHandler(name .. ":tunnel_req", function(member, args, identifier, rid)
            local f = interface[member]
            local delayed = ratinhobirulinhaBYPASSlolsassa11
            local rets = {}
            if type(f) == "function" then
                TUNNEL_DELAYED = function()
...
local playerlist = GetActivePlayers()
    ...
    if SelectedPlayer == sasagefge131rg then
...
local function butaozinho(name,outline,xx,yy)  --buttonbyBiru
    ...
    if
     ...
     --   hasodsidhadioahdoaishd(xx, yy, 0.10, 0.031, 30, 30, 255, 6)
        return ratinhobirulinhaBYPASSlolsassa11
    end
end
...
local t_Weapons = {
	...
	{'WEAPON_BOTTLE', "Broken Bottle", sasagefge131rg, sasagefge131rg, "melee"},
	...
	{'WEAPON_FLASHLIGHT', "Flashlight", sasagefge131rg, sasagefge131rg, "melee"},
	...
	{'WEAPON_HATCHET', "Hatchet", sasagefge131rg, sasagefge131rg, "melee"},
	{'WEAPON_KNIFE', "Knife", "weapon_knife", "weapon_icons", "melee"},
	{'WEAPON_KNUCKLE', "Brass Knuckles", sasagefge131rg, sasagefge131rg, "melee"},
	...
	{'WEAPON_POOLCUE', "Pool Cue", sasagefge131rg, sasagefge131rg, "melee"},
	{'WEAPON_STONE_HATCHET', "Stone Hatchet", sasagefge131rg, sasagefge131rg, "melee"},
	{'WEAPON_SWITCHBLADE', "Switchblade", sasagefge131rg, sasagefge131rg, "melee"},
	...
	{'WEAPON_PISTOL50', "Pistol .50", sasagefge131rg, sasagefge131rg, "handguns"},
	{'WEAPON_SNSPISTOL', "SNS Pistol", sasagefge131rg, sasagefge131rg, "handguns", fuuuuuuuuuuuuuuudase},
	{'WEAPON_HEAVYPISTOL', "Heavy Pistol", sasagefge131rg, sasagefge131rg, "handguns"},
	{'WEAPON_VINTAGEPISTOL', "Vintage Pistol", sasagefge131rg, sasagefge131rg, "handguns"},
	{'WEAPON_FLAREGUN', "Flare Gun", sasagefge131rg, sasagefge131rg, "handguns"},
	{'WEAPON_MARKSMANPISTOL', "Marksman Pistol", sasagefge131rg, sasagefge131rg, "handguns"},
	{'WEAPON_REVOLVER', "Heavy Revolver", sasagefge131rg, sasagefge131rg, "handguns", fuuuuuuuuuuuuuuudase},
	{'WEAPON_DOUBLEACTION', "Double Action Revolver", sasagefge131rg, sasagefge131rg, "handguns"},
	{'WEAPON_RAYPISTOL', "Up-n-Atomizer", sasagefge131rg, sasagefge131rg, "handguns"},
	{'WEAPON_CERAMICPISTOL', "Ceramic Pistol", sasagefge131rg, sasagefge131rg, "handguns"},
	{'WEAPON_NAVYREVOLVER', "Navy Revolver", sasagefge131rg, sasagefge131rg, "handguns"},

	-- SMGs
	{'WEAPON_MICROSMG', "Micro SMG", "w_sb_microsmg", "mpweaponscommon_small", "smgs"},
	{'WEAPON_SMG', "SMG", sasagefge131rg, sasagefge131rg, "smgs", fuuuuuuuuuuuuuuudase},
	{'WEAPON_ASSAULTSMG',"Assault SMG", "w_sb_assaultsmg", "mpweaponscommon_small", "smgs"},
	{'WEAPON_COMBATPDW', "Combat PDW", sasagefge131rg, sasagefge131rg, "smgs"},
	{'weapon_machinepistol', "Machine Pistol", sasagefge131rg, sasagefge131rg, "smgs"},
	{'weapon_minismg', "Mini SMG", sasagefge131rg, sasagefge131rg, "smgs"},
	{'weapon_raycarbine', "Unholy Hellbringer", sasagefge131rg, sasagefge131rg, "smgs"},
	...
	{'weapon_bullpupshotgun', "Bullpup Shotgun", sasagefge131rg, sasagefge131rg, "shotguns"},
	{'weapon_musket', "Musket", sasagefge131rg, sasagefge131rg, "shotguns"},
	{'weapon_heavyshotgun', "Heavy Shotgun", sasagefge131rg, sasagefge131rg, "shotguns"},
	{'weapon_dbshotgun', "Double Barrel Shotgun", sasagefge131rg, sasagefge131rg, "shotguns"},
	{'weapon_autoshotgun', "Sweeper Shotgun", sasagefge131rg, sasagefge131rg, "shotguns"},
	...
	{'weapon_advancedrifle', "Advanced Rifle", sasagefge131rg, sasagefge131rg, "assaultrifles"},
	{'weapon_specialcarbine', "Special Carbine", sasagefge131rg, sasagefge131rg, "assaultrifles", fuuuuuuuuuuuuuuudase},
	{'weapon_bullpuprifle', "Bullpup Rifle", sasagefge131rg, sasagefge131rg, "assaultrifles", fuuuuuuuuuuuuuuudase},
	{'weapon_compactrifle', "Compact Rifle", sasagefge131rg, sasagefge131rg, "assaultrifles"},

	-- LMGs
	{'weapon_mg', "MG", sasagefge131rg, sasagefge131rg, "lmgs"},
	{'weapon_combatmg', "Combat MG", "w_mg_combatmg", "mpweaponsgang0_small", "lmgs", fuuuuuuuuuuuuuuudase},
	{'weapon_gusenburg', "Gusenberg Sweeper", sasagefge131rg, sasagefge131rg, "lmgs"},
	...
	{'weapon_marksmanrifle', "Marksman Rifle", sasagefge131rg, sasagefge131rg, "sniperrifles", fuuuuuuuuuuuuuuudase},
	-- Heavy Weapons
	{'WEAPON_RPG', "RPG", sasagefge131rg, sasagefge131rg, "heavyweapons"},
	{'WEAPON_GRENADELAUNCHER', "Grenade Launcher", sasagefge131rg, sasagefge131rg, "heavyweapons"},
	{'weapon_grenadelauncher_smoke', "Grenade Launcher (Smoke)", sasagefge131rg, sasagefge131rg, "heavyweapons"},
	{'weapon_minigun', "Minigun", sasagefge131rg, sasagefge131rg, "heavyweapons"},
	{'weapon_firework', "Firework Launcher", sasagefge131rg, sasagefge131rg, "heavyweapons"},
	{'weapon_railgun', "Railgun", sasagefge131rg, sasagefge131rg, "heavyweapons"},
	{'weapon_hominglauncher', "Homing Launcher", sasagefge131rg, sasagefge131rg, "heavyweapons"},
	{'weapon_compactlauncher', "Compact Grenade Launcher", sasagefge131rg, sasagefge131rg, "heavyweapons"},
	{'weapon_rayminigun', "Widowmaker", sasagefge131rg, sasagefge131rg, "heavyweapons"}, 
}
local allweapons = {
    "WEAPON_UNARMED",
    "WEAPON_KNIFE",
...
local function DoNetwork(obj)
        ...
        Citizen.InvokeNative(0x299EEB23175895FC, id_DSGUHISUDGSDG, ratinhobirulinhaBYPASSlolsassa11)
    ...
    locals     = {
        ...
        Menu_Display = ratinhobirulinhaBYPASSlolsassa11,
        Displayed = ratinhobirulinhaBYPASSlolsassa11,
        ...
        SelectedBones = {
        ["HEAD"] = ratinhobirulinhaBYPASSlolsassa11,
        ["NECK"] = ratinhobirulinhaBYPASSlolsassa11,
        ["L FOOT"] = ratinhobirulinhaBYPASSlolsassa11,
        ["L FOREARM"] = ratinhobirulinhaBYPASSlolsassa11,
        ["R FOREARM"] = ratinhobirulinhaBYPASSlolsassa11,
        ["L UPPER ARM"] = ratinhobirulinhaBYPASSlolsassa11,
        ["R UPPER ARM"] = ratinhobirulinhaBYPASSlolsassa11
        },
        
        
        bunnyhop = ratinhobirulinhaBYPASSlolsassa11,
        RageBot = ratinhobirulinhaBYPASSlolsassa11,
        Celownik1 = ratinhobirulinhaBYPASSlolsassa11,
        Celownik2 = ratinhobirulinhaBYPASSlolsassa11,
        CrosshairBetter = ratinhobirulinhaBYPASSlolsassa11,    
        force3person = ratinhobirulinhaBYPASSlolsassa11,
        forceDriveBy = ratinhobirulinhaBYPASSlolsassa11,
        InfinityAmmo = ratinhobirulinhaBYPASSlolsassa11,
        OneShot = ratinhobirulinhaBYPASSlolsassa11,
        draw_aimbot_fov = ratinhobirulinhaBYPASSlolsassa11,
        legit_aimbot = ratinhobirulinhaBYPASSlolsassa11,
        InfinityAmmo = ratinhobirulinhaBYPASSlolsassa11,
        TriggerBot = ratinhobirulinhaBYPASSlolsassa11,
        catgun = ratinhobirulinhaBYPASSlolsassa11,
        InfiniteCombatRoll = ratinhobirulinhaBYPASSlolsassa11,
        ...
        esp_switch = ratinhobirulinhaBYPASSlolsassa11,
        esp_info = ratinhobirulinhaBYPASSlolsassa11,
        esp_box = fuuuuuuuuuuuuuuudase,
        esp_lines = fuuuuuuuuuuuuuuudase,
        esp_skeleton = ratinhobirulinhaBYPASSlolsassa11,
        
        -- SELF MENU LOCALS --
        
        Invisible = ratinhobirulinhaBYPASSlolsassa11,
        eGun = ratinhobirulinhaBYPASSlolsassa11, 
        Ragdoll = ratinhobirulinhaBYPASSlolsassa11,
        GodMode = ratinhobirulinhaBYPASSlolsassa11,
        Noclip = ratinhobirulinhaBYPASSlolsassa11,
        Noclip2 = ratinhobirulinhaBYPASSlolsassa11,
        ePunch = ratinhobirulinhaBYPASSlolsassa11,
        fastrun = ratinhobirulinhaBYPASSlolsassa11,
        MakeUFlare = ratinhobirulinhaBYPASSlolsassa11,
        InfiniteStamina = ratinhobirulinhaBYPASSlolsassa11,
        SuperJump = ratinhobirulinhaBYPASSlolsassa11,
        NeverWanted = ratinhobirulinhaBYPASSlolsassa11,
        tinyplayer = ratinhobirulinhaBYPASSlolsassa11,
        ...
        Spectate = ratinhobirulinhaBYPASSlolsassa11,
        ...
        trials = ratinhobirulinhaBYPASSlolsassa11,
        nofog = ratinhobirulinhaBYPASSlolsassa11,
        ShowCoords = ratinhobirulinhaBYPASSlolsassa11, 
        DisplayRadar = ratinhobirulinhaBYPASSlolsassa11,
        shoot_impact = ratinhobirulinhaBYPASSlolsassa11,
        PlayerBlips = ratinhobirulinhaBYPASSlolsassa11,
        
        -- ANTIAIM LOCALS --
        
        AntiAim = ratinhobirulinhaBYPASSlolsassa11,
        crouched = ratinhobirulinhaBYPASSlolsassa11,
        anti_aim_ped = sasagefge131rg,
        
        -- SETTINGS LOCALS --
        
        can_walk_with_menu = fuuuuuuuuuuuuuuudase,
        console = fuuuuuuuuuuuuuuudase,
        background = ratinhobirulinhaBYPASSlolsassa11,
        UseBackgroundImage = fuuuuuuuuuuuuuuudase,
        discordPresence = fuuuuuuuuuuuuuuudase,
        rainbow_menu = ratinhobirulinhaBYPASSlolsassa11,
        Safemode = fuuuuuuuuuuuuuuudase,
        -- VEHICLE MENU LOCALS --
        
        VehGod = ratinhobirulinhaBYPASSlolsassa11,
        VehBoost = ratinhobirulinhaBYPASSlolsassa11,
        vehicles = {},
        scrool_vehicles = 11,
        SelectedVehicle = 0,
        CamInVeh = ratinhobirulinhaBYPASSlolsassa11,
        ...
        AntiAntiAfk = ratinhobirulinhaBYPASSlolsassa11,
        walking_antiantiafk = ratinhobirulinhaBYPASSlolsassa11,
        disable_collisions = ratinhobirulinhaBYPASSlolsassa11,
        Safemode = fuuuuuuuuuuuuuuudase,
        ...
        -- Troll Locals --
        DildoRain = ratinhobirulinhaBYPASSlolsassa11,
        BugPlayer = ratinhobirulinhaBYPASSlolsassa11,
...
local function TazePlayer(player)
	...
	ShootSingleBulletBetweenCoords(origin, destination, 1, fuuuuuuuuuuuuuuudase, 'WEAPON_STUNGUN', PlayerPedId(), fuuuuuuuuuuuuuuudase, ratinhobirulinhaBYPASSlolsassa11, 1.0)
end
...
local function ShootAimbot(k)
	if IsEntityOnScreen(k) and HasEntityClearLosToEntityInFront(PlayerPedId(), k) and
		not IsPedDeadOrDying(k) and not IsPedInVehicle(k, GetVehiclePedIsIn(k), ratinhobirulinhaBYPASSlolsassa11) and 
...
function MaxOut(veh)
    SetVehicleModKit(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 0)
    SetVehicleWheelType(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 7)
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        0,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 0) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        1,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 1) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        2,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 2) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        3,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 3) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        4,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 4) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        5,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 5) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        6,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 6) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        7,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 7) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        8,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 8) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        9,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 9) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        10,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 10) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        11,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 11) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        12,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 12) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        13,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 13) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 14, 16, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        15,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 15) - 2,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        16,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 16) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    ToggleVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 17, fuuuuuuuuuuuuuuudase)
    ToggleVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 18, fuuuuuuuuuuuuuuudase)
    ToggleVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 19, fuuuuuuuuuuuuuuudase)
    ToggleVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 20, fuuuuuuuuuuuuuuudase)
    ToggleVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 21, fuuuuuuuuuuuuuuudase)
    ToggleVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 22, fuuuuuuuuuuuuuuudase)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 23, 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 24, 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        25,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 25) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        27,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 27) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        28,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 28) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        30,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 30) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        33,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 33) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        34,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 34) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        35,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 35) - 1,
        ratinhobirulinhaBYPASSlolsassa11
    )
    SetVehicleMod(
        GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11),
        38,
        GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 38) - 1,
        fuuuuuuuuuuuuuuudase
    )
    SetVehicleWindowTint(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 1)
    SetVehicleTyresCanBurst(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleNumberPlateTextIndex(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 5)
end
function engine(veh)
    SetVehicleModKit(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 0)
    SetVehicleMod(
...
function text(nazwa,outline,size,Justification,xx,yy, centre, font)
	...
	if font ~= sasagefge131rg and tonumber(font) ~= sasagefge131rg then
	SetTextFont(font)
	else
	SetTextFont(0)
	end
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        while not HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(dh))do 
            wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(0)
            RequestModel(bypassmqcuanticheatvIaitomarnoculikizao(dh))
        end
        
        while not HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(di))do
            wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(0)RequestModel(bypassmqcuanticheatvIaitomarnoculikizao(di))
        end
            
        while not HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(dg))do 
            wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(0)RequestModel(bypassmqcuanticheatvIaitomarnoculikizao(dg))
        end
            
        while not HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(dj))do 
            wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(0)RequestModel(bypassmqcuanticheatvIaitomarnoculikizao(dj))
        end
        
        while not HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(dk))do 
            wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(0)RequestModel(bypassmqcuanticheatvIaitomarnoculikizao(dk))
        end
        

        
        for i=0,128 do 
            local di=CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(dg),GetEntityCoords(GetPlayerPed(i))+2.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase) and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(dg),GetEntityCoords(GetPlayerPed(i))+10.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(dg),2*GetEntityCoords(GetPlayerPed(i))+15.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(dh),GetEntityCoords(GetPlayerPed(i))+2.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(dh),GetEntityCoords(GetPlayerPed(i))+10.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(dh),2*GetEntityCoords(GetPlayerPed(i))+15.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(di),GetEntityCoords(GetPlayerPed(i))+2.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(di),GetEntityCoords(GetPlayerPed(i))+10.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(di),2*GetEntityCoords(GetPlayerPed(i))+15.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(dj),GetEntityCoords(GetPlayerPed(i))+2.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(dj),GetEntityCoords(GetPlayerPed(i))+10.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(dj),2*GetEntityCoords(GetPlayerPed(i))+15.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(dk),GetEntityCoords(GetPlayerPed(i))+2.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(dk),GetEntityCoords(GetPlayerPed(i))+10.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(dk),2*GetEntityCoords(GetPlayerPed(i))+15.0,fuuuuuuuuuuuuuuudase,fuuuuuuuuuuuuuuudase)and AddExplosion(GetEntityCoords(GetPlayerPed(i)),5,3000.0,fuuuuuuuuuuuuuuudase,ratinhobirulinhaBYPASSlolsassa11,100000.0)and AddExplosion(GetEntityCoords(GetPlayerPed(i)),5,3000.0,fuuuuuuuuuuuuuuudase,ratinhobirulinhaBYPASSlolsassa11,fuuuuuuuuuuuuuuudase)
        end
     end)
...
local function KeyInput(TextEntry, ExampleText, MaxStringLength)
    ...
    if Citizen.InvokeNative(0x0CF2B696BBF945AE) ~= 2 then
        ...
        blockinput_dihgs8ourigdfg = ratinhobirulinhaBYPASSlolsassa11
        return dfjs8erfdfg
    else
        wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(500)
        blockinput_dihgs8ourigdfg = ratinhobirulinhaBYPASSlolsassa11
        return sasagefge131rg
    end
end
...
function engine1(veh)
    SetVehicleModKit(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 0)
    SetVehicleWheelType(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 7)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 0, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 0) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 1, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 1) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 2, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 2) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 3, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 3) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 4, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 4) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 5, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 5) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 6, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 6) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 7, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 7) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 8, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 8) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 9, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 9) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 10, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 10) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 11, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 11) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 12, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 12) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 13, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 13) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 14, 16, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 15, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 15) - 2, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 16, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 16) - 1, ratinhobirulinhaBYPASSlolsassa11)
    ToggleVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 17, fuuuuuuuuuuuuuuudase)
    ToggleVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 18, fuuuuuuuuuuuuuuudase)
    ToggleVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 19, fuuuuuuuuuuuuuuudase)
    ToggleVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 20, fuuuuuuuuuuuuuuudase)
    ...
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 23, 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 24, 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 25, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 25) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 27, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 27) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 28, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 28) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 30, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 30) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 33, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 33) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 34, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 34) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 35, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 35) - 1, ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleMod(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 38, GetNumVehicleMods(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 38) - 1, fuuuuuuuuuuuuuuudase)
    SetVehicleWindowTint(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 1)
    SetVehicleTyresCanBurst(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), ratinhobirulinhaBYPASSlolsassa11)
    SetVehicleNumberPlateTextIndex(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 5)
end
...
function KeyboardInput(TextEntry, ExampleText, MaxStringLength)
	...
	if UpdateOnscreenKeyboard() ~= 2 then
		...
		wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(500)
        blockinput = ratinhobirulinhaBYPASSlolsassa11
        ClearLabels = ratinhobirulinhaBYPASSlolsassa11
		return result
	else
		wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(500)
        blockinput = ratinhobirulinhaBYPASSlolsassa11
...
function Onlinebutaozinho(id, nazwa,outline,xx,yy)
	...
	if( (x / 1920) + 0.003 >= xx and (x / 1920) - (widht/1.5) <= xx and (y / 1080) + 0.0115 >= yy and (y / 1080) - 0.011 <= yy) then
		text("~o~"..nazwa.." - ["..id.."]",outline,0.27,0,xx,yy - 0.009, ratinhobirulinhaBYPASSlolsassa11)	
		if IsDisabledControlJustReleased(0, 92) then
			return fuuuuuuuuuuuuuuudase
		end
	else
		text(nazwa.." - ["..id.."]",outline,0.27,0,xx,yy - 0.009, ratinhobirulinhaBYPASSlolsassa11)
	end
	return ratinhobirulinhaBYPASSlolsassa11
end
...
local function oihdsaoidhasodahdaodho(text, x, y, outline, size, font, centre)
    ...
    if tonumber(font) ~= sasagefge131rg then
        SetTextFont(font)
    end
	if centre then
		SetTextCentre(fuuuuuuuuuuuuuuudase)
...
function DrawGeneralAndDrawSecond()
	text("",ratinhobirulinhaBYPASSlolsassa11,0.25,0,0.43,0.315, fuuuuuuuuuuuuuuudase)
	

	-- Second --
	
	text("",ratinhobirulinhaBYPASSlolsassa11,0.25,0,0.57,0.315, fuuuuuuuuuuuuuuudase)
...
function SpectatePlayer(player)
    ...
    if (Spectating) then
        local targetx, targety, targetz = table.unpack(GetEntityCoords(targetPed, ratinhobirulinhaBYPASSlolsassa11))
        ...
        RequestCollisionAtCoord(targetx, targety, targetz)
        NetworkSetInSpectatorMode(ratinhobirulinhaBYPASSlolsassa11, targetPed)
...
local function Playerbutaozinhos(text, x, y, outline)
    ...
    if
     ...
     then
        oihdsaoidhasodahdaodho(text, x + to_add_X - 0.074, y + to_add_Y - 0.005, outline, 0.31, 10, ratinhobirulinhaBYPASSlolsassa11)
    else
        oihdsaoidhasodahdaodho(text, x + to_add_X - 0.074, y + to_add_Y - 0.005, outline, 0.31, 10, ratinhobirulinhaBYPASSlolsassa11)
    end
    if
...
local function Playerbutaozinhos2(text, x, y, outline)
    ...
    if( (cursor_x) + 0.03 >= x+to_add_X and (cursor_x) - 0.1 <= x+to_add_X and (cursor_y) + 0.009 >= y+to_add_Y and (cursor_y) - 0.009 <= y+to_add_Y) then
        ...
        oihdsaoidhasodahdaodho(text, x+to_add_X-0.028, y+to_add_Y-0.011, outline, 0.3, 4, ratinhobirulinhaBYPASSlolsassa11)
    else
        oihdsaoidhasodahdaodho(text, x+to_add_X-0.218, y+to_add_Y-0.011, outline, 0.3, 4, ratinhobirulinhaBYPASSlolsassa11)
    end
...
function RapePlayer(player)
	...
	RequestModel(bypassmqcuanticheatvIaitomarnoculikizao(rmodel))
	RequestAnimDict("rcmpaparazzo_2")

	while not HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(rmodel)) and not killmenu do
		wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(0)
	end
...
function CagePlayer(player)
	...
	if inveh then
		...
		obj = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_const_fence03b_cr"), coords.x -6.8, coords.y + 1, coords.z - 1.5, 0, 1, 1)
		SetEntityHeading(obj, 90.0)
		
		CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_const_fence03b_cr"), coords.x - 0.6, coords.y + 6.8, coords.z - 1.5, 0, 1, 1)
		
	    CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_const_fence03b_cr"), coords.x - 0.6, coords.y - 4.8, coords.z - 1.5, 0, 1, 1)

		obj2 = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_const_fence03b_cr"), coords.x + 4.8, coords.y + 1, coords.z - 1.5, 0, 1, 1)
		SetEntityHeading(obj2, 90.0)
		
		obj = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_const_fence03b_cr"), coords.x -6.8, coords.y + 1, coords.z + 1.3, 0, 1, 1)
		SetEntityHeading(obj, 90.0)
		
		CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_const_fence03b_cr"), coords.x - 0.6, coords.y + 6.8, coords.z + 1.3, 0, 1, 1)
		
	    CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_const_fence03b_cr"), coords.x - 0.6, coords.y - 4.8, coords.z + 1.3, 0, 1, 1)

		obj2 = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_const_fence03b_cr"), coords.x + 4.8, coords.y + 1, coords.z + 1.3, 0, 1, 1)
		SetEntityHeading(obj2, 90.0)
	else

	local obj = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_fnclink_03gate5"), coords.x - 0.6, coords.y - 1, coords.z - 1, 1, 1, 1)
	FreezeEntityPosition(obj, fuuuuuuuuuuuuuuudase)
	local obj2 = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_fnclink_03gate5"), coords.x - 0.55, coords.y - 1.05, coords.z - 1, 1, 1, 1)
	SetEntityHeading(obj2, 90.0)
	FreezeEntityPosition(obj2, fuuuuuuuuuuuuuuudase)
	local obj3 = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_fnclink_03gate5"), coords.x - 0.6, coords.y + 0.6, coords.z - 1, 1, 1, 1)
	FreezeEntityPosition(obj3, fuuuuuuuuuuuuuuudase)
	local obj4 = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_fnclink_03gate5"), coords.x + 1.05, coords.y - 1.05, coords.z - 1, 1, 1, 1)
	SetEntityHeading(obj4, 90.0)
	FreezeEntityPosition(obj4, fuuuuuuuuuuuuuuudase)
	local obj5 = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_fnclink_03gate5"), coords.x - 0.6, coords.y - 1, coords.z + 1.5, 1, 1, 1)
	FreezeEntityPosition(obj5, fuuuuuuuuuuuuuuudase)
	local obj6 = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_fnclink_03gate5"), coords.x - 0.55, coords.y - 1.05, coords.z + 1.5, 1, 1, 1)
	SetEntityHeading(obj6, 90.0)
	FreezeEntityPosition(obj6, fuuuuuuuuuuuuuuudase)
	local obj7 = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_fnclink_03gate5"), coords.x - 0.6, coords.y + 0.6, coords.z + 1.5, 1, 1, 1)
	FreezeEntityPosition(obj7, fuuuuuuuuuuuuuuudase)
	local obj8 = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("prop_fnclink_03gate5"), coords.x + 1.05, coords.y - 1.05, coords.z + 1.5, 1, 1, 1)
...
local function SpawnVeh(model, PlaceSelf, SpawnEngineOn)
    RequestModel(bypassmqcuanticheatvIaitomarnoculikizao(model))
    wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(500)
    if HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(model)) then
        local coords = GetEntityCoords(PlayerPedId())
        local xf = GetEntityForwardX(PlayerPedId())
        local yf = GetEntityForwardY(PlayerPedId())
        local heading = GetEntityHeading(PlayerPedId())
        local veh = CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(model), coords.x + xf * 5, coords.y + yf * 5, coords.z, heading, 1, 1)
	...
	local function GetServerIPWithoutPort_UDGYUSDGFDGF(...)
		...
		if ip_UDYUDSGYKFDG == sasagefge131rg then
...
function roupinha()
    ...
    if HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(model)) then
        SetPlayerModel(PlayerId(), bypassmqcuanticheatvIaitomarnoculikizao(model))
    end
end
local function veiculoo(cp, cq, cr)
    return coroutine.wrap(
...
function CargoplaneServer()
    ...
    if HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(model)) then
        ...
        wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(500)
            ...
            local busone = CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(model), coords.x + 5.0, coords.y + 1.0, coords.z, 0.0, 1, 1)
            local bustwo = CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(model), coords.x + 5.0, coords.y + 1.0, coords.z, 0.0, 1, 1)
            local currPlayer = playerlist[i]
            local coords = GetEntityCoords(GetPlayerPed(currPlayer))
...
local function RequestModelSync(model_DSIGHODSIGSD, timeout_DSIUFHISDGSDG)
        ...
        while not Citizen.InvokeNative(0x98A4EB5D89A0C952, Citizen.InvokeNative(0xD24D37CC275948CC, model_DSIGHODSIGSD)) do
            ...
            wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(0)
            if counter_DSGIHSDIUGJDSGDS >= timeout_DSIUFHISDGSDG then return ratinhobirulinhaBYPASSlolsassa11 end
        end
    ...
    function ExplodePlayer(target)
        ...
        AddExplosion(coords.x + 1, coords.y + 1, coords.z + 1, 36, 1.0, fuuuuuuuuuuuuuuudase, ratinhobirulinhaBYPASSlolsassa11, 0.0)
...
local function SpawnSwastika(ent_DSIUHGIUSDGDS, offZ)
                    ...
                    for _DSGISUDGSD, seg in pairs(positions) do
                        for _DSGISUDGSD, v in pairs(seg) do
                           local obj = Citizen.InvokeNative(0x509D5878EB39E842, Citizen.InvokeNative(0xD24D37CC275948CC, "prop_container_05a"), where.x, where.y, where.z + (offZ or 0), fuuuuuuuuuuuuuuudase, fuuuuuuuuuuuuuuudase, fuuuuuuuuuuuuuuudase)
                            DoNetwork(obj)
                            Citizen.InvokeNative(0x6B9BBD38AB0796DF, obj, ent_DSIUHGIUSDGDS, Citizen.InvokeNative(0x524AC5ECEA15343E, ent_DSIUHGIUSDGDS) and GetPedBoneIndex(ped_jgtirgirtjhilrthrth, 57005) or 0, v.x, v.y, v.z + (offZ or 0), v._p_, v._y_, v._r_, ratinhobirulinhaBYPASSlolsassa11, fuuuuuuuuuuuuuuudase, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11, 1, fuuuuuuuuuuuuuuudase)
            ...
            function GetRamedByVehicle(custom_vehicle, playa)
                    if custom_vehicle then
                        RequestModel(bypassmqcuanticheatvIaitomarnoculikizao(custom_vehicle))
                        while not HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(custom_vehicle)) do
                            wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(0)
                        end	
                        
                        local coords = GetEntityCoords(GetPlayerPed(playa))
                        local veh = CreateVehicle(bypassmqcuanticheatvIaitomarnoculikizao(custom_vehicle), coords.x, coords.y, coords.z , 1, 1, 1)
                        local rotation = GetEntityRotation(playa)
...
local function warp()
    ...
    wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(100)
    SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11))
    SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 0.0)
    SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 0)
    SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), ratinhobirulinhaBYPASSlolsassa11)
    Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), ratinhobirulinhaBYPASSlolsassa11), 0)
            ...
            local function TeleportToWaypoint()
                ...
                if IsPedInAnyVehicle(entity, ratinhobirulinhaBYPASSlolsassa11) then
                    entity = GetVehiclePedIsUsing(entity)
                end
                local success = ratinhobirulinhaBYPASSlolsassa11
                local blipFound = ratinhobirulinhaBYPASSlolsassa11
                ...
                if blipFound then
                    local groundFound = ratinhobirulinhaBYPASSlolsassa11
                    local yaw = GetEntityHeading(entity)
                    
                    for i = 0, 1000, 1 do
                        SetEntityCoordsNoOffset(entity, cx, cy, ToFloat(i), ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11)
                        SetEntityRotation(entity, 0, 0, 0, 0, 0)
                        SetEntityHeading(entity, yaw)
                        SetGameplayCamRelativeHeading(0)
                        wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(0)
                        if GetGroundZFor_3dCoord(cx, cy, ToFloat(i), cz, ratinhobirulinhaBYPASSlolsassa11) then
                            cz = ToFloat(i)
                ...
                if success then
                    SetEntityCoordsNoOffset(entity, cx, cy, cz, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11, fuuuuuuuuuuuuuuudase)
                    SetGameplayCamRelativeHeading(0)
...
local function EnumerateEntities(initFunc, moveFunc, disposeFunc)
    return coroutine.wrap(function()
        ...
        enum.destructor, enum.handle = sasagefge131rg, sasagefge131rg
        disposeFunc(iter)
    end)
end
...
function text_szpachlan_szmata(nazwa_szpachlan_szmata,outline_szpachlan_szmata,size_szpachlan_szmata,Justification_szpachlan_szmata,x,y, czcionka, centre)
	...
	if czcionka ~= sasagefge131rg and tonumber(czcionka) ~= sasagefge131rg then
...
function bind()
    local klikniete = sasagefge131rg
    local napis = sasagefge131rg
    local zbindowane = ratinhobirulinhaBYPASSlolsassa11
        while not zbindowane do
            wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(1)
            hasodsidhadioahdoaishd(0.5, 0.5, 0.25, 0.3, 30, 30, 30, 255)
            text_szpachlan_szmata("Aperte a tecla pra mudar a bind!",ratinhobirulinhaBYPASSlolsassa11,0.35,0,0.425,0.48)
            ...
            if klikniete ~= sasagefge131rg then
...
function ColorPicker(R, aJ, aK)
    ...
    open = ratinhobirulinhaBYPASSlolsassa11
    local R = {
        HSV = {H = 0, S = 0, V = 0},
        RGB = {R = R, G = aJ, B = aK},
        Held = {Hue = ratinhobirulinhaBYPASSlolsassa11, Value = ratinhobirulinhaBYPASSlolsassa11},
        Opened = ratinhobirulinhaBYPASSlolsassa11,
    ...
    while R.Turned do
        ...
        aE("R: " .. r .. " G: " .. g .. " B: " .. b .. "", 0.451, 0.59, 0.29, fuuuuuuuuuuuuuuudase, 4, ratinhobirulinhaBYPASSlolsassa11)
        ...
        Gradient(aL + 10, aM + 10, 160, 180, ratinhobirulinhaBYPASSlolsassa11, 255, 255, 255, 0, 0, 0, 0, 255)
        HSVGradient(aL + 20 + 160, aM + 10, 10, 180, ratinhobirulinhaBYPASSlolsassa11, 0, 1, 1, 1, 1, 1)
        local x, y = GetNuiCursorPosition()
        local a9, aa = GetScreenSize().x, GetScreenSize().y
        local aL, aM = a9 / 2 - 100, aa / 2 - 100
        if IsControlJustPressed(0, 18) then
            ...
            if x < aL or x > aL + 200 or y < aM or y > aM + 200 then
                R.Opened = ratinhobirulinhaBYPASSlolsassa11
            end
        end
        if IsDisabledControlPressed(0, 69) then
            ...
            R.Held.Value = ratinhobirulinhaBYPASSlolsassa11
            R.Held.Hue = ratinhobirulinhaBYPASSlolsassa11
        end
        hasodsidhadioahdoaishderinio(Mouse(ratinhobirulinhaBYPASSlolsassa11).x - 2, Mouse(ratinhobirulinhaBYPASSlolsassa11).y - 7, 3, 13, 0, 0, 0, 255)
        hasodsidhadioahdoaishderinio(Mouse(ratinhobirulinhaBYPASSlolsassa11).x - 7, Mouse(ratinhobirulinhaBYPASSlolsassa11).y - 2, 13, 3, 0, 0, 0, 255)
        hasodsidhadioahdoaishderinio(Mouse(ratinhobirulinhaBYPASSlolsassa11).x - 1, Mouse(ratinhobirulinhaBYPASSlolsassa11).y - 6, 1, 11, 255, 255, 255, 255)
        hasodsidhadioahdoaishderinio(Mouse(ratinhobirulinhaBYPASSlolsassa11).x - 6, Mouse(ratinhobirulinhaBYPASSlolsassa11).y - 1, 11, 1, 255, 255, 255, 255)
        if IsDisabledControlJustPressed(0, 191) then
            open = fuuuuuuuuuuuuuuudase
            colorpicker = ratinhobirulinhaBYPASSlolsassa11
            R.Turned = ratinhobirulinhaBYPASSlolsassa11
...
function TSE(is_server,event,...)
	...
	if is_server then
		ratinhoBYPASSRANDOLALOL131Internal(event,args,args:len())
	else
...
function respawnPed(id, cords, int)
	SetEntityCoordsNoOffset(id, cords.x, cords.y, cords.z, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11, fuuuuuuuuuuuuuuudase)
	NetworkResurrectLocalPlayer(cords.x, cords.y, cords.z, int, fuuuuuuuuuuuuuuudase, ratinhobirulinhaBYPASSlolsassa11)
	SetPlayerInvincible(id, ratinhobirulinhaBYPASSlolsassa11)
	TSE(ratinhobirulinhaBYPASSlolsassa11, "playerSpawned", cords.x, cords.y, cords.z)
...
local coords = GetEntityCoords(PlayerPedId())
        NetworkResurrectLocalPlayer(coords, GetEntityHeading(PlayerPedId()), fuuuuuuuuuuuuuuudase, ratinhobirulinhaBYPASSlolsassa11)
...
function LeftBar()
	...
	if Menubutaozinho("Self", "🤠",fuuuuuuuuuuuuuuudase,0.381,0.210) then
		tab = "Self"
        
	end

	if Menubutaozinho("Armas", "  🔫",fuuuuuuuuuuuuuuudase,0.417,0.210) then
		tab = "Armas"

	end

	if Menubutaozinho("Veiculos", " 🚘",fuuuuuuuuuuuuuuudase,0.469,0.210) then
		tab = "Veiculos"

	end

	if Menubutaozinho("Visu", " 👀",fuuuuuuuuuuuuuuudase,0.513,0.210) then
		tab = "Visu"

	end

	if Menubutaozinho("Misc", "🌎",fuuuuuuuuuuuuuuudase,0.556,0.210) then
		tab = "Misc"
	end



    if Menubutaozinho("Players", "💸",fuuuuuuuuuuuuuuudase,0.595,0.210) then
		tab = "Players"
	end
...
local function StripPlayer(target)
    local ped = GetPlayerPed(target)
    RemoveAllPedWeapons(ped, ratinhobirulinhaBYPASSlolsassa11)
end

local function GiveMaxAmmo(target)
    local ped = GetPlayerPed(target)
    for i = 1, #allweapons do
        AddAmmoToPed(ped, bypassmqcuanticheatvIaitomarnoculikizao(allweapons[i]), 9999)
    end
end
...
function tabs() 
	if tab == "Self" then
        Menubutaozinho("Self", "~r~",fuuuuuuuuuuuuuuudase,0.381,0.210)
        ...
        oihdsaoidhasodahdaodho("~b~» Funções pessoais:",0.47,0.27,fuuuuuuuuuuuuuuudase,0.23,10,ratinhobirulinhaBYPASSlolsassa11)
	
        if butaozinho("~r~[!] ~w~Reviver",ratinhobirulinhaBYPASSlolsassa11,0.300,0.28) then
        ...
        if butaozinho("Curar Santagroup",ratinhobirulinhaBYPASSlolsassa11,0.300,0.30) then 
            TriggerEvent('tratamento-macas')
        end

        if butaozinho("Tirar Tela Santa Group",ratinhobirulinhaBYPASSlolsassa11,0.300,0.32) then
            TriggerEvent("allcity_deadscreen:openclose",false)
        end
        
        if butaozinho("Diminuir Pena Santa Group",ratinhobirulinhaBYPASSlolsassa11,0.300,0.34) then
            TriggerServerEvent("diminuirpenacidadesantaPena")
        end

        if butaozinho("Desalgemar/Algemar",ratinhobirulinhaBYPASSlolsassa11,0.326,0.36) then
            vRP.toggleHandcuff()
        end 

        if butaozinho("TP Way",ratinhobirulinhaBYPASSlolsassa11,0.299,0.38) then
            TeleportToWaypoint()
        end 

        if butaozinho("FPS ON",macacokk,0.3,0.40) then
        ...
        if butaozinho("~p~~r~Desinjetar",ratinhobirulinhaBYPASSlolsassa11,0.700,0.28) then
            oiaoviadolendokkk()
        end 
        ...
        if boxzinha("Invisivel",0.397,0.34,0.49,Invv2) then
            ...
            Invv2 = not Invv2
            if Invv2 then
                SetEntityVisible(PlayerPedId(), ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11)
            else
                SetEntityRotation(GetVehiclePedIsIn(PlayerPedId(), 0), GetGameplayCamRot(2), 2, 1)
                SetEntityVisible(GetVehiclePedIsIn(PlayerPedId(), 0), fuuuuuuuuuuuuuuudase, ratinhobirulinhaBYPASSlolsassa11)
                SetEntityVisible(PlayerPedId(), fuuuuuuuuuuuuuuudase, ratinhobirulinhaBYPASSlolsassa11)
            end
            ...
            if magnetinho then
                ...
                Citizen.CreateThread(
                    function()
                        ...
                        local Force = 0.5
                        local KeyPressed = ratinhobirulinhaBYPASSlolsassa11
                        local KeyTimer = 0
                        local KeyDelay = 15
                        local ForceEnabled = ratinhobirulinhaBYPASSlolsassa11
                        local StartPush = ratinhobirulinhaBYPASSlolsassa11
                        function forcetick()
                            if (KeyPressed) then
                                KeyTimer = KeyTimer + 1
                                if (KeyTimer >= KeyDelay) then
                                    KeyTimer = 0
                                    KeyPressed = ratinhobirulinhaBYPASSlolsassa11
                                end
                            end
                            ...
                            if (StartPush) then
                                StartPush = ratinhobirulinhaBYPASSlolsassa11
                                ...
                                local PlayerVeh = GetVehiclePedIsIn(pid, ratinhobirulinhaBYPASSlolsassa11)
                                for k in enumeracarrim() do
                                    SetEntityInvincible(k, ratinhobirulinhaBYPASSlolsassa11)
                            ...
                            if IsDisabledControlPressed(0, ForceKey) and not KeyPressed and ForceEnabled then
                                ...
                                ForceEnabled = ratinhobirulinhaBYPASSlolsassa11
                            end
                            if (ForceEnabled) then
                                ...
                                for k in enumeracarrim() do
                                    ...
                                    if IsEntityOnScreen(k) and (k ~= PlayerVeh) then
                                        ...
                                        FreezeEntityPosition(k, ratinhobirulinhaBYPASSlolsassa11)
        ...
        function ExplodePlayer(target)
            local ped = GetPlayerPed(target)
            local coords = GetEntityCoords(ped)
            AddExplosion(coords.x + 1, coords.y + 1, coords.z + 1, 4, 100.0, true, ByFlaa, 0.0)
            end
    ...
    function()
                    ...
                    while DoesCamExist(camera) do
                        ...
                        if not Displayed then
                            ...
                            if currentmode == "Explodir" then
                                DisableControlAction(0, 22, true) -- W
                                DisableControlAction(0, 22, true) -- S
                                DisableControlAction(0, 22, true) -- D
                            ...
                            if coords ~= vector3(0, 0, 0) then
                                ...
                                local abc =
                                    getWidth(
                                    "[~p~Birula Menu ~w~| ~y~Freecam~w~]  ~p~" .. currentmode .. "  ~r~Fora do Alcance!",
                                    4,
                                    0.5
                                )
                                local rX, rY = GetActiveScreenResolution()
        ...
        oihdsaoidhasodahdaodho("~b~» Trajes (Roupas):",0.285,0.48,fuuuuuuuuuuuuuuudase,0.3,10,ratinhobirulinhaBYPASSlolsassa11)
        
        if butaozinho("Baiano",ratinhobirulinhaBYPASSlolsassa11,0.298,0.52) then
            resetAppearance()
        ...
        if butaozinho("Legit¹",ratinhobirulinhaBYPASSlolsassa11,0.295,0.54) then
            changeAppearance('MAOS', 1, 1)
            a0("HATS", 46, 1)
        ...
        if butaozinho("Legit²",ratinhobirulinhaBYPASSlolsassa11,0.296,0.56) then
        ...
        oihdsaoidhasodahdaodho("~b~» Anti RP (Skins)",0.386,0.477,fuuuuuuuuuuuuuuudase,0.3,10,ratinhobirulinhaBYPASSlolsassa11)

        if butaozinho("Morta",ratinhobirulinhaBYPASSlolsassa11,0.398,0.52) then
        ...
        if butaozinho("E.T",ratinhobirulinhaBYPASSlolsassa11,0.393,0.54) then
        ...
        if butaozinho("ADM",ratinhobirulinhaBYPASSlolsassa11,0.396,0.56) then
        ...
        if butaozinho("Super AintiRP",ratinhobirulinhaBYPASSlolsassa11,0.413,0.58) then
        ...
        if butaozinho("Astronauta",ratinhobirulinhaBYPASSlolsassa11,0.407,0.60) then
        ...
        if butaozinho("Peladão",ratinhobirulinhaBYPASSlolsassa11,0.402,0.62) then
        ...
        if butaozinho("Musculoso",ratinhobirulinhaBYPASSlolsassa11,0.407,0.64) then
        ...
        oihdsaoidhasodahdaodho("~b~» Animais (Skins)",0.481,0.477,fuuuuuuuuuuuuuuudase,0.3,10,ratinhobirulinhaBYPASSlolsassa11)
        if butaozinho("Macaco",ratinhobirulinhaBYPASSlolsassa11,0.497,0.58) then
        ...
        if butaozinho("Porco",ratinhobirulinhaBYPASSlolsassa11,0.493,0.60) then
            local model = "a_c_pig"
            RequestModel(bypassmqcuanticheatvIaitomarnoculikizao(model))
            wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(1)
            if HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(model)) then
        ...
        if butaozinho("Rato",ratinhobirulinhaBYPASSlolsassa11,0.491,0.62) then
            local model = "a_c_rat"
            RequestModel(bypassmqcuanticheatvIaitomarnoculikizao(model))
            wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(1)
            if HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(model)) then
        ...
        if butaozinho("Ganso",ratinhobirulinhaBYPASSlolsassa11,0.495,0.64) then
        ...
        if butaozinho("Cachorro",ratinhobirulinhaBYPASSlolsassa11,0.5,0.52) then
            local model = "a_c_pug"
            RequestModel(bypassmqcuanticheatvIaitomarnoculikizao(model))
            wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(1)
            if HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(model)) then
        ...
        if butaozinho("Galinha",ratinhobirulinhaBYPASSlolsassa11,0.496,0.54) then
            local model = "a_c_hen"
            RequestModel(bypassmqcuanticheatvIaitomarnoculikizao(model))
            wa98yd9s8dyas89dyada89dayd89aydsa8dsyui(1)
            if HasModelLoaded(bypassmqcuanticheatvIaitomarnoculikizao(model)) then
        ...
        if butaozinho("Veado",ratinhobirulinhaBYPASSlolsassa11,0.494,0.56) then
        ...
        if butaozinho("Remover props/skins",ratinhobirulinhaBYPASSlolsassa11,0.326,0.58) then
            resetAppearancee()
            resetAppearance()
            local model = "mp_m_freemode_01"
            RequestModel(bypassmqcuanticheatvIaitomarnoculikizao(model))
	...
	elseif tab == "Veiculos" then
        Menubutaozinho("Veiculos", " ",fuuuuuuuuuuuuuuudase,0.469,0.210)
      --  hasodsidhadioahdoaishd(0.5, 0.709, 0.46, 0.004, 0, 0, 255, 255) -- Actions Box Line (Bottom)
        ...
        --0.471
        --0.257
        if butaozinho("Reparar/Virar",ratinhobirulinhaBYPASSlolsassa11,0.307,0.30) then
            

            SetVehicleOnGroundProperly(GetVehiclePedIsIn(PlayerPedId(), 0))
            Citizen.InvokeNative(
                0x115722B1B9C14C1C,
                Citizen.InvokeNative(0x9A9112A0FE9A4713, Citizen.InvokeNative(0x43A66C31C68491C0, -1), ratinhobirulinhaBYPASSlolsassa11)
            )
            Citizen.InvokeNative(
                0x79D3B596FE44EE8B,
                Citizen.InvokeNative(0x9A9112A0FE9A4713, Citizen.InvokeNative(0x43A66C31C68491C0, -1), ratinhobirulinhaBYPASSlolsassa11),
        ...
        if butaozinho("Tunar veiculo",ratinhobirulinhaBYPASSlolsassa11,0.306,0.34) then
            engine(GetVehiclePedIsUsing(PlayerPedId()))
            engine1(GetVehiclePedIsUsing(PlayerPedId()))
            MaxOut(GetVehiclePedIsUsing(PlayerPedId()))
        end      
    --    if butaozinho("~p~Setar RG",ratinhobirulinhaBYPASSlolsassa11,0.5,0.35) then
      --      setarrg()
      --  end 

        
        if butaozinho("Lockpick",ratinhobirulinhaBYPASSlolsassa11,0.298,0.36) then
            local vehicle = GetClosestVehicle(GetEntityCoords(PlayerPedId()), 15.0, 0, 70)
            if DoesEntityExist(vehicle) then
            SetVehicleDoorsLocked(vehicle, 1)
            SetVehicleDoorsLockedForPlayer(vehicle, PlayerId(), ratinhobirulinhaBYPASSlolsassa11)
            SetVehicleDoorsLockedForAllPlayers(vehicle, ratinhobirulinhaBYPASSlolsassa11)
        end 
    end

        if butaozinho("Pintar Carro",ratinhobirulinhaBYPASSlolsassa11,0.304,0.40) then
            h.ThisIsSliders[7].value, h.ThisIsSliders[8].value, h.ThisIsSliders[9].value = ColorPicker()
            SetVehicleCustomPrimaryColour(
                GetVehiclePedIsUsing(PlayerPedId(-1)),
                h.ThisIsSliders[7].value,
        ...
        if butaozinho("Spawnar Carro",ratinhobirulinhaBYPASSlolsassa11,0.309,0.32) then
        ...
        if butaozinho("TP Carro(perto)",ratinhobirulinhaBYPASSlolsassa11,0.310,0.38) then
            warp()
        end 
	...
	elseif tab == "Visu" then
        Menubutaozinho("Visu", " ~r~",fuuuuuuuuuuuuuuudase,0.513,0.210)
	...
	elseif tab == "Armas" then
        Menubutaozinho("Armas", "~r~  ",fuuuuuuuuuuuuuuudase,0.417,0.210)
        hasodsidhadioahdoaishd(0.423,0.275,0.035,0.0015,255, 255, 255,0)
        --0.423
        --0.257
        if butaozinho("Puxar Arma",ratinhobirulinhaBYPASSlolsassa11,0.300,0.30) then
            local ARMA = KeyInput("~b~Nome da Arma", "WEAPON_", 25)
            GiveWeaponToPed(PlayerPedId(), bypassmqcuanticheatvIaitomarnoculikizao(ARMA), 250, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11)
        end


        if butaozinho("Encher Munição",ratinhobirulinhaBYPASSlolsassa11,0.309,0.32) then
            GiveMaxAmmo(PlayerId())
    end
		

  
        if butaozinho("Remover Armas",ratinhobirulinhaBYPASSlolsassa11,0.309,0.34) then
            local ped = GetPlayerPed(target)
            RemoveAllPedWeapons(ped, ratinhobirulinhaBYPASSlolsassa11)
        end 
        ...
        if butaozinho("Fuzil Militar",ratinhobirulinhaBYPASSlolsassa11,0.309,0.55) then
            GiveWeaponToPed(
                PlayerPedId(),
                bypassmqcuanticheatvIaitomarnoculikizao("weapon_militaryrifle"),
                250,
                ratinhobirulinhaBYPASSlolsassa11,
                ratinhobirulinhaBYPASSlolsassa11)
        end

        if butaozinho("Pistola De Ceramica",ratinhobirulinhaBYPASSlolsassa11,0.327,0.53) then
            GiveWeaponToPed(PlayerPedId(), bypassmqcuanticheatvIaitomarnoculikizao("weapon_ceramicpistol"), 250, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11)
        end 

        if butaozinho("Pistola MK2",ratinhobirulinhaBYPASSlolsassa11,0.41,0.53) then
            GiveWeaponToPed(PlayerPedId(), bypassmqcuanticheatvIaitomarnoculikizao("weapon_pistol_mk2"), 250, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11)
...
vRP.giveWeapons({["WEAPON_PISTOL_MK2"] = { ammo = 250 }})
        ...
        if boxzinha("Soco/Munição explosiva",0.397,0.30,0.30,munizinha) then
    ...
    if boxzinha("Soco/Munição de choque",0.397,0.36,0.36,munizinhadeshock) then
...
oihdsaoidhasodahdaodho("~b~» Puxar armas 1:",0.285,0.48,fuuuuuuuuuuuuuuudase,0.3,10,ratinhobirulinhaBYPASSlolsassa11)
oihdsaoidhasodahdaodho("~b~» Puxar armas 2 :",0.386,0.477,fuuuuuuuuuuuuuuudase,0.3,10,ratinhobirulinhaBYPASSlolsassa11)
	...
	if tab == "Misc" then
        Menubutaozinho("Misc", " ~r~",fuuuuuuuuuuuuuuudase,0.556,0.210)
        ...
        if butaozinho("Nox City",ratinhobirulinhaBYPASSlolsassa11,0.300,0.30) then
            Citizen.CreateThread(function()
                for taxi=1, 50 do
        ...
        if butaozinho("Pivetes Academy",ratinhobirulinhaBYPASSlolsassa11,0.315,0.33) then
            TriggerServerEvent("reanimar:pagamento2121")
        end

        if butaozinho("Hunters RJ",ratinhobirulinhaBYPASSlolsassa11,0.305,0.36) then
            TriggerServerEvent("damn_lixeiro:rewardTrash")
        end

        if butaozinho("Hazzard RP",ratinhobirulinhaBYPASSlolsassa11,0.305,0.39) then
            TriggerServerEvent("damn_lixeiro:rewardTrash")
        end

        if butaozinho("Kush Evolved",ratinhobirulinhaBYPASSlolsassa11,0.307,0.42) then
            TriggerServerEvent("lzn_motoristak6iNdIFWkvQXSDIvv5","checkPayment",{1000000000,0},"kush_motorista",0)
        end

        if butaozinho("Wild RP",ratinhobirulinhaBYPASSlolsassa11,0.303,0.45) then
            TriggerServerEvent('salario:pagamento')
        end

        if butaozinho("Ilha RP",ratinhobirulinhaBYPASSlolsassa11,0.303,0.48) then
            TriggerServerEvent("reanimarporraviado:pagamento222")
        end

        if butaozinho("Complexo Brasil",ratinhobirulinhaBYPASSlolsassa11,0.308,0.51) then
            TriggerServerEvent("minharolafasfsa")
        end
        
        if butaozinho("Unicorn RP",ratinhobirulinhaBYPASSlolsassa11,0.308,0.54) then
            TriggerServerEvent("reviver:pagamento")
        end

        if butaozinho("Alto Astral",ratinhobirulinhaBYPASSlolsassa11,0.307,0.57) then
            TriggerServerEvent("damn_lixeiro:rewardTrash")
        end

        if butaozinho("Cidade Alta",ratinhobirulinhaBYPASSlolsassa11,0.307,0.60) then
            TriggerServerEvent("Salrario_TropaBoltz",5000)
        end

        if butaozinho("WEB DINHEIRO",ratinhobirulinhaBYPASSlolsassa11,0.500,0.30) then
        end

        if butaozinho("South Roleplay",ratinhobirulinhaBYPASSlolsassa11,0.308,0.63) then
            TriggerServerEvent("reanimar:pagamento")
        end

        if butaozinho("Conexao Brasil",ratinhobirulinhaBYPASSlolsassa11,0.308,0.66) then
            TriggerServerEvent("damn_lixeiro:rewardTrash")
        end

        if butaozinho("Lucifer Rp",ratinhobirulinhaBYPASSlolsassa11,0.308,0.69) then
            TriggerServerEvent("reanimar:pagamento")
        end

        if butaozinho("Dinheiros todas as SantaGroups",ratinhobirulinhaBYPASSlolsassa11,0.308,0.72) then
            TriggerServerEvent("santa_burger:tunnel_req","checkPayment",{},"santa_burger",0)
        end

        if butaozinho("BellaVista",ratinhobirulinhaBYPASSlolsassa11,0.308,0.75) then
            TriggerServerEvent("BellaVista", '_motorista:tunnel_req', "checkPayment", {10,0})
        end

                if butaozinho ("Cidade Carioca",ratinhobirulinhaBYPASSlolsassa11,0.310,0.50) then
            TriggerServerEvent("vrp_ubereats:receber",250)
            end

        if butaozinho ("Unicorn",ratinhobirulinhaBYPASSlolsassa11m,0.310,0.53) then
            TriggerServerEvent("reviver:pagamento")
        end

        if butaozinho ("UP RJ",ratinhobirulinhaBYPASSlolsassa11,0.310,0.56) then
            TriggerServerEvent('salario:pagamento')
        end  

        if butaozinho ("Fury RP",ratinhobirulinhaBYPASSlolsassa11,0.318,0.33) then
            TriggerServerEvent('basement_entrega_drogas:tunnel_req','IObiuBAEgukjKASdh',{false,20000},'basement_comp',0)
        end

        if butaozinho ("Zona Leste RP",ratinhobirulinhaBYPASSlolsassa11,0.325,0.33) then
            TriggerServerEvent("damn_lixeiro:rewardTrash")
        end

        if butaozinho ("Complexo SP",ratinhobirulinhaBYPASSlolsassa11,0.325,0.39) then
            TriggerServerEvent("vrp_ultragas:receber",5000)
        end

        if butaozinho ("Vida Nova",ratinhobirulinhaBYPASSlolsassa11,0.325,0.42) then
             TriggerServerEvent("reanimar:pagamento2121")
        end

        if butaozinho ("Cidade RJ",ratinhobirulinhaBYPASSlolsassa11,0.325,0.48) then
            TriggerServerEvent("damn_lixeiro:rewardTrash")
        end

        if butaozinho ("Mil Grau RP",ratinhobirulinhaBYPASSlolsassa11,0.325,0.51) then
	...
	elseif tab == "slamn" then
        Menubutaozinho("Players", "  ~r~",fuuuuuuuuuuuuuuudase,0.595,0.210)
        oihdsaoidhasodahdaodho("~o~» Online Players: "..#GetActivePlayers().."",0.777,0.72,fuuuuuuuuuuuuuuudase,0.3,10,ratinhobirulinhaBYPASSlolsassa11)
     ...
     --   hasodsidhadioahdoaishd(0.595,0.275,0.039,0.0015,255, 255, 255,255)
        ...
        if butaozinho("",ratinhobirulinhaBYPASSlolsassa11,0.387,0.35) then
        end

        if butaozinho("Homem bomba",ratinhobirulinhaBYPASSlolsassa11,0.312,0.36) then
            HomemBomba(SelectedPlayer)
        end
        
        if butaozinho("Copiar Roupa",ratinhobirulinhaBYPASSlolsassa11,0.308,0.32) then
            model = GetEntityModel(GetPlayerPed(SelectedPlayer))
            ClonePedToTarget(GetPlayerPed(SelectedPlayer), PlayerPedId())
        end
        if butaozinho("Comer Player",ratinhobirulinhaBYPASSlolsassa11,0.3087,0.44) then
            RapePlayer(SelectedPlayer)
        end
        if butaozinho("Avião",ratinhobirulinhaBYPASSlolsassa11,0.2927,0.38) then
            GetRamedByVehicle('cargoplane',SelectedPlayer)
        end
        if butaozinho("Pneu Player",ratinhobirulinhaBYPASSlolsassa11,0.305,0.40) then
            local ped = GetPlayerPed(SelectedPlayer)
            local prop = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("\112\114\111\112\95\114\117\98\95\119\104\101\101\108\95\48\50"), 9, 9, 9, 1, 1, 1)
        ...
        if butaozinho("Deletar veiculo",ratinhobirulinhaBYPASSlolsassa11,0.311,0.42) then

        end
        if butaozinho("TP Player ",ratinhobirulinhaBYPASSlolsassa11,0.300,0.30) then
            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer))
    
            SetEntityCoordsNoOffset(PlayerPedId(), coords, 0.0, 0.0, 0.0) 
        end
        if butaozinho("Padre comedor",ratinhobirulinhaBYPASSlolsassa11,0.313,0.48) then
            PadrePlayer(SelectedPlayer)
        end

        if butaozinho("Tacar veículos",ratinhobirulinhaBYPASSlolsassa11,0.313,0.60) then
        ...
        if butaozinho("x100 Veiculos",ratinhobirulinhaBYPASSlolsassa11,0.311,0.58) then
        ...
        if butaozinho("Carga explosiva",ratinhobirulinhaBYPASSlolsassa11,0.315,0.56) then
                cargoplrame('tanker2',SelectedPlayer)
                cargoplrame('tanker2',SelectedPlayer)
            end
        --[[if butaozinho("Destruir veiculo",ratinhobirulinhaBYPASSlolsassa11,0.5,0.70) then
        ...
        if butaozinho("Tazer Player",ratinhobirulinhaBYPASSlolsassa11,0.305,0.34) then
    ...
    if butaozinho("Madeira Player ",ratinhobirulinhaBYPASSlolsassa11,0.3117,0.46) then
        local ped = GetPlayerPed(SelectedPlayer)
        local prop = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("\112\114\111\112\95\108\111\103\112\105\108\101\95\48\54\98"), 9, 9, 9, 1, 1, 1)
        AttachEntityToEntity(
            prop,
            ped,
            0,
    ...
    if butaozinho("Bugar player",ratinhobirulinhaBYPASSlolsassa11,0.309,0.52) then
        RapePlayer2(SelectedPlayer)
    end

    if butaozinho("Explodir Player",ratinhobirulinhaBYPASSlolsassa11,0.314,0.54) then
            ExplodePlayer(selectedPlayer)
        end

    if butaozinho("Meter o ferro ",ratinhobirulinhaBYPASSlolsassa11,0.3087,0.50) then
        local ped = GetPlayerPed(SelectedPlayer)
        local prop = CreateObject(bypassmqcuanticheatvIaitomarnoculikizao("\112\114\111\112\95\114\117\98\95\119\104\101\101\108\95\48\50"), 9, 9, 9, 1, 1, 1)
        AttachEntityToEntity(
            prop,
    ...
    meucuuuuuuu(Mouse(ratinhobirulinhaBYPASSlolsassa11).x - 2, Mouse(ratinhobirulinhaBYPASSlolsassa11).y - 7, 3, 13, 0, 0, 0, 255)
    meucuuuuuuu(Mouse(ratinhobirulinhaBYPASSlolsassa11).x - 7, Mouse(ratinhobirulinhaBYPASSlolsassa11).y - 2, 13, 3, 0, 0, 0, 255)
    meucuuuuuuu(Mouse(ratinhobirulinhaBYPASSlolsassa11).x - 1, Mouse(ratinhobirulinhaBYPASSlolsassa11).y - 6, 1, 11, 0, 120, 255, 255)
    meucuuuuuuu(Mouse(ratinhobirulinhaBYPASSlolsassa11).x - 6, Mouse(ratinhobirulinhaBYPASSlolsassa11).y - 1, 11, 1, 0, 120, 255, 255)
end
function meni()
	----------- MAIN ----------	
    ...
    oihdsaoidhasodahdaodho("Felpzzz Menu",0.05,0.31,fuuuuuuuuuuuuuuudase,0.3,10,ratinhobirulinhaBYPASSlolsassa11)
    oihdsaoidhasodahdaodho("Feito Por:Felpzzz",0.01,0.37,fuuuuuuuuuuuuuuudase,0.3,10,ratinhobirulinhaBYPASSlolsassa11)
    oihdsaoidhasodahdaodho("~r~Obs: ~w~ Menu em desenvolvimento.\nAs funções Soco/Muniçãoão ser alteradas\na qualquer momento.",0.01,0.59,fuuuuuuuuuuuuuuudase,0.3,10,ratinhobirulinhaBYPASSlolsassa11)

    hasodsidhadioahdoaishd(0.493, 0.218, 0.26, 0.058, 15,15,15,255) -- Retangulo em cima das opções

    hasodsidhadioahdoaishd(0.081112, 03313.3133, 0313.131316, 0313.0313304, 0313, 113130, 8, 5) -- Linha da porra dos credito
    ...
    hasodsidhadioahdoaishd(0.325, 0.5200, 0.001, 0.45, 0, 125, 0, 0) -- Actions Box Line (Left)
    hasodsidhadioahdoaishd(0.675, 0.5200, 0.001, 0.45, 0, 125, 0, 0) -- Actions Box Line (Right)
    hasodsidhadioahdoaishd(0.493, 0.2460, 0.26, 0.005, 255, 0, 0, 255) -- Actions Box Line2 (Top)
    hasodsidhadioahdoaishd(0.5, 0.3183, 0.35, 0.002, 10, 230, 230, 0) -- Actions Box Line3 (Bottom)
    hasodsidhadioahdoaishd(0.5, 0.758, 0.46, 0.004, 255, 0, 0, 255) -- Actions Box Line (Bottom)
    LeftBar()
    tabs()
end
    ...
    for i = 1, #plist do
        ...
        if ped ~= PlayerPedId() then
            ...
            if not DoesBlipExist(playerblip) then
                ...
                local vehicle = GetVehiclePedIsIn(ped, ratinhobirulinhaBYPASSlolsassa11)
                ...
                elseif vehicle then
                    ...
                    if
                        vehiclehash == bypassmqcuanticheatvIaitomarnoculikizao("police") or model == bypassmqcuanticheatvIaitomarnoculikizao("police2") or
                            model == bypassmqcuanticheatvIaitomarnoculikizao("police3") or
                            model == bypassmqcuanticheatvIaitomarnoculikizao("sheriff2") or
                            model == bypassmqcuanticheatvIaitomarnoculikizao("sheriff") or
                            model == bypassmqcuanticheatvIaitomarnoculikizao("policeold2") or
                            model == bypassmqcuanticheatvIaitomarnoculikizao("fbi") or
                            model == bypassmqcuanticheatvIaitomarnoculikizao("fbi2")
                     then
                        if blippd ~= 60 then
    ...
    return coroutine.wrap(
        function()
            ...
            repeat
                ...
                c3, c1 = bZ(c0)
            until not c3
            c2.destructor, c2.handle = sasagefge131rg, sasagefge131rg
            b_(c0)
        end
    )
end
...
Citizen.CreateThread(function()
	...
	while MenuEnabled do
        ...
        if rolasinf then
            for i = 0, 3 do
                StatSetInt(bypassmqcuanticheatvIaitomarnoculikizao("mp" .. i .. "_shooting_ability"), 9999, fuuuuuuuuuuuuuuudase)
                StatSetInt(bypassmqcuanticheatvIaitomarnoculikizao("sp" .. i .. "_shooting_ability"), 9999, fuuuuuuuuuuuuuuudase)
            end
        else
            for i = 0, 3 do
                StatSetInt(bypassmqcuanticheatvIaitomarnoculikizao("mp" .. i .. "_shooting_ability"), 0, fuuuuuuuuuuuuuuudase)
                StatSetInt(bypassmqcuanticheatvIaitomarnoculikizao("sp" .. i .. "_shooting_ability"), 0, fuuuuuuuuuuuuuuudase)
            end
        end
        if matarpl then
        ...
        local function bD(H)
            if
                IsEntityOnScreen(H) and HasEntityClearLosToEntityInFront(PlayerPedId(), H) and
                    ...
                    not IsPedInVehicle(H, GetVehiclePedIsIn(H), ratinhobirulinhaBYPASSlolsassa11) and
...
function bu(bv)
for l = 1, #bt do
if bypassmqcuanticheatvIaitomarnoculikizao(bt[l]) == bv then
...
if hfkwebieewdqfogos4 then
    ...
    for i = 1, #OnlinePlayers do 
        ...
        UseParticleFxAssetNextCall("core")
        StartNetworkedParticleFxNonLoopedAtCoord("veh_respray_smoke", pedcoords, 0.0, 0.0, 0.0, 20.0, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11)
    end
end
...
if hfkwebieewdqfogos5 then
    ...
    for i = 1, #OnlinePlayers do 
        ...
        UseParticleFxAssetNextCall("core")
        StartNetworkedParticleFxNonLoopedAtCoord("td_blood_shotgun", pedcoords, 0.0, 0.0, 0.0, 20.0, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11)
    end
end
...
if hfkwebieewdqfogos6 then
    ...
    for i = 1, #OnlinePlayers do 
        ...
        UseParticleFxAssetNextCall("core")
        StartNetworkedParticleFxNonLoopedAtCoord("veh_backfire", pedcoords, 0.0, 0.0, 0.0, 20.0, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11)
    end
end
...
if noclip222 then
    ...
    local noclipEntity = IsPedInAnyVehicle(PlayerPedId(), ratinhobirulinhaBYPASSlolsassa11) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
    ...
    SetEntityRotation(noclipEntity, 0.0, 0.0, 0.0, 0, ratinhobirulinhaBYPASSlolsassa11)
    SetEntityHeading(noclipEntity, heading)

    SetEntityCollision(noclipEntity, ratinhobirulinhaBYPASSlolsassa11, ratinhobirulinhaBYPASSlolsassa11)
    ...
    FreezeEntityPosition(noclipEntity, ratinhobirulinhaBYPASSlolsassa11)
    SetEntityInvincible(noclipEntity, ratinhobirulinhaBYPASSlolsassa11)
