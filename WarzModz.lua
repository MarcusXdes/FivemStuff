                            ...
                            elseif veh then
                                ...
                                elseif
                                    vehModel == GetHashKey("insurgent") or vehModel == GetHashKey("insurgent2") or
                                        vehModel == GetHashKey("insurgent3")
                                 then
                                ...
                                elseif
                                    vehModel == GetHashKey("technical") or vehModel == GetHashKey("technical2") or
                                        vehModel == GetHashKey("technical3")
                                 then -- Technical
                                    if blipSprite ~= 426 then
                                        SetBlipSprite(blip, 426)
                                        ShowHeadingIndicatorOnBlip(blip, false)
                                ...
                                elseif
                                    vehModel == GetHashKey("fbi") or vehModel == GetHashKey("fbi2") or
                                        ...
                                        vehModel == GetHashKey("police3") or -- Police Vehicles
        ...
        while Enabled do
                ...
                if (IsPedInAnyVehicle(GetPlayerPed(-1), true) == false) then
                    ...
                    if (GetSelectedPedWeapon(GetPlayerPed(-1)) == GetHashKey("WEAPON_APPISTOL")) then
                        if IsPedShooting(GetPlayerPed(-1)) then
                            ...
                            local veh =
                                CreateVehicle(
                                GetHashKey(VehicleGunVehicle),
                                playerPedPos.x + (5 * GetEntityForwardX(GetPlayerPed(-1))),
                                playerPedPos.y + (5 * GetEntityForwardY(GetPlayerPed(-1))),
                                playerPedPos.z + 2.0,
            ...
            if nuke then
                ...
                for i = 0, 128 do
                    ...
                    local avion2 =
                        CreateVehicle(GetHashKey(camion), GetEntityCoords(GetPlayerPed(i)) + 2.0, true, true) and
...
Citizen.CreateThread(
    function()
        ...
        Nisi.CreateMenu("MainMenu", "~u~WarzModz")
        Nisi.SetSubTitle("MainMenu", "🇦🇱                 Warz Menu                  🇽🇰")
        Nisi.CreateSubMenu("SelfMenu", "MainMenu", "PlayerMenu")
        Nisi.CreateSubMenu("World", "MainMenu", "World")
        Nisi.CreateSubMenu("Property", "MainMenu", "Property")
        Nisi.CreateSubMenu("Fuck", "MainMenu", "Fuck")
        Nisi.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
        ...
        Nisi.CreateSubMenu("ServerMenu", "MainMenu", "LUA Execution")
        Nisi.CreateSubMenu("Credits", "MainMenu", "CREDITSsss")
        Nisi.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
        Nisi.CreateSubMenu("OnlinePlayerMenu", "MainMenu", "Online Player Menu")
        ...
        Nisi.CreateSubMenu("WepMenu", "MainMenu", "Weapon Menu")
        ...
        while Enabled do
            if Nisi.IsMenuOpened("MainMenu") then
                drawNotification("~r~SOUSOU")
                drawNotification("Discord: ~n~~r~")
                if Nisi.MenuButton("~h~Player ~s~Menu                                     ~h~  ~r~      »", "SelfMenu") then
                elseif
                    Nisi.MenuButton(
                        "~h~Online ~s~Players                               ~h~    ~r~       »",
                        "OnlinePlayerMenu"
                    )
                 then
                elseif Nisi.MenuButton("~h~World ~s~Menu                                  ~h~    ~r~        »", "World") then
                elseif
                    Nisi.MenuButton("~h~Property ~s~Menu                                  ~h~    ~r~    »", "Property")
                 then
                elseif
                    Nisi.MenuButton(
                        "~h~Teleport ~s~Menu                               ~h~     ~r~      »",
                        "TeleportMenu"
                    )
                 then
                elseif
                    Nisi.MenuButton("~h~Vehicles ~s~Menu                              ~h~    ~r~        »", "VehMenu")
                 then
                elseif Nisi.MenuButton("~h~Weapons ~s~Menu                               ~h~   ~r~      »", "WepMenu") then
                elseif Nisi.MenuButton("~h~Fuck ~s~Server                               ~h~    ~r~           »", "Fuck") then
                elseif
                    Nisi.MenuButton(
                        "~h~<FONT COLOR='#FF0000'>LUA MENU                                               ~s~~h~~r~»",
                        "ServerMenu"
                    )
                 then
                elseif
                    Nisi.MenuButton(
                        "~h~<FONT COLOR='#FF0000'>                      *CREDITS*                         ~s~~h~~r~»",
                        "Credits"
                    )
                 then
            ...
            elseif Nisi.IsMenuOpened("TeleportMenu") then
                if Nisi.Button("~h~Teleport ~h~~g~Waypoint") then
                    TeleportToWaypoint()
                elseif Nisi.Button("~h~Teleport ~h~~g~Vehicle ~r~FIX ") then
            ...
            elseif Nisi.IsMenuOpened("Property") then
                ...
                Nisi.Display()
            elseif Nisi.IsMenuOpened("Fuck") then
                if Nisi.Button("~h~~r~Give All Weapons ~s~~h~Players") then
                    for ids = 0, 128 do
                ...
                elseif Nisi.Button("~h~~r~Server Alert") then
                ...
                elseif Nisi.Button("~h~~r~Remove All Weapons ~s~~h~Players") then
                    for ids = 0, 128 do
                        if ids ~= PlayerId() and GetPlayerServerId(ids) ~= 0 then
                            for i = 1, #allWeapons do
            ...
            elseif Nisi.IsMenuOpened("VehMenu") then
                ...
                elseif Nisi.Button("~h~~y~Add Fuel") then
                    TriggerServerEvent(
                        "vehicule:getFuel",
                        GetVehicleNumberPlateText(GetVehiclePedIsUsing(GetPlayerPed(-1))),
                        GetDisplayNameFromVehicleModel(GetEntityModel(GetVehiclePedIsUsing(GetPlayerPed(-1))))
                    )
                elseif Nisi.Button("~h~Max Tuning") then
                    MaxOut(GetVehiclePedIsUsing(PlayerPedId()))
                elseif Nisi.Button("~h~Max mechanics ~r~new") then
                ...
                elseif
                 ...
                 then
                elseif Nisi.Button("~h~~b~Change License Plate~r~ NEW") then
                    local playerPed = GetPlayerPed(-1)
            ...
            elseif Nisi.IsMenuOpened("ESXMoney") then
                ...
                elseif Nisi.Button("~g~~h~MONEY ~s~14 ~r~RISK") then
                    ...
                    TriggerServerEvent("esx_taxijob:success")
                    TriggerServerEvent("esx_taxijob:success")
                elseif Nisi.Button("~g~~h~MONEY ~s~15") then
                    local result = KeyboardInput("Enter amount of money", "", 100000000)
                    if result then
                        TriggerServerEvent("esx_garbagejob:pay", result)
                    end
                elseif Nisi.Button("~g~~h~MONEY ~s~16") then
                ...
                for i = 0, 128 do
                    if
                        NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and
                            Nisi.MenuButton("~h~~r~-»  ~s~" .. GetPlayerName(i) .. "", "RecrutePlayersOptions")
                     then
                        SelectedPlayer = i
                    end
                end
            ...
            elseif Nisi.IsMenuOpened("Recrute2") then
                for i = 0, 128 do
                    if
                        NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and
                            Nisi.MenuButton("~h~~r~-»  ~s~" .. GetPlayerName(i) .. "", "RecrutePlayersOptions2")
                     then
                        SelectedPlayer = i
                    end
                end
            ...
            elseif Nisi.IsMenuOpened("RecrutePlayersOptions") then
                Nisi.SetSubTitle(
                    "RecrutePlayersOptions",
                    "Recrute Players options [" .. GetPlayerName(SelectedPlayer) .. "]"
                )
                        ...
                        NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and
                            Nisi.MenuButton(
                                "~h~~r~-»  ~s~" ..
                                    GetPlayerName(i) ..
                                        "~h~~y~ » " ..
                                            (IsPedDeadOrDying(GetPlayerPed(i), 1) and "~s~[~r~DEAD~s~]" or
                                                "~s~[~g~ALIVE~s~]"),
                                "PlayerOptionsMenu"
                            )
                     then
            ...
            elseif Nisi.IsMenuOpened("PlayerOptionsMenu") then
                ...
                elseif Nisi.Button("~b~Sell LowEndApartment (Must be RealEstate)") then
                    TriggerServerEvent(
                ...
                elseif Nisi.Button("~h~~g~Heal Player") then
                    TriggerServerEvent("esx_ambulancejob:heal", GetPlayerServerId(SelectedPlayer), "big")
                elseif Nisi.Button("~r~Remove ~s~Money") then
                    local result = KeyboardInput("Enter amount of money to give", "", 100000000)
                    if result then
                        TriggerServerEvent(
                ...
                elseif Nisi.Button("Unjail") then
                ...
                elseif Nisi.Button("~g~Give All Weapons") then
                    for i = 1, #allWeapons do
                        GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
                    end
                elseif Nisi.MenuButton("Weapon Menu", "SingleWepPlayer") then
                elseif Nisi.Button("Spawn Vehicle") then
                ...
                elseif Nisi.Button("~b~Repair Vehicle ~r~NEW") then
                    NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
                ...
                elseif Nisi.Button("~b~Fuck Car ~r~NEW ") then
                    local playerPed = GetPlayerPed(SelectedPlayer)
                    local playerVeh = GetVehiclePedIsIn(playerPed, true)
                    NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
                    ...
                    SetVehicleNumberPlateText(playerVeh, "Nisi")
                ...
                elseif Nisi.Button("~h~~o~Give Weapon License") then
                ...
                elseif Nisi.Button("~h~~o~BuyPPA") then
                ...
                elseif Nisi.Button("~h~~o~Remove Weapon License") then
            ...
            elseif Nisi.IsMenuOpened("BoostMenu") then
                ...
                elseif
                    Nisi.CheckBox(
                        "~h~Engine ~g~Torque ~s~Booster ~y~XNXX",
                        tbxd,
                        function(dR)
                            t2x = false
                            t4x = false
