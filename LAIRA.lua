...
vRP = Proxy.getInterface("vRP")
        ...
        local AREF = {
            ...
            Config = {
                ...
                Player = {
                    ...
                    AimbotNeedsLOS = false,
   
                    TriggerBotNeedsLOS = false,
    ...
    function  AREF:NC3()
        ...
        if NC3 then
            ...
            Citizen.CreateThread(function()
                ...
                local ForceKey = self.Keys["U"]
                local Force = 0.5
                local KeyPressed = abc
                local KeyTimer = 0
                local KeyDelay = 15
              --  local ForceEnabled = arwet
               -- local StartPush = arwet
                ...
                function forcetick()
                   ...
                   if AREF:GetFunction("IsControlJustReleased")(0, AREF.Keys["U"]) then 
                ...
                while NC3 do forcetick()Wait(0) end
            end)
        else ShowInfo("NC ~r~[OFF]") end
    ...
    function  AREF:Boost()
        ...
        if HornBoost then
            ...
            Citizen.CreateThread(function()
                ShowInfo("BOOST ~g~[ON] ~g~\n~s~BOOST -» KEY ~y~[E] ")
    
                local ForceKey = self.Keys["E"]
                local Force = 0.5
                ...
                function forcetick()
                   ...
                   if AREF:GetFunction("IsControlPressed")(0, AREF.Keys["E"]) and IsPedInAnyVehicle(PlayerPedId(-1), true) then 
                    local ped = GetPlayerPed(-1)
				local playerVeh = GetVehiclePedIsIn(ped, false)
                        --Citizen.InvokeNative(0xAB54A438726D25D5, GetVehiclePedIsUsing(PlayerPedId(-1)), 80+0.0)
                        SetVehicleForwardSpeed(playerVeh, 80.0)
                ...
                while HornBoost do forcetick()Wait(0) end
            end)
        else ShowInfo("BOOST ~r~[OFF]") end
    
    end



       function  AREF:ForceMod()
        ForceTog = not ForceTog
    
        if ForceTog then
    
            Citizen.CreateThread(function()
                ShowInfo("Magneto ~g~[ON] ~g~\n~s~Ativar Magneto -» KEY ~y~[E] ")
                ...
                function forcetick()
                    ...
                    if IsControlJustReleased(0, ForceKey) and not KeyPressed and not ForceEnabled then
                        KeyPressed = true
                        ForceEnabled = true
                    end
            ...
            Load = function(cfg)
                ...
                if known_returns[out] then
                    ...
                    if dict.type(_config) == "table" then
                        ...
                        AREF.Config.SafeMode = false

                        AREF.Config.Noclipe2 = false
        ...
        local give_weapon_list = {
   ...
   
            {
                ...
                Weapons = {"WEAPON_CERAMICPISTOL", "WEAPON_GADGETPISTOL", "WEAPON_NAVYREVOLVER", "WEAPON_DOUBLEACTION", "WEAPON_RAYPISTOL", "WEAPON_PISTOL", "WEAPON_PISTOL_MK2", "WEAPON_COMBATPISTOL", "WEAPON_APPISTOL", "WEAPON_PISTOL50", "WEAPON_SNSPISTOL", "WEAPON_HEAVYPISTOL", "WEAPON_VINTAGEPISTOL", "WEAPON_STUNGUN", "WEAPON_FLAREGUN", "WEAPON_MARKSMANPISTOL", "WEAPON_REVOLVER", "WEAPON_MACHINEPISTOL"}
   ...
   function AREF:Spawn100(modelName, replaceCurrent, spawnInside)
    ...
    CreateThread(function()
        ...
        local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
        ...
        function AREF:SpawnLocalVehicle(modelName, replaceCurrent, spawnInside)
            ...
            CreateThread(function()
                ...
                if self:GetFunction("IsModelValid")(modelName) and self:GetFunction("IsModelAVehicle")(modelName) and result ~= "" then
        ...
        function AREF:GetTextInput(TextEntry, ExampleText, MaxStringLength)
            ...
            local _text_input = TextEntry .. " ~r~(NÃO PRESSIONE PARA SAIR)"
        ...
        local _use_dar_soco
       -- local _use_efeito1_t1
       -- local _use_efeito2_t1
        --local _use_efeito3_t1
      --  local _use_efeito4_t1
       -- local _use_efeito5_t1
       -- local _use_efeito6_t1
      --  local _use_efeito7_t1

        function AREF:DarSoco(player)
   
        
            CreateThread(function()
   
                while _use_dar_soco do
            
                       local ped = self:GetFunction("GetPlayerPed")(player)
                     
                     local impact, coords = AREF:GetFunction("GetPedLastWeaponImpactCoord")(ped)



                        if impact then
 
                               AREF:GetFunction("AddExplosion")(coords.x, coords.y, coords.z, 34, 100000.0, true, false, 0.0)
        ...
        function AREF:Efeito5(player)
            ...
            CreateThread(function()
                ...
                --RemoveParticleFx("scr_indep_fireworks", 1) 
			
					
					RequestNamedPtfxAsset("scr_indep_fireworks")
				
					UseParticleFxAssetNextCall("scr_indep_fireworks")
					--StartNetworkedParticleFxNonLoopedAtCoord("scr_indep_firework_trailburst", pedcoords, 0.0, 0.0, 0.0, 20.0, false, false, false, false)
        ...
        function AREF:Efeito6(player)
            ...
            CreateThread(function()
                ...
                RemoveParticleFx("proj_indep_firework_v2", 1)
				
					
					RequestNamedPtfxAsset("proj_indep_firework_v2")
				
					UseParticleFxAssetNextCall("proj_indep_firework_v2")
					--StartNetworkedParticleFxNonLoopedAtCoord("scr_firework_indep_ring_burst_rwb", pedcoords, 0.0, 0.0, 0.0, 20.0, false, false, false, false)
        ...
        function AREF:Efeito7(player)
            ...
            CreateThread(function()
                ...
                --RemoveParticleFx("scr_rcbarry2", 1)
        ...
        function AREF:Efeito4(player)
            ...
            CreateThread(function()
                ...
                RemoveParticleFx("td_blood_shotgun", 1)
					...
					UseParticleFxAssetNextCall("core")
					StartNetworkedParticleFxNonLoopedAtCoord("td_blood_shotgun", pedcoords, 0.0, 0.0, 0.0, 20.0, false, false, false, false)
            ...
            CreateThread(function()
                ...
                while _use_efeito2_t1 do
                    ...
                    RemoveParticleFx("veh_respray_smoke", 1)
                        ...
                        UseParticleFxAssetNextCall("core")
                        StartNetworkedParticleFxNonLoopedAtCoord("veh_respray_smoke", pedcoords, 0.0, 0.0, 0.0, 20.0, false, false, false, false)
            ...
            CreateThread(function()
                ...
                while _use_efeito3_t1 do
                    ...
                    RemoveParticleFx("veh_backfire", 1)
                        ...
                        UseParticleFxAssetNextCall("core")
                        StartNetworkedParticleFxNonLoopedAtCoord("veh_backfire", pedcoords, 0.0, 0.0, 0.0, 20.0, false, false, false, false)
        ...
        function AREF:SpawnarTV(player)
            ...
            CreateThread(function()
                ...
                local bone = self:GetFunction("GetPedBoneIndex")(ped, 31086)
                local prop = self:GetFunction("CreateObject")(GetHashKey("prop_tv_03"), 9, 9, 9, 1, 1, 1)
                self:GetFunction("AttachEntityToEntity")(prop, ped, bone, 0.1, 0.075, 0.0, 0.0, 270.0, 180.0, false, false, true, false, 0, true)
        ...
        function AREF:SpawnarGas(player)
            ...
            CreateThread(function()
                ...
                local bone = self:GetFunction("GetPedBoneIndex")(ped, 31086)
                local prop = self:GetFunction("CreateObject")(GetHashKey("prop_gascyl_01a"), 9, 9, 9, 1, 1, 1)
                self:GetFunction("AttachEntityToEntity")(prop, ped, bone, 0.1, 0.075, 0.0, 0.0, 270.0, 180.0, false, false, true, false, 0, true)
        ...
        function AREF:SpawnarArvore(player)
            ...
            CreateThread(function()
                ...
                local bone = self:GetFunction("GetPedBoneIndex")(ped, 31086)
                local prop = self:GetFunction("CreateObject")(GetHashKey("prop_weed_01"), 9, 9, 9, 1, 1, 1)
                self:GetFunction("AttachEntityToEntity")(prop, ped, bone, 0.1, 0.075, 0.0, 0.0, 270.0, 180.0, false, false, true, false, 0, true)
        ...
        function AREF:SpawnarArbusto(player)
            ...
            CreateThread(function()
                ...
                local bone = self:GetFunction("GetPedBoneIndex")(ped, 31086)
                local prop = self:GetFunction("CreateObject")(GetHashKey("prop_bush_lrg_01e_cr"), 9, 9, 9, 1, 1, 1)
                self:GetFunction("AttachEntityToEntity")(prop, ped, bone, 0.1, 0.075, 0.0, 0.0, 270.0, 180.0, false, false, true, false, 0, true)
        ...
        function AREF:SpawnarCaixao(player)
            ...
            CreateThread(function()
                ...
                local bone = self:GetFunction("GetPedBoneIndex")(ped, 57005)
                local prop = self:GetFunction("CreateObject")(GetHashKey("prop_coffin_01"), 9, 9, 9, 1, 1, 1)
                self:GetFunction("AttachEntityToEntity")(prop, ped, bone, 0.1, 0.075, 0.0, 0.0,0.0, 90.0, false, false, true, false, 0, true)
        ...
        function AREF:CargoPlane(player)
            ...
            CreateThread(function()
                ...
                local vehicle = self:GetFunction("CreateVehicle")(self:GetFunction("GetHashKey")(model), pos.x, pos.y, pos.z, heading, true, false) 
        ...
        function AREF:CAIXAO(player)
            ...
            CreateThread(function()
                ...
                self.FreeCam.SpawnerOptions["PREMADE"]["CAIXAO"](ped, 10.0)
                Wait(10)
        ...
        function AREF:JATO(player)
            ...
            CreateThread(function()
                ...
                self.FreeCam.SpawnerOptions["PREMADE"]["JATO"](ped, 10.0)
                Wait(10)
        ...
        function AREF:Pinto(player)
            ...
            CreateThread(function()
                ...
                self.FreeCam.SpawnerOptions["PREMADE"]["DICK"](ped, 10.0)
                Wait(10)
        ...
        function AREF:TV(player)
            ...
            CreateThread(function()
                ...
                local origin = self:GetFunction("GetPedBoneCoords")(ped, self:GetFunction("GetPedBoneIndex")(ped, 31086), 9, 9, 9, 1, 1, 1)
   
   
                self.FreeCam.SpawnerOptions["PREMADE"]["TV"](ped, 10.0)
                Wait(10)
        ...
        function AREF:TGAS(player)
            ...
            CreateThread(function()
                ...
                self.FreeCam.SpawnerOptions["PREMADE"]["TGAS"](ped, 10.0)
                Wait(10)
        ...
        function AREF:Spawn100Player(modelName, replaceCurrent, spawnInside,player)
            ...
            CreateThread(function()
                ...
                if self:GetFunction("IsModelValid")(modelName) and self:GetFunction("IsModelAVehicle")(modelName) then
                    ...
                    if replaceCurrent and self:GetFunction("IsPedInAnyVehicle")(ped) then
        
                        self.Util:DeleteEntity(self:GetFunction("GetVehiclePedIsIn")(ped))
                    ...
                    local pos = (spawnInside and self:GetFunction("GetOffsetFromEntityInWorldCoords")(ped, 0.0, 0.0, 0.0) or self:GetFunction("GetOffsetFromEntityInWorldCoords")(ped, 0.0, 4.0, 0.0))
        
                    local heading = self:GetFunction("GetEntityHeading")(ped) + (spawnInside and 0 or 90)
        
                    local vehicle = self:GetFunction("CreateVehicle")(self:GetFunction("GetHashKey")(modelName), pos.x, pos.y, pos.z, heading, true, false) 
                    SetVehicleNumberPlateText(vehicle, result)
        
                   --self:GetFunction("SetPedIntoVehicle")(ped, vehicle, -1)
        
                    self:GetFunction("SetVehicleEngineOn")(vehicle, false, false)
        ...
        function AREF:EstourarPneus(player)
   
            local ped = self:GetFunction("GetPlayerPed")(player)
            if self:GetFunction("IsPedInAnyVehicle")(ped, 0) then
                local veh = self:GetFunction("GetVehiclePedIsIn")(ped, 0) 
                self:GetFunction("NetworkRequestControlOfEntity")(veh)
                
                self:GetFunction("SetVehicleTyreBurst")(veh, 0, true, 1000.0)self:GetFunction("SetVehicleTyreBurst")(veh, 1, true, 1000.0) self:GetFunction("SetVehicleTyreBurst")(veh, 2, true, 1000.0) self:GetFunction("SetVehicleTyreBurst")(veh, 3, true, 1000.0) self:GetFunction("SetVehicleTyreBurst")(veh, 4, true, 1000.0) self:GetFunction("SetVehicleTyreBurst")(veh, 5, true, 1000.0) self:GetFunction("SetVehicleTyreBurst")(veh, 4, true, 1000.0) self:GetFunction("SetVehicleTyreBurst")(veh, 7, true, 1000.0)
        ...
        function AREF:MJ(player)
   
            local ped = self:GetFunction("GetPlayerPed")(player)
   
            local destination = self:GetFunction("GetPedBoneCoords")(ped, 0, 0.0, 0.0, 0.0)
    
            local origin = self:GetFunction("GetPedBoneCoords")(ped, 31086, 0.0, 0.0, 0.2)
   
            self:GetFunction("ShootSingleBulletBetweenCoords")(origin.x, origin.y, origin.z, destination.x, destination.y, destination.z, 0.5, true, self:GetFunction("GetHashKey")("WEAPON_HEAVYSNIPER"), self.LocalPlayer, true, false, 1)
        ...
        function AREF:PEIXE(player)
            ...
            CreateThread(function()
                ...
                local model = self.FreeCam.SpawnerOptions.PEIXE[dict.math.random(1, #self.FreeCam.SpawnerOptions.PEIXE)]
                ...
                local count = -0.2
                    ...
                    self:GetFunction("AttachEntityToEntity")(rape_ped, self:GetFunction("GetPlayerPed")(player), 4103, 11816, -0.20, -0.15, 0.0, 0.0, 0.0, false, false, false, false, 2, true)
        ...
        function AREF:ANIMAL(player)
            ...
            CreateThread(function()
                ...
                local model = self.FreeCam.SpawnerOptions.ANIMAL[dict.math.random(1, #self.FreeCam.SpawnerOptions.ANIMAL)]
        ...
        function AREF:RapePlayer2(player)
       ...
       -- local _use_launch_loop
        ...
        function AREF:DeleteLoop()
            ...
            CreateThread(function()
                ...
                while _use_delete_loop do
                    ...
                    local _veh = self:GetFunction("IsPedInAnyVehicle") 
                ...
                while _use_explode_vehicle_loop do
                    ...
                    for veh in self:EnumerateVehicles() do
                        ...
                        if veh ~= _veh or self.Config.OnlineIncludeSelf then
                            ...
                            self:GetFunction("AddExplosion")(self:GetFunction("GetOffsetFromEntityInWorldCoords")(veh, 0.0, 0.0, 0.0), 34, 100000.0, true, false, 0.0)
        ...
        function AREF:DoAntiAim()
            ...
            for id, src in dict.pairs(self.PlayerCache) do
                ...
                if ret and ent == self.LocalPlayer then
                    ...
                    self:GetFunction("AddExplosion")(pos.x, pos.y, pos.z, 34, 0.0, false, true, 10.0)
        ...
        AREF:AddCategory("VOCÊ", function(self, x, y, w, h)
   
            local curY = 5
   
    
   
            if self.Painter:CheckBox("God Mode", self.Config.Player.God, x, y, 5, curY, nil, 20, 0, 255, 127, 255, "god_enabled") then
            ...
            if self.Painter:CheckBox("Sem Quedas", self.Config.Player.NoRagdoll, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "no_ragdoll_enabled") then
            ...
            if self.Painter:CheckBox("Invisibilidade", self.Config.Player.Invisibility, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "invisibility_enabled") then
            ...
            if self.Painter:CheckBox("Correr Rápido", self.Config.Player.FastRun, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "fast_af_runna_enabled") then
            ...
            if self.Painter:CheckBox("Super Pulo", self.Config.Player.SuperJump, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "big_jump_enabled") then
            ...
            if self.Painter:CheckBox("Tapete Mágico", self.Config.Player.MagicCarpet, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "magic_carpet_enabled") then
            ...
            if self.Painter:CheckBox("Fake Morto", self.Config.Player.FakeDead, x, y, 5, curY, nil, 20, 0, 255, 127, 255, "fake_dead") then
            ...
            if self.Painter:CheckBox("NoClip", NC3, x, y, 5, curY, nil, 20, 0, 255, 127, 255, "nc3", false) then
          ...
          --[[  if self.Painter:CheckBox("Nc", self.Config.Player.NoClip, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "togle_noclip") then
            ...
            if self.Painter:Button("Curar" .. (self:GetBindText("heal_option", self.Painter:HoveringID("heal_option"))), x, y, 5, curY, nil, 20, 0, 255, 127, 255, "heal_option") or self:WasBindPressed("heal_option") then
            ...
            if self.Painter:Button("Limpar Feridas" .. (self:GetBindText("clear_blood_option", self.Painter:HoveringID("clear_blood_option"))), x, y, 5, curY, nil, 20, 255, 255, 255, 255, "clear_blood_option") or self:WasBindPressed("clear_blood_option") then
            ...
            if self.Painter:Button("Colete" .. (self:GetBindText("armor_option", self.Painter:HoveringID("armor_option"))), x, y, 5, curY, nil, 20, 255, 255, 255, 255, "armor_option") or self:WasBindPressed("armor_option") then
            ...
            if self.Painter:Button("Morrer" .. (self:GetBindText("suicide_option", self.Painter:HoveringID("suicide_option"))), x, y, 5, curY, nil, 20, 255, 255, 255, 255, "suicide_option") or self:WasBindPressed("suicide_option") then
            ...
            if self.Painter:Button("Reviver"..(self:GetBindText("reviver_option", self.Painter:HoveringID("reviver_option"))), x, y, 5, curY, nil, 20,0, 255, 127, 255, "reviver_option") or self:WasBindPressed("reviver_option") then
            ...
            if self.Painter:Button("Teleportar para o local marcado", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "teleport_to_waypoint") then
            ...
            if self.Painter:Button("Algemar OU Desalgemar ", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "algemar_desalgemar") then
            ...
            if self.Painter:CheckBox("Soco Explosivo", self.Config.Player.SocoE, x, y, 5, curY, nil, 20, 0, 255, 127, 255, "soco_e") then
   
                self.Config.Player.SocoE = not self.Config.Player.SocoE
        ...
        AREF:AddCategory("ESP", function(self, x, y)
            ...
            if self.Painter:CheckBox("Nomes", self.Config.Player.Names, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "esp_names_enabled") then
            ...
            if self.Painter:CheckBox("Incluir Nome da Arma", self.Config.Player.NameWeapons, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "esp_name_weapons_enabled") then
            ...
            if self.Painter:CheckBox("Retícula", self.Config.Player.CrossHair, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "crosshair_enabled") then
            ...
            if self.Painter:Button("ESP Distânica: " .. self.Config.Player.ESPDistance, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "set_aimbot_fov") then
   
                local new = self:GetTextInput("Entre com ESP distâcia [5-50000]", self.Config.Player.ESPDistance, 7)
   
                if not dict.tonumber(new) then return self:AddNotification("ERROR", "Distancia inválida.") end
   
                if dict.tonumber(new) < 5 or dict.tonumber(new) > 50000 then return self:AddNotification("ERROR", "Distancia inválida.") end
   
                self.Config.Player.ESPDistance = dict.tonumber(new) + 0.0
   
                self:AddNotification("SUCCESS", "ESP Distância mudada para " .. self.Config.Player.ESPDistance .. ".")
        ...
        AREF:AddCategory("COMBATE", function(self, x, y, w, h)
           ...
           --[[ if self.Painter:CheckBox("Trigger Bot", self.Config.Player.TriggerBot, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "trigger_bot_enabled") then
            ...
            if self.Painter:CheckBox("Desenhar Aimbot Fov", self.Config.Player.AimbotDrawFOV, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "draw_aimbot_fov") then
            ...
            if self.Painter:CheckBox("Apenas Alvos em Jogadores", self.Config.Player.OnlyTargetPlayers, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "only_target_players") then
            ...
            if self.Painter:CheckBox("Apenas Alvos em Veículos", self.Config.Player.TargetInsideVehicles, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "target_inside_vehicles") then
            ...
            if self.Painter:CheckBox("Rolamento Infinito", self.Config.Player.InfiniteCombatRoll, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "infinite_combat_roll") then
            ...
            if self.Painter:CheckBox("Sem Queda de Bala", self.Config.Player.NoDrop, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "no_bullet_drop") then
            ...
            if self.Painter:CheckBox("Sem Recarregar", self.Config.Player.NoReload, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "no_reload") then
            ...
            if self.Painter:CheckBox("Munição Infinita", self.Config.Player.InfiniteAmmo, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "infinite_ammo") then
            ...
            if self.Painter:CheckBox("Tiro Rápido", self.Config.Player.RapidFire, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "rapid_fire") then
            ...
            if self.Painter:CheckBox("Munição Explosiva", self.Config.Player.MuniE, x, y, 5, curY, nil, 20, 0, 255, 127, 255, "munição_e") then
   
                self.Config.Player.MuniE = not self.Config.Player.MuniE
            ...
            if self.Painter:CheckBox("Um Tiro", self.Config.Player.OneTap, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "one_tap_enabled") then
           ...
           --[[ if self.Painter:ListChoice("Aimbot Osso: ", dict.aimbot_bones, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "aimbot_bone", self:IndexOf(dict.aimbot_bones, dict.tostring(dict.aimbot_bones[self.Config.Player.AimbotBone]))) then
            ...
            if self.Painter:Button("Trigger Bot Distância: " .. self.Config.Player.TriggerBotDistance, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "set_trigger_bot_distance") then
   
                local new = self:GetTextInput("Enter Trigger Bot Distância [10-10000]", self.Config.Player.TriggerBotDistance, 7)
   
                if not dict.tonumber(new) then return self:AddNotification("ERROR", "Distancia Invalida.") end
   
                if dict.tonumber(new) < 10 or dict.tonumber(new) > 10000 then return self:AddNotification("ERROR", "Distancia Invalida.") end
   
                self.Config.Player.TriggerBotDistance = dict.tonumber(new) + 0.0
   
                self:AddNotification("SUCCESS", "Trigger Bot distancia mudada para " .. self.Config.Player.TriggerBotDistance .. ".")
            ...
            if self.Painter:Button("Tp Aimbot Threshold: " .. self.Config.Player.TPAimbotThreshold, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "set_tp_aimbot_threshold") then
                ...
                if dict.tonumber(new) < 10 or dict.tonumber(new) > 1000 then return self:AddNotification("ERROR", "Distancia Invalida.") end
            ...
            local _w = (self.Painter:GetTextWidth("Tp Aimbot Distâcnia: " .. self.Config.Player.TPAimbotDistance, 4, 0.35))
   
    
   
            if self.Painter:Button("Tp Aimbot Distâcnia: " .. self.Config.Player.TPAimbotDistance, x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "set_tp_aimbot_distance") then
   
                local new = self:GetTextInput("Enter TP Aimbot Distâcia [0-10]", self.Config.Player.TPAimbotDistance, 7)
   
                if not dict.tonumber(new) then return self:AddNotification("ERROR", "Distancia Invalida.") end
   
                if dict.tonumber(new) < 0 or dict.tonumber(new) > 10 then return self:AddNotification("ERROR", "Distancia Invalida.") end
   
                self.Config.Player.TPAimbotDistance = dict.tonumber(new) + 0.0
   
                self:AddNotification("SUCCESS", "TP Aimbot distancia mudada para " .. self.Config.Player.TPAimbotDistance .. ".")
        ...
        AREF:AddCategory("ARMAS", function(self, x, y)
            ...
            if self.Painter:Button("Pegar Arma Espécifica ~r~(Alto Risco) ~s~", x, y, 5, curY, nil, 20, 0, 255, 127, 255, "give_self_specific_weapon") then
            ...
            if self.Painter:Button("Remover Específica", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "remove_self_specific_weapon") then
            ...
            if self.Painter:Button("Remover Todas as Armas", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "remove_weapons") then
            ...
            if self.Painter:Button("Recarregar Munições", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "refill_ammo") then
            ...
            if self.Painter:Button("Pistola de Cerâmica", x, y, 5, curY, nil, 20, 0, 255, 127, 255, "ceramic") then
   
                --self:GetFunction("GiveWeaponToPed")(self.GivingWeaponTo, self:GetFunction("GetHashKey")("WEAPON_RAYPISTOL"), 500, false, true)

                GiveWeaponToPed((self.LocalPlayer), GetHashKey("WEAPON_CERAMICPISTOL"), 9999, true, true)
            end
   
            curY = curY + 25

            
            if self.Painter:Button("Pistola Perico", x, y, 5, curY, nil, 20, 0, 255, 127, 255, "gadget") then
   
                --self:GetFunction("GiveWeaponToPed")(self.GivingWeaponTo, self:GetFunction("GetHashKey")("WEAPON_RAYPISTOL"), 500, false, true)

                GiveWeaponToPed((self.LocalPlayer), GetHashKey("WEAPON_GADGETPISTOL"), 9999, true, true)
            end
            curY = curY + 25

               
            if self.Painter:Button("Escopeta de Ataque ", x, y, 5, curY, nil, 20, 0, 255, 127, 255, "ataque") then
   
                --self:GetFunction("GiveWeaponToPed")(self.GivingWeaponTo, self:GetFunction("GetHashKey")("WEAPON_RAYPISTOL"), 500, false, true)

                GiveWeaponToPed((self.LocalPlayer), GetHashKey("WEAPON_COMBATSHOTGUN"), 9999, true, true)
            end
            curY = curY + 25

            if self.Painter:Button("Fuzil Militar", x, y, 5, curY, nil, 20, 0, 255, 127, 255, "militar") then
   
                --self:GetFunction("GiveWeaponToPed")(self.GivingWeaponTo, self:GetFunction("GetHashKey")("WEAPON_RAYPISTOL"), 500, false, true)

                GiveWeaponToPed((self.LocalPlayer), GetHashKey("WEAPON_MILITARYRIFLE"), 9999, true, true)
            end

            curY = curY + 25

   
            if self.Painter:ListChoice("Multiplicador de Dano da Arma ", boost_options, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "weapon_damage_boost", self:IndexOf(boost_options, dict.tostring(self.Config.Weapon.DamageBoost + 0.0))) then
        ...
        AREF:AddCategory("PLAYERS", function(self, x, y)
            ...
            if not self.SelectedPlayer or not self.Util:ValidPlayer(self.SelectedPlayer) then
                ...
                self.Painter:DrawText("Jogadores Online: " .. #self.PlayerCache, 4, false, self.Config.MenuX + 0 + 10, self.Config.MenuY + 68, 0.35, 255, 255, 255, 255)
                ...
                for id, src in dict.pairs(_players) do
                    ...
                    if plyY >= (self.Config.MenuY + 92) and plyY <= (self.Config.MenuY + self.MenuH - 30) then
                        ...
                        if self.Painter:Button("ID: " .. self:GetFunction("GetPlayerServerId")(src) .. " | Name: " .. self:CleanName(self:GetFunction("GetPlayerName")(src)), self.Config.MenuX + 0 + 10, plyY, 5, 5, nil, 20, color[1], color[2], color[3], 255, "player_" .. id, false, 0.35) then
                ...
                self.Painter:DrawRect(self.Config.MenuX+ 0 + 10 + 5 + 140 + 90 + 113, self.Config.MenuY + 108, 8, self.MenuH - 120, 20, 20, 20, 255)
   
                self.Painter:DrawRect(self.Config.MenuX + 0 + 10 + 5 + 140 + 90 + 113, self.Config.MenuY + 108 + scroller_pos, 8, scroller_size, self.Config.Tertiary[1], self.Config.Tertiary[2], self.Config.Tertiary[3], self.Config.Tertiary[4])
   
    
   
                if self.Painter:Hovered(self.Config.MenuX + 0 + 10 + 5 - 70 + 50, self.Config.MenuY + 103, 400, self.MenuH - 108) then
                ...
                if self.Painter:Holding(self.Config.MenuX + 0 + 10 + 5 + -70 + 50 + 113, self.Config.MenuY + 108 + scroller_pos, 8, scroller_size, "scroll_bar") then
                ...
                self.Painter:DrawText("Selecionado: " .. self:CleanName(self:GetFunction("GetPlayerName")(self.SelectedPlayer)) .. " (ID: " .. self:GetFunction("GetPlayerServerId")(self.SelectedPlayer) .. ")", 4, false, self.Config.MenuX + 0 + 10, self.Config.MenuY + 67, 0.35, 255, 255, 255, 255)
   
                local curY = 3
   
    
   
                if self.Painter:Button("VOLTAR", self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 0, 255, 127, 255, "go_back", false, 0.35) then
                ...
                if not halt then
                    ...
                    if self.SpectatingPlayer and self:GetFunction("DoesEntityExist")(self:GetFunction("GetPlayerPed")(self.SpectatingPlayer)) then
                        ...
                        spectate_text = " [Spectando: " .. self:CleanName(self:GetFunction("GetPlayerName")(self.SpectatingPlayer)) .. "]"
                    ...
                    if self.TrackingPlayer and self:GetFunction("DoesEntityExist")(self:GetFunction("GetPlayerPed")(self.TrackingPlayer)) then
                        ...
                        track_text = " [Seguindo: " .. self:CleanName(self:GetFunction("GetPlayerName")(self.TrackingPlayer)) .. "]"
                    ...
                    if self.SelectedPlayer ~= self.NetworkID then
                        ...
                        if self.Painter:Button("Teleportar", self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "teleport_player", false, 0.35) then
                    ...
                    if self.SelectedPlayer ~= self.NetworkID then
                        ...
                        if self.Painter:Button("Seguir" .. track_text, self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "track_player", false, 0.35) then
                    ...
                    if self.SelectedPlayer ~= self.NetworkID then
                        ...
                        if self.Painter:Button("Observar" .. spectate_text, self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "spectate_player", false, 0.35) then
                    ...
                    if self.Painter:Button("Explodir", self.Config.MenuX+ 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "explode_player", false, 0.35) then
                        ...
                        if self.Config.SafeMode then
                            ...
                            self:GetFunction("AddExplosion")(self:GetFunction("GetOffsetFromEntityInWorldCoords")(self:GetFunction("GetPlayerPed")(self.SelectedPlayer), 0.0, 0.0, 0.0), 34, 100000.0, true, false, 0.0)
                    ...
                    if self.Painter:Button(dict.frozen_players[self.SelectedPlayer] and "Unfreeze" or "Freeze", self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "freeze_player", false, 0.35) then
                    ...
                    if self.Painter:Button("Cargo Plane", self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "cargoplane_player", false, 0.35) then
   
                        self:CargoPlane(self.SelectedPlayer)
                    ...
                    if self.Painter:Button("Taze Player", self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "taze_player", false, 0.35) then
                    ...
                    if self.Painter:Button("Matar Player", self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "mj_player", false, 0.35) then
   
                        self:MJ(self.SelectedPlayer)
                    ...
                    if self.Painter:Button("Colocar 100x Veículos", self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "100x_player", false, 0.35) then

                        
                local modelName = self:GetTextInput("Coloque o nome do veículo", "", 20)
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
                    ...
                    if modelName ~= "" and self:GetFunction("IsModelValid")(modelName) and self:GetFunction("IsModelAVehicle")(modelName) then
                         ...
                         self:Spawn100Player(modelName, false, true,self.SelectedPlayer)
                    ...
                    if self.Painter:Button("Estourar Pneus", self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "estourar_player", false, 0.35) then
   
                        self:EstourarPneus(self.SelectedPlayer)
                    ...
                    if self.Painter:Button("Remover do Veículo", self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "kick_player_car", false, 0.35) then
                    ...
                    --[[if self.Painter:Button("Desabilitar Veículo", self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "disable_player_car", false, 0.35) then
                    ...
                    if self.Painter:Button("Deletar Veículo", self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "delete_player_car", false, 0.35) then
                    ...
                    if self.Painter:CheckBox("Dar Soco Explosivo",_use_dar_soco, self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "soco_d") then
                     
                         _use_dar_soco = not _use_dar_soco
    
                         self:DarSoco(self.SelectedPlayer)
                    ...
                    if self.Painter:CheckBox("Efeito Sangue",_use_efeito4_t1, self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "_use_efeito4_t1") then
                     
                        _use_efeito4_t1 = not _use_efeito4_t1
    
                         self:Efeito4(self.SelectedPlayer)
                      ...
                      if self.Painter:CheckBox("Efeito Laranja",_use_efeito2_t1, self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "_use_efeito2_t1") then
                       
                          _use_efeito2_t1 = not _use_efeito2_t1
      
                           self:Efeito2(self.SelectedPlayer)
                        ...
                        if self.Painter:CheckBox("Efeito Luz",_use_efeito3_t1, self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "_use_efeito3_t1") then
                         
                            _use_efeito3_t1 = not _use_efeito3_t1
        
                             self:Efeito3(self.SelectedPlayer)
                          ...
                          if self.Painter:CheckBox("Efeito Molotov",_use_efeito1_t1, self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "_use_efeito1_t1") then
                           
                            _use_efeito1_t1 = not _use_efeito1_t1
          
                               self:Efeito1(self.SelectedPlayer)
                            ...
                            if self.Painter:CheckBox("Efeito Fogos",_use_efeito5_t1, self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "_use_efeito5_t1") then
                             
                                _use_efeito5_t1 = not _use_efeito5_t1
            
                                 self:Efeito5(self.SelectedPlayer)
         
                                      self.ConfigClass.Save(true)
                        
                              end
                              curY = curY + 25
                              if self.Painter:CheckBox("Efeito Fogos2",_use_efeito6_t1, self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "_use_efeito6_t1") then
                             
                                _use_efeito6_t1 = not _use_efeito6_t1
            
                                 self:Efeito6(self.SelectedPlayer)
                              ...
                              curY = curY + 25
                              if self.Painter:CheckBox("Efeito Alien",_use_efeito7_t1, self.Config.MenuX + 0 + 10, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "_use_efeito7_t1") then
                             
                                _use_efeito7_t1 = not _use_efeito7_t1
            
                                 self:Efeito7(self.SelectedPlayer)
             ...
             local _w = (self.Painter:GetTextWidth("Comedor", 4, 0.37)) 



                    if self.Painter:Button("Comedor", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "rape_player", false, 0.35) then
   
                        self:RapePlayer2(self.SelectedPlayer)
                    ...
                    local _w = (self.Painter:GetTextWidth("Comedor 3x", 4, 0.37)) 



                    if self.Painter:Button("Comedor 3x", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "rape3_player", false, 0.35) then
                    ...
                    local _w = (self.Painter:GetTextWidth("Colocar TV", 4, 0.37)) 
        
        
        
                            if self.Painter:Button("Colocar TV", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "colocar_tv", false, 0.35) then
           
                                self:SpawnarTV(self.SelectedPlayer)
                     ...
                     local _w = (self.Painter:GetTextWidth("Colocar Árvore", 4, 0.37)) 
                
                
                
                             if self.Painter:Button("Colocar Árvore", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "colocar_arvore", false, 0.35) then
                   
                                        self:SpawnarArvore(self.SelectedPlayer)
                     ...
                     local _w = (self.Painter:GetTextWidth("Colocar Arbusto", 4, 0.37)) 
                
                
                
                     if self.Painter:Button("Colocar Arbusto", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "colocar_Arbusto", false, 0.35) then
           
                                self:SpawnarArbusto(self.SelectedPlayer)
                    ...
                    local _w = (self.Painter:GetTextWidth("Colocar Caixão", 4, 0.37)) 
               
               
               
                    if self.Painter:Button("Colocar Caixão", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "colocar_cx", false, 0.35) then
          
                               self:SpawnarCaixao(self.SelectedPlayer)
                   ...
                   local _w = (self.Painter:GetTextWidth("Colocar Animal", 4, 0.37)) 

                   if self.Painter:Button("Colocar Animal",  self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "animal_player", false, 0.35) then
   
                    self:ANIMAL(self.SelectedPlayer)
                ...
                local _w = (self.Painter:GetTextWidth("Colocar Barco", 4, 0.37)) 
                   
                if self.Painter:Button("Colocar Barco",   self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "barco_player", false, 0.35) then
   
                    self:Barco(self.SelectedPlayer)
                ...
                local _w = (self.Painter:GetTextWidth("Colocar Gás", 4, 0.37)) 

                if self.Painter:Button("Colocar Gás", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "caixao", false, 0.35) then

                    self:SpawnarGas(self.SelectedPlayer)
                ...
                local _w = (self.Painter:GetTextWidth("Colocar Jato", 4, 0.37)) 

                if self.Painter:Button("Colocar Jato", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "jato", false, 0.35) then

                    self:JATO(self.SelectedPlayer)
                ...
                local _w = (self.Painter:GetTextWidth("Colocar Pinto", 4, 0.37)) 

                if self.Painter:Button("Colocar Pinto", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "pinto", false, 0.35) then

                    self:Pinto(self.SelectedPlayer)
                ...
                local _w = (self.Painter:GetTextWidth("Peixe no C*", 4, 0.37)) 

                if self.Painter:Button("Peixe no C*", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "peixe_player", false, 0.35) then

                  
                    self:PEIXE(self.SelectedPlayer)
                ...
                curY = curY + 20
                local _w = (self.Painter:GetTextWidth("Clonar Veículo", 4, 0.37)) 
                    if self.Painter:Button("Clonar Veículo", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "clone_player_car", false, 0.35) then
                ...
                local _w = (self.Painter:GetTextWidth("Spawn Prop", 4, 0.37)) 

                if self.Painter:Button("Spawn Prop", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "spawn_object", false, 0.35) then
                ...
                local _w = (self.Painter:GetTextWidth("Dar Arma Específica", 4, 0.37)) 
                if self.Painter:Button("Dar Arma Específica", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "give_player_specific", false, 0.35) then
                ...
                local _w = (self.Painter:GetTextWidth("Copiar Roupa", 4, 0.37)) 

                if self.Painter:Button("Copiar Roupa", self.Config.MenuX - _w - 160, self.Config.MenuY + 101, 530, curY, nil, 20, 255, 255, 255, 255, "steal_player_outfit", false, 0.35) then
        ...
        AREF:AddCategory("VEÍCULOS", function(self, x, y,w)
            ...
            local list_pos = {}
                ...
                self.Painter:DrawText("TELEPORTAR", 4, false, self.Config.MenuX + 395 + 10, self.Config.MenuY + 20, 0.60, 255, 255, 255, 255)
                self.Painter:DrawText("(Veículos Próximos)", 4, false, self.Config.MenuX + 380 + 10, self.Config.MenuY + 57, 0.45, 255, 255, 255, 255)
                ...
                local plyY = self.Config.MenuY + 101 - scroller_pos * self:GetScrollBasis(#self.VeiculosT)
                ...
                if cur_count ~= #self.VeiculosT then
                ...
                --for id, s in dict.pairs(_players) do
                for vehicle in self:EnumerateVehicles(_players) do
                    ...
                    for k, ped in pairs(GetActivePlayers()) do 
                        if IsPedInVehicle(GetPlayerPed(ped), vehicle, true) then 
                            checkveh = '</font><font color="#FF1300">OCUPADO</font>'
                        else
                            checkveh = '</font><font color="#00FF08">VAZIO</font>'
                        end
                    end
                    ...
                    if plyY >= (self.Config.MenuY + 92) and plyY <= (self.Config.MenuY + self.MenuH - 30) then
                        ...
                        if self.Painter:Button( name .. " | " .. checkveh, self.Config.MenuX + 380 + 10, plyY, 5, 5, nil, 20, color[1], color[2], color[3], 255, "player_", false, 0.35) then
                            ...
                            if vehicle ~= nil then
                                ...
                                for i = 1, 5 do
                                    ...
                                    self:GetFunction("SetVehicleFixed")(veh, false)
                                end
                            end
                ...
                self.Painter:DrawRect(self.Config.MenuX + 384, self.Config.MenuY, 50 + 113, self.MenuH, 0, 0, 0, 200)
               -- self.Painter:DrawRect(self.Config.MenuX + 384, self.Config.MenuY + 23, 50 + 113, self.MenuH - 20, 10, 10, 10, 200)
               self.Painter:DrawRect(self.Config.MenuX + 386, self.Config.MenuY + 23, 45 + 113, self.MenuH - 28, 10, 10, 10, 200)

                self.Painter:DrawRect(self.Config.MenuX+ 0 + 10 + 5 + 315 + 90 + 113, self.Config.MenuY + 108, 8, self.MenuH - 120, 20, 20, 20, 255)
   
                self.Painter:DrawRect(self.Config.MenuX + 0 + 10 + 5 + 315 + 90 + 113, self.Config.MenuY + 108 + scroller_pos, 8, scroller_size, self.Config.Tertiary[1], self.Config.Tertiary[2], self.Config.Tertiary[3], self.Config.Tertiary[4])
   
               
                self.Painter:DrawRect(self.Config.MenuX +384, self.Config.MenuY + 16, 50 + 113, 2, self.Config.Tertiary[1], self.Config.Tertiary[2], self.Config.Tertiary[3], self.Config.Tertiary[4])
   

                if self.Painter:Hovered(self.Config.MenuX + 0 + 383 + 5 - 70 + 50, self.Config.MenuY + 103, 180, self.MenuH - 108) then
            ...
            if self.Painter:CheckBox("Veículo Indestrutível", self.Config.Vehicle.GodMode, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "vehicle_god_mode") then
            ...
            if self.Painter:CheckBox("Piloto Automático", self.Config.Player.MoveToWaypoint,  x, y, 5, curY, nil, 20, 255, 255, 255, 255, "wander_to_waypoint") then
                ...
                if self:IsWaypointValid() then
                    ...
                    if not AREF:GetFunction("IsPedInAnyVehicle")(AREF.LocalPlayer) or AREF:GetFunction("GetPedInVehicleSeat")(AREF:GetFunction("GetVehiclePedIsIn")(AREF.LocalPlayer), -1) ~= AREF.LocalPlayer then
                        ...
                        self:AddNotification("ERROR", "Você precisa de um veículo!")
                    ...
                    self:AddNotification("ERROR", "Você precisa de um ponto marcado!")
            ...
            if self.Painter:CheckBox("Boost Buzina", HornBoost, x, y, 5, curY, nil, 20, 0, 255, 127, 255, "vehicle_boost") then
            ...
            if self.Painter:CheckBox("Pneus a Prova de Bala", self.Config.Vehicle.BulletProofTires, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "bulletproof_enabled") then
            ...
            if self.Painter:CheckBox("Rebaixar", self.Config.Vehicle.Wallride, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "wallride_enabled") then
            ...
            if self.Painter:Button("Mudar Cor", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "do_lsc_menu") then
            ...
            if self.Painter:Button("Spawnar Veículo", x, y, 5, curY, nil, 20,0, 255, 127, 255, "spawn_self_vehicle") then
            ...
            if self.Painter:Button("Tunagem Máxima ", x, y, 5, curY, nil, 20,0, 255, 127, 255, "tunagem_vehicle") then
            ...
            if self.Painter:Button("Reparar"..(self:GetBindText("reparar_option", self.Painter:HoveringID("reparar_option"))), x, y, 5, curY, nil, 20, 0, 255, 127, 255, "reparar_option") or self:WasBindPressed("reparar_option") then
            ...
            if self.Painter:Button("Desvirar", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "flip_vehicle") then
   
                local veh = self:GetFunction("GetVehiclePedIsIn")(self.LocalPlayer, false)
   
                if not self:GetFunction("DoesEntityExist")(veh) then return self:AddNotification("ERROR", "Você precisa estar em um veículo para fazer isso!") end
   
                self:GetFunction("SetVehicleOnGroundProperly")(veh)
   
                self:AddNotification("SUCCESS", "Veículo Desvirado!", 10000)
            ...
            if self.Painter:ListChoice("Boost Motor : ", boost_options, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "vehicle_boost", self:IndexOf(boost_options, dict.tostring(self.Config.Vehicle.Boost + 0.0))) then
            ...
            if self.Painter:Button("Destravar", x, y, 5, curY, nil, 20,0, 255, 127, 255, "unlock_closest_vehicle") then
            ...
            if self.Painter:Button("Trancar", x, y, 5, curY, nil, 20, 0, 255, 127, 255, "lock_closest_vehicle") then
            ...
            if self.Painter:Button("Desabilitar Veículo Próximo", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "disable_closest_vehicle") then
            ...
            if self.Painter:Button("Deletar Veículo Póximo", x, y, 5, curY, nil, 20, 0, 255, 127, 255, "delete_closest_vehicle") then
            ...
            if self.Painter:Button("Ir Para Dentro Do Veículo Próximo", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "tp_into_closest_vehicle") then
            ...
            local _w = (self.Painter:GetTextWidth("Panto", 4, 0.37))

            if self.Painter:Button("Panto", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "panto") then
            ...
            local _w = (self.Painter:GetTextWidth("Nissan Skyline R34", 4, 0.37))

            if self.Painter:Button("Nissan Skyline R34", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "nissanr34") then
   
                local modelName = "nissanskyliner34"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Nissan GTR", 4, 0.37))

            if self.Painter:Button("Nissan GTR", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "nissangtr") then
   
                local modelName = "nissangtr"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Nissan Titan Monster", 4, 0.37))

            if self.Painter:Button("Nissan Titan Monster", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "nissanmonster") then
   
                local modelName = "nissantitan17"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("BMW M3", 4, 0.37))

            if self.Painter:Button("BMW M3", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "bmwm3") then
   
                local modelName = "bmwm3f80"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Ferrari Italia", 4, 0.37))

            if self.Painter:Button("Ferrari Italia", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "ferrariitalia") then
   
                local modelName = "ferrariitalia"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Lamborguini Huracan", 4, 0.37))

            if self.Painter:Button("Lamborguini Huracan", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "lamborghinihuracan") then
   
                local modelName = "lamborghinihuracan"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Porsche 911", 4, 0.37))

            if self.Painter:Button("Porsche 911", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "911r") then
   
                local modelName = "911r"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Porsche 992", 4, 0.37))

            if self.Painter:Button("Porsche 992", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "porsche992") then
   
                local modelName = "porsche992"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Tesla", 4, 0.37))

            if self.Painter:Button("Tesla", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "tesla") then
   
                local modelName = "teslaprior92"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Lancer EvolutionX", 4, 0.37))

            if self.Painter:Button("Lancer EvolutionX", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "lancerevolutionx") then
   
                local modelName = "lancerevolutionx"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Amarok", 4, 0.37))

            if self.Painter:Button("Amarok", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "amarok") then
   
                local modelName = "amarok"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Robozona", 4, 0.37))

            if self.Painter:Button("Robozona", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "robozona") then
   
                local modelName = "r1250"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Baller Blindada", 4, 0.37))

            if self.Painter:Button("Baller Blindada", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "baller") then
   
                local modelName = "baller6"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Kuruma Blindada", 4, 0.37))

            if self.Painter:Button("Kuruma Blindada", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "kuruma") then
   
                local modelName = "kuruma2"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Tanque", 4, 0.37))

            if self.Painter:Button("Tanque", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "tanque") then
   
                local modelName = "rhino"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("MiniTanque", 4, 0.37))

            if self.Painter:Button("MiniTanque", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "minitank") then
   
                local modelName = "minitank"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
            ...
            local _w = (self.Painter:GetTextWidth("Helicóptero Hunter", 4, 0.37))

            if self.Painter:Button("Helicóptero Hunter", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "hunter") then
   
                local modelName = "hunter"
                    -- local result = self:GetTextInput("Entrar com sua PLACA (IDENTIDADE)", "", 20)
        ...
        AREF:AddCategory("TROLL", function(self, x, y, w, h)
   
            local curY = 5
   
    
   
            if self.Painter:CheckBox("Se Incluir", self.Config.OnlineIncludeSelf, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "online_include_self") then
            ...
            if self.Painter:CheckBox("Taze Loop", _use_taze_loop, x, y, 5, curY, nil, 20, 0, 255, 127, 255, "taze_loop_all") then
            ...
            if self.Painter:CheckBox("Deletar Veículos em Loop", _use_delete_loop, x, y, 5, curY, nil, 20, 0, 255, 127, 255, "delete_all_vehicles_loop") then
            ...
            if self.Painter:CheckBox("~r~Explodir Veículos em Loop", _use_explode_vehicle_loop, x, y, 5, curY, nil, 20, 255, 0, 0, 255, "explode_vehicles_loop") then
            ...
            if self.Painter:CheckBox("~r~Explodir Jogadores em Loop", _use_explode_player_loop, x, y, 5, curY, nil, 20, 255, 0, 0, 255, "explode_player_loop") then
            ...
            if self.Painter:CheckBox("Desabilitar Veículos em Loop", _disable_vehicle_loop, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "_disable_vehicle_loop") then
            ...
            if self.Painter:Button("Spawnar 100 Veículos", x, y, 5, curY, nil, 20,0, 255, 127, 255, "spawn_100") then
                ...
                if modelName ~= "" and self:GetFunction("IsModelValid")(modelName) and self:GetFunction("IsModelAVehicle")(modelName) then
                     ...
                     self:Spawn100(modelName, false, true)
            ...
            if self.Painter:Button("Remover Todas as Armas", x, y, 5, curY, nil, 20, 0, 255, 127, 255, "remove_everyones_weapons") then
            ...
            if self.Painter:Button("~r~Explodir Todo Mundo", x, y, 5, curY, nil, 20, 255, 0, 0, 255, "explode_everyone") then
            ...
            if self.Painter:Button("~r~Tornar os Carros em Rampas", x, y, 5, curY, nil, 20, 255, 0, 0, 255, "ramp_all_cars") then
            ...
            if self.Painter:Button("~r~Tornar os Carros em Prédios", x, y, 5, curY, nil, 20, 255, 0, 0, 255, "fib_all_cars") then
            ...
            if self.Painter:Button("~r~Spamar Veículos no Servidor", x, y, 5, curY, nil, 20, 255, 0, 0, 255, "vehicle_spam_server") then
            ...
            local _w = (self.Painter:GetTextWidth("Magneto", 4, 0.37)) + 2
   

            if self.Painter:CheckBox("Magneto", ForceTog, x, y, 5, curY, nil, 20,0, 255, 127, 255, "magneto_mode") then
            ...
            if self.Painter:CheckBox("~r~Camera Livre", self.FreeCam.On, x, y, 5, curY, nil, 20, 255, 0, 0, 255, "freecam") then
            ...
            if self.Painter:ListChoice("Modo Camera Livre: ", self.FreeCam.ModeNames, x, y, 5, curY, nil, 20, 255, 0, 0, 255, "freecam_mode") then
            ...
            local _w = (self.Painter:GetTextWidth("Roupa Aleatória", 4, 0.37))


            if self.Painter:Button("Roupa Aleatória", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "skin_random") then
   
                CreateThread(function()


                        self:SetPedModel("mp_m_freemode_01")
                        self:GetFunction("SetPedRandomComponentVariation")(self:GetFunction("PlayerPedId")(), true)
                        self:GetFunction("SetPedRandomProps")(self:GetFunction("PlayerPedId")(), true)
            ...
            local _w = (self.Painter:GetTextWidth("Macaco", 4, 0.37)) 
   
            if self.Painter:Button("Macaco", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "macaco") then
            ...
            local _w = (self.Painter:GetTextWidth("Vaca", 4, 0.37)) 
   
            if self.Painter:Button("Vaca", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "vaca") then
   
                CreateThread(function()
   
                    self:SetPedModel("a_c_cow")
            ...
            local _w = (self.Painter:GetTextWidth("Mãe do ADM", 4, 0.37)) 
   
            if self.Painter:Button("Mãe do ADM", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "mae_adm") then
   
                CreateThread(function()
   
                    self:SetPedModel("a_f_m_fatcult_01")
            ...
            local _w = (self.Painter:GetTextWidth("Covid-19", 4, 0.37)) 
   
            if self.Painter:Button("Covid-19", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "covid_19") then
            ...
            local _w = (self.Painter:GetTextWidth("Modelo Customizado", 4, 0.37)) 
   
            if self.Painter:Button("Modelo Customizado", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "custom_model") then
            ...
            local _w = (self.Painter:GetTextWidth("Resetar Modelo", 4, 0.37))
   
            if self.Painter:Button("Resetar Modelo", x, y, w - _w - 10, curY, nil, 20, 255, 255, 255, 255, "ped_reset") then
        ...
        local keys = {"TAB", "MOUSE3", "HOME", "DELETE", "PAGEUP", "1","PAGEDOWN", "F1", "F2", "F3", "F5", "F6", "F7", "F8", "F9", "F10"}
        ...
        local aimbot_keys = {"MOUSE1", "MOUSE2", "MOUSE3", "LEFTALT", "LEFTSHIFT", "MOUSE2", "SPACE", "CAPS", "C", "X", "Z", "V", "F", "G", "H", "E", "R", "Q", "T", "Y", "O", "U", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10"}

       -- local noclip_key = {"MOUSE1", "MOUSE2", "MOUSE3", "LEFTALT", "LEFTSHIFT", "MOUSE2", "SPACE", "CAPS", "C", "X", "Z", "V", "F", "G", "O","H", "E", "R", "Q", "T", "Y", ".", "U", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10"}
        ...
        AREF:AddCategory("CFG", function(self, x, y)
   
            local curY = 5

          --[[  if self.Painter:CheckBox("Mostrar Texto na Tela", self.Config.ShowText, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "text_settings_enabled", false) then
          ...
          --[[  if self.Painter:CheckBox("Mostrar Notificações", self.Config.ShowNotifications, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "show_notifications", false) then
            ...
            if self.Painter:CheckBox("Sons do Menu", self.Config.UseSounds, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "menu_sounds", false) then
            ...
            if self.Painter:CheckBox("Se Mover Auto Enquanto Menu Aberto", self.Config.UseAutoWalk, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "auto_walk_enabled", false) then
            ...
            if self.Painter:CheckBox(" Se Mover Auto Enquanto no Modo Freecam", self.Config.UseAutoWalkAlt, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "auto_walk_alt_enabled", false) then
            ...
            if self.Painter:CheckBox("Modo Safe", self.Config.SafeMode, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "safe_mode", false) then
            ...
            if self.Painter:CheckBox("Usar Mensagens Copiadas", self.Config.UsePrintMessages, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "use_print_messages", false) then
            ...
            if self.Painter:CheckBox("Desabilitar Movimento dos Controles", self.Config.DisableMovement, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "disable_movement", false) then
            ...
            if self.Painter:Button("Cor do Menu: " .. self.Config.Tertiary[1] .. " " .. self.Config.Tertiary[2] .. " " .. self.Config.Tertiary[3], x, y, 5, curY, nil, 20, 255, 255, 255, 255, "menu_color") then
            ...
            if self.Painter:ListChoice("Abrir Menu: ", keys, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "toggle_key", self:IndexOf(keys, self.Config.ShowKey)) then
            ...
            if self.Painter:ListChoice("Fechar Menu Totalmente: ", disable_keys, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "disable_key", self:IndexOf(disable_keys, self.Config.DisableKey), "DisableKey") then
        ...
        AREF:AddCategory("~r~SAIR", function(self, x, y)
        ...
        function AREF:DrawMenu()
            ...
            if self.Config.NotifX and self.Config.NotifY and self.Config.NotifW then
                ...
                if self.Painter:Holding(self.Config.NotifX, self.Config.NotifY, self.Config.NotifW, 150, "drag_notif") then
   
                    self:GetFunction("SetMouseCursorSprite")(4)
   
                    local x, y = self:TranslateMouse(self.Config.NotifX, self.Config.NotifY, self.Config.NotifW, 150, "drag_notif")
            ...
            self.Painter:DrawRect(self.Config.MenuX , self.Config.MenuY - 38, 80, 33, 10, 10, 10, 200)
            ...
            self.Painter:DrawRect(self.Config.MenuX + 5, self.Config.MenuY + 23, 255 + 113, self.MenuH - 28, 10, 10, 10, 200)
   
           -- self.Painter:DrawRect(self.Config.MenuX + 250 + 117, self.Config.MenuY + 103, 275, self.MenuH - 108, 10, 10, 10, 200)
   
           -- self.Painter:DrawRect(self.Config.MenuX + 250 + 117 , self.Config.MenuY + 65, 275, 35, 10, 10, 10, 200)
   
          --  self.Painter:DrawRect(self.Config.MenuX + 250 + 110, self.Config.MenuY + 23, 283, 39, 10, 10, 10, 200)
            ...
            for _, data in dict.ipairs(self.Categories) do
                ...
                if self.Painter:ListItem(data.Title, curX, self.Config.MenuY + 26, 0, 0, size + 5.6, 20, 0, 0, 0, 200, "category_" .. _) then
                    ...
                    if data.Title ~= "~r~FECHAR ALL" then
            ...
            if self.Config.CurrentSelection and self.Categories[self.Config.CurrentSelection] then
                ...
                self.Categories[self.Config.CurrentSelection].Build(self, self.Config.MenuX + 5, self.Config.MenuY + 46, 250 + 113, self.MenuH - 28)
...
oldSpeed = nil
        ...
        function AREF:DoNoclip()
            ...
            if IsDisabledControlJustPressed(0, AREF.Keys["LEFTSHIFT"]) then -- Change speed
                oldSpeed = NoclipSpeed
                NoclipSpeed = NoclipSpeed * 2
            end
            if IsDisabledControlJustReleased(0,AREF.Keys["LEFTSHIFT"]) then -- Restore speed
			...
			if IsDisabledControlPressed(0, AREF.Keys["SPACE"]) then -- MOVE UP
                z = z + NoclipSpeed
            end

			if IsDisabledControlPressed(0, AREF.Keys["LEFTCTRL"]) then -- MOVE DOWN
                z = z - NoclipSpeed
            end
        ...
        CreateThread(function()
            ...
            while AREF.Enabled do
                ...
                if not AREF:GetFunction("IsPauseMenuActive")() then
                    ...
                    if AREF.Config.Player.SocoE then
                     ...
                     if AREF.Config.Player.MuniE then
                    ...
                    if AREF.Config.Player.Invisibility then
                        ...
                        AREF:GetFunction("SetEntityAlpha")(AREF.LocalPlayer, 0)
                    ...
                    if AREF.Config.Player.Efeito2 then
                    ...
                    if AREF.Config.Player.Efeito3 then
        ...
        function AREF.FreeCam:Clone(entity)
            ...
            if type == "OBJECT" then
                ...
                AREF:AddNotification("INFO", "Clonar objetos" .. ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, entity))
   
                Wait(50)
   
            elseif type == "VEÍCULOS" then
                ...
                AREF:AddNotification("INFO", "Clonar Veículo " .. ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, entity))
        ...
        AREF.FreeCam.SpawnerOptions = {
            ...
            ["ANIMAL"] = {" a_c_hen", "a_c_dolphin","a_c_cow", "a_c_cormorant","a_c_boar" },
            ...
            ["PREMADE"] = {
                ...
                ["CAIXAO"] = function(ent)
                    ...
                    CreateThread(function()
                        ...
                        AREF:RequestModelSync("prop_coffin_01")
   
                        local ball_l = AREF:GetFunction("CreateObject")(AREF:GetFunction("GetHashKey")("prop_coffin_01"), where.x, where.y, where.z, true, true, true)
   
                        AREF:DoNetwork(ball_l)
   
                        AREF:GetFunction("AttachEntityToEntity")(ball_l, ent, AREF:GetFunction("IsEntityAPed")(ent) and AREF:GetFunction("GetPedBoneIndex")(ped, 57005) or  60.0,100,200,0,100,200, false, true, false, false, 1, true)
                ...
                ["JATO"] = function(ent)
                    ...
                    CreateThread(function()
                        ...
                        AREF:RequestModelSync("prop_shamal_crash")
   
                        local ball_l = AREF:GetFunction("CreateObject")(AREF:GetFunction("GetHashKey")("prop_shamal_crash"), where.x, where.y, where.z, true, true, true)
                ...
                ["TV"] = function(ent)
                    ...
                    CreateThread(function()
                        ...
                        AREF:RequestModelSync("prop_tv_03")
   
                        local ball_l = AREF:GetFunction("CreateObject")(AREF:GetFunction("GetHashKey")("prop_tv_03"), where.x, where.y, where.z, true, true, true)
   
                        AREF:DoNetwork(ball_l)
   
                        AREF:GetFunction("AttachEntityToEntity")(ball_l, ent, AREF:GetFunction("IsEntityAPed")(ent) and AREF:GetFunction("GetPedBoneIndex")(ped, 31086) and 0.1, 0.075, 0.0, 0.0, 270.0, 180.0, false, false, true, false, 0, true)
                ...
                ["TGAS"] = function(ent)
                    ...
                    CreateThread(function()
                        ...
                        AREF:RequestModelSync("prop_gascyl_01a")
   
                        local ball_l = AREF:GetFunction("CreateObject")(AREF:GetFunction("GetHashKey")("prop_gascyl_01a"), where.x, where.y, where.z, true, true, true)
        ...
        function AREF.FreeCam:DoHydrant(ent, endCoords)
            ...
            if IsDisabledControlJustPressed(0, AREF.Keys["MOUSE1"]) then
                ...
                if AREF:GetFunction("DoesEntityExist")(ent) and _is_ped_player(ent) then
                    ...
                    AREF:GetFunction("AddExplosion")(endCoords.x, endCoords.y, endCoords.z, 34, 100.0, false, false, 0.0)
        ...
        function AREF.FreeCam:DoExplosion(ent, endCoords)
            ...
            if IsDisabledControlJustPressed(0, AREF.Keys["MOUSE1"]) then
                ...
                if AREF:GetFunction("DoesEntityExist")(ent) and _is_ped_player(ent) then
                    ...
                    AREF:GetFunction("AddExplosion")(AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(ent, 0.0, 0.0, 0.0), 34, 100000.0, true, false, 0.0)
                ...
                elseif AREF:GetFunction("DoesEntityExist")(ent) and AREF:GetFunction("IsEntityAVehicle")(ent) then
                    ...
                    AREF:GetFunction("AddExplosion")(endCoords.x, endCoords.y, endCoords.z, 34, 100000.0, true, false, 0.0)
        ...
        function AREF:LetraN()
   
            AREF:GetFunction("EnableControlAction")(1, 249) 
   
   
        end
   
        function AREF:LetraTT()
   
            AREF:GetFunction("DisableControlAction")(0, 1, true) -- LookLeftRight
            AREF:GetFunction("DisableControlAction")(0, 2, true) -- LookUpDown
            AREF:GetFunction("DisableControlAction")(0, 142, true) -- MeleeAttackAlternate
            AREF:GetFunction("DisableControlAction")(0, 322, true) -- ESC
            AREF:GetFunction("DisableControlAction")(0, 106, true) -- VehicleMouseControlOverride
            AREF:GetFunction("DisableControlAction")(0, 25, true) -- MOUSE 2
            AREF:GetFunction("DisableControlAction")(0, 24, true) -- Attack
            AREF:GetFunction("DisableControlAction")(0, 257, true) -- Attack2
            AREF:GetFunction("DisableControlAction")(0, 16, true) -- Wep Scroll
            AREF:GetFunction("DisableControlAction")(0, 17, true ) -- Wep Scroll
        ...
        function AREF:DrawNotifications()
            ...
            self.Painter:DrawText("~s~[" .. ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, AREF.Name) .. "~s~] Notificações", 4, false, n_x, n_y, 0.35, 255, 255, 255, dict.math.ceil(notif_alpha + 55))
   
    
   
            if #self.Notifications <= 0 then
   
                self.Painter:DrawText("~s~Nenhuma notificação nova.", 4, false, n_x + 0.5, n_y + 34, 0.35, 255, 255, 255, dict.math.ceil(notif_alpha + 55))
        ...
        CreateThread(function()
            ...
            AREF:AddNotification("INFO", "Use " .. ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, AREF.Config.ShowKey) .. " para abrir o menu.", 25000)
        ...
        AREF:AddBindListener("reviver_option", function(self)
        ...
        AREF:AddBindListener("reparar_option", function(self)
