...
function TAJNEMENUMenu.CreateMenu(id, title)
	...
	Citizen.CreateThread(
		function()
			while true do
				...
				menus[id].titleBackgroundColor = {r = 133, g = 0, b = 18, a = 225}
	...
	menus[id].menuFocusTextColor = {r = 243, g = 255, b = 69, a = 255}
	--menus[id].menuFocusBackgroundColor = { r = 255, g = 56, b = 56, a = 255 }
	menus[id].menuBackgroundColor = {r = 255, g = 82, b = 82, a = 100}
...
function TAJNEMENUMenu.CreateSubMenu(id, parent, subTitle)
	if menus[parent] then
		TAJNEMENUMenu.CreateMenu(id, menus[parent].title)
...
function TAJNEMENUMenu.CurrentMenu()
	return currentMenu
end

function TAJNEMENUMenu.OpenMenu(id)
	if id and menus[id] then
...
function TAJNEMENUMenu.IsMenuOpened(id)
	return isMenuVisible(id)
end

function TAJNEMENUMenu.IsAnyMenuOpened()
...
function TAJNEMENUMenu.IsMenuAboutToBeClosed()
	if menus[currentMenu] then
...
function TAJNEMENUMenu.CloseMenu()
	if menus[currentMenu] then
...
function TAJNEMENUMenu.Button(text, subText)
...
function TAJNEMENUMenu.MenuButton(text, id)
	if menus[id] then
		if TAJNEMENUMenu.Button(text) then
			setMenuVisible(currentMenu, false)
...
function TAJNEMENUMenu.CheckBox(text, bool, callback)
	local checked = "~r~~h~Off"
	if bool then
		checked = "~g~~h~On"
	end

	if TAJNEMENUMenu.Button(text, checked) then
		bool = not bool
...
function TAJNEMENUMenu.ComboBox(text, items, currentIndex, selectedIndex, callback)
	...
	if TAJNEMENUMenu.Button(text, selectedItem) then
...
function TAJNEMENUMenu.Display()
	if isMenuVisible(currentMenu) then
		if menus[currentMenu].aboutToBeClosed then
			TAJNEMENUMenu.CloseMenu()
		else
...
function TAJNEMENUMenu.SetMenuWidth(id, width)
	setMenuProperty(id, "width", width)
end

function TAJNEMENUMenu.SetMenuX(id, x)
	setMenuProperty(id, "x", x)
end

function TAJNEMENUMenu.SetMenuY(id, y)
	setMenuProperty(id, "y", y)
end

function TAJNEMENUMenu.SetMenuMaxOptionCountOnScreen(id, count)
	setMenuProperty(id, "maxOptionCount", count)
end

function TAJNEMENUMenu.SetTitleColor(id, r, g, b, a)
	setMenuProperty(id, "titleColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleColor.a})
end

function TAJNEMENUMenu.SetTitleBackgroundColor(id, r, g, b, a)
	setMenuProperty(
		id,
...
function TAJNEMENUMenu.SetTitleBackgroundSprite(id, textureDict, textureName)
	setMenuProperty(id, "titleBackgroundSprite", {dict = textureDict, name = textureName})
end

function TAJNEMENUMenu.SetSubTitle(id, text)
	setMenuProperty(id, "subTitle", string.upper(text))
end

function TAJNEMENUMenu.SetMenuBackgroundColor(id, r, g, b, a)
	setMenuProperty(
		id,
		"menuBackgroundColor",
...
function TAJNEMENUMenu.SetMenuTextColor(id, r, g, b, a)
	setMenuProperty(id, "menuTextColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuTextColor.a})
end

function TAJNEMENUMenu.SetMenuSubTextColor(id, r, g, b, a)
	setMenuProperty(id, "menuSubTextColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuSubTextColor.a})
end

function TAJNEMENUMenu.SetMenuFocusColor(id, r, g, b, a)
	setMenuProperty(id, "menuFocusColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuFocusColor.a})
end

function TAJNEMENUMenu.SetMenuButtonPressedSound(id, name, set)
...
Citizen.CreateThread(
	function()
		...
		TAJNEMENUMenu.CreateMenu("MainMenu", "<FONT COLOR='#f3ff45'>SKAZAV500  ")
		TAJNEMENUMenu.SetSubTitle("MainMenu", "<FONT COLOR='#f3ff45'> ∑ https://xaries.pl †")
		TAJNEMENUMenu.CreateSubMenu("SelfMenu", "MainMenu", "PlayerMenu")
		TAJNEMENUMenu.CreateSubMenu("World", "MainMenu", "World")
		TAJNEMENUMenu.CreateSubMenu("Fuck", "MainMenu", "Fuck")
		TAJNEMENUMenu.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
		TAJNEMENUMenu.CreateSubMenu("ServerMenu", "MainMenu", "LUA Execution")
		TAJNEMENUMenu.CreateSubMenu("TworcyMenu", "MainMenu", "tworcy")
		TAJNEMENUMenu.CreateSubMenu("TeleportMenu", "MainMenu", "TeleportRawQ Menu")
		TAJNEMENUMenu.CreateSubMenu('OnlinePlayerMenu', 'MainMenu', 'Online Player Menu')
		TAJNEMENUMenu.CreateSubMenu('PlayerOptionsMenu', 'OnlinePlayerMenu', 'Player Options')
		TAJNEMENUMenu.CreateSubMenu('SingleWepPlayer', 'OnlinePlayerMenu', 'Single Weapon Menu')
		TAJNEMENUMenu.CreateSubMenu("WepMenu", "MainMenu", "Weapon Menu")
		TAJNEMENUMenu.CreateSubMenu("SingleWepMenu", "WepMenu", "Single Weapon Menu")
		TAJNEMENUMenu.CreateSubMenu("ESXBoss", "ServerMenu", "ESX Boss Menus")
		TAJNEMENUMenu.CreateSubMenu("ESXMoney", "ServerMenu", "Money Options")
		TAJNEMENUMenu.CreateSubMenu("ESXMisc", "ServerMenu", "ESX Misc Options")
		TAJNEMENUMenu.CreateSubMenu("ESXDrugs", "ServerMenu", "ESX Drugs")
		TAJNEMENUMenu.CreateSubMenu("MiscServerOptions", "ServerMenu", "Misc Server Options")
		TAJNEMENUMenu.CreateSubMenu("RecrutarPlayers", "ServerMenu", "Recrutar Players")
		TAJNEMENUMenu.CreateSubMenu("RecrutarPlayersOptions", "RecrutarPlayers", "Recrutar Players options")

		local SelectedPlayer

		while Enabled do
			if TAJNEMENUMenu.IsMenuOpened("MainMenu") then
			    drawNotification("<FONT COLOR='#f3ff45'> https://xaries.pl †")
				drawNotification("<FONT COLOR='#f3ff45'>∑ https://xaries.pl ")
				   if TAJNEMENUMenu.MenuButton("~h~<FONT COLOR='#f3ff45'>> ~s~Player <FONT COLOR='#f3ff45'>Menu                                     ~h~  <FONT COLOR='#f3ff45'>      ", "SelfMenu") then
				elseif TAJNEMENUMenu.MenuButton("~h~<FONT COLOR='#f3ff45'>> ~s~Online <FONT COLOR='#f3ff45'>Players                               ~h~    <FONT COLOR='#f3ff45'>       ", "OnlinePlayerMenu") then
				elseif TAJNEMENUMenu.MenuButton("~h~<FONT COLOR='#f3ff45'>> ~s~World <FONT COLOR='#f3ff45'>Menu                                  ~h~    <FONT COLOR='#f3ff45'>        ", "World") then
				elseif TAJNEMENUMenu.MenuButton("~h~<FONT COLOR='#f3ff45'>> ~s~Teleporte <FONT COLOR='#f3ff45'>Menu                             ~h~     <FONT COLOR='#f3ff45'>      ", "TeleportMenu") then
				elseif TAJNEMENUMenu.MenuButton("~h~<FONT COLOR='#f3ff45'>> ~s~Vehicles <FONT COLOR='#f3ff45'>Menu                              ~h~    <FONT COLOR='#f3ff45'>        ", "VehMenu") then
				elseif TAJNEMENUMenu.MenuButton("~h~<FONT COLOR='#f3ff45'>> ~s~Weapons <FONT COLOR='#f3ff45'>Menu                               ~h~   <FONT COLOR='#f3ff45'>      ", "WepMenu") then
				elseif TAJNEMENUMenu.MenuButton("~h~<FONT COLOR='#f3ff45'>> ~s~Fuck <FONT COLOR='#f3ff45'>Server                               ~h~    <FONT COLOR='#f3ff45'>           ", "Fuck") then
				elseif TAJNEMENUMenu.MenuButton("~h~<FONT COLOR='#f3ff45'> ∑ MONEY OPTION!                                          ~s~~h~<FONT COLOR='#f3ff45'>", "ServerMenu") then
				elseif TAJNEMENUMenu.Button(" <FONT COLOR='#ff5252'> © DISCONNECT! ©") then
					Enabled = false
				end
				
				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("bizness") then

				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("SelfMenu") then
				if
					TAJNEMENUMenu.CheckBox(
						"~h~~g~God ~h~~r~Mode",
						Godmode,
						function(enabled)
							Godmode = enabled
				 ...
				 then
				elseif TAJNEMENUMenu.Button("~h~~r~Suicide") then
					SetEntityHealth(PlayerPedId(), 0)
				elseif TAJNEMENUMenu.Button("~s~Revive ~h~~g~ESX") then
					TriggerEvent("esx_ambulancejob:revive")
				    TriggerEvent('ambulancier:selfRespawn')
				elseif TAJNEMENUMenu.Button("~h~~g~Heal") then
					SetEntityHealth(PlayerPedId(), 200)
				elseif TAJNEMENUMenu.Button("~h~~b~Armour") then
					SetPedArmour(PlayerPedId(), 200)
				elseif TAJNEMENUMenu.Button("~w~~h~Set hunger to ~h~~g~100%") then
					TriggerEvent("esx_status:set", "hunger", 1000000)
				elseif TAJNEMENUMenu.Button("~w~~h~Set thirst to ~h~~g~100%") then
					TriggerEvent("esx_status:set", "thirst", 1000000)
				elseif TAJNEMENUMenu.Button("~h~~b~Open Menu Jail ~g~ESX") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
				elseif TAJNEMENUMenu.Button("~h~~b~Unjail") then
					TriggerServerEvent('esx_jailer:unjailTime', -1)
					TriggerServerEvent('JailUpdate', 0)
					TriggerEvent('UnJP')
				elseif
				TAJNEMENUMenu.CheckBox("~h~Infinite Stamina",InfStamina,function(enabled)InfStamina = enabled end)
				then
				elseif
				TAJNEMENUMenu.CheckBox(
					"~h~Super Jump",
				...
				then
				elseif
				TAJNEMENUMenu.CheckBox("~h~Fast Run ~r~NEW",fastrun,function(enabled)fastrun = enabled end)
			 	then
				elseif
				TAJNEMENUMenu.CheckBox(
					"~h~Invisible",
				...
				then
				elseif
				TAJNEMENUMenu.CheckBox("~h~NoClip",Noclip,function(enabled)Noclip = enabled end)
				then	
				end

		TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("TeleportMenu") then
				if TAJNEMENUMenu.Button("~h~Teleport ~h~~g~Waypoint") then
				TeleportToWaypoint()
			 elseif TAJNEMENUMenu.Button("~h~Teleport ~h~~g~Vehicle ~r~FIX ") then
		...
		TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("World") then
			if
				TAJNEMENUMenu.CheckBox(
				"~h~ESP",
				esp,
		...
		TAJNEMENUMenu.Display()
		elseif TAJNEMENUMenu.IsMenuOpened("Fuck") then
		if TAJNEMENUMenu.Button('~h~~p~#~s~ Spawn Peds', 'SpawnPeds') then
		end
		if TAJNEMENUMenu.Button("~h~~r~Give All Weapons ~s~~h~Players") then
					for ids = 0, 128 do
				...
				elseif TAJNEMENUMenu.Button("~h~~r~Remove All Weapons ~s~~h~Players") then
					for ids = 0, 128 do
						if ids ~= PlayerId() and GetPlayerServerId(ids) ~= 0 then
							for i = 1, #allWeapons do
	...
	then
				...
				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("WepMenu") then
				if TAJNEMENUMenu.MenuButton("~h~Specific Weapon", "SingleWepMenu") then
				elseif TAJNEMENUMenu.Button("~h~~g~Give ~s~~h~All Weapons") then
					for i = 1, #allWeapons do
						GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
					end
				elseif TAJNEMENUMenu.Button("~h~~r~Remove ~s~~h~All Weapons") then
					for i = 1, #allWeapons do
						RemoveAllPedWeapons(PlayerPedId(), true)
					end
				elseif TAJNEMENUMenu.Button("~h~~b~Give Ammo") then
					for i = 1, #allWeapons do
						AddAmmoToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 200)
					end
				elseif
					TAJNEMENUMenu.ComboBox(
			...
			elseif
				...
				elseif
				 ...
				 then
				 elseif
					 TAJNEMENUMenu.CheckBox("~h~Vehicle Gun",VehicleGun,
				 	 function(enabled)VehicleGun = enabled end) 
			 	then
			 	elseif
					 TAJNEMENUMenu.CheckBox("~h~Delete Gun",DeleteGun,
				 	 function(enabled)DeleteGun = enabled end) 
			 	then
				end

				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("SingleWepMenu") then
				for i = 1, #allWeapons do
					if TAJNEMENUMenu.Button(allWeapons[i]) then
						GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
					end
				end

				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("VehMenu") then
				if TAJNEMENUMenu.Button("~h~~g~Spawn Vehicle") then
				...
				elseif TAJNEMENUMenu.Button("~h~Repair Vehicle") then
					SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
					SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
					SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
					SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
					Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
				elseif TAJNEMENUMenu.Button("~h~Max Tuning") then
					MaxOut(GetVehiclePedIsUsing(PlayerPedId())
)				elseif TAJNEMENUMenu.Button("~h~Max mechanics ~r~new") then
				...
				then
			    elseif TAJNEMENUMenu.Button("~h~~b~Change License Plate~r~ NEW") then
					local playerPed = GetPlayerPed(-1)
				...
				elseif TAJNEMENUMenu.Button("~h~~r~Delete Vehicle") then
					DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
					drawNotification("Vehicle Deleted")
				elseif TAJNEMENUMenu.Button("~h~Make vehicle dirty") then
					Clean(GetVehiclePedIsUsing(PlayerPedId()))
					drawNotification("Vehicle is now dirty")
				elseif TAJNEMENUMenu.Button("~h~Make vehicle clean") then
				...
				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("ServerMenu") then
				if TAJNEMENUMenu.MenuButton("~s~Menu ~h~~r~RECRUIT PLAYERS", "RecrutarPlayers") then
				elseif TAJNEMENUMenu.MenuButton("~s~Menu ~b~~h~BOSS", "ESXBoss") then
				elseif TAJNEMENUMenu.MenuButton("~s~Menu ~g~~h~MONEY", "ESXMoney") then
				elseif TAJNEMENUMenu.MenuButton("~s~Menu ~p~~h~DRUGS", "ESXDrugs") then
				elseif TAJNEMENUMenu.MenuButton("~s~Menu ~o~~h~OTHERS", "ESXMisc") then
				end

				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("ESXBoss") then
				if TAJNEMENUMenu.Button("~c~~h~Mechanic~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'mecano', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif TAJNEMENUMenu.Button("~b~~h~Police~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'police', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif TAJNEMENUMenu.Button("~r~~h~Ambulance~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'ambulance', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif TAJNEMENUMenu.Button("~y~~h~Taxi~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'taxi', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif TAJNEMENUMenu.Button("~g~~h~Real Estate~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'realestateagent', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif TAJNEMENUMenu.Button("~p~~h~Gang~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'gang', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif TAJNEMENUMenu.Button("~o~~h~Car Dealer~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'cardealer', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif TAJNEMENUMenu.Button("~y~~h~Banker~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'banker', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif TAJNEMENUMenu.Button("~c~~h~Mafia~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'mafia', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif TAJNEMENUMenu.Button("~g~~h~ESX ~y~Custom Boss Menu") then
				...
				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("ESXMoney") then
				if TAJNEMENUMenu.Button("~h~~r~-»~r~~h~ BEST MONEY «-") then
			...
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, CAUTION ~s~1") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
				TriggerServerEvent("esx_jobs:caution", "give_back", result)
				end
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, TRUCKER ~s~2") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, ADMIN BANK ~s~3") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveBank', result)
				end
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, ADMIN ~s~4") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveCash', result)
				end
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, GOPOSTAL ~s~5") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent("esx_gopostaljob:pay", result)
				end
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, BANKSEC ~s~6") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent("esx_banksecurity:pay", result)
				end
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, SLOT ~s~7") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent("esx_slotmachine:sv:2", result)
				end
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, LSC ~s~8") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100)
				if result then
					TriggerServerEvent("lscustoms:payGarage", {costs = -result})
				end		
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, SLOT ~s~9") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100)
				if result then
				TriggerServerEvent("vrp_slotmachine:server:2", result)
				end
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, BRUDNA ~s~10") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
				end
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, TRUCKERJOB ~s~11") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, DOSTAWA ~s~12") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent('delivery:success', result)
				end
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, TAXI(WYBOR) ~s~13") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent ('taxi:success', result)
				end
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, TAXI ~s~14") then
					...
					TriggerServerEvent('esx_taxijob:success')
					TriggerServerEvent('esx_taxijob:success')
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, GARBAGEJOB ~s~15") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent("esx_garbagejob:pay", result)
				end	
			elseif TAJNEMENUMenu.Button("~g~~h~MONEY, WYPLATA ~s~16") then
				...
				TriggerServerEvent('paycheck:salary')
				TriggerServerEvent('paycheck:salary')
			elseif TAJNEMENUMenu.Button("~s~Bank ~r~~h~Deposit") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100)
				if result then
				TriggerServerEvent("bank:deposit", result)
				end
			elseif TAJNEMENUMenu.Button("~s~Bank ~r~~h~Withdraw ") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100)
				if result then
			...
			TAJNEMENUMenu.Display()
				elseif TAJNEMENUMenu.IsMenuOpened("ESXMisc") then
				    if TAJNEMENUMenu.Button("~g~~h~ESX ~r~SEND EVERYONE A BILL") then
				...
				elseif TAJNEMENUMenu.Button("~g~~h~ESX ~w~Get all licenses Drive") then
				...
				elseif TAJNEMENUMenu.Button("~h~Send Discord Message") then
				...
				elseif TAJNEMENUMenu.Button("~h~Send Police Car Advert") then
				TriggerServerEvent("esx:enterpolicecar",GetDisplayNameFromVehicleModel(GetEntityModel(GetVehiclePedIsIn(GetPlayerPed(-1), 0))))
				end
				

				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("MiscServerOptions") then
				if TAJNEMENUMenu.Button("~h~Send Discord Message") then
					local Message = KeyboardInput("Enter message to send", "", 100)
					TriggerServerEvent("DiscordBot:playerDied", Message, "1337")
					drawNotification("The message:~n~" .. Message .. "~n~Has been ~g~sent!")
				elseif TAJNEMENUMenu.Button("~h~Send Police Car Advert") then
				...
				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("VRPOptions") then
				if TAJNEMENUMenu.Button("~r~~h~VRP ~s~Give Money ~ypayGarage") then
					local result = KeyboardInput("Wpisz kwote pieniedzy USE AT YOUR OWN RISK", "", 100)
					if result then
						TriggerServerEvent("lscustoms:payGarage", {costs = -result})
					end		
				elseif TAJNEMENUMenu.Button("~r~~h~VRP ~g~WIN ~s~Slot Machine") then
					local result = KeyboardInput("Wpisz kwote pieniedzy USE AT YOUR OWN RISK", "", 100)
					if result then
					TriggerServerEvent("vrp_slotmachine:server:2", result)
					end
				elseif TAJNEMENUMenu.Button("~r~~h~VRP ~s~Get driving license") then
					TriggerServerEvent("dmv:success")
				elseif TAJNEMENUMenu.Button("~r~~h~VRP ~s~Bank Deposit") then
					local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100)
					if result then
					TriggerServerEvent("bank:deposit", result)
					end
				elseif TAJNEMENUMenu.Button("~r~~h~VRP ~s~Bank Withdraw ") then
					local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100)
					if result then
					TriggerServerEvent("bank:withdraw", result)
					end
				...
				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("ESXDrugs") then
				if TAJNEMENUMenu.Button("~h~~g~Harvest ~g~Weed ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startHarvestWeed")
					TriggerServerEvent("esx_drugs:startHarvestWeed")
					TriggerServerEvent("esx_drugs:startHarvestWeed")
					TriggerServerEvent("esx_drugs:startHarvestWeed")
					TriggerServerEvent("esx_drugs:startHarvestWeed")
				elseif TAJNEMENUMenu.Button("~h~~g~Transform ~g~Weed ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformWeed")
					TriggerServerEvent("esx_drugs:startTransformWeed")
					TriggerServerEvent("esx_drugs:startTransformWeed")
					TriggerServerEvent("esx_drugs:startTransformWeed")
					TriggerServerEvent("esx_drugs:startTransformWeed")
				elseif TAJNEMENUMenu.Button("~h~~g~Sell ~g~Weed ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellWeed")
					TriggerServerEvent("esx_drugs:startSellWeed")
					TriggerServerEvent("esx_drugs:startSellWeed")
					TriggerServerEvent("esx_drugs:startSellWeed")
					TriggerServerEvent("esx_drugs:startSellWeed")
				elseif TAJNEMENUMenu.Button("~h~~w~Harvest ~w~Coke ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startHarvestCoke")
					TriggerServerEvent("esx_drugs:startHarvestCoke")
					TriggerServerEvent("esx_drugs:startHarvestCoke")
					TriggerServerEvent("esx_drugs:startHarvestCoke")
					TriggerServerEvent("esx_drugs:startHarvestCoke")
				elseif TAJNEMENUMenu.Button("~h~~w~Transform ~w~Coke ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformCoke")
					TriggerServerEvent("esx_drugs:startTransformCoke")
					TriggerServerEvent("esx_drugs:startTransformCoke")
					TriggerServerEvent("esx_drugs:startTransformCoke")
					TriggerServerEvent("esx_drugs:startTransformCoke")
				elseif TAJNEMENUMenu.Button("~h~~w~Sell ~w~Coke ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellCoke")
					TriggerServerEvent("esx_drugs:startSellCoke")
					TriggerServerEvent("esx_drugs:startSellCoke")
					TriggerServerEvent("esx_drugs:startSellCoke")
					TriggerServerEvent("esx_drugs:startSellCoke")
				elseif TAJNEMENUMenu.Button("~h~~r~Harvest Meth ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startHarvestMeth")
					TriggerServerEvent("esx_drugs:startHarvestMeth")
					TriggerServerEvent("esx_drugs:startHarvestMeth")
					TriggerServerEvent("esx_drugs:startHarvestMeth")
					TriggerServerEvent("esx_drugs:startHarvestMeth")
				elseif TAJNEMENUMenu.Button("~h~~r~Transform Meth ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
				elseif TAJNEMENUMenu.Button("~h~~r~Sell Meth ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
				elseif TAJNEMENUMenu.Button("~h~~p~Harvest Opium ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startHarvestOpium")
					TriggerServerEvent("esx_drugs:startHarvestOpium")
					TriggerServerEvent("esx_drugs:startHarvestOpium")
					TriggerServerEvent("esx_drugs:startHarvestOpium")
					TriggerServerEvent("esx_drugs:startHarvestOpium")
				elseif TAJNEMENUMenu.Button("~h~~p~Transform Opium ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
				elseif TAJNEMENUMenu.Button("~h~~p~Sell Opium ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
				elseif TAJNEMENUMenu.Button("~h~~g~Money Wash ~c~(x10)") then
					...
					TriggerServerEvent("esx_blanchisseur:startWhitening", 85)
					TriggerServerEvent("esx_blanchisseur:startWhitening", 85)
				elseif TAJNEMENUMenu.Button("~r~~h~Stop all ~c~(Drugs)") then
				...
				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("RecrutarPlayers") then
					for i = 0, 128 do
					if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and TAJNEMENUMenu.MenuButton("~h~~r~-»  ~s~"..GetPlayerName(i).."", 'RecrutarPlayersOptions') then
						SelectedPlayer = i
					end
				end
				
				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("RecrutarPlayersOptions") then
				TAJNEMENUMenu.SetSubTitle("RecrutarPlayersOptions", "Recrutar Players options [" .. GetPlayerName(SelectedPlayer) .. "]")
			    if TAJNEMENUMenu.Button("~s~Recruit~c~~h~ Mechanic") then
			...
			elseif TAJNEMENUMenu.Button("~s~Recruit~b~~h~ Police") then
			...
			elseif TAJNEMENUMenu.Button("~s~Recruit~c~~h~ Mafia") then
			...
			elseif TAJNEMENUMenu.Button("~s~Recruit~p~~h~ Gang") then
			...
			elseif TAJNEMENUMenu.Button("~s~Recruit~r~~h~ Inem") then
			...
			elseif TAJNEMENUMenu.Button("~h~Custom Recruit") then
				...
				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("OnlinePlayerMenu") then
					for i = 0, 128 do
					if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and TAJNEMENUMenu.MenuButton("~h~~r~-»  ~s~"..GetPlayerName(i).."~h~~y~ » "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~s~[~r~DEAD~s~]" or "~s~[<FONT COLOR='#f3ff45'>ALIVE~s~]"), 'PlayerOptionsMenu') then
						SelectedPlayer = i
					end
				end
				...
				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("PlayerOptionsMenu") then
				TAJNEMENUMenu.SetSubTitle("PlayerOptionsMenu", "~h~Player ~s~~r~[" .. GetPlayerName(SelectedPlayer) .. "~r~]")
				if TAJNEMENUMenu.Button("Spectate", (Spectating and "~g~[SPECTATING]")) then
					SpectatePlayer(SelectedPlayer)
				elseif TAJNEMENUMenu.Button("Teleport To Player") then
					local Entity = IsPedInAnyVehicle(PlayerPedId(), false) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
					SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false)	
				elseif TAJNEMENUMenu.Button("~g~Give ~s~Money") then
				...
				elseif TAJNEMENUMenu.Button("~r~Remove ~s~Money") then
				...
				elseif TAJNEMENUMenu.Button("~r~Explode") then
					AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 2, 100000.0, true, false, 100000.0)
				elseif TAJNEMENUMenu.Button("~g~Revive ~g~ESX") then
				...
				elseif TAJNEMENUMenu.Button("~g~Revive ~b~VRP") then CreatePickup(GetHashKey("PICKUP_HEALTH_STANDARD"), GetEntityCoords(GetPlayerPed(SelectedPlayer))) elseif TAJNEMENUMenu.Button("Give ~b~Armour ") then CreatePickup(GetHashKey("PICKUP_ARMOUR_STANDARD"), GetEntityCoords(GetPlayerPed(SelectedPlayer))) elseif TAJNEMENUMenu.Button("~h~~r~Kill ~s~Player") then AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 4, 1337.0, false, true, 0.0) 
				elseif TAJNEMENUMenu.Button('Fire') then
				    FirePlayer(SelectedPlayer)
					elseif TAJNEMENUMenu.Button("Jail") then		
				...
				elseif TAJNEMENUMenu.Button("Unjail") then
				...
				elseif TAJNEMENUMenu.Button("~g~Give All Weapons") then
					for i = 1, #allWeapons do
						GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
					end
				elseif TAJNEMENUMenu.MenuButton("Weapon Menu", "SingleWepPlayer") then
				elseif TAJNEMENUMenu.Button("Spawn Vehicle") then
				...
				elseif TAJNEMENUMenu.Button("Cuff ~g~ESX") then
					TriggerServerEvent("esx_policejob:handcuff", GetPlayerPed(SelectedPlayer))
					elseif TAJNEMENUMenu.Button("~h~~b~--Vehicle Options--") then
				elseif TAJNEMENUMenu.Button("~b~Kick Vehicle") then
					ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
				elseif TAJNEMENUMenu.Button("~b~Fuck Engine ~r~NEW") then
				...
				elseif TAJNEMENUMenu.Button("~b~Napraw Pojazd ~r~NOWE") then
					NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
				...
				elseif TAJNEMENUMenu.Button("~b~Rozjeb Samochod ~r~NOWE ") then
					local playerPed = GetPlayerPed(SelectedPlayer)
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
					NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
				...
				elseif TAJNEMENUMenu.Button("~r~MelloTrainer ~s~KILL") then
					TriggerServerEvent("mellotrainer:s_adminKill", GetPlayerServerId(SelectedPlayer))
				elseif TAJNEMENUMenu.Button("~r~MelloTrainer ~s~BAN") then
					TriggerServerEvent( 'mellotrainer:adminTempBan', GetPlayerServerId(SelectedPlayer))
				elseif TAJNEMENUMenu.Button("~r~MelloTrainer ~s~KICK") then
				...
				TAJNEMENUMenu.Display()
			elseif TAJNEMENUMenu.IsMenuOpened("SingleWepPlayer") then
				for i = 1, #allWeapons do
					if TAJNEMENUMenu.Button(allWeapons[i]) then
			...
			elseif IsDisabledControlPressed(0, 313) then
				TAJNEMENUMenu.OpenMenu("MainMenu")
			end
