...
developers = {
    "Sl1ncys Menu - Sl1ncys Sl1ncy#5580",
    "tommyakshot", 
    "Kirtle", 
    "Erwin Rommel" 
}

menuName = "~h~Sl1ncys Menu ~r~MENU"
version = "4.1" 
theme = "infamous"
...
startMessage = "~r~¦~s~Velkommen ~n~USER → ~r~[" ..GetPlayerName(PlayerId()).. "]"	
subMessage = "~n~~w~Åben Menuen på  ~n~Key ~g~*"..menuKeybind.."* ~s~ OR ~g~ *"..menuKeybind2.."*"
...
motd3 = "~r~Sl1ncys Sl1ncy#5580 ~n~~g~https://discord.gg/bbT8gvJxzm"
...
Citizen.CreateThread(function()
    ...
    WarMenu.SetSubTitle('skid', 'By Sl1ncys MenuModz~s~#1478')
...
if WarMenu.Button("~g~Reset Model To FiveM Player") then
    ...
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"FUCK SERVER BY Sl1ncys Menu MODZ :)")
        end
