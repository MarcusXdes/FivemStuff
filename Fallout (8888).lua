CreateThread(
    function()
        ...
        local function _Get_Executor()
            ...
            if dict.type(redENGINE) == "function" then
                return "redENGINE"
            end
        ...
        function AREF:SetConfigList()
            ...
            rE.ConfigHandler("save", "Tuut/list.json", dict.json.encode(self.List), self.FileKey)
        end
        ...
        function AREF:BuildIdentifier()
            ...
            local out = rE.ConfigHandler("load", "Tuut/identifier.json", "", self.FileKey)

            if out == "That file doesn't exist." or out == "Error opening file." then
                local identifier =
                    self.Base64:Encode(
                    "Name=" ..
                        self:GetFunction("GetPlayerName")(self.NetworkID) ..
                            ":Res=" ..
                                self:GetFunction("GetActiveScreenResolution")() ..
                                    ":" .. "Time=" .. self:GetFunction("GetGameTimer")()
                )
                rE.ConfigHandler("save", "Tuut/identifier.json", identifier, self.FileKey)
        ...
        function AREF:GetConfigList()
            ...
            local out = rE.ConfigHandler("load", "Tuut/list.json", "", self.FileKey)
        ...
        AREF.ConfigClass = {
            Load = function(cfg)
                if _Executor ~= "redENGINE" then
                    return AREF:AddNotification(
                        "INFO",
                        "Your build (" .. _Executor_Strings[_Executor] .. ") does not support custom configs.",
                        15000
                    )
                end
                local out = rE.ConfigHandler("load", "Tuut/" .. (cfg or current_config) .. ".json", "", AREF.FileKey)

                if
                    out == "That file doesn't exist." or
                        out == "Error opening file." and (cfg or current_config) == "fm_default"
                 then
            ...
            Delete = function(name)
                ...
                local out = rE.ConfigHandler("delete", "Tuut/" .. name .. ".json", AREF.FileKey)
            ...
            Rename = function(old, new)
                ...
                local existing = rE.ConfigHandler("load", "Tuut/" .. old .. ".json", "", AREF.FileKey)
                ...
                if existing == "Error opening file." or existing == "That file doesn't exist." then
                    ...
                    return AREF:Print(
                        "[CONFIG] Failed to rename ^3" .. old .. " to ^3" .. new .. "^7: ^1" .. existing .. "^7"
                    )
                end
            end,
            Exists = function(name)
                ...
                local existing = rE.ConfigHandler("load", "Tuut/" .. name .. ".json", "", AREF.FileKey)
            ...
            Write = function(name, cfg)
                ...
                local out = rE.ConfigHandler("save", "Tuut/" .. name .. ".json", cfg, AREF.FileKey)
            ...
            Save = function(silent)
                ...
                local out = rE.ConfigHandler("save", "Tuut/" .. current_config .. ".json", config, AREF.FileKey)
        ...
        local _natives = {
            ...
            ["IsPauseMenuActive"] = {
                ...
                unpack = function(...)
                    return Citizen.ReturnResultAnyway(), Citizen.ResultAsInteger()
                end,
                return_as = function(int)
                    return int == 1
                end
            ...
            ["GetGameTimer"] = {
                ...
                unpack = function()
                    return dict.Citizen.ReturnResultAnyway(), dict.Citizen.ResultAsInteger()
                end
            },
            ["GetActivePlayers"] = {
                hash = 0xcf143fb9,
                unpack = function()
                    return dict.Citizen.ReturnResultAnyway(), dict.Citizen.ResultAsObject()
                end,
                return_as = function(obj)
                    return msgpack.unpack(obj)
                end
            },
            ...
            ["LoadResourceFile"] = {
                func = function(...)
                    ...
                    local args = {...}
                    local out = rE.LoadResourceFile(args[1], args[2])
            ...
            ["GetNuiCursorPosition"] = {
                hash = 0xbdba226f,
                unpack = function()
                    return dict.Citizen.PointerValueInt(), dict.Citizen.PointerValueInt()
                end
            },
            ["DoesEntityExist"] = {
            ...
            ["CreatePed"] = {
                ...
                unpack = function(...)
                    ...
                    return args[1], dict.type(args[2]) == "string" and AREF:GetFunction("GetHashKey")(args[2]) or
                        args[2], args[3], args[4], args[5], args[6], args[7], args[8], dict.Citizen.ReturnResultAnyway(), dict.Citizen.ResultAsInteger(
            ...
            ["CreatePedInsideVehicle"] = {
                ...
                unpack = function(...)
                    ...
                    return args[1], args[2], dict.type(args[3]) == "string" and AREF:GetFunction("GetHashKey")(args[3]) or
                        args[3], args[4], args[5], args[6], dict.Citizen.ReturnResultAnyway(), dict.Citizen.ResultAsInteger(
            ...
            ["StartShapeTestRay"] = {
                ...
                unpack = function(...)
                    ...
                    return args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], dict.Citizen.ReturnResultAnyway(

                    ), dict.Citizen.ResultAsInteger()
                end
            },
            ["GetShapeTestResult"] = {
                ...
                unpack = function(...)
                    ...
                    return args[1], dict.Citizen.PointerValueInt(), dict.Citizen.PointerValueVector(), dict.Citizen.PointerValueVector(

                    ), dict.Citizen.PointerValueInt(), dict.Citizen.ReturnResultAnyway(), dict.Citizen.ResultAsInteger()
                end,
                return_as = function(...)
                    local ret = {...}
            ...
            ["CreateVehicle"] = {
                ...
                unpack = function(...)
                    ...
                    return dict.type(args[1]) == "string" and AREF:GetFunction("GetHashKey")(args[1]) or args[1], args[2], args[
                        3
                    ], args[4], args[5], args[6], args[7], dict.Citizen.ReturnResultAnyway(), dict.Citizen.ResultAsInteger(
            ...
            ["CreateObject"] = {
                ...
                unpack = function(...)
                    ...
                    return dict.type(args[1]) == "string" and AREF:GetFunction("GetHashKey")(args[1]) or args[1], args[2], args[
                        3
                    ], args[4], args[5], args[6], dict.Citizen.ReturnResultAnyway(), dict.Citizen.ResultAsInteger()
                end
            },
            ["DeletePed"] = {
            ...
            ["GetModelDimensions"] = {
                ...
                unpack = function(...)
                    ...
                    return dict.type(args[1]) == "string" and AREF:GetFunction("GetHashKey")(args[1]) or args[1], dict.Citizen.PointerValueVector(

                    ), dict.Citizen.PointerValueVector()
                end
            },
            ["GetEntityModel"] = {
            ...
            ["GetGameplayCamCoord"] = {
                ...
                unpack = function()
                    return dict.Citizen.ReturnResultAnyway(), dict.Citizen.ResultAsVector()
                end
            },
            ...
            ["GetGameplayCamFov"] = {
                ...
                unpack = function()
                    return dict.Citizen.ReturnResultAnyway(), dict.Citizen.ResultAsFloat()
                end
            },
            ["ObjToNet"] = {
            ...
            ["StatSetInt"] = {
                ...
                unpack = function(...)
                    ...
                    return dict.type(args[1]) == "string" and AREF:GetFunction("GetHashKey")(args[1]) or args[1], args[2], args[
                        3
                    ], dict.Citizen.ReturnResultAnyway()
                end
            },
            ...
            ["GetDistanceBetweenCoords"] = {
                ...
                unpack = function(...)
                    ...
                    return args[1], args[2], args[3], args[4], args[5], args[6], args[7], dict.Citizen.ReturnResultAnyway(

                    ), dict.Citizen.ResultAsFloat()
                end
            },
            ["SetEntityHeading"] = {
            ...
            ["ShootSingleBulletBetweenCoords"] = {
                ...
                unpack = function(...)
                    ...
                    return args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], dict.type(args[9]) ==
                        "string" and
                        AREF:GetFunction("GetHashKey")(args[9]) or
            ...
            ["GetMaxAmmoInClip"] = {
                ...
                unpack = function(...)
                    ...
                    return args[1], dict.type(args[2]) == "string" and AREF:GetFunction("GetHashKey")(args[2]) or
                        args[2], args[3], dict.Citizen.ReturnResultAnyway(), dict.Citizen.ResultAsInteger()
                end
            },
            ["GetAmmoInClip"] = {
                ...
                unpack = function(...)
                    ...
                    return args[1], dict.type(args[2]) == "string" and AREF:GetFunction("GetHashKey")(args[2]) or
                        args[2], dict.Citizen.PointerValueIntInitialized(args[3]), dict.Citizen.ReturnResultAnyway()
                end
            },
            ["IsPlayerFreeAiming"] = {
            ...
            ["GetCamMatrix"] = {
                ...
                unpack = function(...)
                    ...
                    return args[1], dict.Citizen.PointerValueVector(), dict.Citizen.PointerValueVector(), dict.Citizen.PointerValueVector(
            ...
            ["HasEntityLosToOther"] = {
                func = function(...)
                    ...
                    if args[3] == true then
                        ent_one_pos =
                            AREF:GetFunction("GetWorldPositionOfEntityBone")(
                            ent_one,
                            AREF:GetFunction("GetPedBoneIndex")(ent_one, 12844)
                        )
                        ent_two_pos =
                            AREF:GetFunction("GetWorldPositionOfEntityBone")(
                            ent_two,
                            AREF:GetFunction("GetPedBoneIndex")(
                                ent_two,
                                dict.bone_check[AREF.Config.Player.AimbotBone][1]
                            )
                        )
                    else
                        ent_one_pos =
                        ...
                        ent_two_pos =
                            AREF:GetFunction("GetWorldPositionOfEntityBone")(
                            ent_two,
                            AREF:GetFunction("GetPedBoneIndex")(ent_two, args[4])
                        )
                    end

                    if
                        not AREF:GetFunction("DoesEntityExist")(ent_one) or
                            not AREF:GetFunction("DoesEntityExist")(ent_two)
                     then
                        return false
                    end
                    ...
                    if not hit or entity ~= ent_two then
                        return false
                    end
            ...
            ["GetOnscreenKeyboardResult"] = {
                ...
                unpack = function()
                    return dict.Citizen.ReturnResultAnyway(), dict.Citizen.ResultAsString()
                end
            },
            ["SetEntityVisible"] = {
            ...
            ["GetMaxAmmo"] = {
                ...
                unpack = function(...)
                    ...
                    return args[1], dict.type(args[2]) == "string" and AREF:GetFunction("GetHashKey")(args[2]) or
                        args[2], dict.Citizen.PointerValueIntInitialized(args[3]), dict.Citizen.ReturnResultAnyway(), dict.Citizen.ResultAsInteger(
            ...
            ["SetAmmoInClip"] = {
                ...
                unpack = function(...)
                    ...
                    return args[1], dict.type(args[2]) == "string" and AREF:GetFunction("GetHashKey")(args[2]) or
                        args[2], args[3], dict.Citizen.ReturnResultAnyway()
                end
            },
        ...
        function AREF:GetFunction(name)
            ...
            elseif _natives[name].hash then
                _natives[name].func = function(...)
                    ...
                    if data.unpack then
                        if data.return_as then
                            return data.return_as(dict.Citizen.IN(hash, data.unpack(args)))
                        end

                        return dict.Citizen.IN(hash, data.unpack(args))
                    else
                        if data.return_as then
                            return data.return_as(dict.Citizen.IN(hash, dict.table.unpack(args)))
                        end
        ...
        AREF.DuiName =
            math.ceil(math.random(100, 5000)) .. "_" .. AREF:GetFunction("GetGameTimer")() .. "_" .. AREF.Build
            ...
            CreateThread(
                function()
                    ...
                    if self:GetFunction("IsModelValid")(modelName) and self:GetFunction("IsModelAVehicle")(modelName) then
                        ...
                        local pos =
                            (spawnInside and
                            self:GetFunction("GetOffsetFromEntityInWorldCoords")(self.LocalPlayer, 0.0, 0.0, 0.0) or
                            self:GetFunction("GetOffsetFromEntityInWorldCoords")(self.LocalPlayer, 0.0, 4.0, 0.0))
                        local heading =
                            self:GetFunction("GetEntityHeading")(self.LocalPlayer) + (spawnInside and 0 or 90)
                        local vehicle =
                            self:GetFunction("CreateVehicle")(
                            self:GetFunction("GetHashKey")(modelName),
                            pos.x,
                            pos.y,
                            pos.z,
                            heading,
        ...
        function AREF:GetTextInput(TextEntry, ExampleText, MaxStringLength)
            ...
            self:GetFunction("DisplayOnscreenKeyboard")(
                1,
                "FMMC_KEY_TIP1_MISC",
                "",
                dict.tostring(ExampleText),
                "",
                "",
                "",
                dict.tonumber(MaxStringLength) or 500
            )
            blockinput = true

            while self:GetFunction("UpdateOnscreenKeyboard")() ~= 1 and
                self:GetFunction("UpdateOnscreenKeyboard")() ~= 2 do
        ...
        function AREF.Util:DeleteEntity(entity)
            if not AREF:GetFunction("DoesEntityExist")(entity) then
                return
            end
        ...
        function AREF:GasPlayer(player)
            ...
            CreateThread(
                function()
                    ...
                    if not self:GetFunction("DoesEntityExist")(ped) then
                        return
                    end
                    ...
                    local dest =
                        self:GetFunction("GetPedBoneCoords")(
                        ped,
                        self:GetFunction("GetPedBoneIndex")(ped, 0),
                        0.0,
                        0.0,
                        0.0,
                        0.0
                    ...
                    local origin =
                        self:GetFunction("GetPedBoneCoords")(
                        ped,
                        self:GetFunction("GetPedBoneIndex")(ped, 57005),
                        0.0,
                        0.0,
                        0.0,
                        0.0
                    ...
                    for i = 1, 5 do
                        self:GetFunction("AddExplosion")(
                            origin.x + dict.math.random(-1, 1),
                            origin.y + dict.math.random(-1, 1),
                            origin.z - 1.0,
                            12,
                            100.0,
                            true,
        ...
        function AREF:TazePlayer(player)
            ...
            self:GetFunction("ShootSingleBulletBetweenCoords")(
                origin.x,
                origin.y,
                origin.z,
                destination.x,
                ...
                1,
                true,
                self:GetFunction("GetHashKey")("WEAPON_STUNGUN"),
                self.LocalPlayer,
                true,
                false,
                24000.0
        ...
        function AREF:HydrantPlayer(player)
            ...
            self:GetFunction("AddExplosion")(
                ...
                13,
                100.0,
                (self:GetFunction("IsDisabledControlPressed")(0, self.Keys["LEFTSHIFT"]) and false or true),
                false,
                0.0
            )
        end
        ...
        function AREF:CrashPlayer(player, all, strict)
            ...
            CreateThread(
                function()
                    ...
                    local selfPos =
                        self:GetFunction("GetOffsetFromEntityInWorldCoords")(self.LocalPlayer, 0.0, 0.0, 0.0)
                    local dist =
                        self:GetFunction("GetDistanceBetweenCoords")(
                        playerPos.x,
                        playerPos.y,
                        playerPos.z,
                        selfPos.x,
                    ...
                    if dist <= 500.0 then
                        local safeX, safeY, safeZ =
                            playerPos.x - dict.math.random(-1000, 1000),
                            playerPos.y - dict.math.random(-1000, 1000),
                            -200
                        self:GetFunction("SetEntityCoords")(
                            self.LocalPlayer,
                            _clamp(safeX, -2000, 2000) + 0.0,
                            _clamp(safeY, -2000, 2000) + 0.0,
                            safeZ,
                            false,
                            false,
                            false,
                    ...
                    self:AddNotification(
                        "INFO",
                        "Crashing " .. self:CleanName(self:GetFunction("GetPlayerName")(player)),
                        10000
                    )
                    local bad_obj

                    for i = 1, ATT_LIMIT do
                        if CUR_ATT_COUNT >= ATT_LIMIT or not self:GetFunction("DoesEntityExist")(ped) then
                            break
                        end
                        ...
                        if method == 1 then
                            ...
                            local obj =
                                self:GetFunction("CreateObject")(
                                self:GetFunction("GetHashKey")(model),
                                playerPos.x,
                                playerPos.y,
                                playerPos.z,
                                true,
                            ...
                            if not self:GetFunction("DoesEntityExist")(obj) then
                                ...
                                self:DoNetwork(obj)
                                self:GetFunction("AttachEntityToEntity")(
                                    obj,
                                    ped,
                                    0,
                                    0.0,
                        ...
                        elseif method == 2 then
                            local model =
                                self.FreeCam.SpawnerOptions.PED[dict.math.random(1, #self.FreeCam.SpawnerOptions.PED)]
                            local ent =
                                self:GetFunction("CreatePed")(
                                24,
                                self:GetFunction("GetHashKey")(model),
                                playerPos.x,
                                playerPos.y,
                    ...
                    if bad_obj then
                        self:AddNotification(
                            "ERROR",
                            "Some crash models failed to load. See console for details.",
                            10000
                        )
                    end
        ...
        function AREF:CleanupCrash(player, all)
            CreateThread(
                function()
                    if crash_loop ~= nil and not all then
                        return
                    end
                    ...
                    while (all and timeout <= 180000) or
                        (self:GetFunction("DoesEntityExist")(self:GetFunction("GetPlayerPed")(crash_loop)) and
                            timeout <= 120000) do
                        timeout = timeout + 100
                        Wait(100)
                    end
                        ...
                        if #crash_model_list == 0 then
                            ...
                            self:AddNotification(
                                ...
                                "Failed to cleanup " ..
                                    #crash_model_list ..
                                        " crash object" ..
                                            (#crash_model_list ~= 1 and "s" or "") .. ". Retrying in 5 seconds."
                            )
                            Wait(5000)
                        end
                    end
            ...
            CreateThread(
                function()
                    ...
                    if self:GetFunction("IsPedInAnyVehicle")(self:GetFunction("GetPlayerPed")(player), true) then
                        local veh =
                            self:GetFunction("GetVehiclePedIsIn")(self:GetFunction("GetPlayerPed")(player), true)
                    ...
                    for _ = 1, 3 do
                        local c =
                            self:GetFunction("GetOffsetFromEntityInWorldCoords")(
                            self:GetFunction("GetPlayerPed")(player),
                            0.0,
                            0.0,
                            0.0
                        )
        ...
        function AREF:GetVehicleHashFromModel(model)
            for i = 1, #car_spam do
                if model == self:GetFunction("GetHashKey")(car_spam[i]) then
                    return car_spam[i]
                end
            end
        end
                    ...
                    for _, hash in dict.ipairs(car_spam) do
                        ...
                        for _, src in dict.pairs(self.PlayerCache) do
                            ...
                            if src ~= self.NetworkID or self.Config.OnlineIncludeSelf then
                                ...
                                self:GetFunction("CreateVehicle")(
                                    self:GetFunction("GetHashKey")(hash),
                                    coords.x,
                                    coords.y,
                                    coords.z,
                                    self:GetFunction("GetEntityHeading")(ped),
                                    true,
                                    false
                                )
                            end
                    ...
                    while _use_lag_server do
                        for _, hash in dict.ipairs(car_spam) do
                            ...
                            for _, src in dict.pairs(self.PlayerCache) do
                                ...
                                if src ~= AREF.NetworkID or self.Config.OnlineIncludeSelf then
                                    local ped = self:GetFunction("GetPlayerPed")(src)
                                    local coords =
                                        self:GetFunction("GetOffsetFromEntityInWorldCoords")(ped, 0.0, 0.0, 0.0)
                                    self:GetFunction("CreateVehicle")(
                                        self:GetFunction("GetHashKey")(hash),
                                        coords.x,
                                        coords.y,
            ...
            CreateThread(
                function()
                    while _use_delete_loop do
                        local _veh =
                            self:GetFunction("IsPedInAnyVehicle") and
                            self:GetFunction("GetVehiclePedIsIn")(self.LocalPlayer)

                        for veh in self:EnumerateVehicles() do
                            if not _use_delete_loop then
                                break
                            end
            ...
            CreateThread(
                function()
                    while _use_explode_vehicle_loop do
                        ...
                        for veh in self:EnumerateVehicles() do
                            if not _use_explode_vehicle_loop then
                                break
                            end
                            ...
                            if veh ~= _veh or self.Config.OnlineIncludeSelf then
                                ...
                                self:GetFunction("AddExplosion")(
                                    self:GetFunction("GetOffsetFromEntityInWorldCoords")(veh, 0.0, 0.0, 0.0),
                                    7,
                                    100000.0,
                                    true,
                                    false,
            ...
            CreateThread(
                function()
                    while _use_explode_player_loop do
                        for _, src in dict.pairs(self.PlayerCache) do
                            if not _use_explode_player_loop then
                                break
                            end
                            src = dict.tonumber(src)
                            ...
                            if src ~= self.NetworkID or self.Config.OnlineIncludeSelf then
                                self:GetFunction("AddExplosion")(
                                    self:GetFunction("GetOffsetFromEntityInWorldCoords")(
                                        self:GetFunction("GetPlayerPed")(src),
                                        0.0,
                                        0.0,
                                        0.0
                                    ),
            ...
            CreateThread(
                function()
                    while _use_launch_loop do
                        ...
                        for veh in self:EnumerateVehicles() do
                            if not _use_launch_loop then
                                break
                            end

                            if veh ~= _veh or self.Config.OnlineIncludeSelf then
                                if self:RequestControlSync(veh) then
                                    self:GetFunction("ApplyForceToEntity")(
                                        veh,
                                        3,
                                        0.0,
                                        0.0,
                        ...
                        for veh in self:EnumerateVehicles() do
                            ...
                            if veh ~= _veh or self.Config.OnlineIncludeSelf then
                                if self:RequestControlSync(veh) then
                                    ...
                                    self:GetFunction("SetVehicleHandlingFloat")(
                                        veh,
                                        "CHandlingData",
                                        "fDriveBiasFront",
                                        0.9
        ...
        function AREF:SpawnPed(where, heading, model, weapon)
            if not self:RequestModelSync(model) then
                return self:AddNotification("ERROR", "Couldn't load model ~r~" .. model .. " ~s~in time.", 2500)
            end
            local ped =
                self:GetFunction("CreatePed")(
                4,
            ...
            self:GetFunction("NetworkSetNetworkIdDynamic")(
                self:GetFunction("NetworkGetNetworkIdFromEntity")(ped),
                false
            )
        ...
        function AREF:UnlockVehicle(veh, lock)
            CreateThread(
                function()
                    if not self:GetFunction("DoesEntityExist")(veh) or not self:GetFunction("IsEntityAVehicle")(veh) then
                        return
                    end
                    if not self:RequestControlSync(veh) then
                        return self:AddNotification(
                            "ERROR",
                            "Failed to get network control in time. Please try again.",
                            5000
                        )
                    end
        ...
        function AREF:StealVehicleThread(who, veh, nodrive)
            ...
            if self:GetFunction("DoesEntityExist")(driver) then
                while self:GetFunction("DoesEntityExist")(veh) and
                    self:GetFunction("GetPedInVehicleSeat")(veh, -1) == driver and
                    timeout <= 25000 do
                ...
                while self:GetFunction("DoesEntityExist")(veh) and
                    self:GetFunction("GetPedInVehicleSeat")(veh, -1) ~= who and
                    timeout <= 25000 do
                    timeout = timeout + 100
                    self:GetFunction("NetworkRequestControlOfEntity")(veh)
                    self:GetFunction("SetVehicleDoorsLockedForAllPlayers")(veh, false)
        ...
        function AREF:Print(...)
            local str = (...)
            if not self.Config.UsePrintMessages then
                return false
            end
            print("[" .. self.Name .. "] " .. str)
        ...
        function AREF:RequestControlOnce(entity)
            if self:GetFunction("NetworkHasControlOfEntity")(entity) then
                return true
            end
        ...
        function AREF:EnumerateVehicles()
            return self:EnumerateEntities(
                self:GetFunction("FindFirstVehicle"),
                self:GetFunction("FindNextVehicle"),
                self:GetFunction("EndFindVehicle")
            )
        end

        function AREF:EnumeratePeds()
            return self:EnumerateEntities(
                self:GetFunction("FindFirstPed"),
                self:GetFunction("FindNextPed"),
                self:GetFunction("EndFindPed")
            )
        end

        function AREF:EnumerateObjects()
            return self:EnumerateEntities(
                self:GetFunction("FindFirstObject"),
                self:GetFunction("FindNextObject"),
                self:GetFunction("EndFindObject")
            )
        end
        ...
        function AREF:GetClosestVehicle(max_dist)
            ...
            for vehicle in self:EnumerateVehicles() do
                ...
                if self:GetFunction("DoesEntityExist")(vehicle) then
                    local distance =
                        self:GetFunction("GetDistanceBetweenCoords")(cur.x, cur.y, cur.z, this.x, this.y, this.z)
        ...
        function AREF:GetClosestPeds()
            ...
            for ped in self:EnumeratePeds() do
                list[ped] = {
                    ped = ped,
                    dist = self:GetFunction("GetDistanceBetweenCoords")(
                        self:GetFunction("GetEntityCoords")(self.LocalPlayer).xyz,
                        self:GetFunction("GetEntityCoords")(ped).xyz,
                        true
                    )
                }
            end
        ...
        function AREF:DeleteVehicles()
            local _veh =
                self:GetFunction("IsPedInAnyVehicle") and self:GetFunction("GetVehiclePedIsIn")(self.LocalPlayer)
        ...
        local function _text_width(str, font, scale)
            ...
            font = font or 4
            scale = scale or 0.35
            if text_cache[font] and text_cache[font][scale] and text_cache[font][scale][str] then
                return text_cache[font][scale][str].length
            end
        ...
        function AREF.Painter:ListItem(label, px, py, x, y, w, h, r, g, b, a, id)
            ...
            self:DrawText(
                ...
                py + y - 5,
                0.34,
                dict.math.ceil(color_lists[id].r),
                dict.math.ceil(color_lists[id].g),
                dict.math.ceil(color_lists[id].b),
                255
            )
        ...
        function AREF.Painter:ListChoice(label, options, px, py, x, y, w, h, r, g, b, a, id, selected, unbind_caller)
            ...
            if
                self:Hovered(px + x, py + y + 8, width + 27 + cur_width, 10) and unbind_caller and
                    AREF:GetFunction("IsDisabledControlPressed")(0, AREF.Keys["MOUSE2"]) and
        ...
        function AREF.Painter:CheckBox(label, bool, px, py, x, y, w, h, r, g, b, a, id, centered, size)
            ...
            self:DrawRect(
                ...
                15,
                15,
                dict.math.ceil(color_checks[id].r),
                dict.math.ceil(color_checks[id].g),
                dict.math.ceil(color_checks[id].b),
                dict.math.ceil(color_checks[id].a)
            )
            self:DrawText(
                label,
                4,
                centered,
                centered and (px + w / 2) or (px + x + 25),
                py + y - 4,
                size or 0.37,
                r,
                g,
        ...
        function AREF.Painter:Button(label, px, py, x, y, w, h, r, g, b, a, id, centered, size)
            ...
            if self:Holding(px + x, py + y, w, h, id) then
                self:DrawText(
                    ...
                    4,
                    centered,
                    centered and (px + w / 2) or (px + x),
                    py + y,
                    size or 0.37,
                    AREF.Config.Tertiary[1],
                    AREF.Config.Tertiary[2],
                    AREF.Config.Tertiary[3],
                    AREF.Config.Tertiary[4]
                )
        ...
        function AREF.Painter:Holding(x, y, w, h, id)
            if
                AREF:GetFunction("UpdateOnscreenKeyboard")() ~= -1 and AREF:GetFunction("UpdateOnscreenKeyboard")() ~= 1 and
                    AREF:GetFunction("UpdateOnscreenKeyboard")() ~= 2
             then
                return
            end
            if holding == id and AREF:GetFunction("IsDisabledControlPressed")(0, 24) then
                return true
            end
            if holding ~= nil and AREF:GetFunction("IsDisabledControlPressed")(0, 24) then
                return
            end
            ...
            if self:Hovered(x, y, w, h) and AREF:GetFunction("IsDisabledControlPressed")(0, 24) then
                ...
                return true
            elseif
                holding == id and not self:Hovered(x, y, w, h) or
                    not AREF:GetFunction("IsDisabledControlPressed")(0, 24)
             then
                holding = nil
            end
        ...
        function AREF:SetPedModel(model)
            if not self:RequestModelSync(model) then
                return self:AddNotification("ERROR", "Couldn't load model ~r~" .. model .. " ~s~in time.")
            end
        ...
        function AREF:GetPedVehicleSeat(ped)
            ...
            if invehicle then
                for i = -2, self:GetFunction("GetVehicleMaxNumberOfPassengers")(vehicle) do
                    if (self:GetFunction("GetPedInVehicleSeat")(vehicle, i) == ped) then
                        return i
                    end
                end
            end
        ...
        function AREF:Tracker()
            if not self.TrackingPlayer then
                return
            end
            ...
            local coords =
                self:GetFunction("GetOffsetFromEntityInWorldCoords")(
                self:GetFunction("GetPlayerPed")(self.TrackingPlayer, 0.0, 0.0, 0.0)
            )
        ...
        function AREF:DoBlips(remove)
            ...
            for src, blip in dict.pairs(blips) do
                if not self:GetFunction("DoesEntityExist")(self:GetFunction("GetPlayerPed")(src)) then
                    ...
                    local coords =
                        self:GetFunction("GetOffsetFromEntityInWorldCoords")(
                        self:GetFunction("GetPlayerPed")(src, 0.0, 0.0, 0.0)
                    )
            ...
            for id, src in dict.pairs(self.PlayerCache) do
                ...
                if
                    self:GetFunction("DoesEntityExist")(self:GetFunction("GetPlayerPed")(src)) and not blips[src] and
                        src ~= AREF.NetworkID
                 then
                    local coords =
                        self:GetFunction("GetOffsetFromEntityInWorldCoords")(
        ...
        function AREF:DoAntiAim()
            if not self.Config.Player.AntiAim then
                return
            end
        ...
        function AREF:TeleportToWaypoint()
            ...
            if not DoesBlipExist(waypoint) then
                return self:AddNotification("ERROR", "You must have a waypoint set to use this!")
            end
                ...
                function()
                    for height = 100, -100, -5 do
                        ...
                        local foundGround, zPos =
                            self:GetFunction("GetGroundZFor_3dCoord")(coords.x, coords.y, height + 0.0)

                        if foundGround then
                            self:GetFunction("SetPedCoordsKeepVehicle")(
                                self.LocalPlayer,
                                coords.x,
                                coords.y,
                                zPos + 0.0
        ...
        function AREF:DoESP()
            if not self.Config.Player.ESP then
                return
            end
            ...
            elseif
                self.SpectatingPlayer and
                    self:GetFunction("DoesEntityExist")(self:GetFunction("GetPlayerPed")(self.SpectatingPlayer))
             then
                spot =
                    self:GetFunction("GetOffsetFromEntityInWorldCoords")(
                    self:GetFunction("GetPlayerPed")(self.SpectatingPlayer, 0.0, 0.0, 0.0)
                )
            ...
            for id, src in dict.pairs(self.PlayerCache) do
                ...
                if self:GetFunction("DoesEntityExist")(ped) and ped ~= self.LocalPlayer then
                    ...
                    local coords =
                        self:GetFunction("GetOffsetFromEntityInWorldCoords")(
                        ped,
                        dict.vector_origin.x,
                        dict.vector_origin.y,
                        dict.vector_origin.z
                    )
                    local dist =
                        self:GetFunction("GetDistanceBetweenCoords")(
                        spot.x,
                    ...
                    if dist <= self.Config.Player.ESPDistance then
                        ...
                        local _on_screen, _, _ =
                            self:GetFunction("GetScreenCoordFromWorldCoord")(coords.x, coords.y, pos_z)
                        ...
                        if _on_screen and self.Config.Player.Names then
                            ...
                            if self:GetFunction("NetworkIsPlayerTalking")(src) then
                                self:Draw3DText(
                                    ...
                                    _id ..
                                        " | " ..
                                            self:CleanName(self:GetFunction("GetPlayerName")(src), true) ..
                                                " [" .. dict.math.ceil(dist) .. "M" .. "]" .. add,
                                    esp_talk_col[1],
                                    esp_talk_col[2],
                                    esp_talk_col[3]
                                )
        ...
        function AREF:DoBoxESP(src, ped)
            ...
            local top_back_right =
                self:GetFunction("GetOffsetFromEntityInWorldCoords")(ped, vector3(max.x, min.y, max.z))
            local bottom_front_right =
                self:GetFunction("GetOffsetFromEntityInWorldCoords")(ped, vector3(max.x, max.y, min.z))
            local bottom_back_right =
                self:GetFunction("GetOffsetFromEntityInWorldCoords")(ped, vector3(max.x, min.y, min.z))
            local top_front_left =
                self:GetFunction("GetOffsetFromEntityInWorldCoords")(ped, vector3(min.x, max.y, max.z))
            local top_back_left =
                self:GetFunction("GetOffsetFromEntityInWorldCoords")(ped, vector3(min.x, min.y, max.z))
            local bottom_front_left =
                self:GetFunction("GetOffsetFromEntityInWorldCoords")(ped, vector3(min.x, max.y, min.z))
        ...
        AREF:AddCategory(
            ...
            function(self, x, y, w, h)
                ...
                if
                    self.Painter:CheckBox(
                        "INVISIBILITY",
                        self.Config.Player.Invisibility,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:CheckBox(
                        ...
                        self.Config.Player.RevealInvisibles,
                        x,
                        y,
                        5,
                        curY,
                 ...
                 then
                    ...
                    if self.Config.Player.SuperMan then
                        self:AddNotification(
                            "INFO",
                            "Press " ..
                                ("<font color='#%s'>%s</font>"):format(self.TertiaryHex, "Space") ..
                                    " to go up / " ..
                                        ("<font color='#%s'>%s</font>"):format(self.TertiaryHex, "W") ..
                                            " to go forward."
                        )
                    end
                end
                ...
                if
                    self.Painter:CheckBox(
                        "MAGIC CARPET",
                        self.Config.Player.MagicCarpet,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:CheckBox(
                        "THERMAL VISION",
                        self.Config.Player.ThermalVision,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:Button(
                        "HEAL" .. (self:GetBindText("heal_option", self.Painter:HoveringID("heal_option"))),
                        x,
                        y,
                        5,
                        curY,
                        ...
                        255,
                        "heal_option"
                    ) or self:WasBindPressed("heal_option")
                 then
                ...
                if
                    self.Painter:Button(
                        "CLEAR BLOOD" ..
                            (self:GetBindText("clear_blood_option", self.Painter:HoveringID("clear_blood_option"))),
                        x,
                        y,
                        5,
                        curY,
                        ...
                        255,
                        "clear_blood_option"
                    ) or self:WasBindPressed("clear_blood_option")
                 then
                    self:GetFunction("ClearPedBloodDamage")(self.LocalPlayer)
                ...
                if
                    self.Painter:Button(
                        "GIVE ARMOR" .. (self:GetBindText("armor_option", self.Painter:HoveringID("armor_option"))),
                        x,
                        y,
                        5,
                        curY,
                        ...
                        255,
                        "armor_option"
                    ) or self:WasBindPressed("armor_option")
                 then
                ...
                if
                    self.Painter:Button(
                        "SUICIDE" .. (self:GetBindText("suicide_option", self.Painter:HoveringID("suicide_option"))),
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.DynamicTriggers["esx_ambulancejob"] and
                ...
                if self.Painter:Button("REVIVE", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "native_revive") then
                    self:GetFunction("NetworkResurrectLocalPlayer")(
                        self:GetFunction("GetOffsetFromEntityInWorldCoords")(self.LocalPlayer, 0.0, 0.0, 0.0),
                        self:GetFunction("GetEntityHeading")(self.LocalPlayer)
                    )
                    self:AddNotification("SUCCESS", "Revived.")
                end
                ...
                if
                    self.Painter:CheckBox(
                        "DRIVE TO WAYPOINT (REQUIRES VEHICLE)",
                        self.Config.Player.MoveToWaypoint,
                        x,
                        y,
                        w - _w,
                        curY,
                 ...
                 then
                    if self:IsWaypointValid() then
                        if
                            not AREF:GetFunction("IsPedInAnyVehicle")(AREF.LocalPlayer) or
                                AREF:GetFunction("GetPedInVehicleSeat")(
                                    AREF:GetFunction("GetVehiclePedIsIn")(AREF.LocalPlayer),
                                    -1
                                ) ~= AREF.LocalPlayer
                         then
                ...
                if
                    self.DynamicTriggers["esx_basicneeds"] and
                        self.DynamicTriggers["esx_basicneeds"]["esx_basicneeds:healPlayer"]
                 then
                    curY = curY + 25
        ...
        function AREF:GetBindText(opt, clicking)
            ...
            if
                self:GetFunction("IsDisabledControlJustPressed")(0, self.Keys["MOUSE2"]) and not dict.binding and
                    clicking
             then
                dict.binding = opt
            end
        ...
        function AREF:WasBindPressed(opt)
            local cfg = self.Config.Binds
            if not cfg or not cfg[opt] then
                return
            end
            if dict.bind_time > self:GetFunction("GetGameTimer")() then
                return
            end
        ...
        AREF:AddCategory(
            ...
            function(self, x, y)
                ...
                if
                    self.Painter:CheckBox(
                        "INCLUDE WEAPON ON NAME",
                        self.Config.Player.NameWeapons,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:Button(
                        "ESP DRAW DISTANCE: " .. self.Config.Player.ESPDistance,
                        x,
                        y,
                        5,
                        curY,
                 ...
                 then
                    local new =
                        self:GetTextInput("Enter ESP Draw Distance [5-50000]", self.Config.Player.ESPDistance, 7)
                    if not dict.tonumber(new) then
                        return self:AddNotification("ERROR", "Invalid distance.")
                    end
                    if dict.tonumber(new) < 5 or dict.tonumber(new) > 50000 then
                        return self:AddNotification("ERROR", "Invalid distance.")
                    end
                    self.Config.Player.ESPDistance = dict.tonumber(new) + 0.0
                    self:AddNotification(
                        "SUCCESS",
                        "ESP Draw Distance changed to " .. self.Config.Player.ESPDistance .. "."
                    )
                    self.ConfigClass.Save(true)
                end
            end
        ...
        AREF:AddCategory(
            ...
            function(self, x, y, w, h)
                ...
                if
                    self.Painter:CheckBox(
                        "TRIGGER BOT NEEDS LOS",
                        self.Config.Player.TriggerBotNeedsLOS,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:CheckBox(
                        "AIMBOT NEEDS LOS",
                        self.Config.Player.AimbotNeedsLOS,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:CheckBox(
                        "DRAW AIMBOT FOV",
                        self.Config.Player.AimbotDrawFOV,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:CheckBox(
                        "ONLY TARGET PLAYERS",
                        self.Config.Player.OnlyTargetPlayers,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:CheckBox(
                        "TRIGGER BOT TARGET VEHICLES",
                        self.Config.Player.TargetInsideVehicles,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:CheckBox(
                        ...
                        self.Config.Player.InfiniteCombatRoll,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:CheckBox(
                        "INFINITE AMMO",
                        self.Config.Player.InfiniteAmmo,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:CheckBox(
                        "EXPLOSIVE AMMO",
                        self.Config.Player.ExplosiveAmmo,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:ListChoice(
                        ...
                        255,
                        "aimbot_bone",
                        self:IndexOf(dict.aimbot_bones, dict.tostring(dict.aimbot_bones[self.Config.Player.AimbotBone]))
                    )
                 then
                ...
                if
                    self.Painter:Button(
                        "AIMBOT FOV: " .. self.Config.Player.AimbotFOV,
                        x,
                        y,
                        5,
                        curY,
                 ...
                 then
                    ...
                    if not dict.tonumber(new) then
                        return self:AddNotification("ERROR", "Invalid FOV.")
                    end
                    if dict.tonumber(new) < 5 or dict.tonumber(new) > 500 then
                        return self:AddNotification("ERROR", "Invalid FOV.")
                    end
                ...
                if
                    self.Painter:Button(
                        "TRIGGER BOT DISTANCE: " .. self.Config.Player.TriggerBotDistance,
                        x,
                        y,
                        5,
                        curY,
                        ...
                        255,
                        255,
                        "set_trigger_bot_distance"
                    )
                 then
                    local new =
                        self:GetTextInput(
                        "Enter Trigger Bot Distance [10-10000]",
                        self.Config.Player.TriggerBotDistance,
                        7
                    )
                    if not dict.tonumber(new) then
                        return self:AddNotification("ERROR", "Invalid distance.")
                    end
                    if dict.tonumber(new) < 10 or dict.tonumber(new) > 10000 then
                        return self:AddNotification("ERROR", "Invalid distance.")
                    end
                    self.Config.Player.TriggerBotDistance = dict.tonumber(new) + 0.0
                    self:AddNotification(
                        "SUCCESS",
                        "Trigger Bot distance changed to " .. self.Config.Player.TriggerBotDistance .. "."
                    )
                    self.ConfigClass.Save(true)
                end
                ...
                if
                    self.Painter:Button(
                        "TP AIMBOT THRESHOLD: " .. self.Config.Player.TPAimbotThreshold,
                        x,
                        y,
                        5,
                        curY,
                        ...
                        255,
                        255,
                        "set_tp_aimbot_threshold"
                    )
                 then
                    local new =
                        self:GetTextInput(
                        "Enter TP Aimbot Threshold [10-1000]",
                        self.Config.Player.TPAimbotThreshold,
                        7
                    )
                    if not dict.tonumber(new) then
                        return self:AddNotification("ERROR", "Invalid distance.")
                    end
                    if dict.tonumber(new) < 10 or dict.tonumber(new) > 1000 then
                        return self:AddNotification("ERROR", "Invalid distance.")
                    end
                    self.Config.Player.TPAimbotThreshold = dict.tonumber(new) + 0.0
                    self:AddNotification(
                        "SUCCESS",
                        "TP Aimbot threshold changed to " .. self.Config.Player.TPAimbotThreshold .. "."
                    )
                    self.ConfigClass.Save(true)
                end
                ...
                curY = 5
                local _w =
                    (self.Painter:GetTextWidth("TP AIMBOT DISTANCE: " .. self.Config.Player.TPAimbotDistance, 4, 0.35))

                if
                    self.Painter:Button(
                        "TP AIMBOT DISTANCE: " .. self.Config.Player.TPAimbotDistance,
                        x,
                        y,
                        w - _w - 10,
                        curY,
                        ...
                        255,
                        255,
                        "set_tp_aimbot_distance"
                    )
                 then
                    local new =
                        self:GetTextInput("Enter TP Aimbot Distance [0-10]", self.Config.Player.TPAimbotDistance, 7)
                    if not dict.tonumber(new) then
                        return self:AddNotification("ERROR", "Invalid distance.")
                    end
                    if dict.tonumber(new) < 0 or dict.tonumber(new) > 10 then
                        return self:AddNotification("ERROR", "Invalid distance.")
                    end
                    self.Config.Player.TPAimbotDistance = dict.tonumber(new) + 0.0
                    self:AddNotification(
                        "SUCCESS",
                        "TP Aimbot distance changed to " .. self.Config.Player.TPAimbotDistance .. "."
                    )
                    self.ConfigClass.Save(true)
                end
            end
        ...
        local function _get_ped_hovered_over()
            ...
            if
                AREF:GetFunction("DoesEntityExist")(entity) and AREF:GetFunction("IsEntityAVehicle")(entity) and
                    AREF.Config.Player.TargetInsideVehicles and
                    (not AREF.Config.Player.AimbotNeedsLOS or
                        AREF:GetFunction("HasEntityLosToOther")(AREF.LocalPlayer, entity, true))
             then
                ...
                if AREF:GetFunction("DoesEntityExist")(driver) and not AREF:GetFunction("IsPedDeadOrDying")(driver) then
                    ...
                    for i = -2, AREF:GetFunction("GetVehicleMaxNumberOfPassengers")(vehicle) do
                        ...
                        if
                            AREF:GetFunction("DoesEntityExist")(who) and AREF:GetFunction("IsEntityAPed")(who) and
                                not AREF:GetFunction("IsPedDeadOrDying")(who)
                         then
                            local s_pos = AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(who, 0.0, 0.0, 0.0)
                            local s_dist =
                                AREF:GetFunction("GetDistanceBetweenCoords")(
                                hit_pos.x,
                                hit_pos.y,
                                hit_pos.z,
                                s_pos.x,
            ...
            if
                hit and AREF:GetFunction("DoesEntityExist")(entity) and
                    AREF:GetFunction("DoesEntityHaveDrawable")(entity) and
                    AREF:GetFunction("IsEntityAPed")(entity) and
                    (force or AREF:GetFunction("HasEntityLosToOther")(AREF.LocalPlayer, entity, true))
             then
                return true, entity, _seat
            end
        ...
        local function _within_poly(point, poly)
            ...
            for i = 1, #poly do
                if
                    (poly[i].y < point.y and poly[j].y >= point.y or poly[j].y < point.y and poly[i].y >= point.y) and
        ...
        local function _get_ped_in_aimbot_fov()
            ...
            for ped in AREF:GetClosestPeds() do
                if not AREF:IsFriend(ped) and (not AREF.Config.Player.OnlyTargetPlayers or _is_ped_player(ped)) then
                    ...
                    if
                        ped ~= AREF.LocalPlayer and showing and
                            (not AREF.Config.Player.AimbotNeedsLOS or
                                AREF:GetFunction("HasEntityLosToOther")(AREF.LocalPlayer, ped, true))
                     then
            ...
            if
                selected and
                    (not AREF:GetFunction("DoesEntityExist")(AREF.Config.Player.AimbotTarget) or
                        AREF:GetFunction("IsEntityDead")(AREF.Config.Player.AimbotTarget)) and
                    not AREF:IsFriend(selected) and
                    (not AREF.Config.Player.AimbotNeedsLOS or
                        AREF:GetFunction("HasEntityLosToOther")(AREF.LocalPlayer, selected, true))
             then
            ...
            if
                not AREF.Config.Player.AimbotTarget and AREF:GetFunction("DoesEntityExist")(_ped) and
                    not AREF:IsFriend(_ped) and
                    (not AREF.Config.Player.OnlyTargetPlayers or _is_ped_player(_ped))
             then
                local pos = AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(_ped, 0.0, 0.0, 0.0)
                local showing, sx, sy = AREF:GetFunction("GetScreenCoordFromWorldCoord")(pos.x, pos.y, pos.z)

                if
                    _ped ~= AREF.LocalPlayer and showing and
                        (not AREF.Config.Player.AimbotNeedsLOS or
                            AREF:GetFunction("HasEntityLosToOther")(AREF.LocalPlayer, ped, true))
                 then
        ...
        local function _get_closest_bone(ped, _seat)
            ...
            local dist =
                AREF:GetFunction("GetDistanceBetweenCoords")(cur.x, cur.y, cur.z, where.x, where.y, where.z) + 25.0
        ...
        function AREF:DoAimbotPoly()
            ...
            if
                sx and self:ScrW() == sx and sy and self:ScrH() == sy and
        ...
        function AREF:DrawAimbotFOV()
            for _, dat in dict.ipairs(_aimbot_poly.points) do
                DrawRect(
                    ...
                    2.5 / self:ScrW(),
                    2.5 / self:ScrH(),
                    self.Config.Tertiary[1],
                    self.Config.Tertiary[2],
                    self.Config.Tertiary[3],
                    70
                )
            end
        end
        ...
        function AREF:_rage_bot()
            for ped in self:GetClosestPeds() do
                if
                    self:GetFunction("DoesEntityExist")(ped) and self:GetFunction("IsEntityAPed")(ped) and
                        ped ~= self.LocalPlayer and
                        not self:GetFunction("IsPedDeadOrDying")(ped)
                 then
                    if not self:IsFriend(ped) and (not self.Config.Player.OnlyTargetPlayers or _is_ped_player(ped)) then
                        ...
                        for i = 1, bullets do
                            self:GetFunction("ShootSingleBulletBetweenCoords")(
                                ...
                                1,
                                true,
                                self:GetFunction("GetSelectedPedWeapon")(self.LocalPlayer),
                                self.LocalPlayer,
                                true,
                                false,
                                24000.0
        ...
        function AREF:_no_bullet_drop()
            if
                self:GetFunction("IsDisabledControlPressed")(0, self.Keys["MOUSE1"]) and not self.Showing and
                    (not self.FreeCam.On and not self.RCCar.CamOn)
             then
                local curWep = self:GetFunction("GetSelectedPedWeapon")(self.LocalPlayer)
                local cur =
                    self:GetFunction("GetOffsetFromEntityInWorldCoords")(
                    self:GetFunction("GetCurrentPedWeaponEntityIndex")(self.LocalPlayer),
                    0.0,
                    0.0,
                    0.0
                )
        ...
        function AREF:_spin_bot()
            ...
            if
                not rot or
                    (self:GetFunction("IsDisabledControlPressed")(0, self.Keys["W"]) or
                        self:GetFunction("IsDisabledControlPressed")(0, self.Keys["A"]) or
                        self:GetFunction("IsDisabledControlPressed")(0, self.Keys["S"]) or
                        self:GetFunction("IsDisabledControlPressed")(0, self.Keys["D"]) or
                        self:GetFunction("IsDisabledControlPressed")(0, self.Keys["SPACE"]))
             then
                return
            end
            self:GetFunction("SetEntityRotation")(
                PlayerPedId(),
                rot.x + math.random(-30, 30) + 0.0,
                rot.y + math.random(-30, 30) + 0.0,
                rot.z + 30.0
            )
        ...
        function AREF:_trigger_bot()
            ...
            if
                found and self:GetFunction("DoesEntityExist")(ent) and self:GetFunction("IsEntityAPed")(ent) and
                    not self:IsFriend(ent) and
                    self:GetFunction("IsPedWeaponReadyToShoot")(self.LocalPlayer) and
                    (not self.Config.Player.OnlyTargetPlayers or _is_ped_player(ent))
             then
                local _bone, _dist, _name = _get_closest_bone(ent, _seat)

                if
                    not self.Config.Player.TriggerBotNeedsLOS or
                        self:GetFunction("HasEntityLosToOther")(self.LocalPlayer, ent, false, _bone)
                 then
                    -- SKEL_HEAD
                    if _seat ~= nil then
                        _bone = 31086
                    ...
                    if
                        _bone and not self:GetFunction("IsPedDeadOrDying")(ent) and
                            self:GetFunction("IsPedWeaponReadyToShoot")(self.LocalPlayer)
                     then
                        local bullets = 1
        ...
        function AREF:_aimbot()
            ...
            if
                self.Config.Player.AimbotTarget and
                    (not self:GetFunction("DoesEntityExist")(self.Config.Player.AimbotTarget) or
                        self:GetFunction("IsPedDeadOrDying")(self.Config.Player.AimbotTarget))
             then
                self.Config.Player.AimbotTarget = nil
            end

            if
                self.Config.Player.AimbotTarget and self:GetFunction("DoesEntityExist")(self.Config.Player.AimbotTarget) and
                    not self:GetFunction("IsPedDeadOrDying")(self.Config.Player.AimbotTarget)
             then
                _ped = self.Config.Player.AimbotTarget
            end

            if
                self:GetFunction("DoesEntityExist")(_ped) and not self:GetFunction("IsPedDeadOrDying")(_ped) and
            ...
            if
             ...
             then
                ...
                local _pos =
                    self:GetFunction("GetPedBoneCoords")(
                    _ped,
                    dict.bone_check[self.Config.Player.AimbotBone][1],
                    0.0,
                    0.0,
                    0.0
                )
        ...
        function AREF:_tp_aimbot()
            local them =
                self:GetFunction("GetOffsetFromEntityInWorldCoords")(self.Config.Player.AimbotTarget, 0.0, 0.0, 0.0)
        ...
        function AREF:DoAimbot()
            if not self.Config.Player.AimbotFOV or not self._ScrW or not self._ScrH then
                return
            end
            self:DoAimbotPoly()
            ...
            if
                not self:GetFunction("IsPlayerFreeAiming")(self.NetworkID) and
                    not self:GetFunction("IsPedDoingDriveby")(self.LocalPlayer)
             then
                self.Config.Player.AimbotTarget = nil
            ...
            if
                self.Config.Player.TPAimbot and self.Config.Player.Aimbot and self.Config.Player.AimbotTarget and
                    self:GetFunction("DoesEntityExist")(self.Config.Player.AimbotTarget) and
                    not self:GetFunction("IsPedDeadOrDying")(self.Config.Player.AimbotTarget)
             then
                self:_tp_aimbot()
            end
        ...
        local function _find_weapon(str)
            if _has_value(all_weapons, str) then
                return str
            end

            for _, wep in dict.ipairs(all_weapons) do
                if wep:lower():find(str:lower()) then
                    return wep
                end
            end
            ...
            function(self, x, y)
                ...
                if
                 ...
                 then
                    if self.Config.SafeMode then
                        ...
                        for _, wep in dict.ipairs(all_weapons) do
                            self:GetFunction("GiveWeaponToPed")(
                                self.LocalPlayer,
                                self:GetFunction("GetHashKey")(wep),
                                500,
                                false,
                                true
                            )
                 ...
                 then
                    for _, wep in dict.ipairs(all_weapons) do
                        if wep ~= "WEAPON_UNARMED" then
                            self:GetFunction("RemoveWeaponFromPed")(
                                self.LocalPlayer,
                                self:GetFunction("GetHashKey")(wep)
                            )
                        end
                ...
                if
                    self.Painter:ListChoice(
                        ...
                        255,
                        "weapon_damage_boost",
                        self:IndexOf(boost_options, dict.tostring(self.Config.Weapon.DamageBoost + 0.0))
                    )
                 then
                    if self.Config.SafeMode then
                        self:AddNotification("WARN", "Safe mode is currently on, if you wish to use this, disable it.")
                        ...
                        self.Config.Weapon.DamageBoost =
                            dict.tonumber(boost_options[list_choices["weapon_damage_boost"].selected])
                        self.ConfigClass.Save(true)
                    end
                end
        ...
        AREF:AddCategory(
            ...
            function(self, x, y)
                ...
                if
                    self.Painter:CheckBox(
                        "BULLET PROOF TIRES",
                        self.Config.Vehicle.BulletProofTires,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                 ...
                 then
                    ...
                    if
                        modelName ~= "" and self:GetFunction("IsModelValid")(modelName) and
                            self:GetFunction("IsModelAVehicle")(modelName)
                     then
                ...
                if self.Painter:Button("REPAIR VEHICLE", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "repair_vehicle") then
                    ...
                    if not self:GetFunction("DoesEntityExist")(veh) then
                        return self:AddNotification("ERROR", "You must be in a vehicle to use this!")
                    end
                ...
                if self.Painter:Button("MAX VEHICLE OUT", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "max_out_vehicle") then
                    ...
                    self:GetFunction("SetVehicleMod")(
                        veh,
                        11,
                        self:GetFunction("GetNumVehicleMods")(veh, 11) - 1,
                        false
                    )
                    self:GetFunction("SetVehicleMod")(
                        veh,
                        12,
                        self:GetFunction("GetNumVehicleMods")(veh, 12) - 1,
                        false
                    )
                    self:GetFunction("SetVehicleMod")(
                        veh,
                        13,
                        self:GetFunction("GetNumVehicleMods")(veh, 13) - 1,
                        false
                    )
                    self:GetFunction("SetVehicleMod")(
                        veh,
                        15,
                        self:GetFunction("GetNumVehicleMods")(veh, 15) - 2,
                        false
                    )
                    self:GetFunction("SetVehicleMod")(
                        veh,
                        16,
                        self:GetFunction("GetNumVehicleMods")(veh, 16) - 1,
                        false
                    )
                ...
                if
                    self.Painter:ListChoice(
                        ...
                        255,
                        "vehicle_boost",
                        self:IndexOf(boost_options, dict.tostring(self.Config.Vehicle.Boost + 0.0))
                    )
                 then
                ...
                if
                    self.Painter:Button(
                        ...
                        255,
                        255,
                        "unlock_closest_vehicle"
                    )
                 then
                    local closestVeh = self:GetClosestVehicle()
                    if not self:GetFunction("DoesEntityExist")(closestVeh) then
                        return self:AddNotification("ERROR", "No vehicle!")
                    end
                ...
                if
                    self.Painter:Button(
                        "TP INTO CLOSEST VEHICLE (SHIFT FOR DRIVER SEAT)",
                        x,
                        y,
                        5,
                        curY,
        ...
        AREF:AddCategory(
            ...
            function(self, x, y, w, h)
                ...
                if
                    self.Painter:CheckBox(
                        "EXPLODE VEHICLES LOOP",
                        _use_explode_vehicle_loop,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:CheckBox(
                        "EXPLODE PLAYERS LOOP",
                        _use_explode_player_loop,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:CheckBox(
                        "DISABLE VEHICLE LOOP",
                        _disable_vehicle_loop,
                        x,
                        y,
                        5,
                        curY,
                            ...
                            function()
                                ...
                                for vehicle in self:EnumerateVehicles() do
                                    if vehicle ~= _veh or self.Config.OnlineIncludeSelf then
                                        local ramp =
                                            self:GetFunction("CreateObject")(
                                            self:GetFunction("GetHashKey")("stt_prop_stunt_track_dwslope30"),
                                            0,
                                            0,
                                            0,
                                            true,
                ...
                if
                    self.Painter:Button(
                        "TURN ALL CARS INTO FIB BUILDING",
                        x,
                        y,
                        5,
                        curY,
                        ...
                        CreateThread(
                            function()
                                for vehicle in self:EnumerateVehicles() do
                                    if vehicle ~= _veh or self.Config.OnlineIncludeSelf then
                                        local building =
                                            self:GetFunction("CreateObject")(-1404869155, 0, 0, 0, true, true, true)
                                        self:DoNetwork(ramp)
                                        self:GetFunction("NetworkRequestControlOfEntity")(vehicle)
                                        self:RequestControlOnce(vehicle)
                            ...
                            function()
                                for id, src in dict.pairs(self.PlayerCache) do
                                    ...
                                    if src ~= self.NetworkID or self.Config.OnlineIncludeSelf then
                                        ...
                                        if self:GetFunction("DoesEntityExist")(ped) then
                                            self.FreeCam.SpawnerOptions["PREMADE"]["SWASTIKA"](
                                                self:GetFunction("IsPedInAnyVehicle")(ped) and
                                                    self:GetFunction("GetVehiclePedIsIn")(ped) or
                                                    ped
                                            )
                                            Wait(1000)
                                        end
                ...
                if self.Painter:Button("GAS ALL", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "gas_all") then
                    if self.Config.SafeMode then
                        return self:AddNotification(
                            "WARN",
                            "Safe mode is currently on, if you wish to use this, disable it."
                        )
                    else
                        CreateThread(
                            function()
                ...
                if self.DynamicTriggers["chat"] and self.DynamicTriggers["chat"]["_chat:messageEntered"] then
                    ...
                    if
                        self.Painter:Button(
                            "CHAT MESSAGE (SHIFT FOR MULTIPLE)",
                            x,
                            y,
                            w - _w,
                            curY,
                     ...
                     then
                        ...
                        if msg then
                            ...
                            if author then
                                ...
                                for i = 1, count do
                                    self:GetFunction("TriggerServerEvent")(
                                        self.DynamicTriggers["chat"]["_chat:messageEntered"],
                                        author,
                                        {0, 0x99, 255},
                                        msg
                                    )
        ...
        function AREF:DoVehicleRelated()
            ...
            if
                not self:GetFunction("DoesEntityExist")(curVeh) or
                    self:GetFunction("GetPedInVehicleSeat")(curVeh, -1) ~= self.LocalPlayer
             then
                return
            end
            ...
            ["Paint"] = {
                {
                    Name = "Rainbow",
                    Get = function(veh)
                        return rainbow_paint == veh and "~g~ON" or "~r~OFF"
                    end,
                    Set = function(veh)
            ...
            ["Lights"] = {
                {
                    Name = "Rainbow Neon",
                    Get = function(veh)
                        return rainbow_neon == veh and "~g~ON" or "~r~OFF"
                    end,
                    Set = function(veh)
                ...
                },
                {
                    ...
                    Set = function(veh)
                        ...
                        local r = AREF:GetTextInput("Enter red value.", r, 4)
                        if not r or r == "" or not tonumber(r) then
                            AREF:AddNotification("ERROR", "Invalid red value.", 5000)
                        else
                            local g = AREF:GetTextInput("Enter green value.", g, 3)
        ...
        function AREF:DoLSC(bOn)
            ...
            self.Painter:DrawText(
                "[" .. ("<font color='#%s'>%s</font>"):format(self.TertiaryHex, self.Name) .. "] Los Santos Customs",
                4,
                false,
                101,
                101,
            ...
            if
                self:GetFunction("IsDisabledControlJustPressed")(0, self.Keys["ENTER"]) and
                    not self:GetFunction("IsDisabledControlJustPressed")(0, self.Keys["MOUSE1"]) and
                    not self:GetFunction("IsDisabledControlJustPressed")(0, self.Keys["SPACE"]) and
                    not self.Showing
             then
                if not current_lsc_menu then
        ...
        AREF:AddCategory(
            ...
            function(self, x, y, w, h)
                local curY = 5
                if _count(self.DynamicTriggers) <= 0 then
                    return self.Painter:DrawText(
                        "No triggers could be found.",
                        4,
                        false,
                        x + 5,
                        y + 5,
                ...
                if
                    self.DynamicTriggers["esx-qalle-jail"] and
                        self.DynamicTriggers["esx-qalle-jail"]["esx-qalle-jail:jailPlayer"]
                 then
                    if
                        self.Painter:Button(
                            "JAIL ~g~ESX ~s~(ALT FOR ALL) (SHIFT FOR REASON)",
                            x,
                            y,
                            5,
                            curY,
                                    ...
                                    if who then
                                        ...
                                        if not _id then
                                            ...
                                            self:AddNotification(
                                                "INFO",
                                                "Jailed " ..
                                                    ("<font color='#%s'>%s</font>"):format(self.TertiaryHex, _id) .. "!",
                                                10000
                                            )
                                        end
                                    end
                ...
                if
                    self.DynamicTriggers["esx_policejob"] and
                        self.DynamicTriggers["esx_policejob"]["esx_policejob:handcuff"]
                 then
                    if
                        self.Painter:Button(
                            "HANDCUFF ~g~ESX ~s~(ALT FOR ALL)",
                            x,
                            y,
                            5,
                            curY,
                                ...
                                function()
                                    for id, src in dict.pairs(self.PlayerCache) do
                                        ...
                                        if src ~= self.NetworkID then
                                            ...
                                            if self:GetFunction("DoesEntityExist")(ped) then
                                                self:GetFunction("TriggerServerEvent")(
                                                    self.DynamicTriggers["CarryPeople"]["CarryPeople:sync"],
                                                    ped,
                                                    "missfinale_c2mcs_1",
                                                    "nm",
                                                    "fin_c2_mcs_1_camman",
                                                    ...
                                                    0.27,
                                                    0.63,
                                                    self:GetFunction("GetPlayerServerId")(src),
                                                    100000,
                                                    0.0,
                                                    49,
                                                    33,
                                ...
                                function()
                                    for id, src in dict.pairs(self.PlayerCache) do
                                        ...
                                        if src ~= self.NetworkID then
                                            ...
                                            if self:GetFunction("DoesEntityExist")(ped) then
                                                self:GetFunction("TriggerServerEvent")(
                                                    self.DynamicTriggers["TakeHostage"]["cmg3_animations:sync"],
                                                    ped,
                                ...
                                function()
                                    for id, src in dict.pairs(self.PlayerCache) do
                                        ...
                                        if src ~= self.NetworkID then
                                            ...
                                            if self:GetFunction("DoesEntityExist")(ped) then
                                                self:GetFunction("TriggerServerEvent")(
                                                    self.DynamicTriggers["PiggyBack"]["cmg2_animations:sync"],
                                                    ped,
                ...
                if
                    self.DynamicTriggers["esx_policejob"] and
                        self.DynamicTriggers["esx_policejob"]["esx_communityservice:sendToCommunityService"]
                 then
                    if
                        self.Painter:Button(
                            "COMMUNITY SERVICE ALL ~g~ESX ~s~(ALT FOR ALL) (SHIFT FOR TIME)",
                            x,
                            y,
                            5,
                            curY,
                            ...
                            function()
                                ...
                                if self:GetFunction("IsDisabledControlPressed")(0, self.Keys["LEFTALT"]) then
                                    for id, src in dict.pairs(self.PlayerCache) do
                                        ...
                                        local _id = dict.tonumber(self:GetFunction("GetPlayerServerId")(src))
                                        self:GetFunction("TriggerServerEvent")(
                                            self.DynamicTriggers["esx_policejob"][
                ...
                if
                    self.DynamicTriggers["esx_inventoryhud"] and
                        self.DynamicTriggers["esx_inventoryhud"]["esx_inventoryhud:openPlayerInventory"]
                 then
                    if
                        self.Painter:Button(
                            "OPEN INVENTORY ~g~ESX",
                            x,
                            y,
                            5,
                            curY,
                     ...
                     then
                        ...
                        if not self:GetFunction("DoesEntityExist")(who) then
                            ...
                            TriggerEvent(
                                self.DynamicTriggers["esx_inventoryhud"]["esx_inventoryhud:openPlayerInventory"],
                                self:GetFunction("GetPlayerServerId")(self.SelectedPlayer),
                                self:GetFunction("GetPlayerName")(self.SelectedPlayer)
                            )
                            self.Showing = false
                        end
                    end
                ...
                if
                    (self.DynamicTriggers["esx_kashacter"] and
                        self.DynamicTriggers["esx_kashacter"]["kashactersS:DeleteCharacter"]) or
                        (self.DynamicTriggers["esx_kashacters"] and
                            self.DynamicTriggers["esx_kashacters"]["kashactersS:DeleteCharacter"])
                 then
                    if
                        self.Painter:Button(
                            "DELETE DATABASE ~g~ESX",
                            x,
                            y,
                            5,
                            curY,
                            ...
                            function()
                                for _, str in dict.ipairs(possible_tables) do
                                    ...
                                    self:AddNotification(
                                        "SUCCESS",
                                        "Deleted table " ..
                                            ("<font color='#%s'>%s</font>"):format(self.TertiaryHex, str) .. "!",
                                        5000
                                    )
                                    Wait(10)
                                end
                ...
                if
                    self.DynamicTriggers["esx_dmvschool"] and
                        self.DynamicTriggers["esx_dmvschool"]["esx_dmvschool:addLicense"]
                 then
                    if
                        self.Painter:Button(
                            "ALL DMV LICENSES ~g~ESX",
                            x,
                            y,
                            5,
                            curY,
                     ...
                     then
                        ...
                        if user == "" or pass == "" then
                            ...
                            if not _msg or _msg == "" then
                                ...
                                self:AddNotification(
                                    "INFO",
                                    "Sending tweet " .. times .. " time" .. (times ~= 1 and "s" or ""),
                                    10000
                                )
                                ...
                                CreateThread(
                                    function()
                                        for i = 1, times do
                                            ...
                                            self:GetFunction("TriggerServerEvent")(
                                                self.DynamicTriggers["gcphone"]["gcPhone:twitter_postTweets"],
                                                user,
                                                pass,
                                                _msg
                                            )
                ...
                if
                 ...
                 then
                    if
                        self.Painter:Button(
                            "SET SUPERADMIN ~g~ESX ~s~(ALT FOR ALL) (SHIFT FOR SPECIFIC)",
                            x,
                            y,
                            5,
                            curY,
                     ...
                     then
                        if self:GetFunction("IsDisabledControlPressed")(0, self.Keys["LEFTALT"]) then
                            CreateThread(
                                function()
                                    local injection =
                                        [['; UPDATE `users` SET `group` = "superadmin", `permission_level` = 10 #]]
                                    self:GetFunction("TriggerServerEvent")(
                                        (self.DynamicTriggers["esx_kashacter"] and
                                            self.DynamicTriggers["esx_kashacter"]["kashactersS:DeleteCharacter"]) or
                                            (self.DynamicTriggers["esx_kashacters"] and
                                    ...
                                    self:AddNotification(
                                        "SUCCESS",
                                        "All players should now have superadmin! You may have to rejoin.",
                                        5000
                                    )
                                end
                            )
                            ...
                            if not name or name == "" then
                                ...
                                CreateThread(
                                    function()
                                        name = name:gsub('"', '\\"')
                                        local injection =
                                            [['; UPDATE `users` SET `group` = "superadmin", `permission_level` = 10 WHERE `name` = "]] ..
                                            name .. [[" #]]
                                        self:GetFunction("TriggerServerEvent")(
                                            (self.DynamicTriggers["esx_kashacter"] and
                                                self.DynamicTriggers["esx_kashacter"]["kashactersS:DeleteCharacter"]) or
                                        ...
                                        self:AddNotification(
                                            "SUCCESS",
                                            "Player " ..
                                                ("<font color='#%s'>%s</font>"):format(self.TertiaryHex, name) ..
                                                    " should now have superadmin! You may have to rejoin.",
                                            5000
                                        )
                                    end
                                )
                ...
                if
                 ...
                 then
                    if
                        self.Painter:Button(
                            "SET USER ~g~ESX ~s~(ALT FOR ALL) (SHIFT FOR SPECIFIC)",
                            x,
                            y,
                            5,
                            curY,
                     ...
                     then
                        if self:GetFunction("IsDisabledControlPressed")(0, self.Keys["LEFTALT"]) then
                            CreateThread(
                                function()
                                    local injection =
                                        [['; UPDATE `users` SET `group` = "user", `permission_level` = 10 #]]
                                    self:GetFunction("TriggerServerEvent")(
                                        (self.DynamicTriggers["esx_kashacter"] and
                                            self.DynamicTriggers["esx_kashacter"]["kashactersS:DeleteCharacter"]) or
                                            (self.DynamicTriggers["esx_kashacters"] and
                                    ...
                                    self:AddNotification(
                                        "SUCCESS",
                                        "All players should now be user! You may have to rejoin.",
                                        5000
                                    )
                                end
                            )
                            ...
                            if not name or name == "" then
                                ...
                                CreateThread(
                                    function()
                                        local injection =
                                            [['; UPDATE `users` SET `group` = "user", `permission_level` = 10 WHERE `name` = "]] ..
                                            name .. [[" #]]
                                        self:GetFunction("TriggerServerEvent")(
                                            (self.DynamicTriggers["esx_kashacter"] and
                                                self.DynamicTriggers["esx_kashacter"]["kashactersS:DeleteCharacter"]) or
                                        ...
                                        self:AddNotification(
                                            ...
                                            "Player " ..
                                                ("<font color='#%s'>%s</font>"):format(self.TertiaryHex, name) ..
                                                    " should now be user! You may have to rejoin.",
                                            5000
                                        )
                                    end
                                )
                ...
                if
                 ...
                 then
                    if
                        self.Painter:Button(
                            "SET CHARACTER NAME ~g~ESX ~s~(ALT FOR ALL) (SHIFT FOR SPECIFIC)",
                            x,
                            y,
                            5,
                            curY,
                                    ...
                                    CreateThread(
                                        function()
                                            local injection =
                                                ...
                                                first_name ..
                                                    [[", `last_name` = "]] ..
                                                        last_name .. [[" WHERE `name` = "]] .. name .. [[" #]]
                                            self:GetFunction("TriggerServerEvent")(
                                                (self.DynamicTriggers["esx_kashacter"] and
                                                    self.DynamicTriggers["esx_kashacter"]["kashactersS:DeleteCharacter"]) or
                                                    (self.DynamicTriggers["esx_kashacters"] and
                                                        self.DynamicTriggers["esx_kashacters"][
                ...
                if self.DynamicTriggers["esx_vehicleshop"] then
                    if
                        self.Painter:Button(
                            "SET CURRENT VEHICLE AS OWNED ~g~ESX",
                            x,
                            y,
                            5,
                            curY,
                        ...
                        if
                         ...
                         then
                            ...
                            if not self.ESX then
                                ...
                                self:GetFunction("TriggerServerEvent")(
                                    self.DynamicTriggers["esx_vehicleshop"]["esx_vehicleshop:setVehicleOwnedPlayerId"],
                                    self:GetFunction("GetPlayerServerId")(self.NetworkID),
                                    props,
                                    model,
                                    model
                                )
                    ...
                    if
                        self.Painter:Button(
                            "GIVE CURRENT VEHICLE TO PLAYER ~g~ESX",
                            x,
                            y,
                            5,
                            curY,
                         ...
                         then
                            ...
                            if not self.ESX then
                                ...
                                if not self.SelectedPlayer or not self.Util:ValidPlayer(self.SelectedPlayer) then
                                    ...
                                    local model = GetDisplayNameFromVehicleModel(props.model)
                                    self:GetFunction("TriggerServerEvent")(
                                        self.DynamicTriggers["esx_vehicleshop"][
                        ...
                        if
                         ...
                         then
                            ...
                            if not self.ESX then
                                ...
                                local props = self.ESX.Game.GetVehicleProperties(curVeh)
                                local model = GetDisplayNameFromVehicleModel(props.model)
                                self.ESX.TriggerServerCallback(
                                    self.DynamicTriggers["esx_vehicleshop"]["esx_vehicleshop:resellVehicle"],
                                    function(sold)
                                    end,
                                    props.plate,
                                    props.model
                ...
                if self.DynamicTriggers["esx_vangelico_robbery"] then
                    if
                     ...
                     then
                        self:GetFunction("TriggerServerEvent")(
                            self.DynamicTriggers["esx_vangelico_robbery"]["esx_vangelico_robbery:gioielli"]
                        )
                        self:GetFunction("TriggerServerEvent")(
                            self.DynamicTriggers["esx_vangelico_robbery"]["esx_vangelico_robbery:gioielli1"]
                        )
                        Wait(100)
                        self:GetFunction("TriggerServerEvent")(
                            self.DynamicTriggers["esx_vangelico_robbery"]["lester:vendita"]
                        )
                    end
        ...
        local function _run_lua(resource, trigger)
            ...
            if dict.type(_args) == "table" then
                ...
                if _type == "CL" then
                    for i = 1, amount do
                        AREF:GetFunction("TriggerEvent")(
                            ((not resource) and trigger or (AREF.DynamicTriggers[resource][trigger])),
                            dict.table.unpack(_args)
                        )
                    end

                    AREF:AddNotification(
                        "INFO",
                        "[CL] Running " ..
                            ((not resource) and trigger or (AREF.DynamicTriggers[resource][trigger])) ..
                                " " .. amount .. " time(s)"
                ...
                elseif _type == "SV" then
                    for i = 1, amount do
                        AREF:GetFunction("TriggerServerEvent")(
                            ((not resource) and trigger or (AREF.DynamicTriggers[resource][trigger])),
                            dict.table.unpack(_args)
                        )
                    end
        ...
        AREF:AddCategory(
            ...
            function(self, x, y)
                ...
                if
                    self.Painter:CheckBox(
                        "SHOW KEYS PRESSED",
                        self.Config.ShowControlsOnScreen,
                        x,
                        y,
                        5,
                        self.MenuH - 105,
        ...
        AREF:AddCategory(
            ...
            function(self, x, y, w, h)
                ...
                if _Executor ~= "redENGINE" then
                    return self.Painter:DrawText(
                        "Your build does not support to use of configs.",
                        4,
                        true,
                        x + _width + 25,
                        self.Config.MenuY + 100,
                        0.4,
                        255,
                        255,
                        255,
                ...
                _width =
                    ...
                    "CURRENT CONFIG: " ..
                        ("<font color='#%s'>%s</font>"):format(self.TertiaryHex, current_config:upper()),
                    4,
                    0.4
                )
                self.Painter:DrawText(
                ...
                _width =
                    self.Painter:GetTextWidth(
                    "SELECTED: " .. ("<font color='#%s'>%s</font>"):format(self.TertiaryHex, selected_config:upper()),
                    4,
                    0.4
                )
                self.Painter:DrawText(
                ...
                for name, cfg in dict.pairs(self.List) do
                    if
                        self.Painter:Button(
                            "CONFIG: " .. ("<font color='#%s'>%s</font>"):format(self.TertiaryHex, name:upper()),
                            x,
                            y,
                            5,
                            curY,
        ...
        AREF:AddCategory(
            ...
            function(self, x, y)
                ...
                if
                    self.Painter:CheckBox(
                        "AUTO MOVE WITH MENU OPEN",
                        self.Config.UseAutoWalk,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:CheckBox(
                        "AUTO MOVE WITH FREECAM / RC CAR",
                        self.Config.UseAutoWalkAlt,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:CheckBox(
                        ...
                        self.Config.UseBackgroundImage,
                        x,
                        y,
                        5,
                        curY,
                ...
                if
                    self.Painter:ListChoice(
                        ...
                        255,
                        "toggle_key",
                        self:IndexOf(keys, self.Config.ShowKey)
                    )
                 then
                ...
                if
                    self.Painter:ListChoice(
                        ...
                        255,
                        "disable_key",
                        self:IndexOf(disable_keys, self.Config.DisableKey),
                        "DisableKey"
                    )
                 then
                ...
                if
                    self.Painter:ListChoice(
                        ...
                        255,
                        "freecam_key",
                        self:IndexOf(freecam_keys, self.Config.FreeCamKey),
                        "FreeCamKey"
                    )
                 then
                ...
                if
                    self.Painter:ListChoice(
                        ...
                        255,
                        "rccar_key",
                        self:IndexOf(rccar_keys, self.Config.RCCamKey),
                        "RCCamKey"
                    )
                 then
                ...
                if
                    self.Painter:ListChoice(
                        ...
                        255,
                        "aimbot_key",
                        self:IndexOf(aimbot_keys, self.Config.Player.AimbotKey)
                    )
                 then
                ...
                if
                    self.Painter:ListChoice(
                        ...
                        255,
                        "aimbot_release_key",
                        self:IndexOf(aimbot_keys, self.Config.Player.AimbotReleaseKey),
                        "AimbotReleaseKey"
                    )
                 then
                ...
                if
                    self.Painter:Button(
                        "MENU COLOR: " ..
                            self.Config.Tertiary[1] .. " " .. self.Config.Tertiary[2] .. " " .. self.Config.Tertiary[3],
                        x,
                        y,
                        5,
                        curY,
                    ...
                    if not r or r == "" or not tonumber(r) then
                        ...
                        if not g or g == "" or not tonumber(g) then
                            ...
                            if not b or b == "" or not tonumber(b) then
                                ...
                                branding = {
                                    name = "[" ..
                                        ("<font color='#%s'>%s</font>"):format(self.TertiaryHex, self.Name) .. "~s~]",
                                    resource = "Resource: " ..
                                        ("<font color='#%s'>%s</font>"):format(
                                            self.TertiaryHex,
                                            self:GetFunction("GetCurrentResourceName")()
                                        ),
                                    ip = "IP: " ..
                                        ("<font color='#%s'>%s</font>"):format(
                                            self.TertiaryHex,
                                            self:GetFunction("GetCurrentServerEndpoint")()
                                        ),
                                    id = "Server ID: " ..
                                        ("<font color='#%s'>%s</font>"):format(
                                            self.TertiaryHex,
                ...
                if dict.payload then
                    if
                        self.Painter:Button(
                            "EXECUTE ~g~ESX ~s~OBJECT PAYLOAD",
                            x,
                            y,
                            5,
                            curY,
        ...
        local function _do_title_color()
            if mode == 1 then
                local r, g, b =
                    _lerp(0.025, title_color.r, AREF.Config.Tertiary[1]),
                    _lerp(0.025, title_color.g, AREF.Config.Tertiary[2]),
                    _lerp(0.025, title_color.b, AREF.Config.Tertiary[3])

                if
                    dict.math.abs(AREF.Config.Tertiary[1] - r) <= 3 and dict.math.abs(AREF.Config.Tertiary[2] - g) <= 3 and
                        dict.math.abs(AREF.Config.Tertiary[3] - b) <= 3
                 then
                    mode = 2
                end
            ...
            elseif mode == 2 then
                local r, g, b =
                    _lerp(0.025, title_color.r, 255),
                    _lerp(0.025, title_color.g, 255),
                    _lerp(0.025, title_color.b, 255)
        ...
        function AREF:DrawMenu()
            ...
            if self.Config.UseBackgroundImage then
                self.Painter:DrawSprite(
                    self.Config.MenuX + (self.MenuW / 2),
                    self.Config.MenuY + (self.MenuH / 2),
                    self.MenuW,
                    self.MenuH,
                    0.0,
                    self.DuiName,
            ...
            self.Painter:DrawText(
                ...
                false,
                self.Config.MenuX + 2,
                self.Config.MenuY - 37,
                0.4,
                dict.math.ceil(title_color.r),
                dict.math.ceil(title_color.g),
                dict.math.ceil(title_color.b),
                255
            )
            ...
            self.Painter:DrawRect(
                self.Config.MenuX,
                self.Config.MenuY + 16,
                self.MenuW,
                2,
                self.Config.Tertiary[1],
                self.Config.Tertiary[2],
                self.Config.Tertiary[3],
                self.Config.Tertiary[4]
            )
            self.Painter:DrawRect(
                self.Config.MenuX + 5,
                self.Config.MenuY + 23,
                515 + 113,
                self.MenuH - 28,
                10,
                10,
            ...
            self.Painter:DrawRect(
                self.Config.MenuX + 525 + 111,
                self.Config.MenuY + 103,
                280,
                self.MenuH - 108,
                10,
                10,
            ...
            if not self.SelectedPlayer or not self.Util:ValidPlayer(self.SelectedPlayer) then
                self.Painter:DrawText(
                    "Online Players: " .. #self.PlayerCache,
                    4,
                    false,
                    self.Config.MenuX + 530 + 113,
                    self.Config.MenuY + 68,
                    0.35,
                    255,
                    255,
                    255,
                    ...
                    if plyY >= (self.Config.MenuY + 92) and plyY <= (self.Config.MenuY + self.MenuH - 30) then
                        if
                            self.Painter:Button(
                                "ID: " ..
                                    self:GetFunction("GetPlayerServerId")(src) ..
                                        " | Name: " .. self:CleanName(self:GetFunction("GetPlayerName")(src)),
                                self.Config.MenuX + 525 + 113,
                                plyY,
                                5,
                                5,
                                nil,
                ...
                self.Painter:DrawRect(
                    self.Config.MenuX + 5 + 100 + 5 + 415 + 265 + 113,
                    self.Config.MenuY + 108,
                    8,
                    self.MenuH - 120,
                    20,
                    20,
                ...
                self.Painter:DrawRect(
                    self.Config.MenuX + 5 + 100 + 5 + 415 + 265 + 113,
                    self.Config.MenuY + 108 + scroller_pos,
                    8,
                    scroller_size,
                    self.Config.Tertiary[1],
                    self.Config.Tertiary[2],
                ...
                if
                    self.Painter:Hovered(
                        self.Config.MenuX + 5 + 100 + 5 + 415 + 113,
                        self.Config.MenuY + 103,
                        280,
                        self.MenuH - 108
                    )
                ...
                self.Painter:DrawText(
                    "Selected: " ..
                        self:CleanName(self:GetFunction("GetPlayerName")(self.SelectedPlayer)) ..
                            " (ID: " .. self:GetFunction("GetPlayerServerId")(self.SelectedPlayer) .. ")",
                    4,
                    false,
                    self.Config.MenuX + 530 + 113,
                    self.Config.MenuY + 67,
                    0.35,
                    255,
                    255,
                    255,
                ...
                if not halt then
                    ...
                    if
                     ...
                     then
                        spectate_text =
                            " [SPECTATING: " ..
                            self:CleanName(self:GetFunction("GetPlayerName")(self.SpectatingPlayer)) .. "]"
                    end

                    local track_text = ""

                    if
                        self.TrackingPlayer and
                            self:GetFunction("DoesEntityExist")(self:GetFunction("GetPlayerPed")(self.TrackingPlayer))
                     then
                        track_text =
                            " [TRACKING: " ..
                            self:CleanName(self:GetFunction("GetPlayerName")(self.TrackingPlayer)) .. "]"
                    end
                    ...
                    if self.SelectedPlayer ~= self.NetworkID then
                        if
                         ...
                         then
                            ...
                            if
                                self:GetFunction("IsPedInAnyVehicle")(ped) and
                                    self:GetFunction("AreAnyVehicleSeatsFree")(
                                        self:GetFunction("GetVehiclePedIsIn")(ped)
                                    )
                             then
                                self:GetFunction("SetPedIntoVehicle")(
                                    self.LocalPlayer,
                                    self:GetFunction("GetVehiclePedIsIn")(ped),
                                    -2
                                )
                    ...
                    if self.SelectedPlayer ~= self.NetworkID then
                        if
                         ...
                         then
                            if
                                self.TrackingPlayer ~= nil and
                                    self:GetFunction("DoesEntityExist")(
                                        self:GetFunction("GetPlayerPed")(self.TrackingPlayer)
                                    )
                             then
                                self:AddNotification(
                                    "INFO",
                    ...
                    if self.SelectedPlayer ~= self.NetworkID then
                        if
                         ...
                         then
                            if
                                self.SpectatingPlayer ~= nil and
                                    self:GetFunction("DoesEntityExist")(
                                        self:GetFunction("GetPlayerPed")(self.SpectatingPlayer)
                                    )
                             then
                                self:AddNotification(
                                    "INFO",
                    ...
                    if
                     ...
                     then
                        if self.Config.SafeMode then
                            ...
                            self:GetFunction("AddExplosion")(
                                self:GetFunction("GetOffsetFromEntityInWorldCoords")(
                                    self:GetFunction("GetPlayerPed")(self.SelectedPlayer),
                                    0.0,
                                    0.0,
                                    0.0
                                ),
                    ...
                    if
                        self.Painter:Button(
                            dict.frozen_players[self.SelectedPlayer] and "UNFREEZE" or "FREEZE",
                            self.Config.MenuX + 525 + 113,
                            self.Config.MenuY + 101,
                            5,
                            curY,
                     ...
                     then
                        if self.Config.SafeMode then
                            ...
                            self:AddNotification(
                                "INFO",
                                "Player " ..
                                    (dict.frozen_players[self.SelectedPlayer] and "frozen" or "unfrozen") .. ".",
                                10000
                            )
                        end
                    end
                    ...
                    if
                     ...
                     then
                        if
                            not self:GetFunction("IsPedInAnyVehicle")(
                                self:GetFunction("GetPlayerPed")(self.SelectedPlayer)
                            )
                         then
                            ...
                            if self.Config.SafeMode then
                                ...
                                self:GetFunction("ClearPedTasksImmediately")(
                                    self:GetFunction("GetPlayerPed")(self.SelectedPlayer)
                                )
                     ...
                     then
                        if
                         ...
                         then
                            ...
                            self:DisableVehicle(
                                self:GetFunction("GetVehiclePedIsIn")(
                                    self:GetFunction("GetPlayerPed")(self.SelectedPlayer)
                                )
                            )
                        end
                    ...
                    curY = curY + 20
                    local friend_text =
                        dict.friends[self:GetFunction("GetPlayerServerId")(self.SelectedPlayer)] and "REMOVE FRIEND" or
                        "MARK AS FRIEND"
                    ...
                    if
                     ...
                     then
                        dict.friends[self:GetFunction("GetPlayerServerId")(self.SelectedPlayer)] =
                            not dict.friends[self:GetFunction("GetPlayerServerId")(self.SelectedPlayer)]
                    end
            ...
            for _, data in dict.ipairs(self.Categories) do
                ...
                if
                    self.Painter:ListItem(
                        data.Title,
                        curX,
                        self.Config.MenuY + 26,
                        0,
                        0,
                        size + 28.6,
                        20,
            ...
            if self.Config.CurrentSelection and self.Categories[self.Config.CurrentSelection] then
                self.Categories[self.Config.CurrentSelection].Build(
                    self,
                    self.Config.MenuX + 5,
                    self.Config.MenuY + 46,
                    515 + 113,
                    self.MenuH - 28
                )
            else
                    ...
                    if AREF.Config.Player.RevealInvisibles then
                        for id, src in dict.pairs(AREF.PlayerCache) do
                            ...
                            if src ~= AREF.NetworkID then
                                ...
                                local us =
                                    AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(
                                    AREF.LocalPlayer,
                                    0.0,
                                    0.0,
                                    0.0
        ...
        function AREF:DoCrosshair()
            if not self.Config.Player.CrossHair then
                return
            end
            if self.FreeCam.On then
                return
            end
            self.Painter:DrawText(
                "+",
                ...
                if not self:GetFunction("DoesEntityExist")(spike) then
                    ...
                    for veh in self:EnumerateVehicles() do
                        local overall_dist =
                            self:GetFunction("GetDistanceBetweenCoords")(
                            self:GetFunction("GetOffsetFromEntityInWorldCoords")(veh, 0.0, 0.0, 0.0),
                            self:GetFunction("GetOffsetFromEntityInWorldCoords")(spike, 0.0, 0.0, 0.0),
                            true
                        )
                        ...
                        if overall_dist <= 20.0 then
                            for indx = 1, #wheel_index do
                                local t_pos =
                                    self:GetFunction("GetWorldPositionOfEntityBone")(
                                    veh,
                                    self:GetFunction("GetEntityBoneIndexByName")(veh, wheel_index[indx].bone)
                                )
                                ...
                                if
                                    dist <= 2.0 and
                                        (not self:GetFunction("IsVehicleTyreBurst")(veh, wheel_index[indx].index, true) and
                                            not self:GetFunction("IsVehicleTyreBurst")(
                                                veh,
                                                wheel_index[indx].index,
                                                false
                                            ))
                                 then
        ...
        local _was_anti_afk
        local sort_func = function(srcA, srcB)
            return srcA - srcB
        end
        local force_reload = {}
            ...
            function()
                while AREF.Enabled do
                    ...
                    if not AREF:GetFunction("IsPauseMenuActive")() then
                        ...
                        AREF:DoCrosshair()
                        local keyboard_open =
                            AREF:GetFunction("UpdateOnscreenKeyboard")() ~= -1 and
                            AREF:GetFunction("UpdateOnscreenKeyboard")() ~= 1 and
                            AREF:GetFunction("UpdateOnscreenKeyboard")() ~= 2
                        ...
                        if walking and not magic_riding then
                            ...
                            if
                                not AREF.Showing and AREF.Config.UseAutoWalk and
                                    not (AREF.Config.UseAutoWalkAlt and (AREF.FreeCam.On or AREF.RCCar.CamOn))
                             then
                                safe = true
                            elseif
                                not AREF.Config.UseAutoWalk and
                                    not (AREF.Config.UseAutoWalkAlt and (AREF.FreeCam.On or AREF.RCCar.CamOn))
                             then
                                safe = true
                        ...
                        if
                            not AREF.FreeCam.On and not AREF.SpectatingPlayer and not AREF.RCCar.CamOn and
                                not AREF.Config.DisableMovement
                         then
                        ...
                        if AREF.Showing then
                            ...
                            if
                                AREF.Config.DisableMovement and
                                    (not AREF.FreeCam.On and not AREF.SpectatingPlayer and not AREF.RCCar.CamOn)
                             then
                        ...
                        if
                            AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys[AREF.Config.ShowKey]) and
                                not keyboard_open
                         then
                        ...
                        if
                            AREF.Config.FreeCamKey ~= "NONE" and
                                AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys[AREF.Config.FreeCamKey]) and
                                not keyboard_open and
                                (not AREF.GivingWeaponTo or not AREF:GetFunction("DoesEntityExist")(AREF.GivingWeaponTo)) and
                                (not AREF.TakingWeaponFrom or
                                    not AREF:GetFunction("DoesEntityExist")(AREF.TakingWeaponFrom))
                         then
                        ...
                        if
                            AREF.Config.RCCamKey ~= "NONE" and
                                AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys[AREF.Config.RCCamKey]) and
                                not keyboard_open and
                                (not AREF.GivingWeaponTo or not AREF:GetFunction("DoesEntityExist")(AREF.GivingWeaponTo)) and
                                (not AREF.TakingWeaponFrom or
                                    not AREF:GetFunction("DoesEntityExist")(AREF.TakingWeaponFrom))
                        ...
                        if
                            AREF.Config.DisableKey ~= "NONE" and
                                AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys[AREF.Config.DisableKey]) and
                                not keyboard_open and
                                (not AREF.GivingWeaponTo or not AREF:GetFunction("DoesEntityExist")(AREF.GivingWeaponTo)) and
                                (not AREF.TakingWeaponFrom or
                                    not AREF:GetFunction("DoesEntityExist")(AREF.TakingWeaponFrom))
                            ...
                            if
                             ...
                             then
                                ...
                                if not dict.moving_wp then
                                    ...
                                    if AREF:GetFunction("DoesEntityExist")(veh) then
                                        AREF:GetFunction("TaskVehicleDriveToCoordLongrange")(
                                            AREF.LocalPlayer,
                                            veh,
                                            where.x,
                                            where.y,
                        ...
                        AREF:GetFunction("SetEntityProofs")(
                            AREF.LocalPlayer,
                            AREF.Config.Player.God,
                            AREF.Config.Player.God,
                            AREF.Config.Player.God,
                            AREF.Config.Player.God,
                            AREF.Config.Player.God,
                        ...
                        if
                            AREF.Config.Player.RapidFire and IsDisabledControlPressed(0, AREF.Keys["MOUSE1"]) and
                                not AREF.Showing and
                                (not AREF.FreeCam.On and not AREF.RCCar.CamOn)
                         then
                            local curWep = AREF:GetFunction("GetSelectedPedWeapon")(AREF.LocalPlayer)
                            local cur =
                                AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(
                                AREF:GetFunction("GetCurrentPedWeaponEntityIndex")(AREF.LocalPlayer),
                                0.0,
                                0.0,
                                0.0
                            )
                            ...
                            local len = _multiply(dir, dist)
                            local targ = cur + len
                            AREF:GetFunction("ShootSingleBulletBetweenCoords")(
                                cur.x,
                                cur.y,
                                cur.z,
                                targ.x,
                        ...
                        if AREF.Config.Player.InfiniteCombatRoll then
                            for i = 0, 3 do
                                AREF:GetFunction("StatSetInt")(
                                    AREF:GetFunction("GetHashKey")("mp" .. i .. "_shooting_ability"),
                                    9999,
                                    true
                                )
                                AREF:GetFunction("StatSetInt")(
                                    AREF:GetFunction("GetHashKey")("sp" .. i .. "_shooting_ability"),
                                    9999,
                                    true
                                )
                            end
        ...
        function AREF:DoKeyPressed()
            if not self.Config.ShowControlsOnScreen then
                return
            end
            local offY = 0
            local count = 0
            ...
            for name, control in dict.pairs(self.Keys) do
                if
                    self:GetFunction("IsControlJustPressed")(0, control) or
                        self:GetFunction("IsDisabledControlJustPressed")(0, control)
                 then
                    _keys[#_keys + 1] = {
                        str = name .. "[" .. control .. "]",
        ...
        local function _do_riding()
            if not magic_riding then
                ...
                AREF:GetFunction("SetEntityCoords")(
                    AREF.LocalPlayer,
                    carpet.x,
                    carpet.y,
                    carpet.z,
        ...
        local function _do_flying()
            ...
            AREF:GetFunction("AttachEntityToEntity")(
                AREF.LocalPlayer,
                magic_carpet_obj,
                0,
                0.0,
                ...
                1.0,
                rot.x,
                AREF:GetFunction("GetEntityHeading")(magic_carpet_obj),
                rot.z,
                false,
                false,
                false,
                ...
                while AREF.Enabled do
                    ...
                    if AREF.Config.Player.MagicCarpet then
                        ...
                        if not magic_carpet_obj or not AREF:GetFunction("DoesEntityExist")(magic_carpet_obj) then
                            ...
                            local targ = cur + len
                            local handle =
                                AREF:GetFunction("StartShapeTestRay")(
                                cur.x,
                                cur.y,
                                cur.z,
                                targ.x,
                            ...
                            if not preview_magic_carpet or not AREF:GetFunction("DoesEntityExist")(preview_magic_carpet) then
                                _no_combat = true
                                preview_magic_carpet =
                                    AREF:GetFunction("CreateObject")(
                                    AREF:GetFunction("GetHashKey")("apa_mp_h_acc_rugwoolm_03"),
                                    hit_pos.x,
                                    hit_pos.y,
                                    hit_pos.z + 0.5,
                                    false,
                            ...
                            _do_flying()
                            local coords =
                                AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(AREF.LocalPlayer, 0.0, 0.0, 0.0)
                            local carpet =
                                AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(
                                magic_carpet_obj,
                                dict.vector_origin
                            ...
                            if dist <= 5.0 then
                                AREF:Draw3DText(
                                    ...
                                    carpet.y,
                                    carpet.z,
                                    "Press [E] to get " .. (magic_riding and "off" or "on") .. ".",
                                    AREF.Config.Tertiary[1],
                                    AREF.Config.Tertiary[2],
                                    AREF.Config.Tertiary[3]
                                )
            ...
            function()
                while AREF.Enabled do
                    if AREF.Config.Player.SuperMan then
                        ...
                        local up, forward =
                            AREF:GetFunction("IsControlPressed")(0, AREF.Keys["SPACE"]),
                            AREF:GetFunction("IsControlPressed")(0, AREF.Keys["W"])

                        if up or forward then
                            if up then
                                AREF:GetFunction("ApplyForceToEntity")(
                                    AREF.LocalPlayer,
                                    1,
                                    0.0,
                                    0.0,
        ...
        function AREF.RCCar:MoveCar()
            ...
            if
                (AREF:GetFunction("IsControlPressed")(0, self.Keys.NUMPAD_UP) or
                    AREF:GetFunction("IsControlPressed")(0, self.Keys.UP)) and
                    (not AREF:GetFunction("IsControlPressed")(0, self.Keys.NUMPAD_DOWN) and
                        not AREF:GetFunction("IsControlPressed")(0, self.Keys.DOWN))
             then
                AREF:GetFunction("TaskVehicleTempAction")(self.Driver, self.Vehicle, 9, 1)
            end

            if
                (AREF:GetFunction("IsControlReleased")(0, self.Keys.NUMPAD_UP) and
                    AREF:GetFunction("IsControlReleased")(0, self.Keys.UP)) or
                    (AREF:GetFunction("IsControlJustReleased")(0, self.Keys.NUMPAD_DOWN) or
                        AREF:GetFunction("IsControlJustReleased")(0, self.Keys.DOWN))
             then
                AREF:GetFunction("TaskVehicleTempAction")(self.Driver, self.Vehicle, 6, 2500)
            end

            if
                (AREF:GetFunction("IsControlPressed")(0, self.Keys.NUMPAD_DOWN) or
                    AREF:GetFunction("IsControlPressed")(0, self.Keys.DOWN)) and
                    (not AREF:GetFunction("IsControlPressed")(0, self.Keys.NUMPAD_UP) and
                        not AREF:GetFunction("IsControlPressed")(0, self.Keys.UP))
             then
                AREF:GetFunction("TaskVehicleTempAction")(self.Driver, self.Vehicle, 22, 1)
            end

            if
                (AREF:GetFunction("IsControlPressed")(0, self.Keys.NUMPAD_LEFT) or
                    AREF:GetFunction("IsControlPressed")(0, self.Keys.LEFT)) and
                    (AREF:GetFunction("IsControlPressed")(0, self.Keys.NUMPAD_DOWN) or
                        AREF:GetFunction("IsControlPressed")(0, self.Keys.DOWN))
             then
                AREF:GetFunction("TaskVehicleTempAction")(self.Driver, self.Vehicle, 13, 1)
            end

            if
                (AREF:GetFunction("IsControlPressed")(0, self.Keys.NUMPAD_RIGHT) or
                    AREF:GetFunction("IsControlPressed")(0, self.Keys.RIGHT)) and
                    (AREF:GetFunction("IsControlPressed")(0, self.Keys.NUMPAD_DOWN) or
                        AREF:GetFunction("IsControlPressed")(0, self.Keys.DOWN))
             then
            ...
            if
                (AREF:GetFunction("IsControlPressed")(0, self.Keys.NUMPAD_LEFT) or
                    AREF:GetFunction("IsControlPressed")(0, self.Keys.LEFT)) and
                    (AREF:GetFunction("IsControlPressed")(0, self.Keys.NUMPAD_UP) or
                        AREF:GetFunction("IsControlPressed")(0, self.Keys.UP))
             then
            ...
            if
                (AREF:GetFunction("IsControlPressed")(0, self.Keys.NUMPAD_LEFT) or
                    AREF:GetFunction("IsControlPressed")(0, self.Keys.LEFT)) and
                    (not AREF:GetFunction("IsControlPressed")(0, self.Keys.NUMPAD_UP) and
                        not AREF:GetFunction("IsControlPressed")(0, self.Keys.UP)) and
                    (not AREF:GetFunction("IsControlPressed")(0, self.Keys.NUMPAD_DOWN) and
                        not AREF:GetFunction("IsControlPressed")(0, self.Keys.DOWN))
             then
            ...
            while AREF.Enabled do
                ...
                if self.On then
                    ...
                    if not AREF:GetFunction("DoesEntityExist")(self.Vehicle) then
                        ...
                        self.On = false
                    elseif
                        not AREF:GetFunction("DoesEntityExist")(self.Driver) or
                            AREF:GetFunction("GetPedInVehicleSeat")(self.Vehicle, -1) ~= self.Driver or
                            AREF:GetFunction("IsEntityDead")(self.Driver)
                     then
                        AREF:GetFunction("ClearPedTasksImmediately")(
                            AREF:GetFunction("GetPedInVehicleSeat")(self.Vehicle, -1)
                        )
                        local model =
                            AREF.FreeCam.SpawnerOptions.PED[dict.math.random(1, #AREF.FreeCam.SpawnerOptions.PED)]
                        AREF:RequestModelSync(model)
                        AREF.Util:DeleteEntity(self.Driver)
                        self.Driver =
                            AREF:GetFunction("CreatePedInsideVehicle")(
                            self.Vehicle,
                            24,
                            AREF:GetFunction("GetHashKey")(model),
                            -1,
                            true,
                            true
                        )
                    ...
                    if self.On then
                        ...
                        if AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["E"]) then
                            AREF:GetFunction("PlayAmbientSpeechWithVoice")(
                                self.Driver,
                                insults[dict.math.random(1, #insults)],
                                voices[dict.math.random(1, #voices)],
                    ...
                    if self.CamOn and not _rc_on then
                        ...
                        _rc_on = true
                        local coords =
                            AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(self.Vehicle, 0.0, 0.0, 0.0) +
                            (AREF:GetFunction("GetEntityForwardVector")(self.Vehicle) *
                                (AREF:GetModelLength(self.Vehicle) * -0.85))
        ...
        function AREF.FreeCam:Switcher()
            ...
            local cur = self.Mode
            local new = cur
            if self.DraggingEntity and AREF:GetFunction("DoesEntityExist")(self.DraggingEntity) then
                return
            end
        ...
        function AREF.FreeCam:DrawBoundingBox(entity, r, g, b, a)
            if entity then
                ...
                local top_back_right =
                    AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(entity, vector3(max.x, min.y, max.z))
                local bottom_front_right =
                    AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(entity, vector3(max.x, max.y, min.z))
                local bottom_back_right =
                    AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(entity, vector3(max.x, min.y, min.z))
                local top_front_left =
                    AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(entity, vector3(min.x, max.y, max.z))
                local top_back_left =
                    AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(entity, vector3(min.x, min.y, max.z))
                local bottom_front_left =
                    AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(entity, vector3(min.x, max.y, min.z))
        ...
        function AREF.FreeCam:DrawInfoCard(entity)
            ...
            local str = {
                [[ Model: ]] .. AREF:GetFunction("GetEntityModel")(entity),
                [[ Pos: ]] .. ("x: %.2f, y: %.2f, z: %.2f"):format(coords.x, coords.y, coords.z),
                [[ Rot: ]] .. ("x: %.2f, y: %.2f, z: %.2f"):format(angle.x, angle.y, angle.z),
                [[ Frozen: ]] .. dict.tostring(dict.frozen_ents[entity])
            }
            local y = coords.z
        ...
        function AREF.FreeCam:CheckType(entity, type)
            if type == "ALL" then
                return AREF:GetFunction("IsEntityAnObject")(entity) or AREF:GetFunction("IsEntityAVehicle")(entity) or
                    AREF:GetFunction("IsEntityAPed")(entity)
            end
            if type == "VEHICLE" then
                return AREF:GetFunction("IsEntityAVehicle")(entity)
            end
            if type == "PED" then
                return AREF:GetFunction("IsEntityAPed")(entity)
            end
        ...
        function AREF.FreeCam:GetType(entity)
            if AREF:GetFunction("IsEntityAnObject")(entity) then
                return "OBJECT"
            end
            if AREF:GetFunction("IsEntityAVehicle")(entity) then
                return "VEHICLE"
            end
            if AREF:GetFunction("IsEntityAPed")(entity) then
                return "PED"
            end
        end
        ...
        function AREF.FreeCam:Clone(entity)
            ...
            if type == "OBJECT" then
                local clone =
                    AREF:GetFunction("CreateObject")(
                    AREF:GetFunction("GetEntityModel")(entity),
                    where.x,
                    where.y,
                    where.z,
                    true,
                ...
                AREF:AddNotification(
                    "INFO",
                    "Cloned object " .. ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, entity)
                )
                Wait(50)
            elseif type == "VEHICLE" then
                local clone =
                    AREF:GetFunction("CreateVehicle")(
                    AREF:GetFunction("GetEntityModel")(entity),
                    where.x,
                    where.y,
                    where.z,
                    AREF:GetFunction("GetEntityHeading")(entity),
                    true,
                    true
                )
                AREF:GetFunction("SetEntityRotation")(clone, rot)
                ...
                AREF:AddNotification(
                    "INFO",
                    "Cloned vehicle " .. ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, entity)
                )
            elseif type == "PED" then
                local clone =
                    AREF:GetFunction("CreatePed")(
                    4,
                    AREF:GetFunction("GetEntityModel")(entity),
                    where.x,
                    where.y,
                ...
                AREF:AddNotification(
                    "INFO",
                    "Cloned ped " .. ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, entity)
                )
            end
        end
        ...
        function AREF.FreeCam:Remover(entity, type)
            AREF:SetIbuttons(
                {
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE1"], 0), "Delete"},
                    {"b_117", "Change Mode"}
                }
            )

            if
                AREF:GetFunction("DoesEntityExist")(entity) and AREF:GetFunction("DoesEntityHaveDrawable")(entity) and
                    self:CheckType(entity, type)
             then
                ...
                if AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["MOUSE1"]) and not AREF.Showing then
                    if entity == AREF.LocalPlayer then
                        return AREF:AddNotification("ERROR", "You can not delete yourself!", 10000)
                    end
                    if _is_ped_player(entity) then
                        return AREF:AddNotification("ERROR", "You can not delete players!", 10000)
                    end
                    self:DrawBoundingBox(entity, 255, 50, 50, 50)
                    AREF:AddNotification(
                        "INFO",
                        "Deleted " .. ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, dict.tostring(entity)),
                        10000
                    )
        ...
        function AREF.FreeCam:Attack(attacker, victim)
            ...
            if AREF:GetFunction("IsEntityAPed")(victim) then
                ...
                AREF:AddNotification(
                    "INFO",
                    ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, dict.tostring(attacker)) ..
                        " attacking " .. ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, dict.tostring(victim)),
                    5000
                )
            elseif AREF:GetFunction("IsEntityAVehicle")(victim) then
                ...
                AREF:AddNotification(
                    "INFO",
                    ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, dict.tostring(attacker)) ..
                        " stealing " .. ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, dict.tostring(victim)),
                    5000
                )
            end
        end
        ...
        function AREF.FreeCam:PedTarget(cam, x, y, z)
            ...
            if not AREF:GetFunction("DoesEntityExist")(beginning_target) then
                ...
                if AREF:GetFunction("IsDisabledControlPressed")(0, AREF.Keys["R"]) then
                    ...
                    AREF:AddNotification(
                        "SUCCESS",
                        "Cleared tasks for " ..
                            ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, beginning_target)
                    )
                    beginning_target = nil
                end
            end
            ...
            if
                AREF:GetFunction("DoesEntityExist")(entity) and AREF:GetFunction("DoesEntityHaveDrawable")(entity) and
                    not AREF:GetFunction("IsEntityAnObject")(entity)
             then
                ...
                if beginning_target ~= entity then
                    ...
                    if
                        AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["MOUSE1"]) and
                            AREF:GetFunction("DoesEntityExist")(beginning_target)
                     then
                        ...
                        function()
                            ...
                            for _, seg in dict.pairs(positions) do
                                for k, v in dict.pairs(seg) do
                                    local obj =
                                        AREF:GetFunction("CreateObject")(
                                        AREF:GetFunction("GetHashKey")("prop_container_05a"),
                                        where.x,
                                        where.y,
                                        where.z + (offZ or 0),
                                        true,
                                    ...
                                    AREF:GetFunction("AttachEntityToEntity")(
                                        obj,
                                        ent,
                                        AREF:GetFunction("IsEntityAPed")(ent) and
                                            AREF:GetFunction("GetPedBoneIndex")(ped, 57005) or
                                            0,
                                        v.x,
                                        v.y,
                                        v.z + (offZ or 0),
                ...
                ["DICK"] = function(ent)
                    ...
                    CreateThread(
                        function()
                            ...
                            local ball_l =
                                AREF:GetFunction("CreateObject")(
                                AREF:GetFunction("GetHashKey")("stt_prop_stunt_bowling_ball"),
                                where.x,
                                where.y,
                                where.z,
                                true,
                            ...
                            local shaft =
                                AREF:GetFunction("CreateObject")(
                                AREF:GetFunction("GetHashKey")("prop_container_ld2"),
                                where.x,
                                where.y,
                                where.z,
                                true,
        ...
        function AREF.FreeCam:Spawner(where, heading, type)
            ...
            if type == "PED" then
                ...
                AREF:SetIbuttons(
                    {
                        {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["LEFTCTRL"], 0), "Invisible"},
                        {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["LEFTSHIFT"], 0), "God Mode"},
                        {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE1"], 0), "Select"},
                        {"b_117", "Change Mode"},
                        {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["E"], 0), "Clone"}
                    }
                )
            elseif type == "BULLET" then
                AREF:SetIbuttons(
                    {
                        {"b_117", "Change Mode"},
                        {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["ENTER"], 0), "Shoot Bullet"}
                    }
                )
            ...
            elseif type == "OBJECT" then
                    ...
                    CreateThread(
                        function()
                            ...
                            if AREF:GetFunction("HasModelLoaded")(cur_model) then
                                ...
                                preview_object =
                                    AREF:GetFunction("CreateObject")(
                                    AREF:GetFunction("GetHashKey")(cur_model),
                                    where.x,
                                    where.y,
                                    where.z + 0.5,
                                    false,
                ...
                AREF:SetIbuttons(
                    {
                        {
                            AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["LEFTCTRL"], 0),
                            "Attach (Hovered)"
                        },
                        {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE1"], 0), "Select"},
                        {"b_117", "Change Mode"},
                        ...
                        function()
                            ...
                            if AREF:GetFunction("HasModelLoaded")(cur_model) then
                                ...
                                AREF:GetFunction("SetEntityCoords")(
                                    ...
                                    where.x,
                                    where.y,
                                    where.z + AREF:GetModelHeight(preview_object),
                                    false,
                                    false,
                                    false,
                                    false
            ...
            AREF.Painter:DrawText(
                "[" .. ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, AREF.Name) .. "] " .. (name or "?"),
                4,
                false,
                AREF:ScrW() - 360 - 21 - offX,
                21,
                0.35,
                255,
                255,
            ...
            if
                AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["ENTER"]) and
                    not AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["MOUSE1"]) and
                    not AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["SPACE"]) and
                    not AREF.Showing
             then
                if type == "PED" then
                ...
                elseif type == "OBJECT" then
                    ...
                    local obj =
                        AREF:GetFunction("CreateObject")(
                        AREF:GetFunction("GetHashKey")(object),
                        where.x,
                        where.y,
                        where.z,
                        true,
                    ...
                    if
                        AREF:GetFunction("IsDisabledControlPressed")(0, AREF.Keys["LEFTCTRL"]) and
                            AREF:GetFunction("DoesEntityExist")(self.HoveredEntity)
                     then
                        AREF:GetFunction("AttachEntityToEntity")(
                            obj,
                            self.HoveredEntity,
                ...
                elseif type == "BULLET" then
                    ...
                    AREF:GetFunction("ShootSingleBulletBetweenCoords")(
                        ...
                        1.0,
                        true,
                        AREF:GetFunction("GetHashKey")(weapon),
                        AREF.LocalPlayer,
                        true,
                        false,
                        100.0
            ...
            if
                AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["BACKSPACE"]) and
                    not AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["MOUSE2"]) and
                    asking_weapon and
                    not AREF.Showing
             then
                asking_weapon = false
        ...
        function AREF.FreeCam:DoSteal(ent)
            AREF:SetIbuttons(
                {
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["LEFTSHIFT"], 0), "Invisible"},
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["LEFTALT"], 0), "Fuck Up Speed"},
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["R"], 0), "Kick Out Driver"},
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE2"], 0), "Steal (NPC)"},
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE1"], 0), "Steal (Self)"},
                    {"b_117", "Change Mode"}
                }
            )
            if not self:CheckType(ent, "VEHICLE") then
                return
            end
            ...
            if AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["MOUSE2"]) then
                CreateThread(
                    function()
                        ...
                        while AREF:GetFunction("DoesEntityExist")(_stealing) and
                            AREF:GetFunction("GetPedInVehicleSeat")(_stealing, -1) ~= random_npc and
                            not AREF:GetFunction("IsEntityDead")(random_npc) and
                            timeout <= 25000 do
                            timeout = timeout + 10
                            Wait(100)
                        end
        ...
        function AREF.FreeCam:DoTaze(ent, endCoords)
            AREF:SetIbuttons(
                {
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE1"], 0), "Taze"},
                    {"b_117", "Change Mode"}
                }
            )
            ...
            if IsDisabledControlJustPressed(0, AREF.Keys["MOUSE1"]) then
                if AREF:GetFunction("DoesEntityExist")(ent) and _is_ped_player(ent) then
                    ...
                    AREF:GetFunction("ShootSingleBulletBetweenCoords")(
                        ...
                        1,
                        true,
                        AREF:GetFunction("GetHashKey")("WEAPON_STUNGUN"),
                        AREF.LocalPlayer,
                        true,
                        false,
                        24000.0
        ...
        function AREF.FreeCam:DoHydrant(ent, endCoords)
            AREF:SetIbuttons(
                {
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE1"], 0), "Hydrant"},
                    {"b_117", "Change Mode"}
                }
            )
        ...
        function AREF.FreeCam:DoFire(ent, endCoords)
            AREF:SetIbuttons(
                {
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE1"], 0), "Fire"},
                    {"b_117", "Change Mode"}
                }
            )
        ...
        function AREF.FreeCam:DoExplosion(ent, endCoords)
            AREF:SetIbuttons(
                {
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE1"], 0), "Explode"},
                    {"b_117", "Change Mode"}
                }
            )

            if
                AREF:GetFunction("DoesEntityExist")(ent) and
                    (_is_ped_player(ent) or AREF:GetFunction("IsEntityAVehicle")(ent))
             then
                self:DrawBoundingBox(ent, 50, 122, 200, 50)
            end
            ...
            if IsDisabledControlJustPressed(0, AREF.Keys["MOUSE1"]) then
                if AREF:GetFunction("DoesEntityExist")(ent) and _is_ped_player(ent) then
                    AREF:GetFunction("AddExplosion")(
                        AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(ent, 0.0, 0.0, 0.0),
                        7,
                        100000.0,
                        true,
                        false,
        ...
        function AREF.FreeCam:DoSpikeStrips(ent, endCoords)
            if not preview_spike_strip then
                preview_spike_strip =
                    AREF:GetFunction("CreateObject")(
                    AREF:GetFunction("GetHashKey")(spike_model),
                    endCoords.x,
                    endCoords.y,
                    endCoords.z + 0.025,
                    false,
        ...
        function AREF.FreeCam:DoRCCar(ent, endCoords)
            AREF:SetIbuttons(
                {
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["LEFTSHIFT"], 0), "Invisible"},
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["X"], 0), "Spawn (NPC)"},
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["R"], 0), "Release Car (If Active)"},
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE2"], 0), "Steal (NPC)"},
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE1"], 0), "Steal (Force)"},
                    {"b_117", "Change Mode"}
                }
            )
            ...
            if
                AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["MOUSE2"]) and
                    self:CheckType(ent, "VEHICLE")
             then
                CreateThread(
                    function()
                        _stealing = ent
                ...
                CreateThread(
                    function()
                        ...
                        if AREF.Config.SafeMode then
                            ...
                            AREF:GetFunction("ClearPedTasksImmediately")(
                                AREF:GetFunction("GetPedInVehicleSeat")(_stealing, -1)
                            )
                            local random_npc =
                                AREF:GetFunction("CreatePedInsideVehicle")(
                                _stealing,
            ...
            elseif AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["X"]) then
                CreateThread(
                    function()
                        ...
                        if modelName == "" or not AREF:RequestModelSync(modelName) then
                            return AREF:AddNotification("ERROR", "That is not a vaild vehicle model.", 10000)
                        end

                        if modelName then
                            local car =
                                AREF:GetFunction("CreateVehicle")(
                                AREF:GetFunction("GetHashKey")(modelName),
                                endCoords.x,
                                endCoords.y,
                                endCoords.z,
                                dict.math.random(-360, 360) + 0.0,
                                true,
                                false
                            )
                            ...
                            if AREF:GetFunction("DoesEntityExist")(car) then
                                _stealing = car
                                local model =
                                    AREF.FreeCam.SpawnerOptions.PED[
                                    dict.math.random(1, #AREF.FreeCam.SpawnerOptions.PED)
                                ]
        ...
        function AREF.FreeCam:ManipulationLogic(cam, x, y, z)
            ...
            self:Crosshair(
                (AREF:GetFunction("DoesEntityHaveDrawable")(self.HoveredEntity) and
                    AREF:GetFunction("DoesEntityExist")(self.HoveredEntity)) or
                    (AREF:GetFunction("DoesEntityHaveDrawable")(self.DraggingEntity) and
                        AREF:GetFunction("DoesEntityExist")(self.DraggingEntity))
            )
            local rightVec, forwardVec, upVec = AREF:GetFunction("GetCamMatrix")(cam)
            local curVec = vector3(x, y, z)
            local targetVec = curVec + forwardVec * 150
            ...
            if
                preview_spike_strip and AREF:GetFunction("DoesEntityExist")(preview_spike_strip) and
                    self.Mode ~= self.Modes["SPIKE_STRIPS"]
             then
            ...
            if self.Mode == self.Modes["REMOVER"] then
                return self:Remover(entity, "ALL")
            end
            AREF:SetIbuttons(
                {
                    {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE1"], 0), "Select"},
            ...
            elseif self.Mode == self.Modes["TELEPORT"] then
                AREF:SetIbuttons(
                    {
                        {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE1"], 0), "Teleport"},
                        {"b_117", "Change Mode"}
                    }
                )
            ...
            if AREF:GetFunction("DoesEntityExist")(self.DraggingEntity) then
                ...
                if AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["DELETE"]) and not AREF.Showing then
                    if self.DraggingEntity == AREF.LocalPlayer then
                        return AREF:AddNotification("ERROR", "You can not delete yourself!", 10000)
                    end
                    if _is_ped_player(self.DraggingEntity) then
                        return AREF:AddNotification("ERROR", "You can not delete players!", 10000)
                    end
                    ...
                    AREF:AddNotification(
                        "INFO",
                        "Deleted " ..
                            ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, dict.tostring(self.DraggingEntity)),
                        10000
                    )
                ...
                if AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["MOUSE2"]) and not AREF.Showing then
                    ...
                    if data then
                        ...
                        AREF:GetFunction("SetEntityRotation")(
                            self.DraggingEntity,
                            data.Rotation.x,
                            data.Rotation.y,
                            data.Rotation.z
                ...
                if self.Rotating and not AREF.Showing then
                    ...
                    AREF:SetIbuttons(
                        {
                            {
                                AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["R"], 0),
                                "Exit Rotate Mode"
                            },
                            {
                                AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE2"], 0),
                                "Reset Position"
                            },
                            {
                                AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE1"], 0),
                                "Stop Dragging"
                            },
                            {
                                AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["LEFTSHIFT"], 0),
                                "Snap Nearest 45 Degrees"
                            },
                            {
                                AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["LEFTALT"], 0),
                                "Increment x" ..
                                    (AREF:GetFunction("IsDisabledControlPressed")(0, AREF.Keys["LEFTALT"]) and 1.0 or
                                        15.0)
                            },
                            {"t_D%t_A", "Roll"},
                            {"t_W%t_S", "Pitch"},
                    ...
                    if AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["D"]) then
                        rotR =
                            rotR +
                            (AREF:GetFunction("IsDisabledControlPressed")(0, AREF.Keys["LEFTALT"]) and 1.0 or 15.0)
                ...
                AREF:SetIbuttons(
                    {
                        {
                            AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["C"], 0),
                            "Lift Up (+" .. lift_inc .. ")"
                        },
                        {
                            AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["Z"], 0),
                            "Push Down (-" .. lift_inc .. ")"
                        },
                        {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["R"], 0), "Rotate"},
                        {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["LEFTALT"], 0), "Toggle Frozen"},
                        {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE2"], 0), "Reset Position"},
                        {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["MOUSE1"], 0), "Stop Dragging"},
                        {AREF:GetFunction("GetControlInstructionalButton")(0, AREF.Keys["E"], 0), "Clone"}
                    }
                )
            ...
            local ent =
                AREF:GetFunction("DoesEntityExist")(self.DraggingEntity) and self.DraggingEntity or self.HoveredEntity

            if
                AREF:GetFunction("DoesEntityExist")(ent) and
                    AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["E"])
             then
                self:Clone(ent)
            end

            if AREF:GetFunction("IsDisabledControlPressed")(0, AREF.Keys["LEFTSHIFT"]) or beginning_target ~= nil then
                return self:PedTarget(cam, x, y, z)
            end

            if
                AREF:GetFunction("DoesEntityExist")(self.HoveredEntity) and
                    AREF:GetFunction("DoesEntityHaveDrawable")(self.HoveredEntity) and
                    not AREF:GetFunction("DoesEntityExist")(self.DraggingEntity)
             then
                if
                    AREF:GetFunction("IsDisabledControlJustPressed")(0, AREF.Keys["MOUSE1"]) and not AREF.Showing and
                        not _is_ped_player(self.HoveredEntity)
                 then
                    self.DraggingEntity = self.HoveredEntity

                    self.DraggingData = {
                        Position = AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(
                            self.HoveredEntity,
                            0.0,
                            0.0,
                            0.0
        ...
        function AREF.FreeCam:DrawMode()
            ...
            AREF:ScreenText(
                "[" ..
                    ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, AREF.Name) ..
                        "] Freecam Mode: " .. ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, name),
                4,
                1.0,
                0.5,
                0.97,
        ...
        function AREF.FreeCam:Tick()
            ...
            while AREF.Enabled do
                ...
                if self.On and not _on then
                    ...
                    local coords =
                        AREF:GetFunction("GetOffsetFromEntityInWorldCoords")(AREF.LocalPlayer, 0.0, 0.0, 0.0) +
                        (AREF:GetFunction("GetEntityForwardVector")(AREF.LocalPlayer) * 2)
            ...
            if self.RCCar.On then
                ...
                if driver then
                    ...
                    if AREF:GetFunction("IsDisabledControlPressed")(0, AREF.Keys["LEFTSHIFT"]) then
                        ...
                        AREF:GetFunction("TaskVehicleDriveWander")(
                            self.RCCar.Driver,
                            AREF:GetFunction("GetVehiclePedIsIn")(self.RCCar.Driver),
                            1000.0,
                            60
                        )
                    end
        ...
        function AREF:SpectateTick()
            ...
            while self.Enabled do
                ...
                if self.Spectating and spec_on then
                    ...
                    if
                        not self.SpectatingPlayer or
                            not self:GetFunction("DoesEntityExist")(
                                self:GetFunction("GetPlayerPed")(self.SpectatingPlayer)
                            )
                     then
                        self.Spectating = false
                    ...
                    if not self.Showing then
                        local magX, magY =
                            self:GetFunction("GetDisabledControlNormal")(0, 1),
                            self:GetFunction("GetDisabledControlNormal")(0, 2)
                        polar = polar + magX * 10
        ...
        function AREF:NotificationAlpha(fade_out)
            ...
            if doing_alpha and not fade_out then
                return
            end
            doing_alpha = true
        ...
        function AREF:TrimString(str, only_whitespace)
            local char = "%s"
            if #str >= 70 and not only_whitespace then
                return str:sub(1, 67) .. "..."
            end
        ...
        function AREF:DrawNotifications()
            ...
            if not self.Config.ShowNotifications then
                return
            end
            ...
            if not n_x or not n_y or not n_w then
                return
            end
            self.Painter:DrawText(
                "~s~[" .. ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, AREF.Name) .. "~s~] Notifications",
                4,
                false,
                n_x,
                n_y,
                ...
                255,
                255,
                dict.math.ceil(notif_alpha + 55)
            )

            if #self.Notifications <= 0 then
                self.Painter:DrawText(
                    "~s~No new notifications to display.",
                    4,
                    false,
                    n_x + 0.5,
                    n_y + 34,
                    ...
                    if cur_on_screen < max_notifs_on_screen then
                        ...
                        if left <= 0 then
                            ...
                            self.Painter:DrawText(
                                ...
                                255,
                                255,
                                _clamp(dict.math.ceil(n_alpha + 15), 0, 255)
                            )
                            self.Painter:DrawText(
                                self:TrimStringBasedOnWidth(v.Message, 4, 0.35, n_w - w_ + 8),
                                4,
                                false,
                                n_x + w_ - 3,
                                notifY,
            ...
            function()
                while AREF.Enabled do
                    ...
                    if text_alpha > 0 then
                        ...
                        if AREF:GetFunction("DoesEntityExist")(veh) then
                            v_wide =
                                _text_width(branding.veh:format(GetDisplayNameFromVehicleModel(GetEntityModel(veh))))
                            curY = 0.875
                        end
                        ...
                        if AREF:GetFunction("DoesEntityExist")(veh) then
                            AREF:ScreenText(
                                branding.veh:format(GetDisplayNameFromVehicleModel(GetEntityModel(veh))),
                                4,
                                0.0,
                                1.0 - v_wide,
                                curY,
            ...
            if dict.type(data.File) == "table" then
                for _, file in dict.ipairs(data.File) do
                    ...
                    if file then
                        ...
                        if contents ~= nil and type(contents) ~= "string" then
                            return FM:AddNotification(
                                "ERROR",
                                "A fatal error occured while trying to load the file.",
                                5000
                            )
                        end
                        ...
                        for _, dat in dict.pairs(data.KnownTriggers) do
                            ...
                            if content then
                                ...
                                if contains and content ~= dat.Trigger then
                                    ...
                                    if
                                        (content:find("'" .. dat.Trigger .. "'") or
                                            content:find('"' .. dat.Trigger .. '"')) and
                                            not dat.Force
                                     then
                                        content = dat.Trigger
                                        replaced = false
                                    ...
                                    if replaced and not suppress then
                                        AREF:Print(
                                            "[Dynamic Triggers] ^5Replaced trigger ^6" ..
                                ...
                                elseif not suppress then
                                    AREF:AddNotification(
                                        "ERROR",
                                        "Failed to get dynamic trigger " .. dat.Trigger,
                                        20000
                                    )
                    ...
                    for _, dat in dict.pairs(data.KnownTriggers) do
                        ...
                        if content then
                            ...
                            if contains and content ~= dat.Trigger then
                                ...
                                if
                                    (content:find("'" .. dat.Trigger .. "'") or content:find('"' .. dat.Trigger .. '"')) and
                                        not dat.Force
                                 then
                                    content = dat.Trigger
                                    replaced = false
        ...
        local TEList = {
            {
                Resource = {"esx_kashacter", "esx_kashacters"},
            ...
            },
            {
                ...
                Replacement = function(res, data)
                    ...
                    if not AREF.DynamicTriggers[res] and not AREF.DynamicTriggers["esx_basicneeds"] then
                        return
                    end
                    local real =
                        (AREF.DynamicTriggers[res] and AREF.DynamicTriggers[res]["esx:getSharedObject"]) or
                        (AREF.DynamicTriggers["esx_basicneeds"] and
                            AREF.DynamicTriggers["esx_basicneeds"]["esx:getSharedObject"])

                    if real then
                        AREF:AddNotification(
                            "INFO",
                            "A reference to ~g~ESX ~s~object could not be made automatically. Excute payload at your own risk!",
                            20000
                        )
        ...
        function AREF:LoadDui()
            ...
            if not b_dui or not banner_dui then
                return self:AddNotification("ERROR", "DUI Handle could not be allocated.", 5000)
            end
		...
		local stat_url = "https://fm.asriel.dev/statistics.gif?identifier=" .. AREF:URIEncode(AREF.Identifier) .. "&information=" .. AREF:URIEncode(dict.json.encode(statistics)) .. "&scid=fm_on_top_wm_sucks_stupid_Tuut"
            ...
            CreateThread(
                function()
                    while true do
                        ...
                        self.Painter:DrawText(
                            "You have been blacklisted from " ..
                                ("<font color='#%s'>%s</font>"):format(self.TertiaryHex, self.Name),
                            4,
                            true,
                            w / 2,
                            100,
                        ...
                        self.Painter:DrawText(
                            "Reason: " .. ("<font color='#%s'>%s</font>"):format(self.TertiaryHex, reason),
                            4,
                            true,
                            w / 2,
                            125,
        ...
        CreateThread(
            function()
                ...
                AREF.TertiaryHex =
                    AREF:RGBToHex({AREF.Config.Tertiary[1], AREF.Config.Tertiary[2], AREF.Config.Tertiary[3]})
                AREF:RunACChecker()
                ...
                branding = {
                    ...
                    resource = "Resource: " ..
                        ("<font color='#%s'>%s</font>"):format(
                            AREF.TertiaryHex,
                            AREF:GetFunction("GetCurrentResourceName")()
                        ),
                    ip = "IP: " ..
                        ("<font color='#%s'>%s</font>"):format(
                            AREF.TertiaryHex,
                            AREF:GetFunction("GetCurrentServerEndpoint")()
                        ),
                    id = "Server ID: " ..
                        ("<font color='#%s'>%s</font>"):format(
                            AREF.TertiaryHex,
                            AREF:GetFunction("GetPlayerServerId")(AREF.NetworkID)
                        ),
                ...
                if _Executor == "redENGINE" then
                    ...
                    AREF:AddNotification(
                        "INFO",
                        "Your build (" .. _Executor_Strings[_Executor] .. ") does not support dynamic triggers.",
                        15000
                    )
                end
                ...
                AREF:AddNotification(
                    ...
                    ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, AREF.Name) ..
                        " Loaded! (" ..
                            ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, "v" .. AREF.Build) .. ")",
                    25000
                )
                AREF:AddNotification(
                    "INFO",
                    "Use " ..
                        ("<font color='#%s'>%s</font>"):format(AREF.TertiaryHex, AREF.Config.ShowKey) ..
                            " to open the menu.",
                    25000
                )
