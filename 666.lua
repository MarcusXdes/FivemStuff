                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'foriv#0002 Desudo https://discord.gg/hkZgrv3',
                                43161337
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"Desudo; foriv#0002")
        end
    ...
    function()
        while true do
			...
			if chatspam then
                ...
                TriggerServerEvent('_chat:messageEntered', 'Nacrox#9521', {0, 0x99, 255}, 'Nacrox Menu <3 discord.gg/MRnVqVR')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Nacrox Baby <3 Nacrox#9521 https://discord.gg/MRnVqVR")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Nacrox Baby <3 Nacrox#9521 https://discord.gg/MRnVqVR")
					end
				end
				...
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "The best menu in fivem!?,https://discord.gg/MRnVqVR Nacrox#9521 ", 10000000)
				end
			end
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "6666")
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                drawNotification("~h~~b~6666 ~s~GENG")
                if Plane.MenuButton    ("∑~b~Self Menu~s~", "SelfMenu") then
                elseif Plane.MenuButton("∑~b~Teleport Menu", "TeleportMenu") then
				elseif Plane.MenuButton("∑~b~AI Menu", "AI") then
                elseif Plane.MenuButton("∑~b~Online~s~ Players", "OnlinePlayersMenu") then
                elseif Plane.MenuButton("∑~b~Weapon Menu~s~", "WeaponMenu") then
                elseif Plane.MenuButton("∑~b~Vehicle Menu~s~", "VehMenu") then
                elseif Plane.MenuButton("∑~b~Malicious Hacks~s~", "MaliciousMenu") then
                elseif Plane.MenuButton("∑~b~Trolling Options~s~", "TrollMenu") then
				elseif Plane.MenuButton("∑~b~Models", "Models~s~") then
                elseif Plane.MenuButton("∑~b~ESX~s~ Options~s~", "ESXMenu") then
                elseif Plane.MenuButton("∑~b~VRP~s~ Options~s~", "VRPMenu") then
				elseif Plane.MenuButton("∑~b~Credits~s~", "Credits") then
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "6666 Menu https://discord.gg/pAExtdR", "6536955669")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "6666 Menu https://discord.gg/pAExtdR", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "6666 Menu https://discord.gg/pAExtdR", "696G623691")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "6666 Menu https://discord.gg/pAExtdR", "69693553S9")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "6666 Menu https://discord.gg/pAExtdR", "6969696969")
                end
			...
			if Plane.Button("~b~~h~Clown") then
			...
			elseif Plane.Button("~b~~h~Lion") then
			...
			elseif Plane.Button("~b~~h~Swat") then
			...
			elseif Plane.Button("~b~~h~Stripper") then
			local model = "s_f_y_stripper_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif Plane.Button("~b~~h~Cop") then
			local model = "s_m_y_cop_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif Plane.Button("~b~~h~Chimp") then
			local model = "a_c_chimp"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif Plane.Button("~b~~h~Alien") then
			...
			elseif Plane.Button("~b~~h~Adult") then
			local model = "a_m_o_acult_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif Plane.Button("~b~~h~Pongo") then
			local model = "u_m_y_pogo_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif Plane.Button("~b~~h~Babyd") then
			local model = "u_m_y_babyd"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif Plane.Button("~b~~h~Fivem skin") then
    ...
    if not DoesEntityExist(veh) then
        drawNotification(
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
				...
				elseif Plane.Button(" ~y~~h~foriv#0002 - Developer") then
