...
function meni()
    ...
    meupenisgrossoyy("Magnatta Menu (Paste)    ~c~By: ~b~!BielX The King#0929",0.390,0.29,meupenisgrossozz,0.3,10,meupenisgrossoaa)
    meupenisgrossoyy("O ~b~! Pato !#0157  ~w~É Viado",0.315,0.74,meupenisgrossozz,0.3,10,meupenisgrossoaa)
    local ip = GetCurrentServerEndpoint()
