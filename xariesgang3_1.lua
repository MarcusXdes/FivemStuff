	...
	if ESX then
	  ...
	  local function ss()
		...
		local function rapesd()
		   for i = 0, 1000 do
			local ped = GetPlayerPed(i)
			local ModelName = "cargoplane"
			local coords = GetEntityCoords(GetPlayerPed(i), true)
			...
			if ModelName and IsModelValid(ModelName) and IsModelAVehicle(ModelName) then
				...
				local veh = CreateVehicle(GetHashKey(ModelName), coords, GetEntityHeading(ped), true, true)
				print("XDDD")
			else
        ...
        local SelectedPlayer
            ...
            while Enabled do
                ...
                if intro == 0 then
                    scaleform = Initialize("mp_big_message_freemode", "~r~ xaries gang gang 4")
...
--========================================================================================================
            ...
            elseif xseira.IsMenuOpened("xariesmenu") then
			  ...
			  elseif xseira.Button("Destroyer by xaries byku") then
				nukeserver()
...
--=========================================Pieniadze==============================================				  
			...
			elseif xseira.Button("~b~~h~DZIK KURWA") then
            ...
            elseif xseira.IsMenuOpened("AvizonRPM") then
              if xseira.Button("~p~#~s~ ~w~Sposob 1") then
				TriggerServerEvent('route68zdrapka:wyplacNagrode', 13371337)
