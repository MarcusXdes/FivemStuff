...
function JokerMenu.CreateMenu(id, title)
	...
	Citizen.CreateThread(
		function()
			while true do
				...
				menus[id].titleBackgroundColor = {r = 208, g = 27, b = 245, a = 225}
				menus[id].menuFocusBackgroundColor = {r = 235, g = 30, b = 30, a = 255}
			end
		end)
	...
	menus[id].menuBackgroundColor = {r = 255, g = 255, b = 255, a = 100}
...
function JokerMenu.CreateSubMenu(id, parent, subTitle)
	if menus[parent] then
		JokerMenu.CreateMenu(id, menus[parent].title)
...
function JokerMenu.CurrentMenu()
	return currentMenu
end

function JokerMenu.OpenMenu(id)
	if id and menus[id] then
...
function JokerMenu.IsMenuOpened(id)
	return isMenuVisible(id)
end

function JokerMenu.IsAnyMenuOpened()
...
function JokerMenu.IsMenuAboutToBeClosed()
	if menus[currentMenu] then
...
function JokerMenu.Button(text, subText)
...
function JokerMenu.MenuButton(text, id)
	if menus[id] then
		if JokerMenu.Button(text) then
			setMenuVisible(currentMenu, false)
...
function JokerMenu.CheckBox(text, bool, callback)
	local checked = "~r~~h~Off"
	if bool then
		checked = "~g~~h~On"
	end

	if JokerMenu.Button(text, checked) then
		bool = not bool
...
function JokerMenu.ComboBox(text, items, currentIndex, selectedIndex, callback)
	...
	if JokerMenu.Button(text, selectedItem) then
...
function JokerMenu.SetMenuWidth(id, width)
	setMenuProperty(id, "width", width)
end

function JokerMenu.SetMenuX(id, x)
	setMenuProperty(id, "x", x)
end

function JokerMenu.SetMenuY(id, y)
	setMenuProperty(id, "y", y)
end

function JokerMenu.SetMenuMaxOptionCountOnScreen(id, count)
	setMenuProperty(id, "maxOptionCount", count)
end

function JokerMenu.SetTitleColor(id, r, g, b, a)
	setMenuProperty(id, "titleColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleColor.a})
end

function JokerMenu.SetTitleBackgroundColor(id, r, g, b, a)
	setMenuProperty(
		id,
...
function JokerMenu.SetTitleBackgroundSprite(id, textureDict, textureName)
	setMenuProperty(id, "titleBackgroundSprite", {dict = textureDict, name = textureName})
end

function JokerMenu.SetSubTitle(id, text)
	setMenuProperty(id, "subTitle", string.upper(text))
end

function JokerMenu.SetMenuBackgroundColor(id, r, g, b, a)
	setMenuProperty(
		id,
		"menuBackgroundColor",
...
function JokerMenu.SetMenuTextColor(id, r, g, b, a)
	setMenuProperty(id, "menuTextColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuTextColor.a})
end

function JokerMenu.SetMenuSubTextColor(id, r, g, b, a)
	setMenuProperty(id, "menuSubTextColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuSubTextColor.a})
end

function JokerMenu.SetMenuFocusColor(id, r, g, b, a)
	setMenuProperty(id, "menuFocusColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuFocusColor.a})
end

function JokerMenu.SetMenuButtonPressedSound(id, name, set)
...
Citizen.CreateThread(
	function()
		...
		JokerMenu.CreateMenu("MainMenu", "<FONT COLOR='#1453ff'>Jokerr  ")
		JokerMenu.SetSubTitle("MainMenu", "<FONT COLOR='#fb00ff'> ∑ MASZ MOJE KARTY ?! †")
		JokerMenu.CreateSubMenu("SelfMenu", "MainMenu", "PlayerMenu")
		JokerMenu.CreateSubMenu("World", "MainMenu", "World")
		JokerMenu.CreateSubMenu("Fuck", "MainMenu", "Fuck")
		JokerMenu.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
		JokerMenu.CreateSubMenu("ServerMenu", "MainMenu", "LUA Execution")
		JokerMenu.CreateSubMenu("TworcyMenu", "MainMenu", "tworcy")
		JokerMenu.CreateSubMenu("TeleportMenu", "MainMenu", "TeleportRawQ Menu")
		JokerMenu.CreateSubMenu('OnlinePlayerMenu', 'MainMenu', 'Online Player Menu')
		JokerMenu.CreateSubMenu('PlayerOptionsMenu', 'OnlinePlayerMenu', 'Player Options')
		JokerMenu.CreateSubMenu('SingleWepPlayer', 'OnlinePlayerMenu', 'Single Weapon Menu')
		JokerMenu.CreateSubMenu("WepMenu", "MainMenu", "Weapon Menu")
		JokerMenu.CreateSubMenu("SingleWepMenu", "WepMenu", "Single Weapon Menu")
		JokerMenu.CreateSubMenu("ESXBoss", "ServerMenu", "ESX Boss Menus")
		JokerMenu.CreateSubMenu("ESXMoney", "ServerMenu", "Money Options")
		JokerMenu.CreateSubMenu("ESXMisc", "ServerMenu", "ESX Misc Options")
		JokerMenu.CreateSubMenu("ESXDrugs", "ServerMenu", "ESX Drugs")
		JokerMenu.CreateSubMenu("MiscServerOptions", "ServerMenu", "Misc Server Options")
		JokerMenu.CreateSubMenu("RecrutarPlayers", "ServerMenu", "Recrutar Players")
		JokerMenu.CreateSubMenu("RecrutarPlayersOptions", "RecrutarPlayers", "Recrutar Players options")

		local SelectedPlayer

		while Enabled do
			if JokerMenu.IsMenuOpened("MainMenu") then
			    drawNotification("<FONT COLOR='#1453ff'> EZZZ [sokin#6666] †") 
				drawNotification("<FONT COLOR='#1453ff'>∑ sokin#6666 ~n~ ~s~https://discord.gg/6YFZhqg! ~n~<FONT COLOR='#1453ff'>PSSSSRRT!")
				   if JokerMenu.MenuButton("~h~<FONT COLOR='#1453ff'>> ~s~<FONT COLOR='#fb00ff'> Player <FONT COLOR='#1453ff'>Menu                                     ~h~  <FONT COLOR='#1453ff'>      ", "SelfMenu") then
				elseif JokerMenu.MenuButton("~h~<FONT COLOR='#1453ff'>> ~s~<FONT COLOR='#fb00ff'> Online <FONT COLOR='#1453ff'>Players                               ~h~    <FONT COLOR='#1453ff5'>       ", "OnlinePlayerMenu") then
				elseif JokerMenu.MenuButton("~h~<FONT COLOR='#1453ff'>> ~s~<FONT COLOR='#fb00ff'> World <FONT COLOR='#1453ff'>Menu                                  ~h~    <FONT COLOR='#1453ff'>        ", "World") then
				elseif JokerMenu.MenuButton("~h~<FONT COLOR='#1453ff'>> ~s~<FONT COLOR='#fb00ff'> Teleporte <FONT COLOR='#1453ff'>Menu                             ~h~     <FONT COLOR='#1453ff'>      ", "TeleportMenu") then
				elseif JokerMenu.MenuButton("~h~<FONT COLOR='#1453ff'>> ~s~<FONT COLOR='#fb00ff'> Vehicles <FONT COLOR='#1453ff'>Menu                              ~h~    <FONT COLOR='#1453ff'>        ", "VehMenu") then
				elseif JokerMenu.MenuButton("~h~<FONT COLOR='#1453ff'>> ~s~<FONT COLOR='#fb00ff'> Weapons <FONT COLOR='#1453ff'>Menu                               ~h~   <FONT COLOR='#1453ff'>      ", "WepMenu") then
				elseif JokerMenu.MenuButton("~h~<FONT COLOR='#1453ff'>> ~s~<FONT COLOR='#fb00ff'> Fuck <FONT COLOR='#1453ff'>Server                               ~h~    <FONT COLOR='#1453ff'>           ", "Fuck") then
				elseif JokerMenu.MenuButton("~h~<FONT COLOR='#ffffff'> ∑ MONEY OPTION!                                          ~s~~h~<FONT COLOR='#1453ff'>", "ServerMenu") then
				elseif JokerMenu.Button(" <FONT COLOR='#ff5252'>                   WYLACZ MENU!! ") then
					Enabled = false
				end
				
				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("bizness") then

				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("SelfMenu") then
				if
					JokerMenu.CheckBox(
						"~h~~g~God ~h~~r~Mode",
						Godmode,
				 ...
				 then
				elseif JokerMenu.Button("~h~~r~Suicide") then
					SetEntityHealth(PlayerPedId(), 0)
				elseif JokerMenu.Button("~s~Revive ~h~~g~ESX") then
					TriggerEvent("esx_ambulancejob:revive")
				    TriggerEvent('ambulancier:selfRespawn')
				elseif JokerMenu.Button("~h~~g~Heal") then
					SetEntityHealth(PlayerPedId(), 200)
				elseif JokerMenu.Button("~h~~b~Armour") then
					SetPedArmour(PlayerPedId(), 200)
				elseif JokerMenu.Button("~w~~h~Set hunger to ~h~~g~100%") then
					TriggerEvent("esx_status:set", "hunger", 1000000)
				elseif JokerMenu.Button("~w~~h~Set thirst to ~h~~g~100%") then
					TriggerEvent("esx_status:set", "thirst", 1000000)
				elseif JokerMenu.Button("~h~~b~Open Menu Jail ~g~ESX") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
				elseif JokerMenu.Button("~h~~b~Unjail") then
					TriggerServerEvent('esx_jailer:unjailTime', -1)
					TriggerServerEvent('JailUpdate', 0)
					TriggerEvent('UnJP')
				elseif
				JokerMenu.CheckBox("~h~Infinite Stamina",InfStamina,function(enabled)InfStamina = enabled end)
				then
				elseif
				JokerMenu.CheckBox(
					"~h~Super Jump",
				...
				then
				elseif
				JokerMenu.CheckBox("~h~Fast Run ~r~NEW",fastrun,function(enabled)fastrun = enabled end)
			 	then
				elseif
				JokerMenu.CheckBox(
					"~h~Invisible",
				...
				then
				elseif
				JokerMenu.CheckBox("~h~NoClip",Noclip,function(enabled)Noclip = enabled end)
				then	
				end

		JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("TeleportMenu") then
				if JokerMenu.Button("~h~Teleport ~h~~g~Waypoint") then
				TeleportToWaypoint()
			 elseif JokerMenu.Button("~h~Teleport ~h~~g~Vehicle ~r~FIX ") then
		...
		JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("World") then
			if
				JokerMenu.CheckBox(
				"~h~ESP",
				esp,
		...
		JokerMenu.Display()
		elseif JokerMenu.IsMenuOpened("Fuck") then
		if JokerMenu.Button('~h~~p~#~s~ Spawn Peds', 'SpawnPeds') then
		end
		if JokerMenu.Button("~h~~r~Give All Weapons ~s~~h~Players") then
					for ids = 0, 128 do
				...
				elseif JokerMenu.Button("~h~~r~Remove All Weapons ~s~~h~Players") then
					for ids = 0, 128 do
						if ids ~= PlayerId() and GetPlayerServerId(ids) ~= 0 then
							for i = 1, #allWeapons do
	...
	then
				...
				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("WepMenu") then
				if JokerMenu.MenuButton("~h~Specific Weapon", "SingleWepMenu") then
				elseif JokerMenu.Button("~h~~g~Give ~s~~h~All Weapons") then
					for i = 1, #allWeapons do
						GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
					end
				elseif JokerMenu.Button("~h~~r~Remove ~s~~h~All Weapons") then
					for i = 1, #allWeapons do
						RemoveAllPedWeapons(PlayerPedId(), true)
					end
				elseif JokerMenu.Button("~h~~b~Give Ammo") then
					for i = 1, #allWeapons do
			...
			elseif
				...
				elseif
				 ...
				 then
				 elseif
					 JokerMenu.CheckBox("~h~Vehicle Gun",VehicleGun,
				 	 function(enabled)VehicleGun = enabled end) 
			 	then
			 	elseif
					 JokerMenu.CheckBox("~h~Delete Gun",DeleteGun,
				 	 function(enabled)DeleteGun = enabled end) 
			 	then
				end

				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("SingleWepMenu") then
				for i = 1, #allWeapons do
					if JokerMenu.Button(allWeapons[i]) then
						GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
					end
				end

				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("VehMenu") then
				if JokerMenu.Button("~h~~g~Spawn Vehicle") then
				...
				elseif JokerMenu.Button("~h~Repair Vehicle") then
					SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
					SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
					SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
					SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
					Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
				elseif JokerMenu.Button("~h~Max Tuning") then
					MaxOut(GetVehiclePedIsUsing(PlayerPedId())
)				elseif JokerMenu.Button("~h~Max mechanics ~r~new") then
				...
				then
			    elseif JokerMenu.Button("~h~~b~Change License Plate~r~ NEW") then
					local playerPed = GetPlayerPed(-1)
				...
				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("ServerMenu") then
				if JokerMenu.MenuButton("~s~Menu ~h~~r~RECRUIT PLAYERS", "RecrutarPlayers") then
				elseif JokerMenu.MenuButton("~s~Menu ~b~~h~BOSS", "ESXBoss") then
				elseif JokerMenu.MenuButton("~s~Menu ~g~~h~MONEY", "ESXMoney") then
				elseif JokerMenu.MenuButton("~s~Menu ~p~~h~DRUGS", "ESXDrugs") then
				elseif JokerMenu.MenuButton("~s~Menu ~o~~h~OTHERS", "ESXMisc") then
				end

				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("ESXBoss") then
				if JokerMenu.Button("~c~~h~Mechanic~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'mecano', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif JokerMenu.Button("~b~~h~Police~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'police', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif JokerMenu.Button("~r~~h~Ambulance~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'ambulance', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif JokerMenu.Button("~y~~h~Taxi~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'taxi', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif JokerMenu.Button("~g~~h~Real Estate~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'realestateagent', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif JokerMenu.Button("~p~~h~Gang~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'gang', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif JokerMenu.Button("~o~~h~Car Dealer~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'cardealer', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif JokerMenu.Button("~y~~h~Banker~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'banker', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif JokerMenu.Button("~c~~h~Mafia~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'mafia', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif JokerMenu.Button("~g~~h~ESX ~y~Custom Boss Menu") then
				...
				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("ESXMoney") then
				if JokerMenu.Button("~h~~r~-»~r~~h~ BEST MONEY «-") then
			...
			elseif JokerMenu.Button("~g~~h~MONEY, CAUTION ~s~1") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
				TriggerServerEvent("esx_jobs:caution", "give_back", result)
				end
			elseif JokerMenu.Button("~g~~h~MONEY, TRUCKER ~s~2") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif JokerMenu.Button("~g~~h~MONEY, ADMIN BANK ~s~3") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveBank', result)
				end
			elseif JokerMenu.Button("~g~~h~MONEY, ADMIN ~s~4") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveCash', result)
				end
			elseif JokerMenu.Button("~g~~h~MONEY, GOPOSTAL ~s~5") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent("esx_gopostaljob:pay", result)
				end
			elseif JokerMenu.Button("~g~~h~MONEY, BANKSEC ~s~6") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent("esx_banksecurity:pay", result)
				end
			elseif JokerMenu.Button("~g~~h~MONEY, SLOT ~s~7") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent("esx_slotmachine:sv:2", result)
				end
			elseif JokerMenu.Button("~g~~h~MONEY, LSC ~s~8") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100)
				if result then
					TriggerServerEvent("lscustoms:payGarage", {costs = -result})
				end		
			elseif JokerMenu.Button("~g~~h~MONEY, SLOT ~s~9") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100)
				if result then
				TriggerServerEvent("vrp_slotmachine:server:2", result)
				end
			elseif JokerMenu.Button("~g~~h~MONEY, BRUDNA ~s~10") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
				end
			elseif JokerMenu.Button("~g~~h~MONEY, TRUCKERJOB ~s~11") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif JokerMenu.Button("~g~~h~MONEY, DOSTAWA ~s~12") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent('delivery:success', result)
				end
			elseif JokerMenu.Button("~g~~h~MONEY, TAXI(WYBOR) ~s~13") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent ('taxi:success', result)
				end
			elseif JokerMenu.Button("~g~~h~MONEY, TAXI ~s~14") then
					...
					TriggerServerEvent('esx_taxijob:success')
					TriggerServerEvent('esx_taxijob:success')
			elseif JokerMenu.Button("~g~~h~MONEY, GARBAGEJOB ~s~15") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100000000)
				if result then
					TriggerServerEvent("esx_garbagejob:pay", result)
				end	
			elseif JokerMenu.Button("~g~~h~MONEY, WYPLATA ~s~16") then
				...
				TriggerServerEvent('paycheck:salary')
				TriggerServerEvent('paycheck:salary')
			elseif JokerMenu.Button("~s~Bank ~r~~h~Deposit") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100)
				if result then
				TriggerServerEvent("bank:deposit", result)
				end
			elseif JokerMenu.Button("~s~Bank ~r~~h~Withdraw ") then
				local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100)
				if result then
			...
			JokerMenu.Display()
				elseif JokerMenu.IsMenuOpened("ESXMisc") then
				    if JokerMenu.Button("~g~~h~ESX ~r~SEND EVERYONE A BILL") then
				...
				elseif JokerMenu.Button("~g~~h~ESX ~w~Get all licenses Drive") then
				...
				elseif JokerMenu.Button("~h~Send Discord Message") then
				...
				elseif JokerMenu.Button("~h~Send Police Car Advert") then
				TriggerServerEvent("esx:enterpolicecar",GetDisplayNameFromVehicleModel(GetEntityModel(GetVehiclePedIsIn(GetPlayerPed(-1), 0))))
				end
				

				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("MiscServerOptions") then
				if JokerMenu.Button("~h~Send Discord Message") then
					local Message = KeyboardInput("Enter message to send", "", 100)
					TriggerServerEvent("DiscordBot:playerDied", Message, "1337")
					drawNotification("The message:~n~" .. Message .. "~n~Has been ~g~sent!")
				elseif JokerMenu.Button("~h~Send Police Car Advert") then
				...
				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("VRPOptions") then
				if JokerMenu.Button("~r~~h~VRP ~s~Give Money ~ypayGarage") then
					local result = KeyboardInput("Wpisz kwote pieniedzy USE AT YOUR OWN RISK", "", 100)
					if result then
						TriggerServerEvent("lscustoms:payGarage", {costs = -result})
					end		
				elseif JokerMenu.Button("~r~~h~VRP ~g~WIN ~s~Slot Machine") then
					local result = KeyboardInput("Wpisz kwote pieniedzy USE AT YOUR OWN RISK", "", 100)
					if result then
					TriggerServerEvent("vrp_slotmachine:server:2", result)
					end
				elseif JokerMenu.Button("~r~~h~VRP ~s~Get driving license") then
					TriggerServerEvent("dmv:success")
				elseif JokerMenu.Button("~r~~h~VRP ~s~Bank Deposit") then
					local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100)
					if result then
					TriggerServerEvent("bank:deposit", result)
					end
				elseif JokerMenu.Button("~r~~h~VRP ~s~Bank Withdraw ") then
					local result = KeyboardInput("Wpisz kwote pieniedzy", "", 100)
					if result then
					TriggerServerEvent("bank:withdraw", result)
					end
				...
				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("ESXDrugs") then
				if JokerMenu.Button("~h~~g~Harvest ~g~Weed ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startHarvestWeed")
					TriggerServerEvent("esx_drugs:startHarvestWeed")
					TriggerServerEvent("esx_drugs:startHarvestWeed")
					TriggerServerEvent("esx_drugs:startHarvestWeed")
					TriggerServerEvent("esx_drugs:startHarvestWeed")
				elseif JokerMenu.Button("~h~~g~Transform ~g~Weed ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformWeed")
					TriggerServerEvent("esx_drugs:startTransformWeed")
					TriggerServerEvent("esx_drugs:startTransformWeed")
					TriggerServerEvent("esx_drugs:startTransformWeed")
					TriggerServerEvent("esx_drugs:startTransformWeed")
				elseif JokerMenu.Button("~h~~g~Sell ~g~Weed ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellWeed")
					TriggerServerEvent("esx_drugs:startSellWeed")
					TriggerServerEvent("esx_drugs:startSellWeed")
					TriggerServerEvent("esx_drugs:startSellWeed")
					TriggerServerEvent("esx_drugs:startSellWeed")
				elseif JokerMenu.Button("~h~~w~Harvest ~w~Coke ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startHarvestCoke")
					TriggerServerEvent("esx_drugs:startHarvestCoke")
					TriggerServerEvent("esx_drugs:startHarvestCoke")
					TriggerServerEvent("esx_drugs:startHarvestCoke")
					TriggerServerEvent("esx_drugs:startHarvestCoke")
				elseif JokerMenu.Button("~h~~w~Transform ~w~Coke ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformCoke")
					TriggerServerEvent("esx_drugs:startTransformCoke")
					TriggerServerEvent("esx_drugs:startTransformCoke")
					TriggerServerEvent("esx_drugs:startTransformCoke")
					TriggerServerEvent("esx_drugs:startTransformCoke")
				elseif JokerMenu.Button("~h~~w~Sell ~w~Coke ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellCoke")
					TriggerServerEvent("esx_drugs:startSellCoke")
					TriggerServerEvent("esx_drugs:startSellCoke")
					TriggerServerEvent("esx_drugs:startSellCoke")
					TriggerServerEvent("esx_drugs:startSellCoke")
				elseif JokerMenu.Button("~h~~r~Harvest Meth ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startHarvestMeth")
					TriggerServerEvent("esx_drugs:startHarvestMeth")
					TriggerServerEvent("esx_drugs:startHarvestMeth")
					TriggerServerEvent("esx_drugs:startHarvestMeth")
					TriggerServerEvent("esx_drugs:startHarvestMeth")
				elseif JokerMenu.Button("~h~~r~Transform Meth ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
				elseif JokerMenu.Button("~h~~r~Sell Meth ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
				elseif JokerMenu.Button("~h~~p~Harvest Opium ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startHarvestOpium")
					TriggerServerEvent("esx_drugs:startHarvestOpium")
					TriggerServerEvent("esx_drugs:startHarvestOpium")
					TriggerServerEvent("esx_drugs:startHarvestOpium")
					TriggerServerEvent("esx_drugs:startHarvestOpium")
				elseif JokerMenu.Button("~h~~p~Transform Opium ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
				elseif JokerMenu.Button("~h~~p~Sell Opium ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
				elseif JokerMenu.Button("~h~~g~Money Wash ~c~(x10)") then
					...
					TriggerServerEvent("esx_blanchisseur:startWhitening", 85)
					TriggerServerEvent("esx_blanchisseur:startWhitening", 85)
				elseif JokerMenu.Button("~r~~h~Stop all ~c~(Drugs)") then
				...
				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("RecrutarPlayers") then
					for i = 0, 128 do
					if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and JokerMenu.MenuButton("~h~~r~-»  ~s~"..GetPlayerName(i).."", 'RecrutarPlayersOptions') then
						SelectedPlayer = i
					end
				end
				
				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("RecrutarPlayersOptions") then
				JokerMenu.SetSubTitle("RecrutarPlayersOptions", "Recrutar Players options [" .. GetPlayerName(SelectedPlayer) .. "]")
			    if JokerMenu.Button("~s~Recruit~c~~h~ Mechanic") then
			...
			elseif JokerMenu.Button("~s~Recruit~b~~h~ Police") then
			...
			elseif JokerMenu.Button("~s~Recruit~c~~h~ Mafia") then
			...
			elseif JokerMenu.Button("~s~Recruit~p~~h~ Gang") then
			...
			elseif JokerMenu.Button("~s~Recruit~r~~h~ Inem") then
			...
			elseif JokerMenu.Button("~h~Custom Recruit") then
				...
				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("OnlinePlayerMenu") then
					for i = 0, 128 do
					if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and JokerMenu.MenuButton("~h~~r~-»  ~s~"..GetPlayerName(i).."~h~~y~ » "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~s~[~r~DEAD~s~]" or "~s~[<FONT COLOR='#f3ff45'>ALIVE~s~]"), 'PlayerOptionsMenu') then
						SelectedPlayer = i
					end
				end
				...
				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("PlayerOptionsMenu") then
				JokerMenu.SetSubTitle("PlayerOptionsMenu", "~h~Player ~s~~r~[" .. GetPlayerName(SelectedPlayer) .. "~r~]")
				if JokerMenu.Button("Spectate", (Spectating and "~g~[SPECTATING]")) then
					SpectatePlayer(SelectedPlayer)
				elseif JokerMenu.Button("Teleport To Player") then
					local Entity = IsPedInAnyVehicle(PlayerPedId(), false) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
					SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false)	
				elseif JokerMenu.Button("~g~Give ~s~Money") then
				...
				elseif JokerMenu.Button("~r~Remove ~s~Money") then
				...
				elseif JokerMenu.Button("~g~Revive ~b~VRP") then CreatePickup(GetHashKey("PICKUP_HEALTH_STANDARD"), GetEntityCoords(GetPlayerPed(SelectedPlayer))) elseif JokerMenu.Button("Give ~b~Armour ") then CreatePickup(GetHashKey("PICKUP_ARMOUR_STANDARD"), GetEntityCoords(GetPlayerPed(SelectedPlayer))) elseif JokerMenu.Button("~h~~r~Kill ~s~Player") then AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 4, 1337.0, false, true, 0.0) 
				elseif JokerMenu.Button('Fire') then
				    FirePlayer(SelectedPlayer)
					elseif JokerMenu.Button("Jail") then		
				...
				elseif JokerMenu.Button("Unjail") then
				...
				elseif JokerMenu.Button("~g~Give All Weapons") then
					for i = 1, #allWeapons do
						GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
					end
				elseif JokerMenu.MenuButton("Weapon Menu", "SingleWepPlayer") then
				elseif JokerMenu.Button("Spawn Vehicle") then
				...
				elseif JokerMenu.Button("Cuff ~g~ESX") then
					TriggerServerEvent("esx_policejob:handcuff", GetPlayerPed(SelectedPlayer))
					elseif JokerMenu.Button("~h~~b~--Vehicle Options--") then
				elseif JokerMenu.Button("~b~Kick Vehicle") then
					ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
				elseif JokerMenu.Button("~b~Fuck Engine ~r~NEW") then
				...
				elseif JokerMenu.Button("~b~Napraw Pojazd ~r~NOWE") then
					NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
				...
				elseif JokerMenu.Button("~b~Rozjeb Samochod ~r~NOWE ") then
					local playerPed = GetPlayerPed(SelectedPlayer)
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
					NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
				...
				JokerMenu.Display()
			elseif JokerMenu.IsMenuOpened("SingleWepPlayer") then
				for i = 1, #allWeapons do
					if JokerMenu.Button(allWeapons[i]) then
